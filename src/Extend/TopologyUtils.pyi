...
from OCC.Core.TopoDS import TopoDS_CompSolid, TopoDS_Compound, TopoDS_Edge, TopoDS_Face, TopoDS_Shape as TopoDS_Shape, TopoDS_Shell, TopoDS_Solid, TopoDS_Vertex, TopoDS_Wire
...
class TopologyExplorer:
    ...
    def __init__(self, my_shape: TopoDS_Shape, ignore_orientation: bool | None = True) -> None: ...
...
def dump_topology_to_string(shape: TopoDS_Shape, level: int | None = 0, buffer: str | None = '') -> None: ...
def discretize_wire(a_wire: TopoDS_Wire, deflection: float = 0.5, algorithm: str = 'QuasiUniformDeflection') -> list[gp_Pnt]: ...
def discretize_edge(a_edge: TopoDS_Edge, deflection: float = 0.2, algorithm: str = 'QuasiUniformDeflection'): ...
...
def get_sorted_hlr_edges(shape: TopoDS_Shape, position: gp_Pnt | None = None, direction: gp_Dir | None = None, export_hidden_edges: bool | None = True) -> tuple[list, list]: ...
