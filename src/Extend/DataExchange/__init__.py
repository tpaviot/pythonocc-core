...
def read_step_file(*kargs, **kwargs):
    warning_message = """"read_step_file function marked as deprecated since pythonocc-core-7.6.2.
...
def write_step_file(*kargs, **kwargs):
    warning_message = """"write_step_file function marked as deprecated since pythonocc-core-7.6.2.
    This function is now available from the OCC.Extend.DataExchange.STEP package, use:
...
def read_step_file_with_names_colors(*kargs, **kwargs):
    warning_message = """"read_step_file_with_names_colors function marked as deprecated since pythonocc-core-7.6.2.
    This function is now available from the OCC.Extend.DataExchange.STEP package, use:
...
def write_stl_file(*kargs, **kwargs):
    warning_message = """"write_stl_file function marked as deprecated since pythonocc-core-7.6.2.
...
def read_stl_file(*kargs, **kwargs):
    warning_message = """"read_stl_file function marked as deprecated since pythonocc-core-7.6.2.
    This function is now available from the OCC.Extend.DataExchange.STL package, use:
...
def read_iges_file(*kargs, **kwargs):
    warning_message = """"read_iges_file function marked as deprecated since pythonocc-core-7.6.2.
...
def write_iges_file(*kargs, **kwargs):
    warning_message = """"write_iges_file function marked as deprecated since pythonocc-core-7.6.2.
    This function is now available from the OCC.Extend.DataExchange.IGES package, use:
...
def edge_to_svg_polyline(*kargs, **kwargs):
    warning_message = """"edge_to_svg_polyline function marked as deprecated since pythonocc-core-7.6.2.
...
def export_shape_to_svg(*kargs, **kwargs):
    warning_message = """"export_shape_to_svg function marked as deprecated since pythonocc-core-7.6.2.
    This function is now available from the OCC.Extend.DataExchange.SVG package, use:
