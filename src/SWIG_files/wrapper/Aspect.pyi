...
class Aspect_Window(Standard_Transient):
    ...
    def DevicePixelRatio(self) -> False: ...
    def Dimensions(self) -> False: ...
...
class Aspect_WindowInputListener:
    ...
    def LastMousePosition(self) -> False: ...
