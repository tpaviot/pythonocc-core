...
class Aspect_SequenceOfColor:
    def Assign(self, theItem: Quantity_Color) -> Quantity_Color: ...
    def Clear(self) -> None: ...
...
Aspect_GradientFillMethod_Diagonal1 = (
    Aspect_GradientFillMethod.Aspect_GradientFillMethod_Diagonal1
)
Aspect_GradientFillMethod_Diagonal2 = (
    Aspect_GradientFillMethod.Aspect_GradientFillMethod_Diagonal2
)
...
Aspect_GradientFillMethod_Corner2 = (
    Aspect_GradientFillMethod.Aspect_GradientFillMethod_Corner2
)
...
Aspect_GradientFillMethod_Elliptical = (
    Aspect_GradientFillMethod.Aspect_GradientFillMethod_Elliptical
)
...
Aspect_TOR_RIGHT_AND_BOTTOM_BORDER = (
    Aspect_TypeOfResize.Aspect_TOR_RIGHT_AND_BOTTOM_BORDER
)
Aspect_TOR_BOTTOM_AND_LEFT_BORDER = (
    Aspect_TypeOfResize.Aspect_TOR_BOTTOM_AND_LEFT_BORDER
)
...
Aspect_XRGenericAction_IsHeadsetOn = (
    Aspect_XRGenericAction.Aspect_XRGenericAction_IsHeadsetOn
)
Aspect_XRGenericAction_InputAppMenu = (
    Aspect_XRGenericAction.Aspect_XRGenericAction_InputAppMenu
)
Aspect_XRGenericAction_InputSysMenu = (
    Aspect_XRGenericAction.Aspect_XRGenericAction_InputSysMenu
)
...
Aspect_XRGenericAction_InputGripClick = (
    Aspect_XRGenericAction.Aspect_XRGenericAction_InputGripClick
)
...
Aspect_XRGenericAction_InputTrackPadTouch = (
    Aspect_XRGenericAction.Aspect_XRGenericAction_InputTrackPadTouch
)
...
Aspect_XRGenericAction_InputThumbstickPosition = (
    Aspect_XRGenericAction.Aspect_XRGenericAction_InputThumbstickPosition
)
Aspect_XRGenericAction_InputThumbstickTouch = (
    Aspect_XRGenericAction.Aspect_XRGenericAction_InputThumbstickTouch
)
...
Aspect_XRGenericAction_InputPoseBase = (
    Aspect_XRGenericAction.Aspect_XRGenericAction_InputPoseBase
)
Aspect_XRGenericAction_InputPoseFront = (
    Aspect_XRGenericAction.Aspect_XRGenericAction_InputPoseFront
)
Aspect_XRGenericAction_InputPoseHandGrip = (
    Aspect_XRGenericAction.Aspect_XRGenericAction_InputPoseHandGrip
)
Aspect_XRGenericAction_InputPoseFingerTip = (
    Aspect_XRGenericAction.Aspect_XRGenericAction_InputPoseFingerTip
)
...
Aspect_XRTrackedDeviceRole_Other = (
    Aspect_XRTrackedDeviceRole.Aspect_XRTrackedDeviceRole_Other
)
...
class Aspect_ScrollDelta:
    ...
    def __init__(
        self,
        theValue: float,
        theFlags: Optional[Aspect_VKeyFlags] = Aspect_VKeyFlags_NONE,
    ) -> None: ...
...
class Aspect_XRSession(Standard_Transient):
    ...
    def GenericAction(
        self, theDevice: Aspect_XRTrackedDeviceRole, theAction: Aspect_XRGenericAction
    ) -> Aspect_XRAction: ...
    def GetAnalogActionData(
        self, theAction: Aspect_XRAction
    ...
    @overload
    def LoadRenderModel(
        self, theDevice: int, theTexture: Image_Texture
    ) -> Graphic3d_ArrayOfTriangles: ...
    @overload
    def LoadRenderModel(
        self, theDevice: int, theToApplyUnitFactor: bool, theTexture: Image_Texture
    ) -> Graphic3d_ArrayOfTriangles: ...
    ...
    def ProjectionMatrix(
        self, theEye: Aspect_Eye, theZNear: float, theZFar: float
    ) -> False: ...
    ...
    def TriggerHapticVibrationAction(
        self, theAction: Aspect_XRAction, theParams: Aspect_XRHapticActionData
    ) -> None: ...
