...
Quantity_HArray1OfColor = NewType("Quantity_HArray1OfColor", Any)
...
class Quantity_Color:
    ...
    @overload
    @staticmethod
    def Convert_LinearRGB_To_sRGB(theLinearValue: float) -> False: ...
    @overload
    @staticmethod
    ...
    @overload
    @staticmethod
    def Convert_sRGB_To_LinearRGB(thesRGBValue: float) -> False: ...
    @overload
    @staticmethod
