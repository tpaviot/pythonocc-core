...
Quantity_NOC_LIGHTGOLDENRODYELLOW = (
    Quantity_NameOfColor.Quantity_NOC_LIGHTGOLDENRODYELLOW
)
...
class Quantity_Color:
    ...
    @overload
    def __init__(
        self, theC1: float, theC2: float, theC3: float, theType: Quantity_TypeOfColor
    ) -> None: ...
    @overload
    ...
    @staticmethod
    def ColorToHex(
        theColor: Quantity_Color, theToPrefixHash: Optional[bool] = true
    ) -> str: ...
    @staticmethod
...
class Quantity_ColorRGBA:
    ...
    @overload
    def __init__(
        self, theRed: float, theGreen: float, theBlue: float, theAlpha: float
    ) -> None: ...
    ...
    def ColorFromHex(
        ...
        theAlphaComponentIsOff: Optional[bool] = false,
    ) -> bool: ...
    @staticmethod
    def ColorFromName(
        theColorNameString: str, theColor: Quantity_ColorRGBA
    ) -> bool: ...
    @staticmethod
    def ColorToHex(
        theColor: Quantity_ColorRGBA, theToPrefixHash: Optional[bool] = true
    ) -> str: ...
    @staticmethod
...
class Quantity_ColorRGBAHasher:
    ...
    @staticmethod
    def IsEqual(
        theColor1: Quantity_ColorRGBA, theColor2: Quantity_ColorRGBA
    ) -> bool: ...
