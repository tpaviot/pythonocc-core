...
class Bnd_B2d:
    ...
    @overload
    def IsOut(
        self, theCenter: gp_XY, theRadius: float, isCircleHollow: Optional[bool] = False
    ) -> bool: ...
    @overload
...
class Bnd_B3d:
    ...
    def IsOut(
        ...
        theCenter: gp_XYZ,
        theRadius: float,
        isSphereHollow: Optional[bool] = False,
    ) -> bool: ...
    @overload
    ...
    def IsOut(
        self,
        theLine: gp_Ax1,
        isRay: Optional[bool] = False,
        theOverthickness: Optional[float] = 0.0,
    ) -> bool: ...
    @overload
...
class Bnd_Box2d:
    ...
    @overload
    def Update(
        self, aXmin: float, aYmin: float, aXmax: float, aYmax: float
    ) -> None: ...
    @overload
...
class Bnd_OBB:
    ...
    def ReBuild(
        ...
        theListOfTolerances: Optional[TColStd_Array1OfReal] = 0,
...
class Bnd_Sphere:
    ...
    @overload
    def __init__(
        self, theCntr: gp_XYZ, theRad: float, theU: int, theV: int
    ) -> None: ...
    ...
    def Project(
        self, theNode: gp_XYZ, theProjNode: gp_XYZ
