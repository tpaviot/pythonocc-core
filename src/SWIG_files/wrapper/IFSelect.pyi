...
class IFSelect_Dispatch(Standard_Transient):
    ...
    def Packets(self, G: Interface_Graph, packs: Any) -> None: ...
...
class IFSelect_SelectionIterator:
    ...
    def AddList(self, list: Any) -> None: ...
    def More(self) -> bool: ...
    def Next(self) -> None: ...
...
class IFSelect_SessionFile:
    ...
    def WriteLine(self, line: str, follow: Optional[Any] = 0) -> None: ...
...
class IFSelect_SignatureList(Standard_Transient):
    ...
    def Init(self, name: str, count: Storage_PType, list: Any, nbnuls: int) -> None: ...
...
class IFSelect_WorkSession(Standard_Transient):
    ...
    def SetParams(self, params: Any, uselist: Any) -> None: ...
