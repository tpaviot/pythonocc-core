...
IFSelect_HSeqOfSelection = NewType("IFSelect_HSeqOfSelection", Any)
...
class IFSelect_Activator(Standard_Transient):
    ...
    @staticmethod
    def Commands(mode: Optional[int] = -1, command: Optional[str] = "") -> False: ...
...
class IFSelect_EditForm(Standard_Transient):
    ...
    def EditedList(self, num: int) -> False: ...
    ...
    def OriginalList(self, num: int) -> False: ...
...
class IFSelect_Editor(Standard_Transient):
    ...
    def Label(self) -> str: ...
    def ListEditor(self, num: int) -> IFSelect_ListEditor: ...
    def ListValue(self, form: IFSelect_EditForm, num: int) -> False: ...
...
class IFSelect_Functions:
    ...
    @staticmethod
    def GiveList(WS: IFSelect_WorkSession, first: Optional[str] = "", second: Optional[str] = "") -> False: ...
    @staticmethod
    def Init() -> None: ...
...
class IFSelect_ModelCopier(Standard_Transient):
    ...
    @overload
    def CopiedRemaining(self, G: Interface_Graph, WL: IFSelect_WorkLibrary, TC: Interface_CopyTool) -> Interface_InterfaceModel: ...
    @overload
...
class IFSelect_SignatureList(Standard_Transient):
    ...
    def Clear(self) -> None: ...
    def Entities(self, sign: str) -> False: ...
    def HasEntities(self) -> bool: ...
    def LastValue(self) -> str: ...
    def List(self, root: Optional[str] = "") -> False: ...
...
class IFSelect_WorkSession(Standard_Transient):
    ...
    def AppliedDispatches(self) -> False: ...
    ...
    def FinalModifierIdents(self, formodel: bool) -> False: ...
    ...
    @overload
    def GiveList(self, obj: Standard_Transient) -> False: ...
    @overload
    def GiveList(self, first: str, second: Optional[str] = "") -> False: ...
    def GiveListFromList(self, selname: str, ent: Standard_Transient) -> False: ...
    ...
    def ItemIdents(self, type: Standard_Type) -> False: ...
    def ItemLabel(self, id: int) -> TCollection_HAsciiString: ...
    def ItemNames(self, type: Standard_Type) -> False: ...
    def ItemNamesForLabel(self, label: str) -> False: ...
    ...
    def SelectionResult(self, sel: IFSelect_Selection) -> False: ...
    ...
    def ShareOut(self) -> IFSelect_ShareOut: ...
    def Shareds(self, ent: Standard_Transient) -> False: ...
    def Sharings(self, ent: Standard_Transient) -> False: ...
...
class IFSelect_TransformStandard(IFSelect_Transformer):
    ...
    @overload
    def Copy(self, G: Interface_Graph, TC: Interface_CopyTool) -> Interface_InterfaceModel: ...
    @overload
    ...
    def NbModifiers(self) -> int: ...
    @overload
    def OnTheSpot(self, G: Interface_Graph, TC: Interface_CopyTool) -> Interface_InterfaceModel: ...
    @overload
    ...
    def SetSelection(self, sel: IFSelect_Selection) -> None: ...
    @overload
    def StandardCopy(self, G: Interface_Graph, TC: Interface_CopyTool) -> Interface_InterfaceModel: ...
    @overload
