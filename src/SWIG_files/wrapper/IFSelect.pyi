...
class IFSelect_Activator(Standard_Transient):
    ...
    @staticmethod
    def Adding(
        actor: IFSelect_Activator, number: int, command: str, mode: int
    ) -> None: ...
    @staticmethod
    def Commands(
        mode: Optional[int] = -1, command: Optional[str] = ""
    ) -> TColStd_HSequenceOfAsciiString: ...
    def Do(
        self, number: int, pilot: IFSelect_SessionPilot
...
class IFSelect_ContextModif:
    ...
    @overload
    def __init__(
        self, graph: Interface_Graph, filename: Optional[str] = ""
    ) -> None: ...
    def AddCheck(self, check: Interface_Check) -> None: ...
    def AddFail(
        self, start: Standard_Transient, mess: str, orig: Optional[str] = ""
    ) -> None: ...
    def AddWarning(
        self, start: Standard_Transient, mess: str, orig: Optional[str] = ""
    ) -> None: ...
...
class IFSelect_EditForm(Standard_Transient):
    ...
    def Apply(self) -> bool: ...
    def ApplyData(
        self, ent: Standard_Transient, model: Interface_InterfaceModel
    ) -> bool: ...
    ...
    def ModifyList(
        self, num: int, edited: IFSelect_ListEditor, enforce: Optional[bool] = False
    ) -> bool: ...
    def ModifyListValue(
        self,
        num: int,
    ...
    def PrintValues(
        self, what: int, names: bool, alsolist: Optional[bool] = False
    ) -> str: ...
...
class IFSelect_Editor(Standard_Transient):
    ...
    def Form(
        self, readonly: bool, undoable: Optional[bool] = True
    ) -> IFSelect_EditForm: ...
    ...
    def SetValue(
        ...
        accessmode: Optional[IFSelect_EditValue] = IFSelect_Editable,
    ) -> None: ...
    def StringValue(
        self, form: IFSelect_EditForm, num: int
...
class IFSelect_Functions:
    @staticmethod
    def GiveDispatch(
        WS: IFSelect_WorkSession, name: str, mode: Optional[bool] = True
    ) -> IFSelect_Dispatch: ...
    @staticmethod
    def GiveEntity(
        WS: IFSelect_WorkSession, name: Optional[str] = ""
    ) -> Standard_Transient: ...
    @staticmethod
    def GiveEntityNumber(WS: IFSelect_WorkSession, name: Optional[str] = "") -> int: ...
    @staticmethod
    def GiveList(
        WS: IFSelect_WorkSession, first: Optional[str] = "", second: Optional[str] = ""
...
class IFSelect_ListEditor(Standard_Transient):
    ...
    def AddValue(
        self, val: TCollection_HAsciiString, atnum: Optional[int] = 0
    ) -> bool: ...
    ...
    def Value(
        self, num: int, edited: Optional[bool] = True
    ) -> TCollection_HAsciiString: ...
...
class IFSelect_ModelCopier(Standard_Transient):
    ...
    def SendCopied(
        self, WL: IFSelect_WorkLibrary, protocol: Interface_Protocol
    ) -> Interface_CheckIterator: ...
    def SendSelected(
        self,
        filename: str,
    ...
    def SetAppliedModifiers(
        self, num: int, applied: IFSelect_AppliedModifiers
    ) -> bool: ...
...
class IFSelect_SessionDumper(Standard_Transient):
    ...
    def ReadOwn(
        self, file: IFSelect_SessionFile, type: str, item: Standard_Transient
    ) -> bool: ...
    def WriteOwn(
        self, file: IFSelect_SessionFile, item: Standard_Transient
    ) -> bool: ...
...
class IFSelect_SessionFile:
    ...
    def AddItem(
        self, item: Standard_Transient, active: Optional[bool] = True
    ) -> None: ...
...
class IFSelect_ShareOut(Standard_Transient):
    ...
    def AddModif(
        ...
        formodel: bool,
        atnum: Optional[int] = 0,
    ) -> None: ...
    @overload
    def AddModifier(self, modifier: IFSelect_GeneralModifier, atnum: int) -> None: ...
    @overload
    def AddModifier(
        self, modifier: IFSelect_GeneralModifier, dispnum: int, atnum: int
    ) -> None: ...
...
class IFSelect_ShareOutResult:
    @overload
    def __init__(
        self, sho: IFSelect_ShareOut, mod: Interface_InterfaceModel
    ) -> None: ...
    @overload
    def __init__(self, sho: IFSelect_ShareOut, G: Interface_Graph) -> None: ...
    @overload
    def __init__(
        self, disp: IFSelect_Dispatch, mod: Interface_InterfaceModel
    ) -> None: ...
    @overload
...
class IFSelect_Signature(Interface_SignType):
    ...
    def Name(self) -> str: ...
    def SetIntCase(
        self, hasmin: bool, valmin: int, hasmax: bool, valmax: int
    ) -> None: ...
...
class IFSelect_SignatureList(Standard_Transient):
    ...
    def PrintList(
        self,
        model: Interface_InterfaceModel,
        mod: Optional[IFSelect_PrintCount] = IFSelect_ListByItem,
    ) -> str: ...
...
class IFSelect_Transformer(Standard_Transient):
    ...
    def Updated(
        self, entfrom: Standard_Transient, entto: Standard_Transient
    ) -> bool: ...
...
class IFSelect_WorkLibrary(Standard_Transient):
    ...
    def ReadFile(
        self, name: str, model: Interface_InterfaceModel, protocol: Interface_Protocol
    ) -> int: ...
    def ReadStream(
        self,
        theName: str,
...
class IFSelect_WorkSession(Standard_Transient):
    ...
    def AddNamedItem(
        self, name: str, item: Standard_Transient, active: Optional[bool] = True
    ) -> int: ...
    ...
    def CheckOne(
        self, ent: Standard_Transient, complete: Optional[bool] = True
    ) -> Interface_CheckIterator: ...
    ...
    def CombineRemove(
        self, selcomb: IFSelect_Selection, selrem: IFSelect_Selection
    ) -> bool: ...
    def ComputeCheck(self, enforce: Optional[bool] = False) -> bool: ...
    def ComputeCounter(
        self, counter: IFSelect_SignCounter, forced: Optional[bool] = False
    ) -> bool: ...
    ...
    def EvaluateDispatch(
        self, disp: IFSelect_Dispatch, mode: Optional[int] = 0
    ) -> None: ...
    ...
    @overload
    def GiveList(
        self, first: str, second: Optional[str] = ""
    ) -> TColStd_HSequenceOfTransient: ...
    ...
    def GiveListFromList(
        self, selname: str, ent: Standard_Transient
    ) -> TColStd_HSequenceOfTransient: ...
    ...
    def Model(self) -> Interface_InterfaceModel: ...
    def ModelCheckList(
        self, complete: Optional[bool] = True
    ) -> Interface_CheckIterator: ...
    ...
    def NewParamFromStatic(
        self, statname: str, name: Optional[str] = ""
    ) -> Standard_Transient: ...
    def NewSelectPointed(
        self, list: TColStd_HSequenceOfTransient, name: str
    ) -> IFSelect_Selection: ...
    def NewTextParam(self, name: Optional[str] = "") -> TCollection_HAsciiString: ...
    def NewTransformStandard(
        self, copy: bool, name: Optional[str] = ""
    ) -> IFSelect_Transformer: ...
    def NextIdentForLabel(
        self, label: str, id: int, mode: Optional[int] = 0
    ) -> int: ...
    ...
    def PrintSignatureList(
        self, signlist: IFSelect_SignatureList, mode: IFSelect_PrintCount
    ) -> str: ...
    def Protocol(self) -> Interface_Protocol: ...
    def QueryCheckList(self, chl: Interface_CheckIterator) -> None: ...
    def QueryCheckStatus(self, ent: Standard_Transient) -> int: ...
    def QueryParent(
        self, entdad: Standard_Transient, entson: Standard_Transient
    ) -> int: ...
    ...
    def RunModifierSelected(
        self, modif: IFSelect_Modifier, sel: IFSelect_Selection, copy: bool
    ) -> int: ...
    def RunTransformer(self, transf: IFSelect_Transformer) -> int: ...
    def Selection(self, id: int) -> IFSelect_Selection: ...
    def SelectionResult(
        self, sel: IFSelect_Selection
    ) -> TColStd_HSequenceOfTransient: ...
    def SelectionResultFromList(
        self, sel: IFSelect_Selection, list: TColStd_HSequenceOfTransient
    ) -> TColStd_HSequenceOfTransient: ...
    def SendAll(
        self, filename: str, computegraph: Optional[bool] = False
    ) -> IFSelect_ReturnStatus: ...
    def SendSelected(
        self,
        filename: str,
        sel: IFSelect_Selection,
        computegraph: Optional[bool] = False,
    ) -> IFSelect_ReturnStatus: ...
    ...
    def SetAppliedModifier(
        self, modif: IFSelect_GeneralModifier, item: Standard_Transient
    ) -> bool: ...
    def SetControl(
        self,
        sel: IFSelect_Selection,
        sc: IFSelect_Selection,
        formain: Optional[bool] = True,
    ) -> bool: ...
    ...
    def SetInputSelection(
        self, sel: IFSelect_Selection, input: IFSelect_Selection
    ) -> bool: ...
    def SetIntValue(self, it: IFSelect_IntParam, val: int) -> bool: ...
    def SetItemSelection(
        self, item: Standard_Transient, sel: IFSelect_Selection
    ) -> bool: ...
    ...
    def SetModel(
        self, model: Interface_InterfaceModel, clearpointed: Optional[bool] = True
    ) -> None: ...
    ...
    def SetSelectPointed(
        self, sel: IFSelect_Selection, list: TColStd_HSequenceOfTransient, mode: int
    ) -> bool: ...
    ...
    def Source(
        self, sel: IFSelect_Selection, num: Optional[int] = 1
    ) -> IFSelect_Selection: ...
    ...
    def UsesAppliedModifier(
        self, modif: IFSelect_GeneralModifier
    ) -> Standard_Transient: ...
    ...
    @overload
    def WriteFile(
        self, filename: str, sel: IFSelect_Selection
    ) -> IFSelect_ReturnStatus: ...
...
class IFSelect_ParamEditor(IFSelect_Editor):
    def __init__(
        self, nbmax: Optional[int] = 100, label: Optional[str] = ""
    ) -> None: ...
    def AddConstantText(
        self, val: str, shortname: str, completename: Optional[str] = ""
    ) -> None: ...
    def AddValue(
        self, val: Interface_TypedValue, shortname: Optional[str] = ""
    ) -> None: ...
    def Apply(
        self,
        form: IFSelect_EditForm,
    ...
    @staticmethod
    def StaticEditor(
        list: TColStd_HSequenceOfHAsciiString, label: Optional[str] = ""
...
class IFSelect_SessionPilot(IFSelect_Activator):
    ...
    def Do(
        self, number: int, session: IFSelect_SessionPilot
    ) -> IFSelect_ReturnStatus: ...
    ...
    def ExecuteCounter(
        ...
        counter: IFSelect_SignCounter,
        numword: int,
        mode: Optional[IFSelect_PrintCount] = IFSelect_CountByItem,
    ) -> IFSelect_ReturnStatus: ...
    def Help(self, number: int) -> str: ...
...
class IFSelect_SignCounter(IFSelect_SignatureList):
    @overload
    def __init__(
        self, withmap: Optional[bool] = True, withlist: Optional[bool] = False
    ) -> None: ...
    @overload
    def __init__(
        self,
        matcher: IFSelect_Signature,
        withmap: Optional[bool] = True,
        withlist: Optional[bool] = False,
    ) -> None: ...
    def AddEntity(
        self, ent: Standard_Transient, model: Interface_InterfaceModel
    ) -> bool: ...
    ...
    def AddList(
        self, list: TColStd_HSequenceOfTransient, model: Interface_InterfaceModel
    ) -> None: ...
    ...
    def AddWithGraph(
        self, list: TColStd_HSequenceOfTransient, graph: Interface_Graph
    ) -> None: ...
    def ComputeSelected(
        self, G: Interface_Graph, forced: Optional[bool] = False
    ) -> bool: ...
...
class IFSelect_TransformStandard(IFSelect_Transformer):
    def __init__(self) -> None: ...
    def AddModifier(
        self, modif: IFSelect_Modifier, atnum: Optional[int] = 0
    ) -> bool: ...
    def ApplyModifiers(
        self,
        G: Interface_Graph,
...
class IFSelect_SelectAnyList(IFSelect_SelectDeduct):
    def FillResult(
        self, n1: int, n2: int, ent: Standard_Transient, res: Interface_EntityIterator
    ) -> None: ...
    ...
    def SetRange(
        self, rankfrom: IFSelect_IntParam, rankto: IFSelect_IntParam
    ) -> None: ...
...
class IFSelect_SelectExtract(IFSelect_SelectDeduct):
    ...
    def Sort(
        self, rank: int, ent: Standard_Transient, model: Interface_InterfaceModel
    ) -> bool: ...
    def SortInGraph(
        self, rank: int, ent: Standard_Transient, G: Interface_Graph
    ) -> bool: ...
...
class IFSelect_SelectSent(IFSelect_SelectExtract):
    def __init__(
        self, sentcount: Optional[int] = 1, atleast: Optional[bool] = True
    ) -> None: ...
...
class IFSelect_SelectSignature(IFSelect_SelectExtract):
    @overload
    def __init__(
        self, matcher: IFSelect_Signature, signtext: str, exact: Optional[bool] = True
    ) -> None: ...
    @overload
    def __init__(
        self, matcher: IFSelect_Signature, signtext: str, exact: Optional[bool] = True
    ...
    @overload
    def __init__(
        self, matcher: IFSelect_SignCounter, signtext: str, exact: Optional[bool] = True
    ) -> None: ...
