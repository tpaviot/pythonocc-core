...
class BRepOffset_Analyse:
    ...
    def Type(self, theE: TopoDS_Edge) -> Any: ...
...
class BRepOffset_Inter3d:
    ...
    def ConnexIntByInt(self, SI: TopoDS_Shape, MapSF: Any, A: BRepOffset_Analyse, MES: TopTools_DataMapOfShapeShape, Build: TopTools_DataMapOfShapeShape, Failed: TopTools_ListOfShape, theRange: Message_ProgressRange, bIsPlanar: Optional[bool] = False) -> None: ...
    ...
    def ContextIntByInt(self, ContextFaces: TopTools_IndexedMapOfShape, ExtentContext: bool, MapSF: Any, A: BRepOffset_Analyse, MES: TopTools_DataMapOfShapeShape, Build: TopTools_DataMapOfShapeShape, Failed: TopTools_ListOfShape, theRange: Message_ProgressRange, bIsPlanar: Optional[bool] = False) -> None: ...
