...
class BRepGProp {
	...
	:param SkipShared: default value is Standard_False
	:type SkipShared: bool
	:rtype: float") VolumePropertiesGK;
...
class BRepGProp_Cinert : public GProp_GProps {
	public:
		...
		%feature("autodoc", ":rtype: None") BRepGProp_Cinert;
		 BRepGProp_Cinert ();
...
class BRepGProp_Face {
	...
	:type theTMax: float
	:param theTKnots:
	:type theTKnots: opencascade::handle<TColStd_HArray1OfReal> &
	:rtype: None") GetTKnots;
	...
	:type theUMax: float
	:param theUKnots:
	:type theUKnots: opencascade::handle<TColStd_HArray1OfReal> &
	:rtype: None") GetUKnots;
	...
	:rtype: int") LIntOrder;
		...
		%feature("autodoc", ":rtype: int") LIntSubs;
	...
	:rtype: int") SIntOrder;
		...
		%feature("autodoc", ":rtype: int") SUIntSubs;
		Standard_Integer SUIntSubs ();

		/****************** SVIntSubs ******************/
		%feature("compactdefaultargs") SVIntSubs;
		%feature("autodoc", ":rtype: int") SVIntSubs;
	...
	:rtype: None") UKnots;
		...
		%feature("autodoc", ":rtype: int") VIntegrationOrder;
...
class BRepGProp_MeshCinert : public GProp_GProps {
	public:
		...
		%feature("autodoc", ":rtype: None") BRepGProp_MeshCinert;
		 BRepGProp_MeshCinert ();
	...
	:param thePolyg:
	:type thePolyg: opencascade::handle<TColgp_HArray1OfPnt>
	:rtype: void") PreparePolygon;
...
class BRepGProp_TFunction : public math_Function {
	...
	:rtype: None") BRepGProp_TFunction;
...
class BRepGProp_UFunction : public math_Function {
	...
	:param theCoeffs:
	:type theCoeffs: Standard_Address
	:rtype: None") BRepGProp_UFunction;
...
class BRepGProp_Vinert : public GProp_GProps {
	public:
		...
		%feature("autodoc", ":rtype: None") BRepGProp_Vinert;
		 BRepGProp_Vinert ();
