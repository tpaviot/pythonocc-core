...
class Geom2dLProp_CLProps2d:
    ...
    @overload
    def __init__(
        self, C: Geom2d_Curve, U: float, N: int, Resolution: float
    ) -> None: ...
    @overload
...
class Geom2dLProp_Curve2dTool:
    ...
    @staticmethod
    def D2(
        C: Geom2d_Curve, U: float, P: gp_Pnt2d, V1: gp_Vec2d, V2: gp_Vec2d
    ) -> None: ...
    @staticmethod
    def D3(
        C: Geom2d_Curve, U: float, P: gp_Pnt2d, V1: gp_Vec2d, V2: gp_Vec2d, V3: gp_Vec2d
    ) -> None: ...
    @staticmethod
...
class Geom2dLProp_NumericCurInf2d:
    ...
    @overload
    def PerformCurExt(
        self, C: Geom2d_Curve, UMin: float, UMax: float, Result: LProp_CurAndInf
    ) -> None: ...
    @overload
