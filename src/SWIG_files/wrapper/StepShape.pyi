...
StepShape_HArray1OfConnectedEdgeSet = NewType("StepShape_HArray1OfConnectedEdgeSet", Any)
# the following typedef cannot be wrapped as is
StepShape_HArray1OfConnectedFaceSet = NewType("StepShape_HArray1OfConnectedFaceSet", Any)
# the following typedef cannot be wrapped as is
StepShape_HArray1OfEdge = NewType("StepShape_HArray1OfEdge", Any)
# the following typedef cannot be wrapped as is
StepShape_HArray1OfFace = NewType("StepShape_HArray1OfFace", Any)
# the following typedef cannot be wrapped as is
StepShape_HArray1OfFaceBound = NewType("StepShape_HArray1OfFaceBound", Any)
# the following typedef cannot be wrapped as is
StepShape_HArray1OfGeometricSetSelect = NewType("StepShape_HArray1OfGeometricSetSelect", Any)
# the following typedef cannot be wrapped as is
StepShape_HArray1OfOrientedClosedShell = NewType("StepShape_HArray1OfOrientedClosedShell", Any)
# the following typedef cannot be wrapped as is
StepShape_HArray1OfOrientedEdge = NewType("StepShape_HArray1OfOrientedEdge", Any)
# the following typedef cannot be wrapped as is
StepShape_HArray1OfShapeDimensionRepresentationItem = NewType("StepShape_HArray1OfShapeDimensionRepresentationItem", Any)
# the following typedef cannot be wrapped as is
StepShape_HArray1OfShell = NewType("StepShape_HArray1OfShell", Any)
# the following typedef cannot be wrapped as is
StepShape_HArray1OfValueQualifier = NewType("StepShape_HArray1OfValueQualifier", Any)
