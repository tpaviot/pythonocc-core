...
class StepShape_Array1OfGeometricSetSelect:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepShape_GeometricSetSelect]: ...
...
class StepShape_Array1OfShapeDimensionRepresentationItem:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepShape_ShapeDimensionRepresentationItem]: ...
...
class StepShape_Array1OfShell:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepShape_Shell]: ...
...
class StepShape_Array1OfValueQualifier:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepShape_ValueQualifier]: ...
...
class StepShape_EdgeBasedWireframeModel(StepGeom_GeometricRepresentationItem):
    def __init__(self) -> None: ...
    def EbwmBoundary(self) -> Any: ...
    def Init(self, aRepresentationItem_Name: TCollection_HAsciiString, aEbwmBoundary: Any) -> None: ...
    def SetEbwmBoundary(self, EbwmBoundary: Any) -> None: ...

class StepShape_FaceBasedSurfaceModel(StepGeom_GeometricRepresentationItem):
    def __init__(self) -> None: ...
    def FbsmFaces(self) -> Any: ...
    def Init(self, aRepresentationItem_Name: TCollection_HAsciiString, aFbsmFaces: Any) -> None: ...
    def SetFbsmFaces(self, FbsmFaces: Any) -> None: ...
...
class StepShape_GeometricSet(StepGeom_GeometricRepresentationItem):
    ...
    def Init(self, aName: TCollection_HAsciiString, aElements: Any) -> None: ...
    def NbElements(self) -> int: ...
    def SetElements(self, aElements: Any) -> None: ...
...
class StepShape_MeasureQualification(Standard_Transient):
    ...
    def Init(self, name: TCollection_HAsciiString, description: TCollection_HAsciiString, qualified_measure: Standard_Transient, qualifiers: Any) -> None: ...
    def Name(self) -> TCollection_HAsciiString: ...
    def NbQualifiers(self) -> int: ...
    def QualifiedMeasure(self) -> Standard_Transient: ...
    def Qualifiers(self) -> Any: ...
    ...
    def SetName(self, name: TCollection_HAsciiString) -> None: ...
    def SetQualifiedMeasure(self, qualified_measure: Standard_Transient) -> None: ...
    def SetQualifiers(self, qualifiers: Any) -> None: ...
...
class StepShape_MeasureRepresentationItemAndQualifiedRepresentationItem(StepRepr_RepresentationItem):
    def __init__(self) -> None: ...
    def Init(self, aName: TCollection_HAsciiString, aValueComponent: StepBasic_MeasureValueMember, aUnitComponent: StepBasic_Unit, qualifiers: Any) -> None: ...
...
class StepShape_QualifiedRepresentationItem(StepRepr_RepresentationItem):
    def __init__(self) -> None: ...
    def Init(self, aName: TCollection_HAsciiString, qualifiers: Any) -> None: ...
    def NbQualifiers(self) -> int: ...
    def Qualifiers(self) -> Any: ...
    def QualifiersValue(self, num: int) -> StepShape_ValueQualifier: ...
    def SetQualifiers(self, qualifiers: Any) -> None: ...
...
class StepShape_ShellBasedSurfaceModel(StepGeom_GeometricRepresentationItem):
    def __init__(self) -> None: ...
    def Init(self, aName: TCollection_HAsciiString, aSbsmBoundary: Any) -> None: ...
    def NbSbsmBoundary(self) -> int: ...
    def SbsmBoundary(self) -> Any: ...
    def SbsmBoundaryValue(self, num: int) -> StepShape_Shell: ...
    def SetSbsmBoundary(self, aSbsmBoundary: Any) -> None: ...
...
class StepShape_ConnectedEdgeSet(StepShape_TopologicalRepresentationItem):
    def __init__(self) -> None: ...
    def CesEdges(self) -> Any: ...
    def Init(self, aRepresentationItem_Name: TCollection_HAsciiString, aCesEdges: Any) -> None: ...
    def SetCesEdges(self, CesEdges: Any) -> None: ...

class StepShape_ConnectedFaceSet(StepShape_TopologicalRepresentationItem):
    def __init__(self) -> None: ...
    def CfsFaces(self) -> Any: ...
    def CfsFacesValue(self, num: int) -> StepShape_Face: ...
    def Init(self, aName: TCollection_HAsciiString, aCfsFaces: Any) -> None: ...
    def NbCfsFaces(self) -> int: ...
    def SetCfsFaces(self, aCfsFaces: Any) -> None: ...
...
class StepShape_Face(StepShape_TopologicalRepresentationItem):
    ...
    def Init(self, aName: TCollection_HAsciiString, aBounds: Any) -> None: ...
    def NbBounds(self) -> int: ...
    def SetBounds(self, aBounds: Any) -> None: ...
...
class StepShape_LoopAndPath(StepShape_TopologicalRepresentationItem):
    ...
    @overload
    def Init(self, aName: TCollection_HAsciiString, aEdgeList: Any) -> None: ...
    def Loop(self) -> StepShape_Loop: ...
    def NbEdgeList(self) -> int: ...
    def Path(self) -> StepShape_Path: ...
    def SetEdgeList(self, aEdgeList: Any) -> None: ...
...
class StepShape_ShapeDimensionRepresentation(StepShape_ShapeRepresentation):
    def __init__(self) -> None: ...
    @overload
    def Init(self, theName: TCollection_HAsciiString, theItems: Any, theContextOfItems: StepRepr_RepresentationContext) -> None: ...
    @overload
    def Init(self, theName: TCollection_HAsciiString, theItems: Any, theContextOfItems: StepRepr_RepresentationContext) -> None: ...
    def ItemsAP242(self) -> Any: ...
    def SetItemsAP242(self, theItems: Any) -> None: ...
...
class StepShape_BrepWithVoids(StepShape_ManifoldSolidBrep):
    def __init__(self) -> None: ...
    def Init(self, aName: TCollection_HAsciiString, aOuter: StepShape_ClosedShell, aVoids: Any) -> None: ...
    def NbVoids(self) -> int: ...
    def SetVoids(self, aVoids: Any) -> None: ...
    def Voids(self) -> Any: ...
...
class StepShape_ConnectedFaceSubSet(StepShape_ConnectedFaceSet):
    def __init__(self) -> None: ...
    def Init(self, aRepresentationItem_Name: TCollection_HAsciiString, aConnectedFaceSet_CfsFaces: Any, aParentFaceSet: StepShape_ConnectedFaceSet) -> None: ...
...
class StepShape_FaceSurface(StepShape_Face):
    ...
    def Init(self, aName: TCollection_HAsciiString, aBounds: Any, aFaceGeometry: StepGeom_Surface, aSameSense: bool) -> None: ...
    def SameSense(self) -> bool: ...
...
class StepShape_PolyLoop(StepShape_Loop):
    def __init__(self) -> None: ...
    def Init(self, aName: TCollection_HAsciiString, aPolygon: Any) -> None: ...
    def NbPolygon(self) -> int: ...
    def Polygon(self) -> Any: ...
    def PolygonValue(self, num: int) -> StepGeom_CartesianPoint: ...
    def SetPolygon(self, aPolygon: Any) -> None: ...
...
class StepShape_Subface(StepShape_Face):
    def __init__(self) -> None: ...
    def Init(self, aRepresentationItem_Name: TCollection_HAsciiString, aFace_Bounds: Any, aParentFace: StepShape_Face) -> None: ...
