...
class StepShape_Array1OfGeometricSetSelect:
    ...
    def SetValue(
        self, theIndex: int, theValue: StepShape_GeometricSetSelect
    ) -> None: ...
...
class StepShape_Array1OfShapeDimensionRepresentationItem:
    ...
    def __setitem__(
        self, index: int, value: StepShape_ShapeDimensionRepresentationItem
    ) -> None: ...
    def __len__(self) -> int: ...
    ...
    def SetValue(
        self, theIndex: int, theValue: StepShape_ShapeDimensionRepresentationItem
    ) -> None: ...
...
class StepShape_ContextDependentShapeRepresentation(Standard_Transient):
    ...
    def SetRepresentationRelation(
        self, aRepRel: StepRepr_ShapeRepresentationRelationship
    ) -> None: ...
    def SetRepresentedProductRelation(
        self, aProRel: StepRepr_ProductDefinitionShape
    ) -> None: ...
...
class StepShape_DimensionalCharacteristicRepresentation(Standard_Transient):
    ...
    def SetRepresentation(
        self, Representation: StepShape_ShapeDimensionRepresentation
    ) -> None: ...
...
class StepShape_DimensionalSize(Standard_Transient):
    ...
    def Init(
        self, aAppliesTo: StepRepr_ShapeAspect, aName: TCollection_HAsciiString
    ) -> None: ...
...
class StepShape_EdgeBasedWireframeModel(StepGeom_GeometricRepresentationItem):
    ...
    def SetEbwmBoundary(
        self, EbwmBoundary: StepShape_HArray1OfConnectedEdgeSet
    ) -> None: ...
...
class StepShape_MeasureQualification(Standard_Transient):
    ...
    def SetQualifiedMeasure(
        self, qualified_measure: StepBasic_MeasureWithUnit
    ) -> None: ...
    def SetQualifiers(self, qualifiers: StepShape_HArray1OfValueQualifier) -> None: ...
    def SetQualifiersValue(
        self, num: int, aqualifier: StepShape_ValueQualifier
    ) -> None: ...
...
class StepShape_PlusMinusTolerance(Standard_Transient):
    ...
    def SetTolerancedDimension(
        self, toleranced_dimension: StepShape_DimensionalCharacteristic
    ) -> None: ...
...
class StepShape_ShellBasedSurfaceModel(StepGeom_GeometricRepresentationItem):
    def __init__(self) -> None: ...
    def Init(
        self, aName: TCollection_HAsciiString, aSbsmBoundary: StepShape_HArray1OfShell
    ) -> None: ...
...
class StepShape_Sphere(StepGeom_GeometricRepresentationItem):
    ...
    def Init(
        self, aName: TCollection_HAsciiString, aRadius: float, aCentre: StepGeom_Point
    ) -> None: ...
    def Radius(self) -> float: ...
...
class StepShape_ToleranceValue(Standard_Transient):
    def __init__(self) -> None: ...
    def Init(
        self, lower_bound: Standard_Transient, upper_bound: Standard_Transient
    ) -> None: ...
...
class StepShape_ConnectedFaceSet(StepShape_TopologicalRepresentationItem):
    ...
    def Init(
        self, aName: TCollection_HAsciiString, aCfsFaces: StepShape_HArray1OfFace
    ) -> None: ...
...
class StepShape_CsgSolid(StepShape_SolidModel):
    def __init__(self) -> None: ...
    def Init(
        self, aName: TCollection_HAsciiString, aTreeRootExpression: StepShape_CsgSelect
    ) -> None: ...
    def SetTreeRootExpression(
        self, aTreeRootExpression: StepShape_CsgSelect
    ) -> None: ...
...
class StepShape_Face(StepShape_TopologicalRepresentationItem):
    ...
    def Init(
        self, aName: TCollection_HAsciiString, aBounds: StepShape_HArray1OfFaceBound
    ) -> None: ...
...
class StepShape_ManifoldSolidBrep(StepShape_SolidModel):
    ...
    @overload
    def Init(
        self, aName: TCollection_HAsciiString, aOuter: StepShape_ClosedShell
    ) -> None: ...
    @overload
    def Init(
        self, aName: TCollection_HAsciiString, aOuter: StepShape_ConnectedFaceSet
    ) -> None: ...
...
class StepShape_ShapeDimensionRepresentation(StepShape_ShapeRepresentation):
    ...
    def SetItemsAP242(
        self, theItems: StepShape_HArray1OfShapeDimensionRepresentationItem
    ) -> None: ...
...
class StepShape_SweptAreaSolid(StepShape_SolidModel):
    def __init__(self) -> None: ...
    def Init(
        self, aName: TCollection_HAsciiString, aSweptArea: StepGeom_CurveBoundedSurface
    ) -> None: ...
...
class StepShape_SweptFaceSolid(StepShape_SolidModel):
    def __init__(self) -> None: ...
    def Init(
        self, aName: TCollection_HAsciiString, aSweptArea: StepShape_FaceSurface
    ) -> None: ...
...
class StepShape_VertexLoop(StepShape_Loop):
    def __init__(self) -> None: ...
    def Init(
        self, aName: TCollection_HAsciiString, aLoopVertex: StepShape_Vertex
    ) -> None: ...
...
class StepShape_VertexPoint(StepShape_Vertex):
    def __init__(self) -> None: ...
    def Init(
        self, aName: TCollection_HAsciiString, aVertexGeometry: StepGeom_Point
    ) -> None: ...
...
class StepShape_OrientedClosedShell(StepShape_ClosedShell):
    ...
    def SetClosedShellElement(
        self, aClosedShellElement: StepShape_ClosedShell
    ) -> None: ...
    def SetOrientation(self, aOrientation: bool) -> None: ...
...
class StepShape_HArray1OfConnectedEdgeSet(
    StepShape_Array1OfConnectedEdgeSet, Standard_Transient
):
    def __init__(self, theLower: int, theUpper: int) -> None: ...
    def Array1(self) -> StepShape_Array1OfConnectedEdgeSet: ...

class StepShape_HArray1OfConnectedFaceSet(
    StepShape_Array1OfConnectedFaceSet, Standard_Transient
):
    def __init__(self, theLower: int, theUpper: int) -> None: ...
...
class StepShape_HArray1OfValueQualifier(
    StepShape_Array1OfValueQualifier, Standard_Transient
):
    def __init__(self, theLower: int, theUpper: int) -> None: ...
