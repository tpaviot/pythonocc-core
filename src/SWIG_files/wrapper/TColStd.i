...
/// Constructor") TColStd_PackedMapOfInteger;
		 TColStd_PackedMapOfInteger (const Standard_Integer NbBuckets = 1);
		%feature("autodoc", "Args:
	Other(TColStd_PackedMapOfInteger)
...
No detailed docstring for this function.") NbBuckets;
		inline Standard_Integer NbBuckets ();
		%feature("autodoc", "Args:
	None
Returns:
	inline Standard_Integer
...
No detailed docstring for this function.") IsEmpty;
		...
		%feature("autodoc", "Args:
	outStream(Standard_OStream)

Returns:
	inline void

No detailed docstring for this function.") Statistics;
		inline void Statistics (Standard_OStream & outStream);
		%feature("autodoc", "Args:
	None
Returns:
	Standard_Integer
...
* first map or in the second map or in both. 
* All previous contents of this Map is cleared. This map (result of the
* boolean operation) can also be passed as one of operands. 
*/") Union;
...
* this map or contained in the given (operand) map. 
...
* operands and not contained in the second one. 
* All previous contents of this Map is cleared. This map (result of the
* boolean operation) can also be used as the first operand. 
*/") Subtraction;
...
* this map and not contained in this map. 
...
* first or the second operand maps but not in both. 
* All previous contents of this Map is cleared. This map (result of the
* boolean operation) can also be used as one of operands. 
*/") Difference;
...
* or the operand map, but not in both. 
