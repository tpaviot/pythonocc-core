...
class STEPControl_ActorWrite(Transfer_ActorOfFinderProcess):
    ...
    def TransferSubShape(self, start: Transfer_Finder, SDR: StepShape_ShapeDefinitionRepresentation, AX1: StepGeom_GeometricRepresentationItem, FP: Transfer_FinderProcess, theLocalFactors: Optional[StepData_Factors] = StepData_Factors(), shapeGroup: Optional[TopTools_HSequenceOfShape] = None, isManifold: Optional[bool] = True, theProgress: Optional[Message_ProgressRange] = Message_ProgressRange()) -> Transfer_Binder: ...
...
class STEPControl_Reader(XSControl_Reader):
    ...
    @overload
    def ReadFile(self, filename: str, theParams: Any) -> IFSelect_ReturnStatus: ...
...
class STEPControl_Writer:
    ...
    def SetShapeFixParameters(self, theParameters: Resource_DataMapOfAsciiStringAsciiString) -> None: ...
    @overload
    def SetShapeFixParameters(self, theParameters: DE_ShapeFixParameters) -> None: ...
    @overload
    def SetShapeFixParameters(self, theParameters: DE_ShapeFixParameters, theAdditionalParameters: Resource_DataMapOfAsciiStringAsciiString) -> None: ...
    ...
    @overload
    def Transfer(self, sh: TopoDS_Shape, mode: STEPControl_StepModelType, theParams: Any, compgraph: Optional[bool] = True, theProgress: Optional[Message_ProgressRange] = Message_ProgressRange()) -> IFSelect_ReturnStatus: ...
