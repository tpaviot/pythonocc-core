...
class STEPControl_ActorRead(Transfer_ActorOfTransientProcess):
    ...
    def ComputeSRRWT(self, SRR: StepRepr_RepresentationRelationship, TP: Transfer_TransientProcess, Trsf: gp_Trsf, theLocalFactors: StepData_Factors) -> bool: ...
    def ComputeTransformation(self, Origin: StepGeom_Axis2Placement3d, Target: StepGeom_Axis2Placement3d, OrigContext: StepRepr_Representation, TargContext: StepRepr_Representation, TP: Transfer_TransientProcess, Trsf: gp_Trsf, theLocalFactors: StepData_Factors) -> bool: ...
    ...
    def TransferShape(self, start: Standard_Transient, TP: Transfer_TransientProcess, theLocalFactors: StepData_Factors, isManifold: Optional[bool] = True, theUseTrsf: Optional[bool] = False, theProgress: Optional[Message_ProgressRange] = Message_ProgressRange()) -> Transfer_Binder: ...
...
class STEPControl_ActorWrite(Transfer_ActorOfFinderProcess):
    ...
    def TransferCompound(self, start: Transfer_Finder, SDR: StepShape_ShapeDefinitionRepresentation, FP: Transfer_FinderProcess, theLocalFactors: StepData_Factors, theProgress: Optional[Message_ProgressRange] = Message_ProgressRange()) -> Transfer_Binder: ...
    def TransferShape(self, start: Transfer_Finder, SDR: StepShape_ShapeDefinitionRepresentation, FP: Transfer_FinderProcess, theLocalFactors: StepData_Factors, shapeGroup: Optional[TopTools_HSequenceOfShape] = None, isManifold: Optional[bool] = True, theProgress: Optional[Message_ProgressRange] = Message_ProgressRange()) -> Transfer_Binder: ...
    def TransferSubShape(self, start: Transfer_Finder, SDR: StepShape_ShapeDefinitionRepresentation, AX1: StepGeom_Axis2Placement3d, FP: Transfer_FinderProcess, theLocalFactors: StepData_Factors, shapeGroup: Optional[TopTools_HSequenceOfShape] = None, isManifold: Optional[bool] = True, theProgress: Optional[Message_ProgressRange] = Message_ProgressRange()) -> Transfer_Binder: ...
...
class STEPControl_Reader(XSControl_Reader):
    ...
    @overload
    def ReadFile(self, filename: str, theParams: StepData_ConfParameters) -> IFSelect_ReturnStatus: ...
    @overload
    def ReadStream(self, theName: str, theIStream: str) -> IFSelect_ReturnStatus: ...
    @overload
    def ReadStream(self, theName: str, theParams: StepData_ConfParameters, theIStream: str) -> IFSelect_ReturnStatus: ...
...
class STEPControl_Writer:
    ...
    @overload
    def Transfer(self, sh: TopoDS_Shape, mode: STEPControl_StepModelType, theParams: StepData_ConfParameters, compgraph: Optional[bool] = True, theProgress: Optional[Message_ProgressRange] = Message_ProgressRange()) -> IFSelect_ReturnStatus: ...
