...
STEPControl_FacetedBrepAndBrepWithVoids = (
    STEPControl_StepModelType.STEPControl_FacetedBrepAndBrepWithVoids
)
...
class STEPControl_ActorRead(Transfer_ActorOfTransientProcess):
    ...
    def PrepareUnits(
        self, rep: StepRepr_Representation, TP: Transfer_TransientProcess
    ) -> None: ...
    ...
    def TransferShape(
        ...
        start: Standard_Transient,
        TP: Transfer_TransientProcess,
        isManifold: Optional[bool] = True,
        theUseTrsf: Optional[bool] = False,
        theProgress: Optional[Message_ProgressRange] = Message_ProgressRange(),
    ) -> Transfer_Binder: ...
...
class STEPControl_ActorWrite(Transfer_ActorOfFinderProcess):
    ...
    def TransferShape(
        ...
        SDR: StepShape_ShapeDefinitionRepresentation,
        FP: Transfer_FinderProcess,
        shapeGroup: Optional[TopTools_HSequenceOfShape] = None,
        isManifold: Optional[bool] = True,
        theProgress: Optional[Message_ProgressRange] = Message_ProgressRange(),
    ) -> Transfer_Binder: ...
