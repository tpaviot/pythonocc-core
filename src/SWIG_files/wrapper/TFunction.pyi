...
TFunction_DoubleMapIteratorOfDoubleMapOfIntegerLabel = NewType(
    "TFunction_DoubleMapIteratorOfDoubleMapOfIntegerLabel", Any
)
# the following typedef cannot be wrapped as is
...
class TFunction_Array1OfDataMapOfGUIDDriver:
    ...
    def SetValue(
        self, theIndex: int, theValue: TFunction_DataMapOfGUIDDriver
    ) -> None: ...
...
class TFunction_DriverTable(Standard_Transient):
    def __init__(self) -> None: ...
    def AddDriver(
        self, guid: Standard_GUID, driver: TFunction_Driver, thread: Optional[int] = 0
    ) -> bool: ...
    def Clear(self) -> None: ...
    def FindDriver(
        self, guid: Standard_GUID, driver: TFunction_Driver, thread: Optional[int] = 0
...
class TFunction_Logbook(TDF_Attribute):
    ...
    def IsEmpty(self) -> bool: ...
    def IsModified(
        self, L: TDF_Label, WithChildren: Optional[bool] = False
    ) -> bool: ...
    def NewEmpty(self) -> TDF_Attribute: ...
    def Paste(self, into: TDF_Attribute, RT: TDF_RelocationTable) -> None: ...
    def Restore(self, with_: TDF_Attribute) -> None: ...
