...
# the following typedef cannot be wrapped as is
TFunction_HArray1OfDataMapOfGUIDDriver = NewType("TFunction_HArray1OfDataMapOfGUIDDriver", Any)
...
class TFunction_GraphNode(TDF_Attribute):
    ...
    @staticmethod
    def GetID() -> Standard_GUID: ...
    def GetNext(self) -> False: ...
    def GetPrevious(self) -> False: ...
...
class TFunction_IFunction:
    ...
    def GetAllFunctions(self) -> False: ...
...
class TFunction_Logbook(TDF_Attribute):
    ...
    @staticmethod
    def GetID() -> Standard_GUID: ...
    def GetImpacted(self) -> False: ...
    def GetTouched(self) -> False: ...
    @overload
    def GetValid(self) -> False: ...
    def ID(self) -> Standard_GUID: ...
...
class TFunction_Scope(TDF_Attribute):
    ...
    def ChangeFunctions(self) -> False: ...
    def Dump(self) -> Tuple[Standard_OStream, str]: ...
