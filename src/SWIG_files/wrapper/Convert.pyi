...
class Convert_ConicToBSplineCurve:
    @overload
    def BuildCosAndSin(self, theParametrisation: Convert_ParameterisationType, theCosNumerator: TColStd_HArray1OfReal, theSinNumerator: TColStd_HArray1OfReal, theDenominator: TColStd_HArray1OfReal, theKnots: TColStd_HArray1OfReal, theMults: TColStd_HArray1OfInteger) -> int: ...
    @overload
    def BuildCosAndSin(self, theParametrisation: Convert_ParameterisationType, theUFirst: float, theULast: float, theCosNumerator: TColStd_HArray1OfReal, theSinNumerator: TColStd_HArray1OfReal, theDenominator: TColStd_HArray1OfReal, theKnots: TColStd_HArray1OfReal, theMults: TColStd_HArray1OfInteger) -> int: ...
    def Degree(self) -> int: ...
...
class Convert_GridPolynomialToPoles:
    @overload
    def __init__(self, theMaxUDegree: int, theMaxVDegree: int, theNumCoeff: TColStd_Array1OfInteger, theCoefficients: TColStd_Array1OfReal, thePolynomialUIntervals: TColStd_Array1OfReal, thePolynomialVIntervals: TColStd_Array1OfReal) -> None: ...
    @overload
    def __init__(self, theMaxUDegree: int, theMaxVDegree: int, theNumCoeff: TColStd_HArray1OfInteger, theCoefficients: TColStd_HArray1OfReal, thePolynomialUIntervals: TColStd_HArray1OfReal, thePolynomialVIntervals: TColStd_HArray1OfReal) -> None: ...
    @overload
    def __init__(self, theNbUSurfaces: int, theNbVSurfaces: int, theUContinuity: int, theVContinuity: int, theMaxUDegree: int, theMaxVDegree: int, theNumCoeffPerSurface: TColStd_Array2OfInteger, theCoefficients: TColStd_Array1OfReal, thePolynomialUIntervals: TColStd_Array1OfReal, thePolynomialVIntervals: TColStd_Array1OfReal, theTrueUIntervals: TColStd_Array1OfReal, theTrueVIntervals: TColStd_Array1OfReal) -> None: ...
    @overload
    def __init__(self, theNbUSurfaces: int, theNbVSurfaces: int, theUContinuity: int, theVContinuity: int, theMaxUDegree: int, theMaxVDegree: int, theNumCoeffPerSurface: TColStd_HArray2OfInteger, theCoefficients: TColStd_HArray1OfReal, thePolynomialUIntervals: TColStd_HArray1OfReal, thePolynomialVIntervals: TColStd_HArray1OfReal, theTrueUIntervals: TColStd_HArray1OfReal, theTrueVIntervals: TColStd_HArray1OfReal) -> None: ...
    def IsDone(self) -> bool: ...
    def NbUKnots(self) -> int: ...
    def NbUPoles(self) -> int: ...
    def NbVKnots(self) -> int: ...
