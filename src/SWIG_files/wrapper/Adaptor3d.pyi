...
class Adaptor3d_HSurfaceTool:
    ...
    @staticmethod
    def D0(
        theSurf: Adaptor3d_Surface, theU: float, theV: float, thePnt: gp_Pnt
    ) -> None: ...
    @staticmethod
    def D1(
    ...
    @staticmethod
    def DN(
        theSurf: Adaptor3d_Surface, theU: float, theV: float, theNU: int, theNV: int
    ) -> gp_Vec: ...
    @staticmethod
    ...
    def IsSurfG1(
        theSurf: Adaptor3d_Surface,
        theAlongU: bool,
        theAngTol: Optional[float] = Precision.Angular(),
    ) -> bool: ...
    @staticmethod
    ...
    @staticmethod
    def UIntervals(
        theSurf: Adaptor3d_Surface, theTab: TColStd_Array1OfReal, theSh: GeomAbs_Shape
    ) -> None: ...
    @staticmethod
    ...
    @staticmethod
    def UTrim(
        theSurf: Adaptor3d_Surface, theFirst: float, theLast: float, theTol: float
    ) -> Adaptor3d_Surface: ...
    @staticmethod
    def VIntervals(
        theSurf: Adaptor3d_Surface, theTab: TColStd_Array1OfReal, theSh: GeomAbs_Shape
...
class Adaptor3d_HVertex(Standard_Transient):
    ...
    @overload
    def __init__(
        self, P: gp_Pnt2d, Ori: TopAbs_Orientation, Resolution: float
    ) -> None: ...
...
class Adaptor3d_TopolTool(Standard_Transient):
    ...
    def Classify(
        self, P: gp_Pnt2d, Tol: float, ReacdreOnPeriodic: Optional[bool] = True
    ) -> TopAbs_State: ...
...
class Adaptor3d_IsoCurve(Adaptor3d_Curve):
    ...
    @overload
    def __init__(
        self, S: Adaptor3d_Surface, Iso: GeomAbs_IsoType, Param: float
    ) -> None: ...
    @overload
    def __init__(
        self,
    ...
    @overload
    def Load(
        self, Iso: GeomAbs_IsoType, Param: float, WFirst: float, WLast: float
    ) -> None: ...
    def NbIntervals(self, S: GeomAbs_Shape) -> int: ...
    def NbKnots(self) -> int: ...
    def NbPoles(self) -> int: ...
