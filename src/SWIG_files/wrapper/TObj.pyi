...
class TObj_Application(TDocStd_Application):
    ...
    @overload
    def LoadDocument(
        self, theSourceFile: str, theTargetDoc: TDocStd_Document
    ) -> bool: ...
    @overload
    def LoadDocument(self, theIStream: str, theTargetDoc: TDocStd_Document) -> bool: ...
    def Messenger(self) -> Message_Messenger: ...
    def ResourcesName(self) -> str: ...
    @overload
    def SaveDocument(
        self, theSourceDoc: TDocStd_Document, theTargetFile: str
    ) -> bool: ...
    @overload
    def SaveDocument(self, theSourceDoc: TDocStd_Document) -> Tuple[bool, str]: ...
...
class TObj_Model(Standard_Transient):
    ...
    def CopyReferences(
        self, theTarget: TObj_Model, theRelocTable: TDF_RelocationTable
    ) -> None: ...
    def FindObject(
        self, theName: TCollection_HExtendedString, theDictionary: TObj_TNameContainer
    ) -> TObj_Object: ...
    ...
    @overload
    def Load(self, theIStream: str) -> bool: ...
    def Messenger(self) -> Message_Messenger: ...
    def NewEmpty(self) -> TObj_Model: ...
    def OpenCommand(self) -> None: ...
    def Paste(
        self, theModel: TObj_Model, theRelocTable: Optional[TDF_RelocationTable] = 0
    ) -> bool: ...
    def RegisterName(
        self,
    ...
    @overload
    def SaveAs(self) -> Tuple[bool, str]: ...
...
class TObj_Object(Standard_Transient):
    ...
    def CanDetach(
        self, theMode: Optional[TObj_DeletingMode] = TObj_FreeOnly
    ) -> bool: ...
    ...
    def Clone(
        ...
        theRelocTable: Optional[TDF_RelocationTable] = 0,
    ) -> TObj_Object: ...
    def CopyChildren(
        self, theTargetLabel: TDF_Label, theRelocTable: TDF_RelocationTable
    ) -> None: ...
    def CopyReferences(
        self, theTargetObject: TObj_Object, theRelocTable: TDF_RelocationTable
    ) -> None: ...
    @overload
    ...
    @staticmethod
    def Detach(
        theLabel: TDF_Label, theMode: Optional[TObj_DeletingMode] = TObj_FreeOnly
    ) -> bool: ...
    def GetBackReferences(
        self, theType: Optional[Standard_Type] = None
    ) -> TObj_ObjectIterator: ...
    def GetBadReference(
        self, theRoot: TDF_Label, theBadReference: TDF_Label
    ) -> bool: ...
    ...
    @staticmethod
    def GetObj(
        theLabel: TDF_Label, theResult: TObj_Object, isSuper: Optional[bool] = False
    ) -> bool: ...
    ...
    def RelocateReferences(
        ...
        theToRoot: TDF_Label,
        theUpdateBackRefs: Optional[bool] = True,
    ) -> bool: ...
    def RemoveAllReferences(self) -> None: ...
    def RemoveBackReference(
        self, theObject: TObj_Object, theSingleOnly: Optional[bool] = True
    ) -> None: ...
    ...
    def ReplaceReference(
        self, theOldObject: TObj_Object, theNewObject: TObj_Object
    ) -> None: ...
...
class TObj_TNameContainer(TDF_Attribute):
    ...
    def Paste(self, theInto: TDF_Attribute, theRT: TDF_RelocationTable) -> None: ...
    def RecordName(
        self, theName: TCollection_HExtendedString, theLabel: TDF_Label
    ) -> None: ...
...
class TObj_TReference(TDF_Attribute):
    ...
    def AfterUndo(
        self, theDelta: TDF_AttributeDelta, isForced: Optional[bool] = False
    ) -> bool: ...
    def BeforeForget(self) -> None: ...
    def BeforeUndo(
        self, theDelta: TDF_AttributeDelta, isForced: Optional[bool] = False
    ...
    @staticmethod
    def Set(
        theLabel: TDF_Label, theObject: TObj_Object, theMaster: TObj_Object
    ) -> TObj_TReference: ...
    @overload
...
class TObj_Partition(TObj_Object):
    ...
    @staticmethod
    def Create(
        theLabel: TDF_Label, theSetName: Optional[bool] = True
    ) -> TObj_Partition: ...
    def GetLastIndex(self) -> int: ...
    def GetNamePrefix(self) -> TCollection_HExtendedString: ...
    def GetNewName(
        self, theIsToChangeCount: Optional[bool] = True
...
class TObj_SequenceIterator(TObj_ObjectIterator):
    def __init__(
        ...
        theType: Optional[Standard_Type] = None,
    ) -> None: ...
    def More(self) -> bool: ...
    def Next(self) -> None: ...
    def Value(self) -> TObj_Object: ...
...
class TObj_OcafObjectIterator(TObj_LabelIterator):
    def __init__(
        ...
        theLabel: TDF_Label,
        theType: Optional[Standard_Type] = None,
        theRecursive: Optional[bool] = False,
        theAllSubChildren: Optional[bool] = False,
    ) -> None: ...
...
class TObj_ReferenceIterator(TObj_LabelIterator):
    def __init__(
        ...
        theLabel: TDF_Label,
        theType: Optional[Standard_Type] = None,
        theRecursive: Optional[bool] = True,
    ) -> None: ...
