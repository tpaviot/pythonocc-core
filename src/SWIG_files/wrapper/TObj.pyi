...
class TObj_Model(Standard_Transient):
    ...
    def Paste(self, theModel: TObj_Model, theRelocTable: Optional[TDF_RelocationTable] = None) -> bool: ...
...
class TObj_Object(Standard_Transient):
    ...
    def BeforeForgetReference(self, arg0: TDF_Label) -> None: ...
    ...
    def Clone(self, theTargetLabel: TDF_Label, theRelocTable: Optional[TDF_RelocationTable] = None) -> TObj_Object: ...
    ...
    @overload
    def GetName(self, theName: str) -> bool: ...
    def GetNameForClone(self, arg0: TObj_Object) -> TCollection_HExtendedString: ...
    @staticmethod
...
class TObj_SequenceIterator(TObj_ObjectIterator):
    def __init__(self, theObjects: Any, theType: Optional[Standard_Type] = None) -> None: ...
    def More(self) -> bool: ...
    def Next(self) -> None: ...
    def Value(self) -> TObj_Object: ...
