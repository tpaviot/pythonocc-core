...
class GProp_PEquation:
    ...
    None_ = Type.None_
    Space = Type.Space
    def __init__(self, thePnts: TColgp_Array1OfPnt, theTol: float) -> None: ...
    def Barycentre(self) -> gp_Pnt: ...
    def Box(self, theP: gp_Pnt, theV1: gp_Vec, theV2: gp_Vec, theV3: gp_Vec) -> None: ...
    ...
    def PrincipalAxis(self, theIndex: int) -> gp_Vec: ...
...
class GProp_PGProps(GProp_GProps):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, thePnts: TColgp_Array1OfPnt) -> None: ...
    @overload
    def __init__(self, thePnts: TColgp_Array2OfPnt) -> None: ...
    @overload
    def __init__(self, thePnts: TColgp_Array1OfPnt, theDensity: TColStd_Array1OfReal) -> None: ...
    @overload
    def __init__(self, thePnts: TColgp_Array2OfPnt, theDensity: TColStd_Array2OfReal) -> None: ...
    @overload
    def AddPoint(self, thePnt: gp_Pnt) -> None: ...
    @overload
    def AddPoint(self, thePnt: gp_Pnt, theDensity: float) -> None: ...
    @overload
    @staticmethod
    def Barycentre(thePnts: TColgp_Array1OfPnt) -> gp_Pnt: ...
    @overload
    @staticmethod
    def Barycentre(thePnts: TColgp_Array2OfPnt) -> gp_Pnt: ...
    @overload
    @staticmethod
    def Barycentre(thePnts: TColgp_Array1OfPnt, theDensity: TColStd_Array1OfReal, theG: gp_Pnt) -> float: ...
    @overload
    @staticmethod
    def Barycentre(thePnts: TColgp_Array2OfPnt, theDensity: TColStd_Array2OfReal, theG: gp_Pnt) -> float: ...
