...
class Media_FormatContext(Standard_Transient):
    ...
    @staticmethod
    def FormatAVErrorDescription(theErrCodeAV: int) -> TCollection_AsciiString: ...
    @staticmethod
    def FormatTime(theSeconds: float) -> TCollection_AsciiString: ...
    @staticmethod
    def FormatTimeProgress(theProgress: float, theDuration: float) -> TCollection_AsciiString: ...
    def NbSteams(self) -> int: ...
    def OpenInput(self, theInput: TCollection_AsciiString) -> bool: ...
...
class Media_PlayerContext(Standard_Transient):
    ...
    @overload
    @staticmethod
    def DumpFirstFrame(theSrcVideo: TCollection_AsciiString, theMediaInfo: TCollection_AsciiString) -> Media_Frame: ...
    @overload
    @staticmethod
    def DumpFirstFrame(theSrcVideo: TCollection_AsciiString, theOutImage: TCollection_AsciiString, theMediaInfo: TCollection_AsciiString, theMaxSize: Optional[int] = 0) -> bool: ...
    def Pause(self) -> None: ...
