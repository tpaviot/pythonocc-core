...
class Media_CodecContext(Standard_Transient):
    ...
    def Flush(self) -> None: ...
    @overload
    def Init(self, theStream: Any, thePtsStartBase: float, theNbThreads: Optional[int] = -1) -> bool: ...
    @overload
    def Init(self, theStream: Any, thePtsStartBase: float, theNbThreads: int, theCodecId: int) -> bool: ...
...
class Media_FormatContext(Standard_Transient):
    ...
    @staticmethod
    def FormatUnitsToSeconds(theTimeUnits: Any) -> float: ...
    ...
    @overload
    @staticmethod
    def SecondsToUnits(theTimeBase: Any, theTimeSeconds: float) -> int: ...
    ...
    def Stream(self, theIndex: int) -> Any: ...
    def StreamInfo(self, theIndex: int, theCodecCtx: Optional[Any] = None) -> str: ...
    @staticmethod
    def StreamSecondsToUnits(theStream: Any, theTimeSeconds: float) -> int: ...
    @staticmethod
    def StreamUnitsToSeconds(theStream: Any, theTimeUnits: Any) -> float: ...
    @staticmethod
    def UnitsToSeconds(theTimeBase: Any, theTimeUnits: Any) -> float: ...

class Media_Frame(Standard_Transient):
    def __init__(self) -> None: ...
    def BestEffortTimestamp(self) -> Any: ...
    def ChangeFrame(self) -> Any: ...
    def Format(self) -> int: ...
    @staticmethod
    ...
    def Plane(self, thePlaneId: int) -> Any: ...
    def Pts(self) -> float: ...
...
class Media_Packet(Standard_Transient):
    def __init__(self) -> None: ...
    def ChangeData(self) -> Any: ...
    def ChangePacket(self) -> Any: ...
    def Data(self) -> Any: ...
    def Dts(self) -> Any: ...
...
class Media_Scaler(Standard_Transient):
    ...
    def Init(self, theSrcDims: Any, theSrcFormat: int, theResDims: Any, theResFormat: int) -> bool: ...
