...
GeomFill_HArray1OfLocationLaw = NewType("GeomFill_HArray1OfLocationLaw", Any)
# the following typedef cannot be wrapped as is
GeomFill_HArray1OfSectionLaw = NewType("GeomFill_HArray1OfSectionLaw", Any)
# the following typedef cannot be wrapped as is
GeomFill_HSequenceOfAx2 = NewType("GeomFill_HSequenceOfAx2", Any)
...
class geomfill:
    ...
    @staticmethod
    def GetTolerance(TConv: Convert_ParameterisationType, AngleMin: float, Radius: float, AngularTol: float, SpatialTol: float) -> False: ...
    @staticmethod
...
class GeomFill_Gordon:
    def __init__(self) -> None: ...
    def GetApproximationMode(self) -> False: ...
    def Init(self, theProfiles: TColGeom_Array1OfCurve, theGuides: TColGeom_Array1OfCurve, theTolerance: float) -> None: ...
    def IsApproximate(self) -> bool: ...
    def IsDone(self) -> bool: ...
    def IsParallelMode(self) -> bool: ...
    def Perform(self) -> None: ...
    def Report(self) -> False: ...
    def SetParallelMode(self, theToUseParallel: bool) -> None: ...
    def Status(self) -> False: ...
    def Surface(self) -> Geom_BSplineSurface: ...
...
class GeomFill_NetworkSurface:
    def __init__(self) -> None: ...
    def Init(self, theProfiles: TColGeom_Array1OfBSplineCurve, theGuides: TColGeom_Array1OfBSplineCurve, theProfileParameters: TColStd_Array1OfReal, theGuideParameters: TColStd_Array1OfReal, theIntersectionPoints: TColgp_Array2OfPnt, theIntersectionWeights: TColStd_Array2OfReal, theTolerance: float, theIsUClosed: bool, theIsVClosed: bool) -> None: ...
    def IsDone(self) -> bool: ...
    def Perform(self) -> None: ...
    def Status(self) -> False: ...
    def Surface(self) -> Geom_BSplineSurface: ...
...
class GeomFill_NSections(GeomFill_SectionLaw):
    ...
    @overload
    def __init__(self, NC: TColGeom_SequenceOfCurve, NP: TColStd_SequenceOfReal, UF: float, UL: float) -> None: ...
    @overload
...
class GeomFill_HArray1OfLocationLaw(NCollection_Array1<opencascade::handle<GeomFill_LocationLaw>>, Standard_Transient):
    def __init__(self, theLower: int, theUpper: int) -> None: ...
    def Array1(self) -> NCollection_Array1<opencascade::handle<GeomFill_LocationLaw>>: ...


class GeomFill_HArray1OfSectionLaw(NCollection_Array1<opencascade::handle<GeomFill_SectionLaw>>, Standard_Transient):
    def __init__(self, theLower: int, theUpper: int) -> None: ...
    def Array1(self) -> NCollection_Array1<opencascade::handle<GeomFill_SectionLaw>>: ...

# harray2 classes
# hsequence classes

class GeomFill_HSequenceOfAx2(NCollection_Sequence<gp_Ax2>, Standard_Transient):
    @overload
    def __init__(self) -> None: ...
    @overload
    def __init__(self, other: NCollection_Sequence<gp_Ax2>) -> None: ...
    def Sequence(self) -> NCollection_Sequence<gp_Ax2>: ...
    def Append(self, theSequence: NCollection_Sequence<gp_Ax2>) -> None: ...
