...
class GeomFill_SequenceOfAx2:
    def Assign(self, theItem: gp_Ax2) -> gp_Ax2: ...
    def Clear(self) -> None: ...
...
class GeomFill_SequenceOfTrsf:
    def Assign(self, theItem: gp_Trsf) -> gp_Trsf: ...
    def Clear(self) -> None: ...
...
class geomfill:
    ...
    def GetShape(
        MaxAng: float,
    ) -> Tuple[int, int, int, Convert_ParameterisationType]: ...
    @staticmethod
    def GetTolerance(
        TConv: Convert_ParameterisationType,
        AngleMin: float,
    ...
    @staticmethod
    def Knots(
        TypeConv: Convert_ParameterisationType, TKnots: TColStd_Array1OfReal
    ) -> None: ...
    @staticmethod
    def Mults(
        TypeConv: Convert_ParameterisationType, TMults: TColStd_Array1OfInteger
    ) -> None: ...
    @staticmethod
...
class GeomFill_AppSurf(AppBlend_Approx):
    ...
    def __init__(
        ...
        Tol2d: float,
        NbIt: int,
        KnownParameters: Optional[bool] = False,
    ) -> None: ...
    ...
    def Perform(
        ...
        SpApprox: Optional[bool] = False,
    ) -> None: ...
    @overload
    def Perform(
        self, Lin: GeomFill_Line, SecGen: GeomFill_SectionGenerator, NbMaxP: int
    ) -> None: ...
    def PerformSmoothing(
        self, Lin: GeomFill_Line, SecGen: GeomFill_SectionGenerator
    ) -> None: ...
...
class GeomFill_AppSweep(AppBlend_Approx):
    ...
    @overload
    def Perform(
        self, Lin: GeomFill_Line, SecGen: GeomFill_SweepSectionGenerator, NbMaxP: int
    ) -> None: ...
    def PerformSmoothing(
        self, Lin: GeomFill_Line, SecGen: GeomFill_SweepSectionGenerator
    ) -> None: ...
    def SetContinuity(self, C: GeomAbs_Shape) -> None: ...
    def SetCriteriumWeight(self, W1: float, W2: float, W3: float) -> None: ...
    def SetParType(self, ParType: Approx_ParametrizationType) -> None: ...
...
class GeomFill_BSplineCurves:
    ...
    @overload
    def __init__(
        self, C1: Geom_BSplineCurve, C2: Geom_BSplineCurve, Type: GeomFill_FillingStyle
    ) -> None: ...
    @overload
    def Init(
        self,
...
class GeomFill_BezierCurves:
    ...
    @overload
    def __init__(
        self, C1: Geom_BezierCurve, C2: Geom_BezierCurve, Type: GeomFill_FillingStyle
    ) -> None: ...
    @overload
    def Init(
        self,
...
class GeomFill_FunctionGuide(math_FunctionSetWithDerivatives):
    def __init__(
        ...
        ParamOnLaw: Optional[float] = 0.0,
    ) -> None: ...
    def DerivT(
        self, X: math_Vector, DCentre: gp_XYZ, DDir: gp_XYZ, DFDT: math_Vector
    ) -> bool: ...
    def Derivatives(self, X: math_Vector, D: math_Matrix) -> bool: ...
    def NbEquations(self) -> int: ...
    def NbVariables(self) -> int: ...
    def SetParam(
        self, Param: float, Centre: gp_Pnt, Dir: gp_XYZ, XDir: gp_XYZ
    ) -> None: ...
    def Value(self, X: math_Vector, F: math_Vector) -> bool: ...
    def Values(self, X: math_Vector, F: math_Vector, D: math_Matrix) -> bool: ...
...
class GeomFill_LocFunction:
    ...
    def DN(
        self, Param: float, First: float, Last: float, Order: int
    ) -> Tuple[float, int]: ...
...
class GeomFill_LocationLaw(Standard_Transient):
    ...
    @overload
    def D0(
        self, Param: float, M: gp_Mat, V: gp_Vec, Poles2d: TColgp_Array1OfPnt2d
    ) -> bool: ...
    def D1(
        self,
        Param: float,
...
class GeomFill_Pipe:
    ...
    def __init__(
        ...
        Option: Optional[GeomFill_Trihedron] = GeomFill_IsCorrectedFrenet,
    ) -> None: ...
    @overload
    def __init__(
        self, Path: Geom2d_Curve, Support: Geom_Surface, FirstSect: Geom_Curve
    ) -> None: ...
    @overload
    def __init__(
        self, Path: Geom_Curve, FirstSect: Geom_Curve, Dir: gp_Dir
    ) -> None: ...
    @overload
    def __init__(
        self, Path: Geom_Curve, FirstSect: Geom_Curve, LastSect: Geom_Curve
    ) -> None: ...
    @overload
    def __init__(
        self, Path: Geom_Curve, NSections: TColGeom_SequenceOfCurve
    ) -> None: ...
    @overload
    def __init__(
        self, Path: Geom_Curve, Curve1: Geom_Curve, Curve2: Geom_Curve, Radius: float
    ) -> None: ...
    @overload
    def __init__(
        self,
    ...
    def Perform(
        ...
        myPolynomial: Optional[bool] = False,
    ) -> None: ...
    @overload
    def Perform(
        self,
        ...
        MaxDegree: Optional[int] = 11,
        NbMaxSegment: Optional[int] = 30,
    ) -> None: ...
...
class GeomFill_PlanFunc(math_FunctionWithDerivative):
    ...
    def D2E(
        self, X: float, DP: gp_Vec, D2P: gp_Vec, DV: gp_Vec, D2V: gp_Vec
...
class GeomFill_SectionLaw(Standard_Transient):
    ...
    def D0(
        self, Param: float, Poles: TColgp_Array1OfPnt, Weigths: TColStd_Array1OfReal
    ) -> bool: ...
    def D1(
        self,
        Param: float,
...
class GeomFill_SectionPlacement:
    ...
    def Transformation(
        self, WithTranslation: bool, WithCorrection: Optional[bool] = False
    ) -> gp_Trsf: ...
...
class GeomFill_Sweep:
    def __init__(
        self, Location: GeomFill_LocationLaw, WithKpart: Optional[bool] = True
    ) -> None: ...
    def Build(
        self,
        Section: GeomFill_SectionLaw,
        Methode: Optional[GeomFill_ApproxStyle] = GeomFill_Location,
        Continuity: Optional[GeomAbs_Shape] = GeomAbs_C2,
        Degmax: Optional[int] = 10,
    ...
    def SetDomain(
        self, First: float, Last: float, SectionFirst: float, SectionLast: float
    ) -> None: ...
...
class GeomFill_TrihedronLaw(Standard_Transient):
    ...
    def D0(
        self, Param: float, Tangent: gp_Vec, Normal: gp_Vec, BiNormal: gp_Vec
    ) -> bool: ...
    def D1(
        self,
        Param: float,
    ...
    def ErrorStatus(self) -> GeomFill_PipeError: ...
    def GetAverageLaw(
        self, ATangent: gp_Vec, ANormal: gp_Vec, ABiNormal: gp_Vec
    ) -> None: ...
    def GetInterval(self) -> Tuple[float, float]: ...
    def Intervals(self, T: TColStd_Array1OfReal, S: GeomAbs_Shape) -> None: ...
...
class GeomFill_BoundWithSurf(GeomFill_Boundary):
    def __init__(
        self, CurveOnSurf: Adaptor3d_CurveOnSurface, Tol3d: float, Tolang: float
    ) -> None: ...
    def Bounds(self) -> Tuple[float, float]: ...
    def D1(self, U: float, P: gp_Pnt, V: gp_Vec) -> None: ...
    def D1Norm(self, U: float, N: gp_Vec, DN: gp_Vec) -> None: ...
...
class GeomFill_DegeneratedBound(GeomFill_Boundary):
    def __init__(
        self, Point: gp_Pnt, First: float, Last: float, Tol3d: float, Tolang: float
    ) -> None: ...
    def Bounds(self) -> Tuple[float, float]: ...
    def D1(self, U: float, P: gp_Pnt, V: gp_Vec) -> None: ...
    def IsDegenerated(self) -> bool: ...
...
class GeomFill_LocationGuide(GeomFill_LocationLaw):
    ...
    def ComputeAutomaticLaw(
        self, ParAndRad: TColgp_HArray1OfPnt2d
    ) -> GeomFill_PipeError: ...
    def Copy(self) -> GeomFill_LocationLaw: ...
    @overload
    def D0(self, Param: float, M: gp_Mat, V: gp_Vec) -> bool: ...
...
class GeomFill_NSections(GeomFill_SectionLaw):
    ...
    @overload
    def __init__(
        self, NC: TColGeom_SequenceOfCurve, NP: TColStd_SequenceOfReal
    ) -> None: ...
    @overload
    def __init__(
        self,
...
class GeomFill_UniformSection(GeomFill_SectionLaw):
    def __init__(
        self,
        C: Geom_Curve,
        FirstParameter: Optional[float] = 0.0,
        LastParameter: Optional[float] = 1.0,
    ) -> None: ...
    def BSplineSurface(self) -> Geom_BSplineSurface: ...
    def BarycentreOfSurf(self) -> gp_Pnt: ...
    def ConstantSection(self) -> Geom_Curve: ...
