...
class GeomFill_Gordon:
    ...
    def Report(self) -> Any: ...
    def SetApproximationMode(self, theMode: Any) -> None: ...
...
class GeomFill_Tensor:
    ...
    def ChangeValue(self, Row: int, Col: int, Mat: int) -> Any: ...
...
class GeomFill_NSections(GeomFill_SectionLaw):
    ...
    @overload
    def __init__(self, NC: TColGeom_SequenceOfCurve, Trsfs: Any, NP: TColStd_SequenceOfReal, UF: float, UL: float, VF: float, VL: float, Surf: Geom_BSplineSurface) -> None: ...
    def BSplineSurface(self) -> Geom_BSplineSurface: ...
    def BarycentreOfSurf(self) -> gp_Pnt: ...
    def CirclSection(self, Param: float) -> Geom_Curve: ...
