...
class prsdim:
    ...
    @staticmethod
    def GetPlaneFromFace(aFace: TopoDS_Face, aPlane: gp_Pln, aSurf: Geom_Surface, aSurfType: PrsDim_KindOfSurface) -> Tuple[bool, float]: ...
    @staticmethod
    ...
    @staticmethod
    def InitFaceLength(aFace: TopoDS_Face, aPlane: gp_Pln, aSurface: Geom_Surface, aSurfaceType: PrsDim_KindOfSurface) -> float: ...
    @staticmethod
...
prsdim_ComputeGeomCurve = prsdim.ComputeGeomCurve
prsdim_ComputeGeometry = prsdim.ComputeGeometry
prsdim_ComputeGeometry = prsdim.ComputeGeometry
prsdim_ComputeGeometry = prsdim.ComputeGeometry
prsdim_ComputeGeometry = prsdim.ComputeGeometry
prsdim_ComputeGeometry = prsdim.ComputeGeometry
prsdim_ComputeGeometry = prsdim.ComputeGeometry
prsdim_ComputeGeometry = prsdim.ComputeGeometry
prsdim_ComputeProjEdgePresentation = prsdim.ComputeProjEdgePresentation
prsdim_ComputeProjVertexPresentation = prsdim.ComputeProjVertexPresentation
prsdim_DistanceFromApex = prsdim.DistanceFromApex
prsdim_Farest = prsdim.Farest
prsdim_GetPlaneFromFace = prsdim.GetPlaneFromFace
prsdim_InDomain = prsdim.InDomain
prsdim_InitAngleBetweenCurvilinearFaces = prsdim.InitAngleBetweenCurvilinearFaces
prsdim_InitAngleBetweenPlanarFaces = prsdim.InitAngleBetweenPlanarFaces
prsdim_InitFaceLength = prsdim.InitFaceLength
prsdim_InitLengthBetweenCurvilinearFaces = prsdim.InitLengthBetweenCurvilinearFaces
prsdim_Nearest = prsdim.Nearest
prsdim_Nearest = prsdim.Nearest
prsdim_Nearest = prsdim.Nearest
prsdim_NearestApex = prsdim.NearestApex
prsdim_ProjectPointOnLine = prsdim.ProjectPointOnLine
prsdim_ProjectPointOnPlane = prsdim.ProjectPointOnPlane
prsdim_TranslatePointToBound = prsdim.TranslatePointToBound
PrsDim_EqualDistanceRelation_ComputeOneEdgeOneVertexLength = PrsDim_EqualDistanceRelation.ComputeOneEdgeOneVertexLength
PrsDim_EqualDistanceRelation_ComputeTwoEdgesLength = PrsDim_EqualDistanceRelation.ComputeTwoEdgesLength
PrsDim_EqualDistanceRelation_ComputeTwoVerticesLength = PrsDim_EqualDistanceRelation.ComputeTwoVerticesLength
