...
class PrsDim_Dimension(AIS_InteractiveObject):
    ...
    def SetDisplayUnits(self, arg0: str) -> None: ...
    def SetFlyout(self, theFlyout: float) -> None: ...
    def SetModelUnits(self, arg0: str) -> None: ...
    def SetSelToleranceForText2d(self, theTol: float) -> None: ...
    def SetSpecialSymbol(self, theSpecialSymbol: Any) -> None: ...
    def SetTextPosition(self, arg0: gp_Pnt) -> None: ...
    def SpecialSymbol(self) -> Any: ...
