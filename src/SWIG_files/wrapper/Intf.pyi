...
class Intf_SeqOfSectionLine:
    def Assign(self, theItem: Intf_SectionLine) -> Intf_SectionLine: ...
    def Clear(self) -> None: ...
...
class Intf_SeqOfSectionPoint:
    def Assign(self, theItem: Intf_SectionPoint) -> Intf_SectionPoint: ...
    def Clear(self) -> None: ...
...
class Intf_SeqOfTangentZone:
    def Assign(self, theItem: Intf_TangentZone) -> Intf_TangentZone: ...
    def Clear(self) -> None: ...
...
class intf:
    ...
    @staticmethod
    def PlaneEquation(
        P1: gp_Pnt, P2: gp_Pnt, P3: gp_Pnt, NormalVector: gp_XYZ
    ) -> float: ...
...
class Intf_Tool:
    ...
    def Hypr2dBox(
        self, theHypr2d: gp_Hypr2d, bounding: Bnd_Box2d, boxHypr: Bnd_Box2d
    ) -> None: ...
    def HyprBox(
        self, theHypr: gp_Hypr, bounding: Bnd_Box, boxHypr: Bnd_Box
    ) -> None: ...
    def Lin2dBox(
        self, theLin2d: gp_Lin2d, bounding: Bnd_Box2d, boxLin: Bnd_Box2d
    ) -> None: ...
    def LinBox(self, theLin: gp_Lin, bounding: Bnd_Box, boxLin: Bnd_Box) -> None: ...
    def NbSegments(self) -> int: ...
    def Parab2dBox(
        self, theParab2d: gp_Parab2d, bounding: Bnd_Box2d, boxHypr: Bnd_Box2d
    ) -> None: ...
    def ParabBox(
        self, theParab: gp_Parab, bounding: Bnd_Box, boxHypr: Bnd_Box
    ) -> None: ...
