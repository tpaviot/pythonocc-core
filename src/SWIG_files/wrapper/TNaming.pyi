...
class TNaming_Localizer:
    def __init__(self) -> None: ...
    def Ancestors(self, S: TopoDS_Shape, Type: TopAbs_ShapeEnum) -> False: ...
    @staticmethod
    ...
    def SubShapes(self, S: TopoDS_Shape, Type: TopAbs_ShapeEnum) -> False: ...
