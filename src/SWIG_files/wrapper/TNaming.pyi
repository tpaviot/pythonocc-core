...
TNaming_DataMapIteratorOfDataMapOfShapeMapOfShape = NewType(
    "TNaming_DataMapIteratorOfDataMapOfShapeMapOfShape", Any
)
# the following typedef cannot be wrapped as is
TNaming_MapIteratorOfMapOfNamedShape = NewType(
    "TNaming_MapIteratorOfMapOfNamedShape", Any
)
# the following typedef cannot be wrapped as is
...
class TNaming_ListOfIndexedDataMapOfShapeListOfShape:
    def Append(
        self, theItem: TopTools_IndexedDataMapOfShapeListOfShape
    ) -> TopTools_IndexedDataMapOfShapeListOfShape: ...
    def Assign(
        self, theItem: TNaming_ListOfIndexedDataMapOfShapeListOfShape
    ...
    def __iter__(self) -> TopTools_IndexedDataMapOfShapeListOfShape: ...

class TNaming_ListOfMapOfShape:
    def Append(self, theItem: TopTools_MapOfShape) -> TopTools_MapOfShape: ...
    def Assign(self, theItem: TNaming_ListOfMapOfShape) -> TNaming_ListOfMapOfShape: ...
    def Clear(self) -> None: ...
    ...
    def __init__(self) -> None: ...
    def __len__(self) -> int: ...
    def __iter__(self) -> TopTools_MapOfShape: ...

class TNaming_ListOfNamedShape:
    def Append(self, theItem: False) -> False: ...
    def Assign(self, theItem: TNaming_ListOfNamedShape) -> TNaming_ListOfNamedShape: ...
    def Clear(self) -> None: ...
...
class tnaming:
    ...
    @staticmethod
    def Displace(
        label: TDF_Label, aLocation: TopLoc_Location, WithOld: Optional[bool] = True
    ) -> None: ...
    @staticmethod
    def FindUniqueContext(S: TopoDS_Shape, Context: TopoDS_Shape) -> TopoDS_Shape: ...
    @staticmethod
    def FindUniqueContextSet(
        S: TopoDS_Shape, Context: TopoDS_Shape, Arr: TopTools_HArray1OfShape
    ) -> TopoDS_Shape: ...
    @staticmethod
...
class TNaming_CopyShape:
    ...
    @staticmethod
    def Translate(
        L: TopLoc_Location, aMap: TColStd_IndexedDataMapOfTransientTransient
    ) -> TopLoc_Location: ...
...
class TNaming_Identifier:
    @overload
    def __init__(
        self, Lab: TDF_Label, S: TopoDS_Shape, Context: TopoDS_Shape, Geom: bool
    ) -> None: ...
    @overload
    def __init__(
        self, Lab: TDF_Label, S: TopoDS_Shape, ContextNS: TNaming_NamedShape, Geom: bool
    ) -> None: ...
    def AncestorIdentification(
        self, Localizer: TNaming_Localizer, Context: TopoDS_Shape
    ) -> None: ...
    ...
    def GeneratedIdentification(
        self, Localizer: TNaming_Localizer, NS: TNaming_NamedShape
    ) -> None: ...
    def Identification(
        self, Localizer: TNaming_Localizer, NS: TNaming_NamedShape
    ) -> None: ...
...
class TNaming_Localizer:
    def __init__(self) -> None: ...
    def Ancestors(
        self, S: TopoDS_Shape, Type: TopAbs_ShapeEnum
    ) -> TopTools_IndexedDataMapOfShapeListOfShape: ...
    def Backward(
        self,
    ...
    def FindFeaturesInAncestors(
        self, S: TopoDS_Shape, In: TopoDS_Shape, AncInFeatures: TopTools_MapOfShape
    ) -> None: ...
    @staticmethod
    def FindGenerator(
        NS: TNaming_NamedShape,
    ...
    def FindNeighbourg(
        self, Cont: TopoDS_Shape, S: TopoDS_Shape, Neighbourg: TopTools_MapOfShape
    ) -> None: ...
    @staticmethod
    def FindShapeContext(
        NS: TNaming_NamedShape, theS: TopoDS_Shape, theSC: TopoDS_Shape
    ) -> None: ...
    def GoBack(
        self,
        S: TopoDS_Shape,
...
class TNaming_NamedShape(TDF_Attribute):
    ...
    def Paste(
        self, intoAttribute: TDF_Attribute, aRelocTationable: TDF_RelocationTable
    ) -> None: ...
...
class TNaming_Naming(TDF_Attribute):
    ...
    def Name(
        ...
        KeepOrientation: Optional[bool] = False,
        BNproblem: Optional[bool] = False,
    ) -> TNaming_NamedShape: ...
    def NewEmpty(self) -> TDF_Attribute: ...
...
class TNaming_NewShapeIterator:
    @overload
    def __init__(
        self, aShape: TopoDS_Shape, Transaction: int, access: TDF_Label
    ) -> None: ...
    @overload
...
class TNaming_Scope:
    ...
    def UnvalidChildren(
        self, L: TDF_Label, withroot: Optional[bool] = True
    ) -> None: ...
...
class TNaming_Selector:
    ...
    def Select(
        ...
        Context: TopoDS_Shape,
        Geometry: Optional[bool] = False,
        KeepOrientatation: Optional[bool] = False,
    ) -> bool: ...
    @overload
    def Select(
        self,
...
class TNaming_ShapesSet:
    ...
    @overload
    def __init__(
        self, S: TopoDS_Shape, Type: Optional[TopAbs_ShapeEnum] = TopAbs_SHAPE
    ) -> None: ...
    @overload
...
class TNaming_Tool:
    ...
    def Collect(
        ...
        OnlyModif: Optional[bool] = True,
    ) -> None: ...
    @overload
    @staticmethod
    def CurrentNamedShape(
        NS: TNaming_NamedShape, Updated: TDF_LabelMap
    ) -> TNaming_NamedShape: ...
    @overload
    @staticmethod
    ...
    @staticmethod
    def GeneratedShape(
        S: TopoDS_Shape, Generation: TNaming_NamedShape
    ) -> TopoDS_Shape: ...
    @staticmethod
    ...
    @staticmethod
    def InitialShape(
        aShape: TopoDS_Shape, anAcces: TDF_Label, Labels: TDF_LabelList
    ) -> TopoDS_Shape: ...
    @staticmethod
