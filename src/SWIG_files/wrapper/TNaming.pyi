...
class TNaming_MapOfShape:
    def __init__(self, *args: Any, **kwargs: Any) -> None: ...
    def __getattr__(self, name: str) -> Any: ...

class TNaming_DataMapOfShapeMapOfShape:
    def __init__(self, *args: Any, **kwargs: Any) -> None: ...
    def __getattr__(self, name: str) -> Any: ...
...
class TNaming_Localizer:
    ...
    def Backward(self, NS: TNaming_NamedShape, S: TopoDS_Shape, Primitives: Any, ValidShapes: TopTools_MapOfShape) -> None: ...
    ...
    def GoBack(self, S: TopoDS_Shape, Lab: TDF_Label, Evol: TNaming_Evolution, OldS: TopTools_ListOfShape, OldLab: Any) -> None: ...
...
class TNaming_Tool:
    @staticmethod
    def Collect(NS: TNaming_NamedShape, Labels: Any, OnlyModif: Optional[bool] = True) -> None: ...
    @overload
    @staticmethod
