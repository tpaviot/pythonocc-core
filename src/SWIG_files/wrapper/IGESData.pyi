...
class IGESData_Array1OfDirPart:
    ...
    def __iter__(self) -> typing.Iterator[IGESData_DirPart]: ...
...
class IGESData_GlobalSection:
    ...
    def SetEndMark(self, val: Any) -> None: ...
    ...
    def SetSeparator(self, val: Any) -> None: ...
...
class IGESData_ParamReader:
    ...
    @overload
    def ReadEnts(self, IR: IGESData_IGESReaderData, PC: IGESData_ParamCursor, amsg: Message_Msg, val: Any, index: Optional[int] = 1) -> bool: ...
    @overload
    def ReadEnts(self, IR: IGESData_IGESReaderData, PC: IGESData_ParamCursor, mess: str, val: Any, index: Optional[int] = 1) -> bool: ...
    @overload
...
class IGESData_FreeFormatEntity(IGESData_UndefinedEntity):
    def __init__(self) -> None: ...
    def AddEntities(self, ents: Any) -> None: ...
