...
class IGESData_BasicEditor:
    ...
    @overload
    def __init__(
        self, model: IGESData_IGESModel, protocol: IGESData_Protocol
    ) -> None: ...
...
class IGESData_DirChecker:
    ...
    def CheckTypeAndForm(
        self, ach: Interface_Check, ent: IGESData_IGESEntity
    ) -> None: ...
...
class IGESData_DirPart:
    ...
    def Values(self, res1: str, res2: str, label: str, subscript: str) -> Tuple[
        int,
        int,
        int,
        int,
...
class IGESData_GeneralModule(Interface_GeneralModule):
    ...
    def OwnImpliedCase(
        self, CN: int, ent: IGESData_IGESEntity, iter: Interface_EntityIterator
    ) -> None: ...
    def OwnRenewCase(
        self,
        CN: int,
...
class IGESData_GlobalNodeOfSpecificLib(Standard_Transient):
    def __init__(self) -> None: ...
    def Add(
        self, amodule: IGESData_SpecificModule, aprotocol: IGESData_Protocol
    ) -> None: ...
...
class IGESData_GlobalNodeOfWriterLib(Standard_Transient):
    def __init__(self) -> None: ...
    def Add(
        self, amodule: IGESData_ReadWriteModule, aprotocol: IGESData_Protocol
    ) -> None: ...
...
class IGESData_GlobalSection:
    ...
    @staticmethod
    def NewDateString(
        date: TCollection_HAsciiString, mode: Optional[int] = 1
    ) -> TCollection_HAsciiString: ...
    ...
    def TranslatedFromHollerith(
        self, astr: TCollection_HAsciiString
    ) -> TCollection_HAsciiString: ...
...
class IGESData_IGESDumper:
    ...
    def Dump(
        self, ent: IGESData_IGESEntity, own: int, attached: Optional[int] = -1
    ) -> str: ...
...
class IGESData_IGESEntity(Standard_Transient):
    ...
    def InitLevel(
        self, ent: IGESData_LevelListEntity, val: Optional[int] = 0
    ) -> None: ...
    def InitLineFont(
        self, ent: IGESData_LineFontEntity, rank: Optional[int] = 0
    ) -> None: ...
    def InitMisc(
        self, str: IGESData_IGESEntity, lab: IGESData_LabelDisplayEntity, weightnum: int
    ) -> None: ...
    def InitStatus(
        self, blank: int, subordinate: int, useflag: int, hierarchy: int
    ) -> None: ...
    ...
    def SetLabel(
        self, label: TCollection_HAsciiString, sub: Optional[int] = -1
    ) -> None: ...
    ...
    def TypedProperty(
        self, atype: Standard_Type, anum: Optional[int] = 0
    ) -> IGESData_IGESEntity: ...
...
class IGESData_IGESModel(Interface_InterfaceModel):
    ...
    def SetStartSection(
        self, list: TColStd_HSequenceOfHAsciiString, copy: Optional[bool] = True
    ) -> None: ...
...
class IGESData_IGESReaderData(Interface_FileReaderData):
    ...
    def DirValues(self, num: int, res1: str, res2: str, label: str, subs: str) -> Tuple[
        int,
        int,
        int,
        int,
...
class IGESData_IGESReaderTool(Interface_FileReaderTool):
    def __init__(
        self, reader: IGESData_IGESReaderData, protocol: IGESData_Protocol
    ) -> None: ...
    def AnalyseRecord(
...
class IGESData_ParamReader:
    ...
    @overload
    def AddFail(
        self, af: TCollection_HAsciiString, bf: TCollection_HAsciiString
    ) -> None: ...
    @overload
    def AddWarning(self, awarn: str, bwarn: Optional[str] = "") -> None: ...
    @overload
    def AddWarning(
        self, aw: TCollection_HAsciiString, bw: TCollection_HAsciiString
    ) -> None: ...
    ...
    def ParamEntity(
        self, IR: IGESData_IGESReaderData, num: int
    ) -> IGESData_IGESEntity: ...
    ...
    @overload
    def ReadBoolean(
        self, PC: IGESData_ParamCursor, amsg: Message_Msg, exact: Optional[bool] = True
    ) -> Tuple[bool, bool]: ...
    @overload
    def ReadBoolean(
        self, PC: IGESData_ParamCursor, mess: str, exact: Optional[bool] = True
    ) -> Tuple[bool, bool]: ...
    @overload
    def ReadEntList(
        self,
    ...
    @overload
    def ReadText(
        self, thePC: IGESData_ParamCursor, theMsg: Message_Msg
    ) -> Tuple[bool, str]: ...
    @overload
    ...
    @overload
    def ReadXY(
        self, PC: IGESData_ParamCursor, amsg: Message_Msg, val: gp_XY
    ) -> bool: ...
    @overload
    def ReadXY(self, PC: IGESData_ParamCursor, mess: str, val: gp_XY) -> bool: ...
    @overload
    def ReadXYZ(
        self, PC: IGESData_ParamCursor, amsg: Message_Msg, val: gp_XYZ
    ) -> bool: ...
    @overload
...
class IGESData_ReadWriteModule(Interface_ReaderModule):
    ...
    def WriteOwnParams(
        self, CN: int, ent: IGESData_IGESEntity, IW: IGESData_IGESWriter
    ) -> None: ...
...
class IGESData_SpecificLib:
    ...
    def Protocol(self) -> IGESData_Protocol: ...
    def Select(
        self, obj: IGESData_IGESEntity, module: IGESData_SpecificModule
    ) -> Tuple[bool, int]: ...
    def SetComplete(self) -> None: ...
    @staticmethod
    def SetGlobal(
        amodule: IGESData_SpecificModule, aprotocol: IGESData_Protocol
    ) -> None: ...
    def Start(self) -> None: ...
...
class IGESData_SpecificModule(Standard_Transient):
    ...
    def OwnDump(
        self, CN: int, ent: IGESData_IGESEntity, dumper: IGESData_IGESDumper, own: int
    ) -> str: ...

class IGESData_ToolLocation(Standard_Transient):
    def __init__(
        self, amodel: IGESData_IGESModel, protocol: IGESData_Protocol
    ) -> None: ...
    def AnalyseLocation(self, loc: gp_GTrsf, result: gp_Trsf) -> bool: ...
    @staticmethod
    def ConvertLocation(
        prec: float, loc: gp_GTrsf, result: gp_Trsf, uni: Optional[float] = 1
    ) -> bool: ...
    ...
    def SetParentAssoc(
        self, parent: IGESData_IGESEntity, child: IGESData_IGESEntity
    ) -> None: ...
...
class IGESData_WriterLib:
    ...
    def Protocol(self) -> IGESData_Protocol: ...
    def Select(
        self, obj: IGESData_IGESEntity, module: IGESData_ReadWriteModule
    ) -> Tuple[bool, int]: ...
    def SetComplete(self) -> None: ...
    @staticmethod
    def SetGlobal(
        amodule: IGESData_ReadWriteModule, aprotocol: IGESData_Protocol
    ) -> None: ...
    def Start(self) -> None: ...
...
class IGESData_UndefinedEntity(IGESData_IGESEntity):
    ...
    def ReadDir(
        self, IR: IGESData_IGESReaderData, DP: IGESData_DirPart, ach: Interface_Check
    ) -> bool: ...
    def ReadOwnParams(
        self, IR: IGESData_IGESReaderData, PR: IGESData_ParamReader
    ) -> None: ...
...
class IGESData_FreeFormatEntity(IGESData_UndefinedEntity):
    ...
    def ParamData(
        self, num: int, ptype: Interface_ParamType, ent: IGESData_IGESEntity
    ) -> Tuple[bool, str]: ...
