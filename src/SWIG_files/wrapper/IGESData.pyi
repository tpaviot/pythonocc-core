...
IGESData_HArray1OfIGESEntity = NewType("IGESData_HArray1OfIGESEntity", Any)
...
class IGESData_BasicEditor:
    ...
    @staticmethod
    def UnitFlagValue(flag: int) -> False: ...
    @staticmethod
...
class IGESData_IGESWriter:
    ...
    def SectionStrings(self, numsec: int) -> False: ...
...
class IGESData_FreeFormatEntity(IGESData_UndefinedEntity):
    ...
    def IsParamEntity(self, num: int) -> bool: ...
    def NbParams(self) -> int: ...
    def NegativePointers(self) -> False: ...
