...
class IGESData_DirPart:
    ...
    def Values(
        self, res1: str, res2: str, label: str, subscript: str
    ) -> Tuple[
        int,
        int,
        int,
...
class IGESData_IGESReaderData(Interface_FileReaderData):
    ...
    def DirValues(
        self, num: int, res1: str, res2: str, label: str, subs: str
    ) -> Tuple[
        int,
        int,
        int,
