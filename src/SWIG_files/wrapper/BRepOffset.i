...
class BRepOffset_Inter2d {
	...
	:param AsDes:
	:type AsDes: opencascade::handle<BRepAlgo_AsDes> &
	:param F:
	:type F: TopoDS_Face &
	:param NewEdges:
...
") Compute;
	...
	:param AsDes2d:
	:type AsDes2d: opencascade::handle<BRepAlgo_AsDes> &
	:param Offset:
	:type Offset: float
	:param Tol:
	:type Tol: float
...
") ExtentEdge;
	...
	:type theDMVV: TopTools_IndexedDataMapOfShapeListOfShape &
	:param theAsDes:
	:type theAsDes: opencascade::handle<BRepAlgo_AsDes> &
	:rtype: void
") FuseVertices;
...
") AddCommonEdges;
		...
		%feature("autodoc", "	:rtype: opencascade::handle<BRepAlgo_AsDes>
") AsDes;
