...
class ShapeConstruct_ProjectCurveOnSurface(Standard_Transient):
    ...
    def AdjustOverDegenMode(self) -> Any: ...
    @overload
    def Init(self, theSurf: Geom_Surface, thePreci: float) -> None: ...
    @overload
    def Init(self, theSurf: ShapeAnalysis_Surface, thePreci: float) -> None: ...
    def Perform(self, theC3D: Geom_Curve, theFirst: float, theLast: float, theC2D: Geom2d_Curve, theTolFirst: Optional[float] = ..., theTolLast: Optional[float] = ...) -> bool: ...
