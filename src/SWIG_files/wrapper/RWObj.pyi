...
class RWObj_ObjWriterContext:
    ...
    def WriteNormal(self, theValue: Any) -> bool: ...
    def WriteQuad(self, theQuad: Any) -> bool: ...
    def WriteTexCoord(self, theValue: Any) -> bool: ...
    def WriteTriangle(self, theTri: Any) -> bool: ...
    def WriteVertex(self, theValue: Any) -> bool: ...

class RWObj_Reader(Standard_Transient):
    def ExternalFiles(self) -> Interface_IndexedMapOfAsciiString: ...
