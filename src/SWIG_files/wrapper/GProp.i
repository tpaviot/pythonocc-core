...
class GProp_GProps {
	...
	:rtype: GProp_PrincipalProps") PrincipalProperties;
...
class GProp_PrincipalProps {
	...
	:rtype: gp_Vec") FirstAxisOfInertia;
	...
	:rtype: None") GProp_PrincipalProps;
		 GProp_PrincipalProps ();
	...
	:rtype: gp_Vec") SecondAxisOfInertia;
	...
	:rtype: gp_Vec") ThirdAxisOfInertia;
...
class GProp_CelGProps : public GProp_GProps {
	public:
		...
		%feature("autodoc", ":rtype: None") GProp_CelGProps;
		 GProp_CelGProps ();
...
class GProp_SelGProps : public GProp_GProps {
	public:
		...
		%feature("autodoc", ":rtype: None") GProp_SelGProps;
		 GProp_SelGProps ();
...
class GProp_VelGProps : public GProp_GProps {
	public:
		...
		%feature("autodoc", ":rtype: None") GProp_VelGProps;
		 GProp_VelGProps ();
