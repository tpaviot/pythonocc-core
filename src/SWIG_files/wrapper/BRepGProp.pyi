...
class BRepGProp_Face:
    ...
    @overload
    def GetTKnots(self, theTMin: float, theTMax: float) -> TColStd_HArray1OfReal: ...
    @overload
    def GetTKnots(self, theTMin: float, theTMax: float, theTKnots: TColStd_HArray1OfReal) -> None: ...
    @overload
    def GetUKnots(self, theUMin: float, theUMax: float) -> TColStd_HArray1OfReal: ...
    @overload
...
class BRepGProp_MeshCinert(GProp_GProps):
    ...
    @overload
    @staticmethod
    def PreparePolygon(theE: TopoDS_Edge) -> TColgp_HArray1OfPnt: ...
    @overload
    @staticmethod
...
class BRepGProp_TFunction(math_Function):
    def __init__(self, theSurface: BRepGProp_Face, theVertex: gp_Pnt, IsByPoint: bool, theCoeffs: Any, theUMin: float, theTolerance: float) -> None: ...
...
class BRepGProp_UFunction(math_Function):
    def __init__(self, theSurface: BRepGProp_Face, theVertex: gp_Pnt, IsByPoint: bool, theCoeffs: Any) -> None: ...
