...
V3d_TypeOfBackfacingModel = NewType(
    "V3d_TypeOfBackfacingModel", Graphic3d_TypeOfBackfacingModel
)
...
class V3d_ListOfLight:
    ...
    def Assign(self, theItem: V3d_ListOfLight) -> V3d_ListOfLight: ...
    def Clear(self) -> None: ...
...
class V3d_ListOfView:
    def Append(self, theItem: False) -> False: ...
    def Assign(self, theItem: V3d_ListOfView) -> V3d_ListOfView: ...
    def Clear(self) -> None: ...
    def First(self) -> False: ...
    def Last(self) -> False: ...
    def Prepend(self, theItem: False) -> False: ...
...
V3d_TypeOfOrientation_Zup_Bottom = (
    V3d_TypeOfOrientation.V3d_TypeOfOrientation_Zup_Bottom
)
...
V3d_TypeOfOrientation_Yup_AxoLeft = (
    V3d_TypeOfOrientation.V3d_TypeOfOrientation_Yup_AxoLeft
)
...
V3d_TypeOfOrientation_Yup_Bottom = (
    V3d_TypeOfOrientation.V3d_TypeOfOrientation_Yup_Bottom
)
...
class v3d:
    ...
    @overload
    @staticmethod
    def TypeOfOrientationFromString(
        theTypeString: str,
    ) -> Tuple[bool, V3d_TypeOfOrientation]: ...
    @staticmethod
    def TypeOfOrientationToString(theType: V3d_TypeOfOrientation) -> str: ...

class V3d_AmbientLight(Graphic3d_CLight):
    def __init__(
        self, theColor: Optional[Quantity_Color] = Quantity_NOC_WHITE
    ) -> None: ...
...
class V3d_CircularGrid(Aspect_CircularGrid):
    ...
    def SetColors(
        self, aColor: Quantity_Color, aTenthColor: Quantity_Color
    ) -> None: ...
...
class V3d_Plane(Standard_Transient):
    def __init__(
        self,
        theA: Optional[float] = 0.0,
        theB: Optional[float] = 0.0,
        theC: Optional[float] = 1.0,
        theD: Optional[float] = 0.0,
    ) -> None: ...
    def ClipPlane(self) -> Graphic3d_ClipPlane: ...
    def Display(
        self, theView: V3d_View, theColor: Optional[Quantity_Color] = Quantity_NOC_GRAY
    ) -> None: ...
    def Erase(self) -> None: ...
    def IsDisplayed(self) -> bool: ...
...
class V3d_View(Standard_Transient):
    ...
    def __init__(
        ...
        theType: Optional[V3d_TypeOfView] = V3d_ORTHOGRAPHIC,
    ) -> None: ...
    @overload
    ...
    @overload
    def BackgroundColor(
        self, Type: Quantity_TypeOfColor
    ...
    def DepthFitAll(
        self, Aspect: Optional[float] = 0.01, Margin: Optional[float] = 0.01
    ) -> None: ...
    ...
    def Dump(
        self,
        theFile: str,
        theBufferType: Optional[Graphic3d_BufferType] = Graphic3d_BT_RGB,
    ) -> bool: ...
    def DumpJson(self, depth: Optional[int] = -1) -> str: ...
    def Eye(self) -> Tuple[float, float, float]: ...
    @overload
    def FitAll(
        self, theMargin: Optional[float] = 0.01, theToUpdate: Optional[bool] = True
    ) -> None: ...
    @overload
    def FitAll(
        self,
        theBox: Bnd_Box,
        theMargin: Optional[float] = 0.01,
        theToUpdate: Optional[bool] = True,
    ) -> None: ...
    @overload
    def FitAll(
        self, theMinXv: float, theMinYv: float, theMaxXv: float, theMaxYv: float
    ) -> None: ...
    def FitMinMax(
        self,
        ...
        theBox: Bnd_Box,
        theMargin: float,
        theResolution: Optional[float] = 0.0,
        theToEnlargeIfLine: Optional[bool] = True,
    ) -> bool: ...
    ...
    def GradientBackgroundColors(
        self, theColor1: Quantity_Color, theColor2: Quantity_Color
    ) -> None: ...
    ...
    @overload
    def Move(
        self, Dx: float, Dy: float, Dz: float, Start: Optional[bool] = True
    ) -> None: ...
    @overload
    def Move(
        self, Axe: V3d_TypeOfAxe, Length: float, Start: Optional[bool] = True
    ) -> None: ...
    @overload
    ...
    def Pan(
        ...
        theDXp: int,
        theDYp: int,
        theZoomFactor: Optional[float] = 1,
        theToStart: Optional[bool] = True,
    ) -> None: ...
    def Panning(
        self,
        theDXv: float,
    ...
    @overload
    def Rotate(
        self, Ax: float, Ay: float, Az: float, Start: Optional[bool] = True
    ) -> None: ...
    @overload
    def Rotate(
        self,
    ...
    @overload
    def Rotate(
        self, Axe: V3d_TypeOfAxe, Angle: float, Start: Optional[bool] = True
    ) -> None: ...
    @overload
    ...
    def SetAutoZFitMode(
        self, theIsOn: bool, theScaleFactor: Optional[float] = 1.0
    ) -> None: ...
    ...
    def SetBackgroundColor(
        self, theType: Quantity_TypeOfColor, theV1: float, theV2: float, theV3: float
    ) -> None: ...
    @overload
    ...
    def SetBackgroundCubeMap(
        ...
        theToUpdate: Optional[bool] = False,
    ) -> None: ...
    @overload
    def SetBackgroundImage(
        self,
        theFileName: str,
        theFillStyle: Optional[Aspect_FillMethod] = Aspect_FM_CENTERED,
        theToUpdate: Optional[bool] = False,
    ) -> None: ...
    @overload
    def SetBackgroundImage(
    ...
    def SetBgImageStyle(
        self, theFillStyle: Aspect_FillMethod, theToUpdate: Optional[bool] = False
    ) -> None: ...
    ...
    def SetImageBasedLighting(
        self, theToEnableIBL: bool, theToUpdate: Optional[bool] = False
    ) -> None: ...
    ...
    @overload
    def SetProj(
        self, theOrientation: V3d_TypeOfOrientation, theIsYup: Optional[bool] = False
    ) -> None: ...
    ...
    def SetWindow(
        self,
        theWindow: Aspect_Window,
        theContext: Optional[Aspect_RenderingContext] = None,
    ) -> None: ...
    @overload
    def SetWindow(
        self,
        ...
        theCorner: Optional[Aspect_TypeOfTriedronPosition] = Aspect_TOTP_LEFT_UPPER,
        theOffset: Optional[Graphic3d_Vec2d] = Graphic3d_Vec2d(),
        theMargins: Optional[Graphic3d_Vec2i] = Graphic3d_Vec2i(),
    ) -> None: ...
    ...
    def StartRotation(
        self, X: int, Y: int, zRotationThreshold: Optional[float] = 0.0
    ) -> None: ...
    ...
    @overload
    def ToPixMap(
        self, theImage: Image_PixMap, theParams: V3d_ImageDumpOptions
    ) -> bool: ...
    @overload
    def ToPixMap(
        self,
        ...
        theHeight: int,
        theBufferType: Optional[Graphic3d_BufferType] = Graphic3d_BT_RGB,
        theToAdjustAspect: Optional[bool] = True,
        theTargetZLayerId: Optional[int] = Graphic3d_ZLayerId_BotOSD,
        theIsSingleLayer: Optional[int] = False,
        theStereoOptions: Optional[V3d_StereoDumpOptions] = V3d_SDO_MONO,
        theLightName: Optional[str] = "",
    ) -> bool: ...
    @overload
    def Translate(
        self, Dx: float, Dy: float, Dz: float, Start: Optional[bool] = True
    ...
    def TriedronDisplay(
        self,
        thePosition: Optional[Aspect_TypeOfTriedronPosition] = Aspect_TOTP_CENTER,
        theColor: Optional[Quantity_Color] = Quantity_NOC_WHITE,
        theScale: Optional[float] = 0.02,
        theMode: Optional[V3d_TypeOfVisualization] = V3d_WIREFRAME,
    ) -> None: ...
    ...
    def WindowFit(
        self, theMinXp: int, theMinYp: int, theMaxXp: int, theMaxYp: int
    ) -> None: ...
    def WindowFitAll(self, Xmin: int, Ymin: int, Xmax: int, Ymax: int) -> None: ...
    def ZBufferTriedronSetup(
        self,
        theXColor: Optional[Quantity_Color] = Quantity_NOC_RED,
        theYColor: Optional[Quantity_Color] = Quantity_NOC_GREEN,
        theZColor: Optional[Quantity_Color] = Quantity_NOC_BLUE1,
        theSizeRatio: Optional[float] = 0.8,
        theAxisDiametr: Optional[float] = 0.05,
        theNbFacettes: Optional[int] = 12,
    ) -> None: ...
...
class V3d_Viewer(Standard_Transient):
    ...
    def ActivateGrid(
        self, aGridType: Aspect_GridType, aGridDrawMode: Aspect_GridDrawMode
    ) -> None: ...
    def ActiveLight(self) -> V3d_Light: ...
    def ActiveLightIterator(self) -> V3d_ListOfLightIterator: ...
    def ActiveLights(self) -> V3d_ListOfLight: ...
    ...
    def AddZLayer(
        self,
        theSettings: Optional[Graphic3d_ZLayerSettings] = Graphic3d_ZLayerSettings(),
    ) -> Tuple[bool, int]: ...
    ...
    def DisplayPrivilegedPlane(
        self, theOnOff: bool, theSize: Optional[float] = 1
    ) -> None: ...
    ...
    @overload
    def Grid(
        self, theGridType: Aspect_GridType, theToCreate: Optional[bool] = true
    ) -> Aspect_Grid: ...
    ...
    def InsertLayerAfter(
        self, theSettings: Graphic3d_ZLayerSettings, theLayerBefore: int
    ) -> Tuple[bool, int]: ...
    def InsertLayerBefore(
        self, theSettings: Graphic3d_ZLayerSettings, theLayerAfter: int
    ) -> Tuple[bool, int]: ...
    def Invalidate(self) -> None: ...
    ...
    def SetDefaultRenderingParams(
        self, theParams: Graphic3d_RenderingParams
    ) -> None: ...
    ...
    def SetRectangularGridGraphicValues(
        self, XSize: float, YSize: float, OffSet: float
    ) -> None: ...
...
class V3d_DirectionalLight(V3d_PositionLight):
    ...
    def __init__(
        self,
        theDirection: Optional[V3d_TypeOfOrientation] = V3d_XposYposZpos,
        theColor: Optional[Quantity_Color] = Quantity_NOC_WHITE,
        theIsHeadlight: Optional[bool] = False,
    ) -> None: ...
    @overload
    def __init__(
        self,
...
class V3d_PositionalLight(V3d_PositionLight):
    def __init__(
        self, thePos: gp_Pnt, theColor: Optional[Quantity_Color] = Quantity_NOC_WHITE
    ) -> None: ...
...
class V3d_SpotLight(V3d_PositionLight):
    ...
    def __init__(
        self,
        thePos: gp_Pnt,
        theDirection: Optional[V3d_TypeOfOrientation] = V3d_XnegYnegZpos,
        theColor: Optional[Quantity_Color] = Quantity_NOC_WHITE,
    ) -> None: ...
    @overload
    def __init__(
