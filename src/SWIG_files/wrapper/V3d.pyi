...
class V3d_View(Standard_Transient):
    ...
    def ActiveLightIterator(self) -> False: ...
    def ActiveLights(self) -> False: ...
    ...
    @overload
    def SetWindow(self, theWindow: Aspect_Window, theContext: Optional[Aspect_RenderingContext] = nullptr) -> None: ...
...
class V3d_Viewer(Standard_Transient):
    ...
    def ActiveViewIterator(self) -> False: ...
    def ActiveViews(self) -> False: ...
    ...
    def DefinedLightIterator(self) -> False: ...
    def DefinedLights(self) -> False: ...
    def DefinedView(self) -> V3d_View: ...
    def DefinedViewIterator(self) -> False: ...
