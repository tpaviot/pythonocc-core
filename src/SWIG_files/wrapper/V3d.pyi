...
class V3d_View(Standard_Transient):
    ...
    @overload
    def ConvertToGrid(self, Xp: int, Yp: int, theGridPoint: Graphic3d_Vertex) -> bool: ...
    @overload
    def ConvertToGrid(self, X: float, Y: float, Z: float) -> Tuple[float, float, float]: ...
    def ConvertToGridEcho(self, Xp: int, Yp: int, theGridPoint: Graphic3d_Vertex, theEchoPoint: Graphic3d_Vertex) -> bool: ...
    ...
    @overload
    def GridDisplay(self, theParams: Aspect_GridParams) -> None: ...
    @overload
    ...
    def PickSubview(self, thePnt: Any) -> V3d_View: ...
    ...
    @overload
    def SetWindow(self, theParentView: V3d_View, theSize: Any, theCorner: Optional[Aspect_TypeOfTriedronPosition] = Aspect_TOTP_LEFT_UPPER, theOffset: Optional[Any] = NCollection_Vec2<double>(), theMargins: Optional[Any] = NCollection_Vec2<int>()) -> None: ...
