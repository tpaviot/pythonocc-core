...
class BinObjMgt_SRelocationTable:
...
class BinObjMgt_Persistent:
    ...
    def GetByte(self, theValue: Any) -> BinObjMgt_Persistent: ...
    ...
    def GetCharacter(self, theValue: Any) -> BinObjMgt_Persistent: ...
    def GetExtCharArray(self, theArray: BinObjMgt_PExtChar, theLength: int) -> BinObjMgt_Persistent: ...
    def GetExtCharacter(self, theValue: Any) -> BinObjMgt_Persistent: ...
    ...
    def PutByte(self, theValue: Any) -> BinObjMgt_Persistent: ...
    ...
    def PutCharacter(self, theValue: Any) -> BinObjMgt_Persistent: ...
    def PutExtCharArray(self, theArray: BinObjMgt_PExtChar, theLength: int) -> BinObjMgt_Persistent: ...
    def PutExtCharacter(self, theValue: Any) -> BinObjMgt_Persistent: ...
