...
# the following typedef cannot be wrapped as is
StepElement_HArray1OfCurveElementEndReleasePacket = NewType("StepElement_HArray1OfCurveElementEndReleasePacket", Any)
# the following typedef cannot be wrapped as is
StepElement_HArray1OfCurveElementSectionDefinition = NewType("StepElement_HArray1OfCurveElementSectionDefinition", Any)
# the following typedef cannot be wrapped as is
...
# the following typedef cannot be wrapped as is
StepElement_HArray1OfMeasureOrUnspecifiedValue = NewType("StepElement_HArray1OfMeasureOrUnspecifiedValue", Any)
# the following typedef cannot be wrapped as is
StepElement_HArray1OfSurfaceSection = NewType("StepElement_HArray1OfSurfaceSection", Any)
# the following typedef cannot be wrapped as is
StepElement_HArray1OfVolumeElementPurpose = NewType("StepElement_HArray1OfVolumeElementPurpose", Any)
# the following typedef cannot be wrapped as is
StepElement_HArray1OfVolumeElementPurposeMember = NewType("StepElement_HArray1OfVolumeElementPurposeMember", Any)
# the following typedef cannot be wrapped as is
StepElement_HArray2OfCurveElementPurposeMember = NewType("StepElement_HArray2OfCurveElementPurposeMember", Any)
# the following typedef cannot be wrapped as is
StepElement_HArray2OfSurfaceElementPurpose = NewType("StepElement_HArray2OfSurfaceElementPurpose", Any)
# the following typedef cannot be wrapped as is
StepElement_HArray2OfSurfaceElementPurposeMember = NewType("StepElement_HArray2OfSurfaceElementPurposeMember", Any)
# the following typedef cannot be wrapped as is
StepElement_HSequenceOfCurveElementPurposeMember = NewType("StepElement_HSequenceOfCurveElementPurposeMember", Any)
# the following typedef cannot be wrapped as is
StepElement_HSequenceOfCurveElementSectionDefinition = NewType("StepElement_HSequenceOfCurveElementSectionDefinition", Any)
# the following typedef cannot be wrapped as is
StepElement_HSequenceOfElementMaterial = NewType("StepElement_HSequenceOfElementMaterial", Any)
# the following typedef cannot be wrapped as is
StepElement_HSequenceOfSurfaceElementPurposeMember = NewType("StepElement_HSequenceOfSurfaceElementPurposeMember", Any)
...
class StepElement_CurveElementSectionDerivedDefinitions(StepElement_CurveElementSectionDefinition):
    ...
    def LocationOfCentroid(self) -> False: ...
    def LocationOfNonStructuralMass(self) -> False: ...
    def LocationOfShearCentre(self) -> False: ...
    def NonStructuralMass(self) -> StepElement_MeasureOrUnspecifiedValue: ...
