...
class GeomEvaluator_Curve(Standard_Transient):
    ...
    def D2(
        self, theU: float, theValue: gp_Pnt, theD1: gp_Vec, theD2: gp_Vec
    ) -> None: ...
    def D3(
        self, theU: float, theValue: gp_Pnt, theD1: gp_Vec, theD2: gp_Vec, theD3: gp_Vec
    ) -> None: ...
...
class GeomEvaluator_Surface(Standard_Transient):
    ...
    def D1(
        self, theU: float, theV: float, theValue: gp_Pnt, theD1U: gp_Vec, theD1V: gp_Vec
    ) -> None: ...
    def D2(
        self,
        theU: float,
...
class GeomEvaluator_OffsetCurve(GeomEvaluator_Curve):
    @overload
    def __init__(
        self, theBase: Geom_Curve, theOffset: float, theDirection: gp_Dir
    ) -> None: ...
    @overload
    def __init__(
        self, theBase: GeomAdaptor_Curve, theOffset: float, theDirection: gp_Dir
    ) -> None: ...
    def D0(self, theU: float, theValue: gp_Pnt) -> None: ...
    def D1(self, theU: float, theValue: gp_Pnt, theD1: gp_Vec) -> None: ...
    def D2(
...
class GeomEvaluator_OffsetSurface(GeomEvaluator_Surface):
    ...
    def __init__(
        ...
        theOffset: float,
        theOscSurf: Optional[Geom_OsculatingSurface] = Geom_OsculatingSurface(),
    ) -> None: ...
    @overload
    def __init__(
        self,
...
class GeomEvaluator_SurfaceOfRevolution(GeomEvaluator_Surface):
    @overload
    def __init__(
        self, theBase: Geom_Curve, theRevolDir: gp_Dir, theRevolLoc: gp_Pnt
    ) -> None: ...
    @overload
    def __init__(
        self, theBase: Adaptor3d_Curve, theRevolDir: gp_Dir, theRevolLoc: gp_Pnt
    ) -> None: ...
    def D0(self, theU: float, theV: float, theValue: gp_Pnt) -> None: ...
    def D1(
        self, theU: float, theV: float, theValue: gp_Pnt, theD1U: gp_Vec, theD1V: gp_Vec
