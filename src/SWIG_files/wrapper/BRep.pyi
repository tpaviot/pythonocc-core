...
class BRep_Tool:
    ...
    @staticmethod
    def MaxTolerance(theShape: TopoDS_Shape, theSubShape: TopAbs_ShapeEnum) -> False: ...
    @staticmethod
    def NaturalRestriction(F: TopoDS_Face) -> bool: ...
    @overload
    @staticmethod
    def Parameter(V: TopoDS_Vertex, E: TopoDS_Edge) -> False: ...
    @overload
    @staticmethod
    def Parameter(V: TopoDS_Vertex, E: TopoDS_Edge, F: TopoDS_Face) -> False: ...
    @overload
    @staticmethod
    def Parameter(V: TopoDS_Vertex, E: TopoDS_Edge, S: Geom_Surface, L: TopLoc_Location) -> False: ...
    @staticmethod
    ...
    @overload
    @staticmethod
    def Tolerance(F: TopoDS_Face) -> False: ...
    @overload
    @staticmethod
    def Tolerance(E: TopoDS_Edge) -> False: ...
    @overload
    @staticmethod
    def Tolerance(V: TopoDS_Vertex) -> False: ...
    @staticmethod
    ...
    @staticmethod
    def Triangulations(theFace: TopoDS_Face, theLocation: TopLoc_Location) -> False: ...
    @overload
    @staticmethod
