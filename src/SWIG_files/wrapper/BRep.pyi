...
class BRep_ListOfCurveRepresentation:
    ...
    def Assign(self, theItem: BRep_ListOfCurveRepresentation) -> BRep_ListOfCurveRepresentation: ...
    def Clear(self) -> None: ...
...
class BRep_ListOfPointRepresentation:
    def Append(self, theItem: False) -> False: ...
    def Assign(self, theItem: BRep_ListOfPointRepresentation) -> BRep_ListOfPointRepresentation: ...
    def Clear(self) -> None: ...
    def First(self) -> False: ...
    def Last(self) -> False: ...
    def Prepend(self, theItem: False) -> False: ...
