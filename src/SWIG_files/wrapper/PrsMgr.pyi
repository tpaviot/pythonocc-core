...
class PrsMgr_PresentationManager(Standard_Transient):
    ...
    def Color(self, thePrsObject: PrsMgr_PresentableObject, theStyle: Prs3d_Drawer, theMode: Optional[int] = 0, theSelObj: Optional[PrsMgr_PresentableObject] = nullptr, theImmediateStructLayerId: Optional[int] = Graphic3d_ZLayerId_Topmost) -> None: ...
    ...
    def Presentation(self, thePrsObject: PrsMgr_PresentableObject, theMode: Optional[int] = 0, theToCreate: Optional[bool] = false, theSelObj: Optional[PrsMgr_PresentableObject] = nullptr) -> PrsMgr_Presentation: ...
    ...
    def UpdateHighlightTrsf(self, theViewer: V3d_Viewer, theObj: PrsMgr_PresentableObject, theMode: Optional[int] = 0, theSelObj: Optional[PrsMgr_PresentableObject] = nullptr) -> None: ...
