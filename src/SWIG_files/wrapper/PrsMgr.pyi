...
class PrsMgr_ListOfPresentableObjects:
    ...
    def Assign(self, theItem: PrsMgr_ListOfPresentableObjects) -> PrsMgr_ListOfPresentableObjects: ...
    def Clear(self) -> None: ...
...
class PrsMgr_ListOfPresentations:
    def Append(self, theItem: False) -> False: ...
    def Assign(self, theItem: PrsMgr_ListOfPresentations) -> PrsMgr_ListOfPresentations: ...
    def Clear(self) -> None: ...
    def First(self) -> False: ...
    def Last(self) -> False: ...
    def Prepend(self, theItem: False) -> False: ...
