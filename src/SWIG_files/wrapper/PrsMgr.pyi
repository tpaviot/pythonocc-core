...
Handle_PrsMgr_Presentation3d = NewType(
    "Handle_PrsMgr_Presentation3d", Handle_PrsMgr_Presentation
)
Handle_PrsMgr_PresentationManager3d = NewType(
...
PrsMgr_PresentationManager3d = NewType(
...
class PrsMgr_ListOfPresentableObjects:
    ...
    def Assign(
        self, theItem: PrsMgr_ListOfPresentableObjects
...
class PrsMgr_ListOfPresentations:
    def Append(self, theItem: False) -> False: ...
    def Assign(
        self, theItem: PrsMgr_ListOfPresentations
...
class PrsMgr_PresentableObject(Standard_Transient):
    ...
    def AddChildWithCurrentTransformation(
        self, theObject: PrsMgr_PresentableObject
    ) -> None: ...
    ...
    def SetCurrentFacingModel(
        self, theModel: Optional[Aspect_TypeOfFacingModel] = Aspect_TOFM_BOTH_SIDE
    ) -> None: ...
    ...
    def SetPolygonOffsets(
        self, aMode: int, aFactor: Optional[float] = 1.0, aUnits: Optional[float] = 0.0
    ) -> None: ...
...
class PrsMgr_PresentationManager(Standard_Transient):
    ...
    def Clear(
        self, thePrsObject: PrsMgr_PresentableObject, theMode: Optional[int] = 0
    ) -> None: ...
    ...
    def Color(
        ...
        theSelObj: Optional[PrsMgr_PresentableObject] = None,
        theImmediateStructLayerId: Optional[int] = Graphic3d_ZLayerId_Topmost,
    ) -> None: ...
    def Connect(
        self,
        thePrsObject: PrsMgr_PresentableObject,
        ...
        theMode: Optional[int] = 0,
        theOtherMode: Optional[int] = 0,
    ) -> None: ...
    def Display(
        self, thePrsObject: PrsMgr_PresentableObject, theMode: Optional[int] = 0
    ) -> None: ...
    def DisplayPriority(
        self, thePrsObject: PrsMgr_PresentableObject, theMode: int
    ...
    def GetZLayer(
        self, thePrsObject: PrsMgr_PresentableObject
    ) -> Graphic3d_ZLayerId: ...
    def HasPresentation(
        self, thePrsObject: PrsMgr_PresentableObject, theMode: Optional[int] = 0
    ) -> bool: ...
    ...
    def Presentation(
        ...
        thePrsObject: PrsMgr_PresentableObject,
        theMode: Optional[int] = 0,
        theToCreate: Optional[bool] = False,
        theSelObj: Optional[PrsMgr_PresentableObject] = None,
    ) -> PrsMgr_Presentation: ...
    ...
    def SetVisibility(
        self, thePrsObject: PrsMgr_PresentableObject, theMode: int, theValue: bool
    ) -> None: ...
    def SetZLayer(
        self, thePrsObject: PrsMgr_PresentableObject, theLayerId: int
    ) -> None: ...
