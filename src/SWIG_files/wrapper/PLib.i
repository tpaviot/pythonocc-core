...
class PLib {
	...
	:param NivConstr:
	:type NivConstr: int
	:rtype: GeomAbs_Shape") ConstraintOrder;
	...
	:rtype: bool") HermiteCoefficients;
	...
	:param Results:
	:type Results: float &
	:rtype: void") NoDerivativeEvalPolynomial;
	...
	:rtype: inline TColStd_Array1OfReal *") NoWeights;
		inline static TColStd_Array1OfReal * NoWeights ();

		/****************** NoWeights2 ******************/
		%feature("compactdefaultargs") NoWeights2;
		%feature("autodoc", "* Used as argument for a non rational functions
	:rtype: inline TColStd_Array2OfReal *") NoWeights2;
	...
	:rtype: void") RationalDerivatives;
...
class PLib_DoubleJacobiPolynomial {
	...
	:rtype: float") MaxErrorV;
		...
		%feature("autodoc", ":rtype: None") PLib_DoubleJacobiPolynomial;
		 PLib_DoubleJacobiPolynomial ();

		/****************** PLib_DoubleJacobiPolynomial ******************/
		%feature("compactdefaultargs") PLib_DoubleJacobiPolynomial;
		%feature("autodoc", ":param JacPolU:
	:type JacPolU: opencascade::handle<PLib_JacobiPolynomial> &
	:param JacPolV:
	:type JacPolV: opencascade::handle<PLib_JacobiPolynomial> &
	:rtype: None") PLib_DoubleJacobiPolynomial;
	...
	:param Coefficients:
	:type Coefficients: TColStd_Array1OfReal &
	:rtype: None") WDoubleJacobiToCoefficients;
...
class PLib_JacobiPolynomial : public PLib_Base {
	...
	:param ConstraintOrder:
	:type ConstraintOrder: GeomAbs_Shape
	:rtype: None") PLib_JacobiPolynomial;
