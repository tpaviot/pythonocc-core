...
class XCAFDoc_AssemblyItemRef(TDF_Attribute):
    ...
    @staticmethod
    def Set(
        theLabel: TDF_Label, theItemId: XCAFDoc_AssemblyItemId
    ) -> XCAFDoc_AssemblyItemRef: ...
    @overload
    @staticmethod
    def Set(
        theLabel: TDF_Label, theItemId: XCAFDoc_AssemblyItemId, theGUID: Standard_GUID
    ) -> XCAFDoc_AssemblyItemRef: ...
    @overload
    @staticmethod
    def Set(
        theLabel: TDF_Label, theItemId: XCAFDoc_AssemblyItemId, theShapeIndex: int
    ) -> XCAFDoc_AssemblyItemRef: ...
...
class XCAFDoc_AssemblyIterator:
    @overload
    def __init__(
        self, theDoc: TDocStd_Document, theLevel: Optional[int] = INT_MAX
    ) -> None: ...
    @overload
    def __init__(
        self,
...
class XCAFDoc_ClippingPlaneTool(TDataStd_GenericEmpty):
    ...
    def AddClippingPlane(
        self, thePlane: gp_Pln, theName: str, theCapping: bool
    ) -> TDF_Label: ...
    @overload
    def AddClippingPlane(
        self, thePlane: gp_Pln, theName: TCollection_HAsciiString, theCapping: bool
    ) -> TDF_Label: ...
    @overload
    def AddClippingPlane(self, thePlane: gp_Pln, theName: str) -> TDF_Label: ...
    @overload
    def AddClippingPlane(
        self, thePlane: gp_Pln, theName: TCollection_HAsciiString
    ) -> TDF_Label: ...
    ...
    def GetClippingPlane(
        self, theLabel: TDF_Label, thePlane: gp_Pln, theName: str
    ) -> Tuple[bool, bool]: ...
    @overload
    def GetClippingPlane(
        self, theLabel: TDF_Label, thePlane: gp_Pln
    ) -> Tuple[bool, str, bool]: ...
    ...
    def UpdateClippingPlane(
        self, theLabelL: TDF_Label, thePlane: gp_Pln, theName: str
    ) -> None: ...
...
class XCAFDoc_Color(TDF_Attribute):
    ...
    @staticmethod
    def Set(
        label: TDF_Label, R: float, G: float, B: float, alpha: Optional[float] = 1.0
    ) -> XCAFDoc_Color: ...
    @overload
    ...
    @overload
    def Set(
        self, R: float, G: float, B: float, alpha: Optional[float] = 1.0
    ) -> None: ...
...
class XCAFDoc_ColorTool(TDataStd_GenericEmpty):
    ...
    @staticmethod
    def GetColor(
        L: TDF_Label, type: XCAFDoc_ColorType, color: Quantity_Color
    ) -> bool: ...
    @overload
    @staticmethod
    def GetColor(
        L: TDF_Label, type: XCAFDoc_ColorType, color: Quantity_ColorRGBA
    ) -> bool: ...
    @overload
    def GetColor(
        self, S: TopoDS_Shape, type: XCAFDoc_ColorType, colorL: TDF_Label
    ) -> bool: ...
    @overload
    def GetColor(
        self, S: TopoDS_Shape, type: XCAFDoc_ColorType, color: Quantity_Color
    ) -> bool: ...
    @overload
    def GetColor(
        self, S: TopoDS_Shape, type: XCAFDoc_ColorType, color: Quantity_ColorRGBA
    ) -> bool: ...
    ...
    def GetInstanceColor(
        self, theShape: TopoDS_Shape, type: XCAFDoc_ColorType, color: Quantity_Color
    ) -> bool: ...
    @overload
    def GetInstanceColor(
        self, theShape: TopoDS_Shape, type: XCAFDoc_ColorType, color: Quantity_ColorRGBA
    ) -> bool: ...
    def ID(self) -> Standard_GUID: ...
    ...
    @overload
    def SetColor(
        self, L: TDF_Label, colorL: TDF_Label, type: XCAFDoc_ColorType
    ) -> None: ...
    @overload
    def SetColor(
        self, L: TDF_Label, Color: Quantity_Color, type: XCAFDoc_ColorType
    ) -> None: ...
    @overload
    def SetColor(
        self, L: TDF_Label, Color: Quantity_ColorRGBA, type: XCAFDoc_ColorType
    ) -> None: ...
    @overload
    def SetColor(
        self, S: TopoDS_Shape, colorL: TDF_Label, type: XCAFDoc_ColorType
    ) -> bool: ...
    @overload
    def SetColor(
        self, S: TopoDS_Shape, Color: Quantity_Color, type: XCAFDoc_ColorType
    ) -> bool: ...
    @overload
    def SetColor(
        self, S: TopoDS_Shape, Color: Quantity_ColorRGBA, type: XCAFDoc_ColorType
    ) -> bool: ...
    def SetColorByLayer(
        self, shapeLabel: TDF_Label, isColorByLayer: Optional[bool] = False
    ) -> None: ...
    @overload
    def SetInstanceColor(
        ...
        isCreateSHUO: Optional[bool] = True,
    ) -> bool: ...
    @overload
    def SetInstanceColor(
        self,
    ...
    def SetVisibility(
        self, shapeLabel: TDF_Label, isvisible: Optional[bool] = True
    ) -> None: ...
...
class XCAFDoc_DimTolTool(TDataStd_GenericEmpty):
    ...
    @staticmethod
    def GetDatumOfTolerLabels(
        theDimTolL: TDF_Label, theDatums: TDF_LabelSequence
    ) -> bool: ...
    @staticmethod
    def GetDatumWithObjectOfTolerLabels(
        theDimTolL: TDF_Label, theDatums: TDF_LabelSequence
    ) -> bool: ...
    def GetDimTol(
        self, theDimTolL: TDF_Label, theVal: TColStd_HArray1OfReal
    ...
    def GetRefDatumLabel(
        self, theShapeL: TDF_Label, theDatum: TDF_LabelSequence
    ) -> bool: ...
    def GetRefDimensionLabels(
        self, theShapeL: TDF_Label, theDimensions: TDF_LabelSequence
    ) -> bool: ...
    def GetRefGeomToleranceLabels(
        self, theShapeL: TDF_Label, theDimTols: TDF_LabelSequence
    ) -> bool: ...
    @staticmethod
    ...
    def GetTolerOfDatumLabels(
        self, theDatumL: TDF_Label, theTols: TDF_LabelSequence
    ) -> bool: ...
    def ID(self) -> Standard_GUID: ...
    ...
    @overload
    def SetDatum(
        self, theShapeLabels: TDF_LabelSequence, theDatumL: TDF_Label
    ) -> None: ...
    @overload
    def SetDatum(
        self,
    ...
    @overload
    def SetDimension(
        self, theFirstL: TDF_Label, theSecondL: TDF_Label, theDimL: TDF_Label
    ) -> None: ...
    @overload
    ...
    def SetGeomTolerance(
        self, theL: TDF_LabelSequence, theGeomTolL: TDF_Label
    ) -> None: ...
    def ShapeTool(self) -> XCAFDoc_ShapeTool: ...
...
class XCAFDoc_Dimension(TDataStd_GenericEmpty):
    ...
    def SetObject(
        self, theDimensionObject: XCAFDimTolObjects_DimensionObject
    ) -> None: ...
...
class XCAFDoc_DocumentTool(TDataStd_GenericEmpty):
    ...
    @staticmethod
    def GetLengthUnit(
        theDoc: TDocStd_Document, theBaseUnit: UnitsMethods_LengthUnit
    ) -> Tuple[bool, float]: ...
    @overload
    @staticmethod
...
class XCAFDoc_Editor:
    ...
    @staticmethod
    def Expand(
        theDoc: TDF_Label, theShape: TDF_Label, theRecursively: Optional[bool] = True
    ) -> bool: ...
    @overload
    @staticmethod
    ...
    def Extract(
        ...
        theIsNoVisMat: Optional[bool] = False,
    ) -> bool: ...
    @overload
    @staticmethod
    def Extract(
    ...
    @staticmethod
    def FilterShapeTree(
        theShapeTool: XCAFDoc_ShapeTool, theLabelsToKeep: TDF_LabelMap
    ) -> bool: ...
    @staticmethod
    def GetChildShapeLabels(
        theLabel: TDF_Label, theRelatedLabels: TDF_LabelMap
    ) -> None: ...
    @staticmethod
    def GetParentShapeLabels(
        theLabel: TDF_Label, theRelatedLabels: TDF_LabelMap
    ) -> None: ...
    @staticmethod
    def RescaleGeometry(
        ...
        theForceIfNotRoot: Optional[bool] = False,
    ) -> bool: ...
...
class XCAFDoc_LayerTool(TDataStd_GenericEmpty):
    ...
    def FindLayer(
        self,
        aLayer: str,
        theToFindWithProperty: Optional[bool] = False,
        theToFindVisible: Optional[bool] = True,
    ) -> TDF_Label: ...
    @staticmethod
    def GetID() -> Standard_GUID: ...
    ...
    @overload
    def GetLayers(
        self, L: TDF_Label, aLayerS: TColStd_HSequenceOfExtendedString
    ) -> bool: ...
    @overload
    ...
    @overload
    def GetLayers(
        self, Sh: TopoDS_Shape, aLayerS: TColStd_HSequenceOfExtendedString
    ) -> bool: ...
    @overload
    ...
    @staticmethod
    def GetShapesOfLayer(
        theLayerL: TDF_Label, theShLabels: TDF_LabelSequence
    ) -> None: ...
    def ID(self) -> Standard_GUID: ...
    ...
    @overload
    def SetLayer(
        self, L: TDF_Label, LayerL: TDF_Label, shapeInOneLayer: Optional[bool] = False
    ) -> None: ...
    @overload
    def SetLayer(
        self, L: TDF_Label, aLayer: str, shapeInOneLayer: Optional[bool] = False
    ) -> None: ...
    @overload
    def SetLayer(
        self,
        Sh: TopoDS_Shape,
        LayerL: TDF_Label,
        shapeInOneLayer: Optional[bool] = False,
    ) -> bool: ...
    @overload
    def SetLayer(
        self, Sh: TopoDS_Shape, aLayer: str, shapeInOneLayer: Optional[bool] = False
    ) -> bool: ...
    def SetVisibility(
        self, layerL: TDF_Label, isvisible: Optional[bool] = True
    ) -> None: ...
    def ShapeTool(self) -> XCAFDoc_ShapeTool: ...
    @overload
...
class XCAFDoc_LengthUnit(TDF_Attribute):
    ...
    @staticmethod
    def Set(
        theLabel: TDF_Label, theUnitName: str, theUnitValue: float
    ) -> XCAFDoc_LengthUnit: ...
    @overload
    @staticmethod
...
class XCAFDoc_NotesTool(TDataStd_GenericEmpty):
    ...
    @overload
    def AddNote(
        self, theNoteLabel: TDF_Label, theItemId: XCAFDoc_AssemblyItemId
    ) -> XCAFDoc_AssemblyItemRef: ...
    @overload
    def AddNote(
        self, theNoteLabel: TDF_Label, theItemLabel: TDF_Label
    ) -> XCAFDoc_AssemblyItemRef: ...
    @overload
    def AddNoteToAttr(
        self,
    ...
    @overload
    def AddNoteToAttr(
        self, theNoteLabel: TDF_Label, theItemLabel: TDF_Label, theGUID: Standard_GUID
    ) -> XCAFDoc_AssemblyItemRef: ...
    @overload
    ...
    @overload
    def AddNoteToSubshape(
        self, theNoteLabel: TDF_Label, theItemLabel: TDF_Label, theSubshapeIndex: int
    ) -> XCAFDoc_AssemblyItemRef: ...
    def CreateBalloon(
        self, theUserName: str, theTimeStamp: str, theComment: str
    ) -> XCAFDoc_Note: ...
    @overload
    def CreateBinData(
        self,
    ...
    def FindAnnotatedItemAttr(
        self, theItemId: XCAFDoc_AssemblyItemId, theGUID: Standard_GUID
    ) -> TDF_Label: ...
    @overload
    def FindAnnotatedItemAttr(
        self, theItemLabel: TDF_Label, theGUID: Standard_GUID
    ) -> TDF_Label: ...
    @overload
    def FindAnnotatedItemSubshape(
        self, theItemId: XCAFDoc_AssemblyItemId, theSubshapeIndex: int
    ) -> TDF_Label: ...
    @overload
    def FindAnnotatedItemSubshape(
        self, theItemLabel: TDF_Label, theSubshapeIndex: int
    ) -> TDF_Label: ...
    ...
    @overload
    def GetNotes(
        self, theItemId: XCAFDoc_AssemblyItemId, theNoteLabels: TDF_LabelSequence
    ) -> int: ...
    @overload
    def GetNotes(
        self, theItemLabel: TDF_Label, theNoteLabels: TDF_LabelSequence
    ) -> int: ...
    ...
    def RemoveAllAttrNotes(
        ...
        theItemId: XCAFDoc_AssemblyItemId,
        theGUID: Standard_GUID,
        theDelIfOrphan: Optional[bool] = False,
    ) -> bool: ...
    @overload
    def RemoveAllAttrNotes(
        self,
    ...
    @overload
    def RemoveAllNotes(
        self, theItemId: XCAFDoc_AssemblyItemId, theDelIfOrphan: Optional[bool] = False
    ) -> bool: ...
    @overload
    def RemoveAllNotes(
        self, theItemLabel: TDF_Label, theDelIfOrphan: Optional[bool] = False
    ) -> bool: ...
...
class XCAFDoc_ShapeTool(TDataStd_GenericEmpty):
    ...
    @overload
    def AddComponent(
        self, assembly: TDF_Label, comp: TDF_Label, Loc: TopLoc_Location
    ) -> TDF_Label: ...
    @overload
    def AddComponent(
        self, assembly: TDF_Label, comp: TopoDS_Shape, expand: Optional[bool] = False
    ) -> TDF_Label: ...
    def AddShape(
        self,
        S: TopoDS_Shape,
        makeAssembly: Optional[bool] = True,
        makePrepare: Optional[bool] = True,
    ) -> TDF_Label: ...
    @overload
    def AddSubShape(self, shapeL: TDF_Label, sub: TopoDS_Shape) -> TDF_Label: ...
    @overload
    def AddSubShape(
        self, shapeL: TDF_Label, sub: TopoDS_Shape, addedSubShapeL: TDF_Label
    ) -> bool: ...
    @staticmethod
    def AutoNaming() -> bool: ...
    def BaseLabel(self) -> TDF_Label: ...
    ...
    @overload
    def Dump(self, deep: bool) -> Tuple[Standard_OStream, str]: ...
    @overload
    def Dump(self) -> Tuple[Standard_OStream, str]: ...
    def DumpJson(self, depth: Optional[int] = -1) -> str: ...
    @staticmethod
    def DumpShape(
        L: TDF_Label, level: Optional[int] = 0, deep: Optional[bool] = False
    ) -> str: ...
    def Expand(self, Shape: TDF_Label) -> bool: ...
    def FindComponent(
        self, theShape: TopoDS_Shape, Labels: TDF_LabelSequence
    ) -> bool: ...
    ...
    @overload
    def FindShape(
        self, S: TopoDS_Shape, L: TDF_Label, findInstance: Optional[bool] = False
    ) -> bool: ...
    @overload
    def FindShape(
        self, S: TopoDS_Shape, findInstance: Optional[bool] = False
    ) -> TDF_Label: ...
    def FindSubShape(
        self, shapeL: TDF_Label, sub: TopoDS_Shape, L: TDF_Label
    ) -> bool: ...
    @staticmethod
    def GetAllComponentSHUO(
        CompLabel: TDF_Label, SHUOAttrs: TDF_AttributeSequence
    ) -> bool: ...
    def GetAllSHUOInstances(
        self, theSHUO: XCAFDoc_GraphNode, theSHUOShapeSeq: TopTools_SequenceOfShape
    ) -> bool: ...
    @staticmethod
    def GetComponents(
        L: TDF_Label, Labels: TDF_LabelSequence, getsubchilds: Optional[bool] = False
    ) -> bool: ...
    @staticmethod
    ...
    def GetNamedProperties(
        self, theLabel: TDF_Label, theToCreate: Optional[bool] = False
    ) -> TDataStd_NamedData: ...
    @overload
    def GetNamedProperties(
        self, theShape: TopoDS_Shape, theToCreate: Optional[bool] = False
    ) -> TDataStd_NamedData: ...
    @overload
    @staticmethod
    ...
    def RemoveShape(
        self, L: TDF_Label, removeCompletely: Optional[bool] = True
    ) -> bool: ...
    def Search(
        self,
        S: TopoDS_Shape,
        L: TDF_Label,
        findInstance: Optional[bool] = True,
        findComponent: Optional[bool] = True,
        findSubshape: Optional[bool] = True,
    ) -> bool: ...
    def SearchUsingMap(
        self, S: TopoDS_Shape, L: TDF_Label, findWithoutLoc: bool, findSubshape: bool
    ) -> bool: ...
    @staticmethod
    ...
    @overload
    def SetExternRefs(
        self, L: TDF_Label, SHAS: TColStd_SequenceOfHAsciiString
    ) -> None: ...
    def SetInstanceSHUO(self, theShape: TopoDS_Shape) -> XCAFDoc_GraphNode: ...
    def SetLocation(
        self, theShapeLabel: TDF_Label, theLoc: TopLoc_Location, theRefLabel: TDF_Label
    ) -> bool: ...
    def SetSHUO(
        self, Labels: TDF_LabelSequence, MainSHUOAttr: XCAFDoc_GraphNode
    ) -> bool: ...
...
class XCAFDoc_ViewTool(TDataStd_GenericEmpty):
    ...
    def GetRefAnnotationLabel(
        self, theViewL: TDF_Label, theAnnotationLabels: TDF_LabelSequence
    ) -> bool: ...
    def GetRefClippingPlaneLabel(
        self, theViewL: TDF_Label, theClippingPlaneLabels: TDF_LabelSequence
    ) -> bool: ...
    def GetRefGDTLabel(
        self, theViewL: TDF_Label, theGDTLabels: TDF_LabelSequence
    ) -> bool: ...
    def GetRefNoteLabel(
        self, theViewL: TDF_Label, theNoteLabels: TDF_LabelSequence
    ) -> bool: ...
    def GetRefShapeLabel(
    ...
    def GetViewLabelsForAnnotation(
        self, theAnnotationL: TDF_Label, theViews: TDF_LabelSequence
    ) -> bool: ...
    def GetViewLabelsForClippingPlane(
        self, theClippingPlaneL: TDF_Label, theViews: TDF_LabelSequence
    ) -> bool: ...
    def GetViewLabelsForGDT(
        self, theGDTL: TDF_Label, theViews: TDF_LabelSequence
    ) -> bool: ...
    def GetViewLabelsForNote(
        self, theNoteL: TDF_Label, theViews: TDF_LabelSequence
    ) -> bool: ...
    def GetViewLabelsForShape(
        self, theShapeL: TDF_Label, theViews: TDF_LabelSequence
    ) -> bool: ...
    def ID(self) -> Standard_GUID: ...
    def IsLocked(self, theViewL: TDF_Label) -> bool: ...
    ...
    def SetClippingPlanes(
        self, theClippingPlaneLabels: TDF_LabelSequence, theViewL: TDF_Label
    ) -> None: ...
    @overload
    def SetView(
        self,
...
class XCAFDoc_VisMaterialTool(TDF_Attribute):
    ...
    def GetShapeMaterial(
        theShapeLabel: TDF_Label, theMaterialLabel: TDF_Label
    ) -> bool: ...
    @overload
    @staticmethod
    ...
    @overload
    def GetShapeMaterial(
        self, theShape: TopoDS_Shape, theMaterialLabel: TDF_Label
    ) -> bool: ...
    @overload
    ...
    def SetShapeMaterial(
        self, theShapeLabel: TDF_Label, theMaterialLabel: TDF_Label
    ) -> None: ...
    @overload
    def SetShapeMaterial(
        self, theShape: TopoDS_Shape, theMaterialLabel: TDF_Label
...
class XCAFDoc_NoteBinData(XCAFDoc_Note):
    ...
    @overload
    def Set(
        self, theTitle: str, theMIMEtype: str, theData: TColStd_HArray1OfByte
    ) -> None: ...
    def Size(self) -> int: ...
    def Title(self) -> str: ...
...
class XCAFDoc_NoteComment(XCAFDoc_Note):
    ...
    @staticmethod
    def Set(
        theLabel: TDF_Label, theUserName: str, theTimeStamp: str, theComment: str
    ) -> XCAFDoc_NoteComment: ...
    @overload
