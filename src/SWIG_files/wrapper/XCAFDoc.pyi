...
class XCAFDoc_LayerTool(TDataStd_GenericEmpty):
    ...
    @overload
    def GetLayers(self, L: TDF_Label) -> False: ...
    @overload
    def GetLayers(self, Sh: TopoDS_Shape) -> False: ...
    def ID(self) -> Standard_GUID: ...
