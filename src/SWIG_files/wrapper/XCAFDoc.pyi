...
class XCAFDoc_Editor:
    @staticmethod
    def CloneMetaData(theSrcLabel: TDF_Label, theDstLabel: TDF_Label, theVisMatMap: Any, theToCopyColor: Optional[bool] = True, theToCopyLayer: Optional[bool] = True, theToCopyMaterial: Optional[bool] = True, theToCopyVisMaterial: Optional[bool] = True, theToCopyAttributes: Optional[bool] = True) -> None: ...
    @staticmethod
    ...
    @staticmethod
    def FilterShapeTree(theShapeTool: XCAFDoc_ShapeTool, theLabelsToKeep: TDF_LabelMap) -> bool: ...
    @staticmethod
    def GetChildShapeLabels(theLabel: TDF_Label, theRelatedLabels: TDF_LabelMap) -> None: ...
    @staticmethod
    def GetParentShapeLabels(theLabel: TDF_Label, theRelatedLabels: TDF_LabelMap) -> None: ...
    @staticmethod
...
class XCAFDoc_ShapeTool(TDataStd_GenericEmpty):
    ...
    def DumpJson(self, depth: Optional[int]=-1) -> str: ...
    @staticmethod
    def DumpShape(L: TDF_Label, level: Optional[int] = 0, deep: Optional[bool] = False) -> str: ...
...
class XCAFDoc_VisMaterialTool(TDF_Attribute):
    ...
    def NewEmpty(self) -> TDF_Attribute: ...
    def Paste(self, arg0: TDF_Attribute, arg1: TDF_RelocationTable) -> None: ...
    def RemoveMaterial(self, theLabel: TDF_Label) -> None: ...
    def Restore(self, arg0: TDF_Attribute) -> None: ...
    @staticmethod
