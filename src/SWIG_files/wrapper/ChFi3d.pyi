...
class chfi3d:
    ...
    def IsTangentFaces(
        ...
        Order: Optional[GeomAbs_Shape] = GeomAbs_G1,
    ) -> bool: ...
    @overload
    @staticmethod
    def NextSide(
    ...
    @staticmethod
    def NextSide(
        Or: TopAbs_Orientation, OrSave: TopAbs_Orientation, OrFace: TopAbs_Orientation
    ) -> None: ...
    @staticmethod
    def SameSide(
...
class ChFi3d_Builder:
    ...
    def Reset(self) -> None: ...
    def SetContinuity(
        self, InternalContinuity: GeomAbs_Shape, AngularTolerance: float
    ) -> None: ...
    def SetParams(
        self,
        Tang: float,
...
class ChFi3d_ChBuilder(ChFi3d_Builder):
    ...
    def AddDA(
        self, Dis: float, Angle: float, E: TopoDS_Edge, F: TopoDS_Face
    ) -> None: ...
    ...
    def SetDistAngle(
        self, Dis: float, Angle: float, IC: int, F: TopoDS_Face
    ) -> None: ...
...
class ChFi3d_FilBuilder(ChFi3d_Builder):
    def __init__(
        self,
        S: TopoDS_Shape,
        FShape: Optional[ChFi3d_FilletShape] = ChFi3d_Rational,
        Ta: Optional[float] = 1.0e-2,
    ) -> None: ...
    @overload
    def Add(self, E: TopoDS_Edge) -> None: ...
    @overload
