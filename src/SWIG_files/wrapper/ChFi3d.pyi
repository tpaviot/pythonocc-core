...
class ChFi3d_Builder:
    ...
    def SplitKPart(self, Data: ChFiDS_SurfData, SetData: Any, Spine: ChFiDS_Spine, Iedge: int, S1: Adaptor3d_Surface, I1: Adaptor3d_TopolTool, S2: Adaptor3d_Surface, I2: Adaptor3d_TopolTool) -> Tuple[bool, bool, bool]: ...
...
class ChFi3d_ChBuilder(ChFi3d_Builder):
    ...
    def Sect(self, IC: int, IS: int) -> Any: ...
