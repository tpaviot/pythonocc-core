...
class IGESToBRep_IGESBoundary(Standard_Transient):
    ...
    @overload
    def Transfer(self, curve3d: IGESData_IGESEntity, toreverse3d: bool, curves2d: Any, number: int) -> Tuple[bool, bool, bool, bool]: ...
    @overload
    def Transfer(self, curve3d: ShapeExtend_WireData, curves2d: Any, toreverse2d: bool, number: int, lsewd: ShapeExtend_WireData) -> Tuple[bool, bool, bool, bool]: ...
...
class IGESToBRep_Reader:
    ...
    def Clear(self) -> None: ...
    def GetShapeFixParameters(self) -> Resource_DataMapOfAsciiStringAsciiString: ...
    ...
    def SetModel(self, model: IGESData_IGESModel) -> None: ...
    @overload
    def SetShapeFixParameters(self, theParameters: Resource_DataMapOfAsciiStringAsciiString) -> None: ...
    @overload
    def SetShapeFixParameters(self, theParameters: Resource_DataMapOfAsciiStringAsciiString) -> None: ...
    @overload
    def SetShapeFixParameters(self, theParameters: DE_ShapeFixParameters, theAdditionalParameters: Optional[Resource_DataMapOfAsciiStringAsciiString] = {}) -> None: ...
...
class IGESToBRep_BRepEntity(IGESToBRep_CurveAndSurface):
    ...
    def TransferEdge(self, start: Any, index: int) -> TopoDS_Shape: ...
    def TransferFace(self, start: Any) -> TopoDS_Shape: ...
    def TransferLoop(self, start: Any, Face: TopoDS_Face, trans: gp_Trsf2d, uFact: float) -> TopoDS_Shape: ...
    def TransferManifoldSolid(self, start: Any, theProgress: Optional[Message_ProgressRange] = Message_ProgressRange()) -> TopoDS_Shape: ...
    def TransferShell(self, start: Any, theProgress: Optional[Message_ProgressRange] = Message_ProgressRange()) -> TopoDS_Shape: ...
    def TransferVertex(self, start: Any, index: int) -> TopoDS_Vertex: ...
...
class IGESToBRep_BasicCurve(IGESToBRep_CurveAndSurface):
    ...
    @overload
    def __init__(self, eps: float, epsGeom: float, epsCoeff: float, mode: bool, modeapprox: bool, optimized: bool) -> None: ...
    def Transfer2dBSplineCurve(self, start: Any) -> Geom2d_Curve: ...
    def Transfer2dBasicCurve(self, start: IGESData_IGESEntity) -> Geom2d_Curve: ...
    def Transfer2dCircularArc(self, start: Any) -> Geom2d_Curve: ...
    def Transfer2dConicArc(self, start: Any) -> Geom2d_Curve: ...
    def Transfer2dCopiousData(self, start: Any) -> Geom2d_BSplineCurve: ...
    def Transfer2dLine(self, start: Any) -> Geom2d_Curve: ...
    def Transfer2dSplineCurve(self, start: Any) -> Geom2d_BSplineCurve: ...
    def TransferBSplineCurve(self, start: Any) -> Geom_Curve: ...
    def TransferBasicCurve(self, start: IGESData_IGESEntity) -> Geom_Curve: ...
    def TransferCircularArc(self, start: Any) -> Geom_Curve: ...
    def TransferConicArc(self, start: Any) -> Geom_Curve: ...
    def TransferCopiousData(self, start: Any) -> Geom_BSplineCurve: ...
    def TransferLine(self, start: Any) -> Geom_Curve: ...
    def TransferSplineCurve(self, start: Any) -> Geom_BSplineCurve: ...
    def TransferTransformation(self, start: Any) -> Geom_Transformation: ...
...
class IGESToBRep_BasicSurface(IGESToBRep_CurveAndSurface):
    ...
    @overload
    def __init__(self, eps: float, epsGeom: float, epsCoeff: float, mode: bool, modeapprox: bool, optimized: bool) -> None: ...
    def TransferBSplineSurface(self, start: Any) -> Geom_BSplineSurface: ...
    def TransferBasicSurface(self, start: IGESData_IGESEntity) -> Geom_Surface: ...
    def TransferPlaneSurface(self, start: Any) -> Geom_Plane: ...
    def TransferRigthConicalSurface(self, start: Any) -> Geom_ConicalSurface: ...
    def TransferRigthCylindricalSurface(self, start: Any) -> Geom_CylindricalSurface: ...
    def TransferSphericalSurface(self, start: Any) -> Geom_SphericalSurface: ...
    def TransferSplineSurface(self, start: Any) -> Geom_BSplineSurface: ...
    def TransferToroidalSurface(self, start: Any) -> Geom_ToroidalSurface: ...
...
class IGESToBRep_TopoCurve(IGESToBRep_CurveAndSurface):
    ...
    def Transfer2dCompositeCurve(self, start: Any, face: TopoDS_Face, trans: gp_Trsf2d, uFact: float) -> TopoDS_Shape: ...
    def Transfer2dOffsetCurve(self, start: Any, face: TopoDS_Face, trans: gp_Trsf2d, uFact: float) -> TopoDS_Shape: ...
    def Transfer2dPoint(self, start: Any) -> TopoDS_Vertex: ...
    ...
    def TransferBoundary(self, start: Any) -> TopoDS_Shape: ...
    def TransferBoundaryOnFace(self, face: TopoDS_Face, start: Any, trans: gp_Trsf2d, uFact: float) -> TopoDS_Shape: ...
    def TransferCompositeCurve(self, start: Any) -> TopoDS_Shape: ...
    def TransferCurveOnFace(self, face: TopoDS_Face, start: Any, trans: gp_Trsf2d, uFact: float, IsCurv: bool) -> TopoDS_Shape: ...
    def TransferCurveOnSurface(self, start: Any) -> TopoDS_Shape: ...
    def TransferOffsetCurve(self, start: Any) -> TopoDS_Shape: ...
    def TransferPoint(self, start: Any) -> TopoDS_Vertex: ...
...
class IGESToBRep_TopoSurface(IGESToBRep_CurveAndSurface):
    ...
    def TransferBoundedSurface(self, start: Any) -> TopoDS_Shape: ...
    def TransferOffsetSurface(self, start: Any) -> TopoDS_Shape: ...
    def TransferPerforate(self, start: Any) -> TopoDS_Shape: ...
    def TransferPlane(self, start: Any) -> TopoDS_Shape: ...
    def TransferRuledSurface(self, start: Any) -> TopoDS_Shape: ...
    def TransferSurfaceOfRevolution(self, start: Any) -> TopoDS_Shape: ...
    def TransferTabulatedCylinder(self, start: Any) -> TopoDS_Shape: ...
    ...
    def TransferTrimmedSurface(self, start: Any) -> TopoDS_Shape: ...
