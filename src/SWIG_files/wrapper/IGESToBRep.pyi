...
class igestobrep:
    ...
    @staticmethod
    def IGESCurveToSequenceOfIGESCurve(
        curve: IGESData_IGESEntity, sequence: TColStd_HSequenceOfTransient
    ) -> int: ...
    @staticmethod
    def Init() -> None: ...
    @staticmethod
    ...
    @staticmethod
    def TransferPCurve(
        fromedge: TopoDS_Edge, toedge: TopoDS_Edge, face: TopoDS_Face
    ) -> bool: ...
...
class IGESToBRep_CurveAndSurface:
    ...
    def AddShapeResult(
        self, start: IGESData_IGESEntity, result: TopoDS_Shape
    ) -> None: ...
    def GetContinuity(self) -> int: ...
...
class IGESToBRep_IGESBoundary(Standard_Transient):
    ...
    def Check(
        self, result: bool, checkclosure: bool, okCurve3d: bool, okCurve2d: bool
    ) -> None: ...
    def Init(
        self,
...
class IGESToBRep_Reader:
    ...
    def TransferRoots(
        self,
        onlyvisible: Optional[bool] = True,
        theProgress: Optional[Message_ProgressRange] = Message_ProgressRange(),
    ) -> None: ...
...
class IGESToBRep_TopoSurface(IGESToBRep_CurveAndSurface):
    ...
    def ParamSurface(
        self, start: IGESData_IGESEntity, trans: gp_Trsf2d
