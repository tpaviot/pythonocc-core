...
class TopoDS_AlertAttribute(Message_AttributeStream):
    def __init__(
        self, theShape: TopoDS_Shape, theName: Optional[str] = TCollection_AsciiString()
    ) -> None: ...
...
class TopoDS_Shape:
    ...
    def Located(
        self, theLoc: TopLoc_Location, theRaiseExc: Optional[bool] = False
    ) -> TopoDS_Shape: ...
    @overload
    ...
    def Move(
        self, thePosition: TopLoc_Location, theRaiseExc: Optional[bool] = False
    ) -> None: ...
    def Moved(
        self, thePosition: TopLoc_Location, theRaiseExc: Optional[bool] = False
    ) -> TopoDS_Shape: ...
