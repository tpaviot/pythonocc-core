...
class Law_Laws:
    ...
    def Assign(self, theItem: Law_Laws) -> Law_Laws: ...
    def Clear(self) -> None: ...
...
class law:
    ...
    @staticmethod
    def Scale(
        First: float, Last: float, HasF: bool, HasL: bool, VFirst: float, VLast: float
    ) -> Law_BSpline: ...
    @staticmethod
    def ScaleCub(
        First: float, Last: float, HasF: bool, HasL: bool, VFirst: float, VLast: float
...
class Law_BSpline(Standard_Transient):
    ...
    def LocalD2(
        self, U: float, FromK1: int, ToK2: int
...
class Law_Interpolate:
    @overload
    def __init__(
        self, Points: TColStd_HArray1OfReal, PeriodicFlag: bool, Tolerance: float
    ) -> None: ...
    @overload
    def __init__(
        self,
    ...
    @overload
    def Load(
        self, Tangents: TColStd_Array1OfReal, TangentFlags: TColStd_HArray1OfBoolean
    ) -> None: ...
...
class Law_Interpol(Law_BSpFunc):
    ...
    @overload
    def Set(
        self, ParAndRad: TColgp_Array1OfPnt2d, Periodic: Optional[bool] = False
    ) -> None: ...
    @overload
    def Set(
        self,
