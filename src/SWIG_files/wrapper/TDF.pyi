...
# the following typedef cannot be wrapped as is
TDF_DoubleMapIteratorOfAttributeDoubleMap = NewType(
    "TDF_DoubleMapIteratorOfAttributeDoubleMap", Any
)
# the following typedef cannot be wrapped as is
TDF_DoubleMapIteratorOfGUIDProgIDMap = NewType(
    "TDF_DoubleMapIteratorOfGUIDProgIDMap", Any
)
# the following typedef cannot be wrapped as is
TDF_DoubleMapIteratorOfLabelDoubleMap = NewType(
    "TDF_DoubleMapIteratorOfLabelDoubleMap", Any
)
# the following typedef cannot be wrapped as is
...
class TDF_AttributeDeltaList:
    ...
    def Assign(self, theItem: TDF_AttributeDeltaList) -> TDF_AttributeDeltaList: ...
    def Clear(self) -> None: ...
    def First(self) -> False: ...
    def Last(self) -> False: ...
...
class TDF_AttributeList:
    def Append(self, theItem: False) -> False: ...
    def Assign(self, theItem: TDF_AttributeList) -> TDF_AttributeList: ...
    def Clear(self) -> None: ...
    def First(self) -> False: ...
    def Last(self) -> False: ...
    def Prepend(self, theItem: False) -> False: ...
...
class TDF_DeltaList:
    def Append(self, theItem: False) -> False: ...
    def Assign(self, theItem: TDF_DeltaList) -> TDF_DeltaList: ...
    def Clear(self) -> None: ...
    def First(self) -> False: ...
    def Last(self) -> False: ...
    def Prepend(self, theItem: False) -> False: ...
...
class TDF_IDList:
    ...
    def Assign(self, theItem: TDF_IDList) -> TDF_IDList: ...
    def Clear(self) -> None: ...
    ...
    def __init__(self) -> None: ...
    def __len__(self) -> int: ...
    def __iter__(self) -> Standard_GUID: ...

class TDF_LabelList:
    def Append(self, theItem: TDF_Label) -> TDF_Label: ...
    def Assign(self, theItem: TDF_LabelList) -> TDF_LabelList: ...
    def Clear(self) -> None: ...
    ...
    def __init__(self) -> None: ...
    def __len__(self) -> int: ...
    def __iter__(self) -> TDF_Label: ...

class TDF_LabelSequence:
    def Assign(self, theItem: TDF_Label) -> TDF_Label: ...
    def Clear(self) -> None: ...
    def First(self) -> TDF_Label: ...
    def IsDeletables(self) -> bool: ...
    def IsEmpty(self) -> bool: ...
...
class TDF_Attribute(Standard_Transient):
    ...
    def AfterUndo(
        self, anAttDelta: TDF_AttributeDelta, forceIt: Optional[bool] = False
    ) -> bool: ...
    ...
    def DeltaOnModification(
        self, anOldAttribute: TDF_Attribute
    ...
    def ExtendedDump(
        self, aFilter: TDF_IDFilter, aMap: TDF_AttributeIndexedMap
    ) -> str: ...
    @overload
    def FindAttribute(
        self, anID: Standard_GUID, anAttribute: TDF_Attribute
    ) -> bool: ...
    ...
    def Paste(
        self, intoAttribute: TDF_Attribute, aRelocationTable: TDF_RelocationTable
    ) -> None: ...
...
class TDF_AttributeIterator:
    ...
    @overload
    def __init__(
        self, aLabel: TDF_Label, withoutForgotten: Optional[bool] = True
    ) -> None: ...
    @overload
    def __init__(
        self, aLabelNode: TDF_LabelNodePtr, withoutForgotten: Optional[bool] = True
    ) -> None: ...
    def Initialize(
        self, aLabel: TDF_Label, withoutForgotten: Optional[bool] = True
    ) -> None: ...
...
class TDF_ChildIDIterator:
    ...
    @overload
    def __init__(
        self, aLabel: TDF_Label, anID: Standard_GUID, allLevels: Optional[bool] = False
    ) -> None: ...
    def Initialize(
        self, aLabel: TDF_Label, anID: Standard_GUID, allLevels: Optional[bool] = False
    ) -> None: ...
...
class TDF_ChildIterator:
    ...
    @overload
    def __init__(
        self, aLabel: TDF_Label, allLevels: Optional[bool] = False
    ) -> None: ...
    def Initialize(
        self, aLabel: TDF_Label, allLevels: Optional[bool] = False
    ) -> None: ...
...
class TDF_ClosureTool:
    ...
    @staticmethod
    def Closure(
        aDataSet: TDF_DataSet, aFilter: TDF_IDFilter, aMode: TDF_ClosureMode
    ) -> None: ...
    @overload
    @staticmethod
    def Closure(
...
class TDF_CopyLabel:
    ...
    def ExternalReferences(
        Lab: TDF_Label, aExternals: TDF_AttributeMap, aFilter: TDF_IDFilter
    ) -> bool: ...
    @overload
    @staticmethod
    def ExternalReferences(
...
class TDF_CopyTool:
    ...
    @staticmethod
    def Copy(
        aSourceDataSet: TDF_DataSet, aRelocationTable: TDF_RelocationTable
    ) -> None: ...
    @overload
    @staticmethod
    def Copy(
...
class TDF_Data(Standard_Transient):
    ...
    def Transaction(self) -> int: ...
    def Undo(
        self, aDelta: TDF_Delta, withDelta: Optional[bool] = False
    ) -> TDF_Delta: ...
...
class TDF_Label:
    def __init__(self) -> None: ...
    def AddAttribute(
        self, anAttribute: TDF_Attribute, append: Optional[bool] = True
    ) -> None: ...
    ...
    @overload
    def FindAttribute(
        self, anID: Standard_GUID, aTransaction: int, anAttribute: TDF_Attribute
    ) -> bool: ...
...
class TDF_RelocationTable(Standard_Transient):
    ...
    def Clear(self) -> None: ...
    def Dump(
        self, dumpLabels: bool, dumpAttributes: bool, dumpTransients: bool
    ) -> Tuple[Standard_OStream, str]: ...
    @overload
    def HasRelocation(
        self, aSourceLabel: TDF_Label, aTargetLabel: TDF_Label
    ) -> bool: ...
    @overload
    def HasRelocation(
        self, aSourceAttribute: TDF_Attribute, aTargetAttribute: TDF_Attribute
    ) -> bool: ...
    def HasTransientRelocation(
        self, aSourceTransient: Standard_Transient, aTargetTransient: Standard_Transient
    ) -> bool: ...
...
class TDF_Tool:
    @staticmethod
    def CountLabels(
        aLabelList: TDF_LabelList, aLabelMap: TDF_LabelIntegerMap
    ) -> None: ...
    @staticmethod
    def DeductLabels(
        aLabelList: TDF_LabelList, aLabelMap: TDF_LabelIntegerMap
    ...
    @overload
    @staticmethod
    def ExtendedDeepDump(aDF: TDF_Data, aFilter: TDF_IDFilter) -> str: ...
    @overload
    @staticmethod
    ...
    @staticmethod
    def Label(
        aDF: TDF_Data, anEntry: str, aLabel: TDF_Label, create: Optional[bool] = False
    ) -> None: ...
    @overload
    @staticmethod
    def Label(
