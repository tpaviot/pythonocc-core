...
# the following typedef cannot be wrapped as is
TDF_HAttributeArray1 = NewType("TDF_HAttributeArray1", Any)
# the following typedef cannot be wrapped as is
...
class TDF_Attribute(Standard_Transient):
    ...
    @overload
    def FindAttribute(self, anID: Standard_GUID, anAttribute: TDF_Attribute) -> Optional[TDF_Attribute]: ...
...
class TDF_Label:
    ...
    def FindAttribute(self, anID: Standard_GUID, anAttribute: TDF_Attribute) -> Optional[TDF_Attribute]: ...
    @overload
    def FindAttribute(self, anID: Standard_GUID, aTransaction: int, anAttribute: TDF_Attribute) -> Optional[TDF_Attribute]: ...
