...
class TDF_ListIteratorOfLabelList:
    def __init__(self, *args: Any, **kwargs: Any) -> None: ...
    def __getattr__(self, name: str) -> Any: ...
TDF_LabelNodeImportMsk: int
TDF_LabelNodeAttModMsk: int
TDF_LabelNodeMayModMsk: int
TDF_LabelNodeFlagsMsk: int
...
class TDF_Attribute(Standard_Transient):
    ...
    def ExtendedDump(self, aFilter: TDF_IDFilter, aMap: Any) -> str: ...
    @overload
    def FindAttribute(self, anID: Standard_GUID, anAttribute: _TDF_AttributeT) -> Optional[_TDF_AttributeT]: ...
    ...
    @overload
    def SetID(self, arg0: Standard_GUID) -> None: ...
    @overload
    def SetID(self) -> None: ...
...
class TDF_Label:
    ...
    def FindAttribute(self, anID: Standard_GUID, anAttribute: _TDF_AttributeT) -> Optional[_TDF_AttributeT]: ...
    @overload
    def FindAttribute(self, anID: Standard_GUID, aTransaction: int, anAttribute: _TDF_AttributeT) -> Optional[_TDF_AttributeT]: ...
...
class TDF_RelocationTable(Standard_Transient):
    ...
    def Clear(self) -> None: ...
    def Dump(self, dumpLabels: bool, dumpAttributes: bool, dumpTransients: bool) -> Tuple[Standard_OStream, str]: ...
    @overload
