...
ProjLib_HCompProjectedCurve = NewType(
...
class ProjLib_CompProjectedCurve(Adaptor2d_Curve2d):
    ...
    @overload
    def __init__(
        self, S: Adaptor3d_Surface, C: Adaptor3d_Curve, TolU: float, TolV: float
    ) -> None: ...
    @overload
    def __init__(
        self,
    ...
    def Trim(
        self, FirstParam: float, LastParam: float, Tol: float
    ) -> Adaptor2d_Curve2d: ...
...
class ProjLib_ComputeApprox:
    ...
    @overload
    def __init__(
        self, C: Adaptor3d_Curve, S: Adaptor3d_Surface, Tol: float
    ) -> None: ...
...
class ProjLib_ComputeApproxOnPolarSurface:
    ...
    @overload
    def __init__(
        self, C: Adaptor3d_Curve, S: Adaptor3d_Surface, Tol: Optional[float] = 1.0e-4
    ) -> None: ...
    @overload
    def __init__(
        self,
    ...
    def BuildInitialCurve2d(
        self, Curve: Adaptor3d_Curve, S: Adaptor3d_Surface
    ) -> Adaptor2d_Curve2d: ...
    ...
    @overload
    def Perform(
        self, InitCurve2d: Adaptor2d_Curve2d, C: Adaptor3d_Curve, S: Adaptor3d_Surface
    ) -> Geom2d_BSplineCurve: ...
...
class ProjLib_PrjFunc(math_FunctionSetWithDerivatives):
    def __init__(
        self, C: Adaptor3d_Curve, FixVal: float, S: Adaptor3d_Surface, Fix: int
    ) -> None: ...
...
class ProjLib_PrjResolve:
    ...
    def Perform(
        ...
        Inf: gp_Pnt2d,
        Sup: gp_Pnt2d,
        FTol: Optional[float] = -1,
        StrictInside: Optional[bool] = False,
    ) -> None: ...
    def Solution(self) -> gp_Pnt2d: ...
...
class ProjLib_ProjectOnPlane(Adaptor3d_Curve):
    ...
    def Load(
        ...
        C: Adaptor3d_Curve,
        Tolerance: float,
        KeepParametrization: Optional[bool] = True,
    ) -> None: ...
    def NbIntervals(self, S: GeomAbs_Shape) -> int: ...
...
class ProjLib_ProjectedCurve(Adaptor2d_Curve2d):
    ...
    @overload
    def __init__(
        self, S: Adaptor3d_Surface, C: Adaptor3d_Curve, Tol: float
    ) -> None: ...
    def BSpline(self) -> Geom2d_BSplineCurve: ...
    def Bezier(self) -> Geom2d_BezierCurve: ...
...
class ProjLib_Projector:
    ...
    def UFrame(
        self, CFirst: float, CLast: float, UFirst: float, Period: float
    ) -> None: ...
    def VFrame(
        self, CFirst: float, CLast: float, VFirst: float, Period: float
    ) -> None: ...
...
class ProjLib_HSequenceOfHSequenceOfPnt(
    ProjLib_SequenceOfHSequenceOfPnt, Standard_Transient
):
    @overload
    def __init__(self) -> None: ...
    @overload
