...
class BRepClass3d_SClassifier:
    ...
    def PerformInfinitePoint(
        self, S: BRepClass3d_SolidExplorer, Tol: float
    ) -> None: ...
...
class BRepClass3d_SolidExplorer:
    ...
    def DumpSegment(
        self, P: gp_Pnt, L: gp_Lin, Par: float, S: TopAbs_State
    ) -> None: ...
    @overload
    @staticmethod
    ...
    @overload
    @staticmethod
    def FindAPointInTheFace(
        F: TopoDS_Face, P: gp_Pnt
    ) -> Tuple[bool, float, float, float]: ...
    @overload
    @staticmethod
    def FindAPointInTheFace(
        F: TopoDS_Face, P: gp_Pnt, theVecD1U: gp_Vec, theVecD1V: gp_Vec
    ) -> Tuple[bool, float, float, float]: ...
    @overload
    @staticmethod
