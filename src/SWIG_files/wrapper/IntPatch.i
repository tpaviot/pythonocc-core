...
"Intersection between two patches.The class PatchIntersection implements the algorithmes of intersection.
The classes IntPoint, PointOnDomain, Line, ILin, a.s.o...describe the results of the algorithmes.
