...
TColGeom2d_HArray1OfBSplineCurve = NewType("TColGeom2d_HArray1OfBSplineCurve", Any)
# the following typedef cannot be wrapped as is
TColGeom2d_HArray1OfBezierCurve = NewType("TColGeom2d_HArray1OfBezierCurve", Any)
# the following typedef cannot be wrapped as is
TColGeom2d_HArray1OfCurve = NewType("TColGeom2d_HArray1OfCurve", Any)
# the following typedef cannot be wrapped as is
TColGeom2d_HSequenceOfBoundedCurve = NewType("TColGeom2d_HSequenceOfBoundedCurve", Any)
# the following typedef cannot be wrapped as is
TColGeom2d_HSequenceOfCurve = NewType("TColGeom2d_HSequenceOfCurve", Any)
