...
class APIHeaderSection_MakeHeader:
    ...
    def AddSchemaIdentifier(
        self, aSchemaIdentifier: TCollection_HAsciiString
    ) -> None: ...
    ...
    def SetDescriptionValue(
        self, num: int, aDescription: TCollection_HAsciiString
    ) -> None: ...
    def SetImplementationLevel(
        self, aImplementationLevel: TCollection_HAsciiString
    ) -> None: ...
    def SetName(self, aName: TCollection_HAsciiString) -> None: ...
    def SetOrganization(
        self, aOrganization: Interface_HArray1OfHAsciiString
    ) -> None: ...
    def SetOrganizationValue(
        self, num: int, aOrganization: TCollection_HAsciiString
    ) -> None: ...
    def SetOriginatingSystem(
        self, aOriginatingSystem: TCollection_HAsciiString
    ) -> None: ...
    def SetPreprocessorVersion(
        self, aPreprocessorVersion: TCollection_HAsciiString
    ) -> None: ...
    def SetSchemaIdentifiers(
        self, aSchemaIdentifiers: Interface_HArray1OfHAsciiString
    ) -> None: ...
    def SetSchemaIdentifiersValue(
        self, num: int, aSchemaIdentifier: TCollection_HAsciiString
    ) -> None: ...
