...
class STEPConstruct_UnitContext:
    ...
    @overload
    def ComputeFactors(self, aContext: StepRepr_GlobalUnitAssignedContext, theLocalFactors: StepData_Factors) -> int: ...
    @overload
    def ComputeFactors(self, aUnit: StepBasic_NamedUnit, theLocalFactors: StepData_Factors) -> int: ...
    ...
    def Init(self, Tol3d: float, theModel: StepData_StepModel, theLocalFactors: StepData_Factors) -> None: ...
    def IsDone(self) -> bool: ...
...
class STEPConstruct_Styles(STEPConstruct_Tool):
    ...
    def GetColors(self, style: StepVisual_StyledItem, SurfCol: StepVisual_Colour, BoundCol: StepVisual_Colour, CurveCol: StepVisual_Colour, RenderCol: StepVisual_Colour) -> Tuple[bool, float, bool]: ...
    def Init(self, WS: XSControl_WorkSession) -> bool: ...
...
class STEPConstruct_ValidationProps(STEPConstruct_Tool):
    ...
    def GetPropPnt(self, item: StepRepr_RepresentationItem, Context: StepRepr_RepresentationContext, Pnt: gp_Pnt, theLocalFactors: StepData_Factors) -> bool: ...
    def GetPropReal(self, item: StepRepr_RepresentationItem, theLocalFactors: StepData_Factors) -> Tuple[bool, float, bool]: ...
    @overload
