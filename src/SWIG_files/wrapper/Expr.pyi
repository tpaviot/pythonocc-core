...
class Expr_GeneralExpression(Standard_Transient):
    ...
    def Evaluate(
        self, vars: Expr_Array1OfNamedUnknown, vals: TColStd_Array1OfReal
    ) -> float: ...
    ...
    def Replace(
        self, var: Expr_NamedUnknown, with_: Expr_GeneralExpression
    ) -> None: ...
...
class Expr_FunctionDerivative(Expr_GeneralFunction):
    def __init__(
        self, func: Expr_GeneralFunction, withX: Expr_NamedUnknown, deg: int
    ) -> None: ...
    def Copy(self) -> Expr_GeneralFunction: ...
    def Degree(self) -> int: ...
    ...
    def Derivative(self, var: Expr_NamedUnknown, deg: int) -> Expr_GeneralFunction: ...
    def Evaluate(
        self, vars: Expr_Array1OfNamedUnknown, values: TColStd_Array1OfReal
    ) -> float: ...
...
class Expr_NamedFunction(Expr_GeneralFunction):
    def __init__(
        self, name: str, exp: Expr_GeneralExpression, vars: Expr_Array1OfNamedUnknown
    ) -> None: ...
    def Copy(self) -> Expr_GeneralFunction: ...
    @overload
    def Derivative(self, var: Expr_NamedUnknown) -> Expr_GeneralFunction: ...
...
class Expr_Difference(Expr_BinaryExpression):
    def __init__(
        self, exp1: Expr_GeneralExpression, exp2: Expr_GeneralExpression
    ) -> None: ...
    def Copy(self) -> Expr_GeneralExpression: ...
    def Derivative(self, X: Expr_NamedUnknown) -> Expr_GeneralExpression: ...
    def Evaluate(
...
class Expr_PolyFunction(Expr_PolyExpression):
    def __init__(
        self, func: Expr_GeneralFunction, exps: Expr_Array1OfGeneralExpression
    ) -> None: ...
    def Copy(self) -> Expr_GeneralExpression: ...
    def Derivative(self, X: Expr_NamedUnknown) -> Expr_GeneralExpression: ...
    def Evaluate(
...
class Expr_UnaryFunction(Expr_UnaryExpression):
    def __init__(
        self, func: Expr_GeneralFunction, exp: Expr_GeneralExpression
    ) -> None: ...
    def Copy(self) -> Expr_GeneralExpression: ...
    def Derivative(self, X: Expr_NamedUnknown) -> Expr_GeneralExpression: ...
    def Evaluate(
