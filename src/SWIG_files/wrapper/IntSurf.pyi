...
class IntSurf_ListOfPntOn2S:
    ...
    def Assign(self, theItem: IntSurf_ListOfPntOn2S) -> IntSurf_ListOfPntOn2S: ...
    def Clear(self) -> None: ...
    ...
    def __iter__(self) -> IntSurf_PntOn2S: ...

class IntSurf_SequenceOfCouple:
    def Assign(self, theItem: IntSurf_Couple) -> IntSurf_Couple: ...
    def Clear(self) -> None: ...
...
class IntSurf_SequenceOfInteriorPoint:
    def Assign(self, theItem: IntSurf_InteriorPoint) -> IntSurf_InteriorPoint: ...
    def Clear(self) -> None: ...
...
class IntSurf_SequenceOfPathPoint:
    def Assign(self, theItem: IntSurf_PathPoint) -> IntSurf_PathPoint: ...
    def Clear(self) -> None: ...
...
class IntSurf_SequenceOfPntOn2S:
    def Assign(self, theItem: IntSurf_PntOn2S) -> IntSurf_PntOn2S: ...
    def Clear(self) -> None: ...
    def First(self) -> IntSurf_PntOn2S: ...
    def IsDeletables(self) -> bool: ...
    def IsEmpty(self) -> bool: ...
...
class intsurf:
    ...
    def SetPeriod(
        ...
        theArrOfPeriod_list: List[float],
    ) -> None: ...
...
class IntSurf_InteriorPoint:
    ...
    @overload
    def __init__(
        self, P: gp_Pnt, U: float, V: float, Direc: gp_Vec, Direc2d: gp_Vec2d
    ) -> None: ...
...
class IntSurf_PntOn2S:
    ...
    def IsSame(
        ...
        theTol3D: Optional[float] = 0.0,
        theTol2D: Optional[float] = -1.0,
    ) -> bool: ...
    ...
    @overload
    def SetValue(
        self, Pt: gp_Pnt, U1: float, V1: float, U2: float, V2: float
    ) -> None: ...
    @overload
...
class IntSurf_QuadricTool:
    @staticmethod
    def Gradient(
        Quad: IntSurf_Quadric, X: float, Y: float, Z: float, V: gp_Vec
    ) -> None: ...
    @staticmethod
    ...
    def ValueAndGradient(
        Quad: IntSurf_Quadric, X: float, Y: float, Z: float, Grad: gp_Vec
    ) -> float: ...
