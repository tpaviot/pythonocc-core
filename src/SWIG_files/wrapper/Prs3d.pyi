...
Prs3d_NListIteratorOfListOfSequenceOfPnt = NewType(
    "Prs3d_NListIteratorOfListOfSequenceOfPnt", Any
)
...
class Prs3d_NListOfSequenceOfPnt:
    ...
    def Assign(
        self, theItem: Prs3d_NListOfSequenceOfPnt
...
Prs3d_DatumAttribute_ShadingTubeRadiusPercent = (
    Prs3d_DatumAttribute.Prs3d_DatumAttribute_ShadingTubeRadiusPercent
)
Prs3d_DatumAttribute_ShadingConeRadiusPercent = (
    Prs3d_DatumAttribute.Prs3d_DatumAttribute_ShadingConeRadiusPercent
)
...
Prs3d_DatumAttribute_ShadingOriginRadiusPercent = (
    Prs3d_DatumAttribute.Prs3d_DatumAttribute_ShadingOriginRadiusPercent
)
Prs3d_DatumAttribute_ShadingNumberOfFacettes = (
    Prs3d_DatumAttribute.Prs3d_DatumAttribute_ShadingNumberOfFacettes
)
...
Prs3d_DP_ShadingTubeRadiusPercent = (
    Prs3d_DatumAttribute.Prs3d_DP_ShadingTubeRadiusPercent
)
Prs3d_DP_ShadingConeRadiusPercent = (
    Prs3d_DatumAttribute.Prs3d_DP_ShadingConeRadiusPercent
)
Prs3d_DP_ShadingConeLengthPercent = (
    Prs3d_DatumAttribute.Prs3d_DP_ShadingConeLengthPercent
)
Prs3d_DP_ShadingOriginRadiusPercent = (
    Prs3d_DatumAttribute.Prs3d_DP_ShadingOriginRadiusPercent
)
...
Prs3d_TypeOfHighlight_LocalDynamic = (
    Prs3d_TypeOfHighlight.Prs3d_TypeOfHighlight_LocalDynamic
)
...
class prs3d:
    ...
    @staticmethod
    def MatchSegment(
        X: float, Y: float, Z: float, aDistance: float, p1: gp_Pnt, p2: gp_Pnt
    ) -> Tuple[bool, float]: ...
    @staticmethod
    def PrimitivesFromPolylines(
...
class Prs3d_Drawer(Graphic3d_PresentationAttributes):
    ...
    def SetFaceBoundaryUpperContinuity(
        self, theMostAllowedEdgeClass: GeomAbs_Shape
    ) -> None: ...
    ...
    def SetOwnDatumAspects(
        self, theDefaults: Optional[Prs3d_Drawer] = Prs3d_Drawer()
    ) -> bool: ...
    ...
    def SetShaderProgram(
        ...
        theToOverrideDefaults: Optional[bool] = false,
    ) -> bool: ...
    ...
    def SetTypeOfDeflection(
        self, theTypeOfDeflection: Aspect_TypeOfDeflection
    ) -> None: ...
...
class Prs3d_PresentationShadow(Graphic3d_Structure):
    def __init__(
        self, theViewer: Graphic3d_StructureManager, thePrs: Graphic3d_Structure
    ) -> None: ...
...
class Prs3d_ToolQuadric:
    ...
    @overload
    def FillArray(
        self, theArray: Graphic3d_ArrayOfTriangles, theTrsf: gp_Trsf
    ) -> None: ...
    @overload
    def FillArray(
        self,
    ...
    @staticmethod
    def VerticesNb(
        theSlicesNb: int, theStacksNb: int, theIsIndexed: Optional[bool] = True
    ) -> int: ...
    @overload
...
class Prs3d_BndBox(Prs3d_Root):
    ...
    @staticmethod
    def Add(
        thePresentation: Prs3d_Presentation, theBndBox: Bnd_Box, theDrawer: Prs3d_Drawer
    ) -> None: ...
    @overload
    @staticmethod
    def Add(
        thePresentation: Prs3d_Presentation, theBndBox: Bnd_OBB, theDrawer: Prs3d_Drawer
    ) -> None: ...
    @overload
    @staticmethod
    ...
    @staticmethod
    def FillSegments(
        theSegments: Graphic3d_ArrayOfSegments, theBox: Bnd_OBB
    ) -> None: ...
    @overload
    @staticmethod
    def FillSegments(
        theSegments: Graphic3d_ArrayOfSegments, theBox: Bnd_Box
    ) -> None: ...
    @staticmethod
    def fillSegments(
        theSegments: Graphic3d_ArrayOfSegments, theBox: gp_Pnt
    ) -> None: ...
...
class Prs3d_DimensionAspect(Prs3d_BasicAspect):
    ...
    def SetArrowOrientation(
        self, theArrowOrient: Prs3d_DimensionArrowOrientation
    ) -> None: ...
    ...
    def SetTextHorizontalPosition(
        self, thePosition: Prs3d_DimensionTextHorizontalPosition
    ) -> None: ...
    def SetTextVerticalPosition(
        self, thePosition: Prs3d_DimensionTextVerticalPosition
    ) -> None: ...
...
class Prs3d_ShadingAspect(Prs3d_BasicAspect):
    ...
    def Color(
        self, aModel: Optional[Aspect_TypeOfFacingModel] = Aspect_TOFM_FRONT_SIDE
    ) -> Quantity_Color: ...
    def DumpJson(self, depth: Optional[int] = -1) -> str: ...
    def Material(
        self, aModel: Optional[Aspect_TypeOfFacingModel] = Aspect_TOFM_FRONT_SIDE
...
class Prs3d_ToolSector(Prs3d_ToolQuadric):
    def __init__(
        self, theRadius: float, theNbSlices: int, theNbStacks: int
    ) -> None: ...
    @staticmethod
    def Create(
        theRadius: float, theNbSlices: int, theNbStacks: int, theTrsf: gp_Trsf
    ) -> Graphic3d_ArrayOfTriangles: ...
...
class Prs3d_ToolTorus(Prs3d_ToolQuadric):
    @overload
    def __init__(
        self, theMajorRad: float, theMinorRad: float, theNbSlices: int, theNbStacks: int
    ) -> None: ...
    @overload
    def __init__(
        self,
