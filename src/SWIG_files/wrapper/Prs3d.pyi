...
class prs3d:
    ...
    @staticmethod
    def AddPrimitivesGroup(thePrs: Prs3d_Presentation, theAspect: Prs3d_LineAspect, thePolylines: Any) -> None: ...
    @overload
    @staticmethod
    def GetDeflection(theBndMin: Any, theBndMax: Any, theDeviationCoefficient: float) -> float: ...
    @overload
    @staticmethod
    ...
    @staticmethod
    def PrimitivesFromPolylines(thePoints: Any) -> Graphic3d_ArrayOfPrimitives: ...
