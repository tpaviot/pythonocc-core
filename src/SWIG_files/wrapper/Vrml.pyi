...
class Vrml_IndexedFaceSet(Standard_Transient):
    @overload
    def __init__(self) -> None: ...
    def CoordIndex(self) -> False: ...
    def MaterialIndex(self) -> False: ...
    def NormalIndex(self) -> False: ...
    def Print(self) -> Tuple[Standard_OStream, str]: ...
    def TextureCoordIndex(self) -> False: ...
...
class Vrml_LOD(Standard_Transient):
    ...
    def Print(self) -> Tuple[Standard_OStream, str]: ...
    def Range(self) -> False: ...
    def SetCenter(self, aCenter: gp_Vec) -> None: ...

class Vrml_Material(Standard_Transient):
    @overload
    def __init__(self) -> None: ...
    def AmbientColor(self) -> False: ...
    def DiffuseColor(self) -> False: ...
    def EmissiveColor(self) -> False: ...
    def Print(self) -> Tuple[Standard_OStream, str]: ...
    def Shininess(self) -> False: ...
    def SpecularColor(self) -> False: ...
