...
class geomadaptor:
    ...
    @staticmethod
    def MakeSurface(
        theS: Adaptor3d_Surface, theTrimFlag: Optional[bool] = True
    ) -> Geom_Surface: ...
...
class GeomAdaptor_Curve(Adaptor3d_Curve):
    ...
    @overload
    def __init__(
        self, theCurve: Geom_Curve, theUFirst: float, theULast: float
    ) -> None: ...
...
class GeomAdaptor_Surface(Adaptor3d_Surface):
    ...
    def __init__(
        ...
        theVFirst: float,
        theVLast: float,
        theTolU: Optional[float] = 0.0,
        theTolV: Optional[float] = 0.0,
    ) -> None: ...
