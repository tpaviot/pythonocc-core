...
class GeomAdaptor_Curve(Adaptor3d_Curve):
    ...
    def EvalD1(self, theU: float) -> Any: ...
    def EvalD2(self, theU: float) -> Any: ...
    def EvalD3(self, theU: float) -> Any: ...
...
class GeomAdaptor_Surface(Adaptor3d_Surface):
    ...
    def EvalD1(self, theU: float, theV: float) -> Any: ...
    def EvalD2(self, theU: float, theV: float) -> Any: ...
    def EvalD3(self, theU: float, theV: float) -> Any: ...
