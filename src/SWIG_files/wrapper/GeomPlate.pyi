...
class GeomPlate_SequenceOfAij:
    def Assign(self, theItem: GeomPlate_Aij) -> GeomPlate_Aij: ...
    def Clear(self) -> None: ...
...
class GeomPlate_BuildAveragePlane:
    ...
    @overload
    def __init__(
        self, Normals: TColgp_SequenceOfVec, Pts: TColgp_HArray1OfPnt
    ) -> None: ...
    @staticmethod
    def HalfSpace(
...
class GeomPlate_BuildPlateSurface:
    ...
    def Disc3dContour(
        self, nbp: int, iordre: int, Seq3d: TColgp_SequenceOfXYZ
    ) -> None: ...
    @overload
...
class GeomPlate_CurveConstraint(Standard_Transient):
    ...
    def SetProjectedCurve(
        self, Curve2d: Adaptor2d_Curve2d, TolU: float, TolV: float
    ) -> None: ...
...
class GeomPlate_MakeApprox:
    ...
    def __init__(
        ...
        EnlargeCoeff: Optional[float] = 1.1,
    ) -> None: ...
    @overload
    def __init__(
        self,
...
class GeomPlate_PlateG0Criterion(AdvApp2Var_Criterion):
    def __init__(
        ...
        Maximum: float,
        Type: Optional[AdvApp2Var_CriterionType] = AdvApp2Var_Absolute,
        Repart: Optional[AdvApp2Var_CriterionRepartition] = AdvApp2Var_Regular,
    ) -> None: ...
...
class GeomPlate_PointConstraint(Standard_Transient):
    @overload
    def __init__(
        self, Pt: gp_Pnt, Order: int, TolDist: Optional[float] = 0.0001
    ) -> None: ...
    @overload
    def __init__(
        self,
    ...
    def D2(
        self, P: gp_Pnt, V1: gp_Vec, V2: gp_Vec, V3: gp_Vec, V4: gp_Vec, V5: gp_Vec
    ) -> None: ...
...
class GeomPlate_HArray1OfSequenceOfReal(
    GeomPlate_Array1OfSequenceOfReal, Standard_Transient
):
    def __init__(self, theLower: int, theUpper: int) -> None: ...
...
class GeomPlate_HSequenceOfCurveConstraint(
    GeomPlate_SequenceOfCurveConstraint, Standard_Transient
):
    @overload
    def __init__(self) -> None: ...
    @overload
...
class GeomPlate_HSequenceOfPointConstraint(
    GeomPlate_SequenceOfPointConstraint, Standard_Transient
):
    @overload
    def __init__(self) -> None: ...
    @overload
