...
class GeomPlate_Array1OfSequenceOfReal:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[TColStd_SequenceOfReal]: ...
...
class GeomPlate_BuildAveragePlane:
    ...
    @staticmethod
    def HalfSpace(NewNormals: TColgp_SequenceOfVec, Normals: TColgp_SequenceOfVec, Bset: Any, LinTol: float, AngTol: float) -> bool: ...
...
class GeomPlate_BuildPlateSurface:
    @overload
    def __init__(self, NPoints: TColStd_HArray1OfInteger, TabCurve: Any, Tang: TColStd_HArray1OfInteger, Degree: int, NbIter: Optional[int] = 3, Tol2d: Optional[float] = 0.00001, Tol3d: Optional[float] = 0.0001, TolAng: Optional[float] = 0.01, TolCurv: Optional[float] = 0.1, Anisotropie: Optional[bool] = False) -> None: ...
    @overload
