...
class Adaptor2d_Line2d(Adaptor2d_Curve2d):
    ...
    @overload
    def __init__(
        self, P: gp_Pnt2d, D: gp_Dir2d, UFirst: float, ULast: float
    ) -> None: ...
    def BSpline(self) -> Geom2d_BSplineCurve: ...
    def Bezier(self) -> Geom2d_BezierCurve: ...
    def Circle(self) -> gp_Circ2d: ...
    ...
    def D3(
        self, X: float, P: gp_Pnt2d, V1: gp_Vec2d, V2: gp_Vec2d, V3: gp_Vec2d
    ) -> None: ...
    def DN(self, U: float, N: int) -> gp_Vec2d: ...
    def Degree(self) -> int: ...
    def Ellipse(self) -> gp_Elips2d: ...
...
class Adaptor2d_OffsetCurve(Adaptor2d_Curve2d):
    ...
    @overload
    def __init__(
        self, C: Adaptor2d_Curve2d, Offset: float, WFirst: float, WLast: float
    ) -> None: ...
    def BSpline(self) -> Geom2d_BSplineCurve: ...
    def Bezier(self) -> Geom2d_BezierCurve: ...
    def Circle(self) -> gp_Circ2d: ...
