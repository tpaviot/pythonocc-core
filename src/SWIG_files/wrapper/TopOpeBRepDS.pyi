...
class topopebrepds:
    ...
    @overload
    @staticmethod
    def Print(K: TopOpeBRepDS_Kind, I: int, B: Optional[str] = "", A: Optional[str] = "") -> Tuple[Standard_OStream, str]: ...
    @overload
    @staticmethod
...
class TopOpeBRepDS_Association(Standard_Transient):
    ...
    @overload
    def Associate(self, I: TopOpeBRepDS_Interference, LI: Any) -> None: ...
    def Associated(self, I: TopOpeBRepDS_Interference) -> Any: ...
...
class TopOpeBRepDS_Check(Standard_Transient):
    ...
    def ChkIntgInterf(self, LI: Any) -> bool: ...
...
class TopOpeBRepDS_Curve:
    ...
    def GetSCI(self, theI1: TopOpeBRepDS_Interference, theI2: TopOpeBRepDS_Interference) -> None: ...
...
class TopOpeBRepDS_DataStructure:
    ...
    def ChangeCurveInterferences(self, I: int) -> Any: ...
    @overload
    ...
    def ChangeMapOfShapeWithState(self, aShape: TopoDS_Shape) -> Tuple[Any, bool]: ...
    def ChangeMapOfShapeWithStateObj(self) -> Any: ...
    def ChangeMapOfShapeWithStateTool(self) -> Any: ...
    def ChangeNbCurves(self, N: int) -> None: ...
    def ChangePoint(self, I: int) -> TopOpeBRepDS_Point: ...
    def ChangePointInterferences(self, I: int) -> Any: ...
    @overload
    def ChangeShapeInterferences(self, S: TopoDS_Shape) -> Any: ...
    @overload
    def ChangeShapeInterferences(self, I: int) -> Any: ...
    @overload
    ...
    def ChangeShapes(self) -> Any: ...
    def ChangeSurface(self, I: int) -> TopOpeBRepDS_Surface: ...
    def ChangeSurfaceInterferences(self, I: int) -> Any: ...
    def Curve(self, I: int) -> TopOpeBRepDS_Curve: ...
    def CurveInterferences(self, I: int) -> Any: ...
    @overload
    ...
    def PointInterferences(self, I: int) -> Any: ...
    ...
    @overload
    def ShapeInterferences(self, S: TopoDS_Shape, FindKeep: Optional[bool] = True) -> Any: ...
    @overload
    def ShapeInterferences(self, I: int, FindKeep: Optional[bool] = True) -> Any: ...
    @overload
    ...
    def SurfaceInterferences(self, I: int) -> Any: ...
...
class TopOpeBRepDS_FIR:
    def __init__(self, HDS: TopOpeBRepDS_HDataStructure) -> None: ...
    @overload
    def ProcessFaceInterferences(self, M: Any) -> None: ...
    @overload
    def ProcessFaceInterferences(self, I: int, M: Any) -> None: ...
...
class TopOpeBRepDS_Filter:
    def __init__(self, HDS: TopOpeBRepDS_HDataStructure, pClassif: Optional[TopOpeBRepTool_PShapeClassifier] = None) -> None: ...
    @overload
    ...
    def ProcessEdgeInterferences(self, I: int) -> None: ...
    @overload
    def ProcessFaceInterferences(self, MEsp: Any) -> None: ...
    @overload
    def ProcessFaceInterferences(self, I: int, MEsp: Any) -> None: ...
    def ProcessInterferences(self) -> None: ...

class TopOpeBRepDS_GapFiller:
    def __init__(self, HDS: TopOpeBRepDS_HDataStructure) -> None: ...
    def AddPointsOnConnexShape(self, F: TopoDS_Shape, LI: Any) -> None: ...
    def AddPointsOnShape(self, S: TopoDS_Shape, LI: Any) -> None: ...
    def BuildNewGeometries(self) -> None: ...
    def CheckConnexity(self, LI: Any) -> bool: ...
    def FilterByEdge(self, E: TopoDS_Edge, LI: Any) -> None: ...
    def FilterByFace(self, F: TopoDS_Face, LI: Any) -> None: ...
    def FilterByIncidentDistance(self, F: TopoDS_Face, I: TopOpeBRepDS_Interference, LI: Any) -> None: ...
    def FindAssociatedPoints(self, I: TopOpeBRepDS_Interference, LI: Any) -> None: ...
...
class TopOpeBRepDS_GapTool(Standard_Transient):
    ...
    @overload
    def __init__(self, HDS: TopOpeBRepDS_HDataStructure) -> None: ...
    def ChangeSameInterferences(self, I: TopOpeBRepDS_Interference) -> Any: ...
    ...
    def Interferences(self, IndexPoint: int) -> Any: ...
    def ParameterOnEdge(self, I: TopOpeBRepDS_Interference, E: TopoDS_Shape) -> Tuple[bool, float]: ...
    def SameInterferences(self, I: TopOpeBRepDS_Interference) -> Any: ...
...
class TopOpeBRepDS_GeometryData:
    ...
    def ChangeInterferences(self) -> Any: ...
...
class TopOpeBRepDS_TKI:
    ...
    def ChangeInterferences(self, K: TopOpeBRepDS_Kind, G: int) -> Any: ...
    def ChangeValue(self) -> Tuple[Any, TopOpeBRepDS_Kind, int]: ...
    def Clear(self) -> None: ...
    def DumpTKIIterator(self, s1: Optional[str] = "", s2: Optional[str] = "") -> None: ...
    def FillOnGeometry(self, L: Any) -> None: ...
    def FillOnSupport(self, L: Any) -> None: ...
    def HasInterferences(self, K: TopOpeBRepDS_Kind, G: int) -> bool: ...
    def Init(self) -> None: ...
    def Interferences(self, K: TopOpeBRepDS_Kind, G: int) -> Any: ...
    def IsBound(self, K: TopOpeBRepDS_Kind, G: int) -> bool: ...
    def More(self) -> bool: ...
    def Next(self) -> None: ...
    def Value(self) -> Tuple[Any, TopOpeBRepDS_Kind, int]: ...

class TopOpeBRepDS_TOOL:
    @staticmethod
    def EShareG(HDS: TopOpeBRepDS_HDataStructure, E: TopoDS_Edge, lEsd: TopTools_ListOfShape) -> int: ...
    @staticmethod
    def GetConfig(HDS: TopOpeBRepDS_HDataStructure, MEspON: Any, ie: int, iesd: int) -> Tuple[bool, int]: ...
    @staticmethod
    ...
    @staticmethod
    def ShareSplitON(HDS: TopOpeBRepDS_HDataStructure, MspON: Any, i1: int, i2: int, spON: TopoDS_Shape) -> bool: ...
