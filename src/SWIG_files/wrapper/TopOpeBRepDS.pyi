...
class TopOpeBRepDS_Array1OfDataMapOfIntegerListOfInterference:
    ...
    def __setitem__(
        self, index: int, value: TopOpeBRepDS_DataMapOfIntegerListOfInterference
    ) -> None: ...
    ...
    __next__ = next
    def Init(
        self, theValue: TopOpeBRepDS_DataMapOfIntegerListOfInterference
    ) -> None: ...
    def Size(self) -> int: ...
    def Length(self) -> int: ...
    ...
    def SetValue(
        self, theIndex: int, theValue: TopOpeBRepDS_DataMapOfIntegerListOfInterference
    ) -> None: ...
