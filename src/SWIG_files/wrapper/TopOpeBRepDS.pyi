...
# the following typedef cannot be wrapped as is
TopOpeBRepDS_HArray1OfDataMapOfIntegerListOfInterference = NewType("TopOpeBRepDS_HArray1OfDataMapOfIntegerListOfInterference", Any)
# the following typedef cannot be wrapped as is
...
class TopOpeBRepDS_Association(Standard_Transient):
    ...
    def Associated(self, I: TopOpeBRepDS_Interference) -> False: ...
...
class TopOpeBRepDS_DataStructure:
    ...
    def ChangeCurveInterferences(self, I: int) -> False: ...
    @overload
    ...
    def ChangeMapOfRejectedShapesObj(self) -> False: ...
    def ChangeMapOfRejectedShapesTool(self) -> False: ...
    def ChangeMapOfShapeWithState(self, aShape: TopoDS_Shape) -> Tuple[False, bool]: ...
    def ChangeMapOfShapeWithStateObj(self) -> False: ...
    def ChangeMapOfShapeWithStateTool(self) -> False: ...
    def ChangeNbCurves(self, N: int) -> None: ...
    def ChangePoint(self, I: int) -> TopOpeBRepDS_Point: ...
    def ChangePointInterferences(self, I: int) -> False: ...
    @overload
    def ChangeShapeInterferences(self, S: TopoDS_Shape) -> False: ...
    @overload
    def ChangeShapeInterferences(self, I: int) -> False: ...
    @overload
    def ChangeShapeSameDomain(self, S: TopoDS_Shape) -> False: ...
    @overload
    def ChangeShapeSameDomain(self, I: int) -> False: ...
    def ChangeShapes(self) -> False: ...
    def ChangeSurface(self, I: int) -> TopOpeBRepDS_Surface: ...
    def ChangeSurfaceInterferences(self, I: int) -> False: ...
    def Curve(self, I: int) -> TopOpeBRepDS_Curve: ...
    def CurveInterferences(self, I: int) -> False: ...
    @overload
    ...
    def PointInterferences(self, I: int) -> False: ...
    ...
    @overload
    def ShapeInterferences(self, S: TopoDS_Shape, FindKeep: Optional[bool] = true) -> False: ...
    @overload
    def ShapeInterferences(self, I: int, FindKeep: Optional[bool] = true) -> False: ...
    @overload
    def ShapeSameDomain(self, S: TopoDS_Shape) -> False: ...
    @overload
    def ShapeSameDomain(self, I: int) -> False: ...
    def Surface(self, I: int) -> TopOpeBRepDS_Surface: ...
    def SurfaceInterferences(self, I: int) -> False: ...
...
class TopOpeBRepDS_Filter:
    def __init__(self, HDS: TopOpeBRepDS_HDataStructure, pClassif: Optional[TopOpeBRepTool_PShapeClassifier] = nullptr) -> None: ...
    @overload
...
class TopOpeBRepDS_GapTool(Standard_Transient):
    ...
    @overload
    def __init__(self, HDS: TopOpeBRepDS_HDataStructure) -> None: ...
    def ChangeSameInterferences(self, I: TopOpeBRepDS_Interference) -> False: ...
    ...
    def Interferences(self, IndexPoint: int) -> False: ...
    def SameInterferences(self, I: TopOpeBRepDS_Interference) -> False: ...
...
class TopOpeBRepDS_GeometryData:
    ...
    def ChangeInterferences(self) -> False: ...
...
class TopOpeBRepDS_InterferenceTool:
    ...
    @overload
    @staticmethod
    def Parameter(CPI: TopOpeBRepDS_Interference) -> False: ...
    @overload
    @staticmethod
...
class TopOpeBRepDS_ListOfShapeOn1State:
    def __init__(self) -> None: ...
    def ChangeListOnState(self) -> False: ...
    def Clear(self) -> None: ...
    def IsSplit(self) -> bool: ...
    def ListOnState(self) -> False: ...
...
class TopOpeBRepDS_ShapeWithState:
    ...
    def Part(self, aState: TopAbs_State) -> False: ...
