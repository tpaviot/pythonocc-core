...
class StepFEA_FeaModel(StepRepr_Representation):
    ...
    def Description(self) -> TCollection_HAsciiString: ...
    def IntendedAnalysisCode(self) -> False: ...
...
class StepFEA_SymmetricTensor22d(StepData_SelectType):
    def __init__(self) -> None: ...
    def AnisotropicSymmetricTensor22d(self) -> False: ...
    def CaseNum(self, ent: Standard_Transient) -> int: ...

class StepFEA_SymmetricTensor23d(StepData_SelectType):
    def __init__(self) -> None: ...
    def AnisotropicSymmetricTensor23d(self) -> False: ...
    def CaseMem(self, ent: StepData_SelectMember) -> int: ...
    def CaseNum(self, ent: Standard_Transient) -> int: ...
    def IsotropicSymmetricTensor23d(self) -> float: ...
    def NewMember(self) -> StepData_SelectMember: ...
    def OrthotropicSymmetricTensor23d(self) -> False: ...
...
class StepFEA_SymmetricTensor42d(StepData_SelectType):
    def __init__(self) -> None: ...
    def AnisotropicSymmetricTensor42d(self) -> False: ...
    def CaseNum(self, ent: Standard_Transient) -> int: ...

class StepFEA_SymmetricTensor43d(StepData_SelectType):
    def __init__(self) -> None: ...
    def AnisotropicSymmetricTensor43d(self) -> False: ...
    def CaseMem(self, ent: StepData_SelectMember) -> int: ...
    def CaseNum(self, ent: Standard_Transient) -> int: ...
    def FeaColumnNormalisedMonoclinicSymmetricTensor43d(self) -> False: ...
    def FeaColumnNormalisedOrthotropicSymmetricTensor43d(self) -> False: ...
    def FeaIsoOrthotropicSymmetricTensor43d(self) -> False: ...
    def FeaIsotropicSymmetricTensor43d(self) -> False: ...
    def FeaTransverseIsotropicSymmetricTensor43d(self) -> False: ...
    def NewMember(self) -> StepData_SelectMember: ...
