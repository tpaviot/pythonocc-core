...
class StepFEA_Array1OfDegreeOfFreedom:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepFEA_DegreeOfFreedom]: ...
...
class StepFEA_Curve3dElementProperty(Standard_Transient):
    ...
    def EndOffsets(self) -> Any: ...
    def EndReleases(self) -> Any: ...
    def Init(self, aPropertyId: TCollection_HAsciiString, aDescription: TCollection_HAsciiString, aIntervalDefinitions: Any, aEndOffsets: Any, aEndReleases: Any) -> None: ...
    def IntervalDefinitions(self) -> Any: ...
    def PropertyId(self) -> TCollection_HAsciiString: ...
    def SetDescription(self, Description: TCollection_HAsciiString) -> None: ...
    def SetEndOffsets(self, EndOffsets: Any) -> None: ...
    def SetEndReleases(self, EndReleases: Any) -> None: ...
    def SetIntervalDefinitions(self, IntervalDefinitions: Any) -> None: ...
...
class StepFEA_CurveElementEndRelease(Standard_Transient):
    def __init__(self) -> None: ...
    def CoordinateSystem(self) -> StepFEA_CurveElementEndCoordinateSystem: ...
    def Init(self, aCoordinateSystem: StepFEA_CurveElementEndCoordinateSystem, aReleases: Any) -> None: ...
    def Releases(self) -> Any: ...
    def SetCoordinateSystem(self, CoordinateSystem: StepFEA_CurveElementEndCoordinateSystem) -> None: ...
    def SetReleases(self, Releases: Any) -> None: ...
...
class StepFEA_ElementRepresentation(StepRepr_Representation):
    def __init__(self) -> None: ...
    def Init(self, aRepresentation_Name: TCollection_HAsciiString, aRepresentation_Items: Any, aRepresentation_ContextOfItems: StepRepr_RepresentationContext, aNodeList: Any) -> None: ...
    def NodeList(self) -> Any: ...
    def SetNodeList(self, NodeList: Any) -> None: ...
...
class StepFEA_FreedomsList(Standard_Transient):
    def __init__(self) -> None: ...
    def Freedoms(self) -> Any: ...
    def Init(self, aFreedoms: Any) -> None: ...
    def SetFreedoms(self, Freedoms: Any) -> None: ...
...
class StepFEA_NodeRepresentation(StepRepr_Representation):
    def __init__(self) -> None: ...
    def Init(self, aRepresentation_Name: TCollection_HAsciiString, aRepresentation_Items: Any, aRepresentation_ContextOfItems: StepRepr_RepresentationContext, aModelRef: StepFEA_FeaModel) -> None: ...
    def ModelRef(self) -> StepFEA_FeaModel: ...
    def SetModelRef(self, ModelRef: StepFEA_FeaModel) -> None: ...

class StepFEA_NodeSet(StepGeom_GeometricRepresentationItem):
    def __init__(self) -> None: ...
    def Init(self, aRepresentationItem_Name: TCollection_HAsciiString, aNodes: Any) -> None: ...
    def Nodes(self) -> Any: ...
    def SetNodes(self, Nodes: Any) -> None: ...
...
class StepFEA_Curve3dElementRepresentation(StepFEA_ElementRepresentation):
    ...
    def Init(self, aRepresentation_Name: TCollection_HAsciiString, aRepresentation_Items: Any, aRepresentation_ContextOfItems: StepRepr_RepresentationContext, aElementRepresentation_NodeList: Any, aModelRef: StepFEA_FeaModel3d, aElementDescriptor: StepElement_Curve3dElementDescriptor, aProperty: StepFEA_Curve3dElementProperty, aMaterial: StepElement_ElementMaterial) -> None: ...
...
class StepFEA_CurveElementIntervalLinearlyVarying(StepFEA_CurveElementInterval):
    def __init__(self) -> None: ...
    def Init(self, aCurveElementInterval_FinishPosition: StepFEA_CurveElementLocation, aCurveElementInterval_EuAngles: StepBasic_EulerAngles, aSections: Any) -> None: ...
    def Sections(self) -> Any: ...
    def SetSections(self, Sections: Any) -> None: ...
...
class StepFEA_ElementGroup(StepFEA_FeaGroup):
    ...
    def Init(self, aGroup_Name: TCollection_HAsciiString, aGroup_Description: TCollection_HAsciiString, aFeaGroup_ModelRef: StepFEA_FeaModel, aElements: Any) -> None: ...
    def SetElements(self, Elements: Any) -> None: ...
...
class StepFEA_NodeGroup(StepFEA_FeaGroup):
    def __init__(self) -> None: ...
    def Init(self, aGroup_Name: TCollection_HAsciiString, aGroup_Description: TCollection_HAsciiString, aFeaGroup_ModelRef: StepFEA_FeaModel, aNodes: Any) -> None: ...
    def Nodes(self) -> Any: ...
    def SetNodes(self, Nodes: Any) -> None: ...
