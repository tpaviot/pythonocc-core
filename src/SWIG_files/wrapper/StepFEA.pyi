...
StepFEA_HArray1OfCurveElementEndOffset = NewType("StepFEA_HArray1OfCurveElementEndOffset", Any)
# the following typedef cannot be wrapped as is
StepFEA_HArray1OfCurveElementEndRelease = NewType("StepFEA_HArray1OfCurveElementEndRelease", Any)
# the following typedef cannot be wrapped as is
StepFEA_HArray1OfCurveElementInterval = NewType("StepFEA_HArray1OfCurveElementInterval", Any)
# the following typedef cannot be wrapped as is
StepFEA_HArray1OfDegreeOfFreedom = NewType("StepFEA_HArray1OfDegreeOfFreedom", Any)
# the following typedef cannot be wrapped as is
StepFEA_HArray1OfElementRepresentation = NewType("StepFEA_HArray1OfElementRepresentation", Any)
# the following typedef cannot be wrapped as is
StepFEA_HArray1OfNodeRepresentation = NewType("StepFEA_HArray1OfNodeRepresentation", Any)
# the following typedef cannot be wrapped as is
StepFEA_HSequenceOfCurve3dElementProperty = NewType("StepFEA_HSequenceOfCurve3dElementProperty", Any)
# the following typedef cannot be wrapped as is
StepFEA_HSequenceOfElementGeometricRelationship = NewType("StepFEA_HSequenceOfElementGeometricRelationship", Any)
# the following typedef cannot be wrapped as is
StepFEA_HSequenceOfElementRepresentation = NewType("StepFEA_HSequenceOfElementRepresentation", Any)
# the following typedef cannot be wrapped as is
StepFEA_HSequenceOfNodeRepresentation = NewType("StepFEA_HSequenceOfNodeRepresentation", Any)
...
class StepFEA_Curve3dElementProperty(Standard_Transient):
    ...
    def EndOffsets(self) -> False: ...
    def EndReleases(self) -> False: ...
    def IntervalDefinitions(self) -> False: ...
