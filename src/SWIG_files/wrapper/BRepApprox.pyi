...
class BRepApprox_SurfaceTool:
    ...
    @staticmethod
    def FirstUParameter(S: BRepAdaptor_Surface) -> False: ...
    @staticmethod
    def FirstVParameter(S: BRepAdaptor_Surface) -> False: ...
    @staticmethod
    ...
    @staticmethod
    def LastUParameter(S: BRepAdaptor_Surface) -> False: ...
    @staticmethod
    def LastVParameter(S: BRepAdaptor_Surface) -> False: ...
    @overload
    @staticmethod
    ...
    @staticmethod
    def UPeriod(S: BRepAdaptor_Surface) -> False: ...
    @staticmethod
    def UResolution(S: BRepAdaptor_Surface, R3d: float) -> False: ...
    @staticmethod
    def UTrim(S: BRepAdaptor_Surface, First: float, Last: float, Tol: float) -> Adaptor3d_Surface: ...
    @staticmethod
    def VPeriod(S: BRepAdaptor_Surface) -> False: ...
    @staticmethod
    def VResolution(S: BRepAdaptor_Surface, R3d: float) -> False: ...
    @staticmethod
...
class BRepApprox_TheComputeLineBezierOfApprox:
    ...
    def NbMultiCurves(self) -> int: ...
    def Parameters(self, Index: Optional[int] = 1) -> False: ...
