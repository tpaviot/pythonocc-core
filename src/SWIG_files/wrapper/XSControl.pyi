...
class XSControl_Utils:
    ...
    def AppendEStr(self, seqval: TColStd_HSequenceOfHExtendedString, strval: Any) -> None: ...
    ...
    def AsciiToExtended(self, str: str) -> Any: ...
    ...
    def EStrValue(self, list: Standard_Transient, num: int) -> Any: ...
    def ExtendedToAscii(self, str: Any) -> str: ...
    def IsAscii(self, str: Any) -> bool: ...
    ...
    @overload
    def ToEString(self, strval: TCollection_HExtendedString) -> Any: ...
    @overload
    def ToEString(self, strval: str) -> Any: ...
    @overload
    def ToHString(self, strcon: str) -> TCollection_HAsciiString: ...
    @overload
    def ToHString(self, strcon: Any) -> TCollection_HExtendedString: ...
    def ToXString(self, strcon: Any) -> str: ...
