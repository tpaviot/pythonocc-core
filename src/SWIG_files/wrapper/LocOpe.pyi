...
class LocOpe_SequenceOfCirc:
    def Assign(self, theItem: gp_Circ) -> gp_Circ: ...
    def Clear(self) -> None: ...
...
class LocOpe_SequenceOfLin:
    def Assign(self, theItem: gp_Lin) -> gp_Lin: ...
    def Clear(self) -> None: ...
...
class LocOpe_SequenceOfPntFace:
    def Assign(self, theItem: LocOpe_PntFace) -> LocOpe_PntFace: ...
    def Clear(self) -> None: ...
...
class LocOpe_BuildWires:
    ...
    @overload
    def __init__(
        self, Ledges: TopTools_ListOfShape, PW: LocOpe_WiresOnShape
    ) -> None: ...
...
class LocOpe_CSIntersector:
    ...
    @overload
    def LocalizeAfter(
        self, I: int, From: float, Tol: float
    ) -> Tuple[bool, TopAbs_Orientation, int, int]: ...
    @overload
    def LocalizeAfter(
        self, I: int, FromInd: int, Tol: float
    ) -> Tuple[bool, TopAbs_Orientation, int, int]: ...
    @overload
    def LocalizeBefore(
        self, I: int, From: float, Tol: float
...
class LocOpe_DPrism:
    @overload
    def __init__(
        self, Spine: TopoDS_Face, Height1: float, Height2: float, Angle: float
    ) -> None: ...
    @overload
...
class LocOpe_LinearForm:
    ...
    @overload
    def __init__(
        self, Base: TopoDS_Shape, V: gp_Vec, Pnt1: gp_Pnt, Pnt2: gp_Pnt
    ) -> None: ...
    @overload
    def __init__(
        self, Base: TopoDS_Shape, V: gp_Vec, Vectra: gp_Vec, Pnt1: gp_Pnt, Pnt2: gp_Pnt
    ) -> None: ...
    def FirstShape(self) -> TopoDS_Shape: ...
    def LastShape(self) -> TopoDS_Shape: ...
    @overload
...
class LocOpe_SplitDrafts:
    ...
    def Perform(
        ...
        NPld: gp_Pln,
        Angled: float,
        ModifyLeft: Optional[bool] = True,
        ModifyRight: Optional[bool] = True,
    ) -> None: ...
    @overload
    def Perform(
        self, F: TopoDS_Face, W: TopoDS_Wire, Extract: gp_Dir, NPl: gp_Pln, Angle: float
    ) -> None: ...
    def Shape(self) -> TopoDS_Shape: ...
...
class LocOpe_WiresOnShape(Standard_Transient):
    ...
    @overload
    def OnEdge(
        self, V: TopoDS_Vertex, EdgeFrom: TopoDS_Edge, E: TopoDS_Edge
    ) -> Tuple[bool, float]: ...
