...
class LocOpe_DPrism:
    ...
    def Shape(self) -> TopoDS_Shape: ...
    def Shapes(self, S: TopoDS_Shape) -> False: ...
...
class LocOpe_GeneratedShape(Standard_Transient):
    ...
    def GeneratingEdges(self) -> False: ...
    def OrientedFaces(self) -> False: ...
...
class LocOpe_Generator:
    ...
    @overload
    def __init__(self, S: TopoDS_Shape) -> None: ...
    def DescendantFace(self, F: TopoDS_Face) -> False: ...
    def Init(self, S: TopoDS_Shape) -> None: ...
    def IsDone(self) -> bool: ...
...
class LocOpe_Gluer:
    ...
    def DescendantFaces(self, F: TopoDS_Face) -> False: ...
...
class LocOpe_SplitDrafts:
    ...
    def Shape(self) -> TopoDS_Shape: ...
    def ShapesFromShape(self, S: TopoDS_Shape) -> False: ...
...
class LocOpe_SplitShape:
    ...
    def DescendantShapes(self, S: TopoDS_Shape) -> False: ...
    def Init(self, S: TopoDS_Shape) -> None: ...
    def LeftOf(self, W: TopoDS_Wire, F: TopoDS_Face) -> False: ...
    def Shape(self) -> TopoDS_Shape: ...
