...
class LocOpe_CSIntersector:
    ...
    @overload
    def LocalizeAfter(
        self, I: int, From: float, Tol: float, Or: TopAbs_Orientation
    ) -> Tuple[bool, int, int]: ...
    @overload
    def LocalizeAfter(
        self, I: int, FromInd: int, Tol: float, Or: TopAbs_Orientation
    ) -> Tuple[bool, int, int]: ...
    @overload
    def LocalizeBefore(
        self, I: int, From: float, Tol: float, Or: TopAbs_Orientation
...
class LocOpe_CurveShapeIntersector:
    ...
    @overload
    def LocalizeAfter(
        self, From: float, Or: TopAbs_Orientation
    ) -> Tuple[bool, int, int]: ...
    @overload
    def LocalizeAfter(
        self, FromInd: int, Or: TopAbs_Orientation
    ) -> Tuple[bool, int, int]: ...
    @overload
    def LocalizeBefore(
        self, From: float, Or: TopAbs_Orientation
