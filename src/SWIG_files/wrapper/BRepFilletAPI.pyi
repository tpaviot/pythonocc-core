...
class BRepFilletAPI_MakeFillet2d(BRepBuilderAPI_MakeShape):
    ...
    @overload
    def AddChamfer(
        self, E1: TopoDS_Edge, E2: TopoDS_Edge, D1: float, D2: float
    ) -> TopoDS_Edge: ...
    @overload
    def AddChamfer(
        self, E: TopoDS_Edge, V: TopoDS_Vertex, D: float, Ang: float
    ) -> TopoDS_Edge: ...
    ...
    @overload
    def ModifyChamfer(
        self, Chamfer: TopoDS_Edge, E: TopoDS_Edge, D: float, Ang: float
    ) -> TopoDS_Edge: ...
...
class BRepFilletAPI_MakeFillet(BRepFilletAPI_LocalOperation):
    def __init__(
        self, S: TopoDS_Shape, FShape: Optional[ChFi3d_FilletShape] = ChFi3d_Rational
    ) -> None: ...
    def Abscissa(self, IC: int, V: TopoDS_Vertex) -> float: ...
    @overload
    def Add(self, E: TopoDS_Edge) -> None: ...
