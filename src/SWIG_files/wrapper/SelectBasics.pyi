...
class SelectBasics_PickResult:
    ...
    @overload
    def SetSurfaceNormal(self, theNormal: Any) -> None: ...
    @overload
    def SetSurfaceNormal(self, theNormal: gp_Vec) -> None: ...
    def SurfaceNormal(self) -> Any: ...
...
class SelectBasics_SelectingVolumeManager:
    ...
    @overload
    def Overlaps(self, theBoxMin: Any, theBoxMax: Any, thePickResult: SelectBasics_PickResult) -> bool: ...
    @overload
    def Overlaps(self, theBoxMin: Any, theBoxMax: Any, theInside: Optional[bool] = None) -> bool: ...
    @overload
