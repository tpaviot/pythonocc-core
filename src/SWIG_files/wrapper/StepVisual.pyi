...
class StepVisual_Array1OfAnnotationPlaneElement:
    ...
    def __iter__(self) -> typing.Iterator[StepVisual_AnnotationPlaneElement]: ...
...
class StepVisual_Array1OfBoxCharacteristicSelect:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepVisual_BoxCharacteristicSelect]: ...
...
class StepVisual_Array1OfCameraModelD3MultiClippingInterectionSelect:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepVisual_CameraModelD3MultiClippingInterectionSelect]: ...
...
class StepVisual_Array1OfCameraModelD3MultiClippingUnionSelect:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepVisual_CameraModelD3MultiClippingUnionSelect]: ...
...
class StepVisual_Array1OfDirectionCountSelect:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepVisual_DirectionCountSelect]: ...
...
class StepVisual_Array1OfDraughtingCalloutElement:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepVisual_DraughtingCalloutElement]: ...
...
class StepVisual_Array1OfFillStyleSelect:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepVisual_FillStyleSelect]: ...
...
class StepVisual_Array1OfInvisibleItem:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepVisual_InvisibleItem]: ...
...
class StepVisual_Array1OfLayeredItem:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepVisual_LayeredItem]: ...
...
class StepVisual_Array1OfPresentationStyleSelect:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepVisual_PresentationStyleSelect]: ...
...
class StepVisual_Array1OfRenderingPropertiesSelect:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepVisual_RenderingPropertiesSelect]: ...
...
class StepVisual_Array1OfStyleContextSelect:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepVisual_StyleContextSelect]: ...
...
class StepVisual_Array1OfSurfaceStyleElementSelect:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepVisual_SurfaceStyleElementSelect]: ...
...
class StepVisual_Array1OfTessellatedEdgeOrVertex:
    ...
    def __setitem__(self, index: int, value: StepVisual_TessellatedEdgeOrVertex) -> None: ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepVisual_TessellatedEdgeOrVertex]: ...
    ...
    def SetValue(self, theIndex: int, theValue: StepVisual_TessellatedEdgeOrVertex) -> None: ...
...
class StepVisual_Array1OfTextOrCharacter:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepVisual_TextOrCharacter]: ...
...
class StepVisual_CameraModelD3MultiClippingIntersection(StepGeom_GeometricRepresentationItem):
    def __init__(self) -> None: ...
    def Init(self, theName: TCollection_HAsciiString, theShapeClipping: Any) -> None: ...
    def SetShapeClipping(self, theShapeClipping: Any) -> None: ...
    def ShapeClipping(self) -> Any: ...
...
class StepVisual_CompositeText(StepGeom_GeometricRepresentationItem):
    def __init__(self) -> None: ...
    def CollectedText(self) -> Any: ...
    def CollectedTextValue(self, num: int) -> StepVisual_TextOrCharacter: ...
    def Init(self, aName: TCollection_HAsciiString, aCollectedText: Any) -> None: ...
    def NbCollectedText(self) -> int: ...
    def SetCollectedText(self, aCollectedText: Any) -> None: ...
...
class StepVisual_CurveStyleFont(Standard_Transient):
    def __init__(self) -> None: ...
    def Init(self, aName: TCollection_HAsciiString, aPatternList: Any) -> None: ...
    def Name(self) -> TCollection_HAsciiString: ...
    def NbPatternList(self) -> int: ...
    def PatternList(self) -> Any: ...
    def PatternListValue(self, num: int) -> StepVisual_CurveStyleFontPattern: ...
    def SetName(self, aName: TCollection_HAsciiString) -> None: ...
    def SetPatternList(self, aPatternList: Any) -> None: ...
...
class StepVisual_DraughtingCallout(StepGeom_GeometricRepresentationItem):
    ...
    def Init(self, theName: TCollection_HAsciiString, theContents: Any) -> None: ...
    def NbContents(self) -> int: ...
    def SetContents(self, theContents: Any) -> None: ...
...
class StepVisual_FillAreaStyle(Standard_Transient):
    def __init__(self) -> None: ...
    def FillStyles(self) -> Any: ...
    def FillStylesValue(self, num: int) -> StepVisual_FillStyleSelect: ...
    def Init(self, aName: TCollection_HAsciiString, aFillStyles: Any) -> None: ...
    def Name(self) -> TCollection_HAsciiString: ...
    def NbFillStyles(self) -> int: ...
    def SetFillStyles(self, aFillStyles: Any) -> None: ...
    def SetName(self, aName: TCollection_HAsciiString) -> None: ...
...
class StepVisual_Invisibility(Standard_Transient):
    def __init__(self) -> None: ...
    def Init(self, aInvisibleItems: Any) -> None: ...
    def InvisibleItems(self) -> Any: ...
    def InvisibleItemsValue(self, num: int) -> StepVisual_InvisibleItem: ...
    def NbInvisibleItems(self) -> int: ...
    def SetInvisibleItems(self, aInvisibleItems: Any) -> None: ...
...
class StepVisual_PresentationLayerAssignment(Standard_Transient):
    def __init__(self) -> None: ...
    def AssignedItems(self) -> Any: ...
    def AssignedItemsValue(self, num: int) -> StepVisual_LayeredItem: ...
    def Description(self) -> TCollection_HAsciiString: ...
    def Init(self, aName: TCollection_HAsciiString, aDescription: TCollection_HAsciiString, aAssignedItems: Any) -> None: ...
    def Name(self) -> TCollection_HAsciiString: ...
    def NbAssignedItems(self) -> int: ...
    def SetAssignedItems(self, aAssignedItems: Any) -> None: ...
...
class StepVisual_PresentationStyleAssignment(Standard_Transient):
    def __init__(self) -> None: ...
    def Init(self, aStyles: Any) -> None: ...
    def NbStyles(self) -> int: ...
    def SetStyles(self, aStyles: Any) -> None: ...
    def Styles(self) -> Any: ...
...
class StepVisual_StyledItem(StepRepr_RepresentationItem):
    def __init__(self) -> None: ...
    def Init(self, aName: TCollection_HAsciiString, aStyles: Any, aItem: Standard_Transient) -> None: ...
...
class StepVisual_SurfaceSideStyle(Standard_Transient):
    def __init__(self) -> None: ...
    def Init(self, aName: TCollection_HAsciiString, aStyles: Any) -> None: ...
    def Name(self) -> TCollection_HAsciiString: ...
    def NbStyles(self) -> int: ...
    def SetName(self, aName: TCollection_HAsciiString) -> None: ...
    def SetStyles(self, aStyles: Any) -> None: ...
...
class StepVisual_SurfaceStyleParameterLine(Standard_Transient):
    def __init__(self) -> None: ...
    def DirectionCounts(self) -> Any: ...
    def DirectionCountsValue(self, num: int) -> StepVisual_DirectionCountSelect: ...
    def Init(self, aStyleOfParameterLines: StepVisual_CurveStyle, aDirectionCounts: Any) -> None: ...
    def NbDirectionCounts(self) -> int: ...
    def SetDirectionCounts(self, aDirectionCounts: Any) -> None: ...
...
class StepVisual_CompositeTextWithExtent(StepVisual_CompositeText):
    ...
    def Init(self, aName: TCollection_HAsciiString, aCollectedText: Any, aExtent: StepVisual_PlanarExtent) -> None: ...
...
class StepVisual_ContextDependentInvisibility(StepVisual_Invisibility):
    def __init__(self) -> None: ...
    def Init(self, aInvisibleItems: Any, aPresentationContext: StepVisual_InvisibilityContext) -> None: ...
...
class StepVisual_OverRidingStyledItem(StepVisual_StyledItem):
    def __init__(self) -> None: ...
    def Init(self, aName: TCollection_HAsciiString, aStyles: Any, aItem: Standard_Transient, aOverRiddenStyle: StepVisual_StyledItem) -> None: ...
...
class StepVisual_PresentationStyleByContext(StepVisual_PresentationStyleAssignment):
    def __init__(self) -> None: ...
    def Init(self, aStyles: Any, aStyleContext: StepVisual_StyleContextSelect) -> None: ...
...
class StepVisual_RepositionedTessellatedItem(StepVisual_TessellatedItem):
    def __init__(self) -> None: ...
    def Init(self, theName: TCollection_HAsciiString, theLocation: StepGeom_Axis2Placement3d) -> None: ...
...
class StepVisual_SurfaceStyleRenderingWithProperties(StepVisual_SurfaceStyleRendering):
    def __init__(self) -> None: ...
    def Init(self, theSurfaceStyleRendering_RenderingMethod: StepVisual_ShadingSurfaceMethod, theSurfaceStyleRendering_SurfaceColour: StepVisual_Colour, theProperties: Any) -> None: ...
    def Properties(self) -> Any: ...
    def SetProperties(self, theProperties: Any) -> None: ...
...
class StepVisual_TessellatedCurveSet(StepVisual_TessellatedItem):
    ...
    def Curves(self) -> Any: ...
    def Init(self, theName: TCollection_HAsciiString, theCoordList: StepVisual_CoordinatesList, theCurves: Any) -> None: ...

class StepVisual_TessellatedGeometricSet(StepVisual_TessellatedItem):
    def __init__(self) -> None: ...
    def Init(self, theName: TCollection_HAsciiString, theItems: Any) -> None: ...
    def Items(self) -> Any: ...

class StepVisual_TessellatedPointSet(StepVisual_TessellatedItem):
    def __init__(self) -> None: ...
    def Coordinates(self) -> StepVisual_CoordinatesList: ...
    def Init(self, theRepresentationItem_Name: TCollection_HAsciiString, theCoordinates: StepVisual_CoordinatesList, thePointList: TColStd_HArray1OfInteger) -> None: ...
...
class StepVisual_TessellatedShapeRepresentationWithAccuracyParameters(StepVisual_TessellatedShapeRepresentation):
    def __init__(self) -> None: ...
    def Init(self, theRepresentation_Name: TCollection_HAsciiString, theRepresentation_Items: Any, theRepresentation_ContextOfItems: StepRepr_RepresentationContext, theTessellationAccuracyParameters: TColStd_HArray1OfReal) -> None: ...
    def NbTessellationAccuracyParameters(self) -> int: ...
    def SetTessellationAccuracyParameters(self, theTessellationAccuracyParameters: TColStd_HArray1OfReal) -> None: ...
...
class StepVisual_TessellatedShell(StepVisual_TessellatedItem):
    ...
    def Init(self, theRepresentationItem_Name: TCollection_HAsciiString, theItems: Any, theHasTopologicalLink: bool, theTopologicalLink: StepShape_ConnectedFaceSet) -> None: ...
    def Items(self) -> Any: ...
    def ItemsValue(self, theNum: int) -> StepVisual_TessellatedStructuredItem: ...
    def NbItems(self) -> int: ...
    def SetItems(self, theItems: Any) -> None: ...
    def SetTopologicalLink(self, theTopologicalLink: StepShape_ConnectedFaceSet) -> None: ...
...
class StepVisual_TessellatedSolid(StepVisual_TessellatedItem):
    ...
    def Init(self, theRepresentationItem_Name: TCollection_HAsciiString, theItems: Any, theHasGeometricLink: bool, theGeometricLink: StepShape_ManifoldSolidBrep) -> None: ...
    def Items(self) -> Any: ...
    def ItemsValue(self, theNum: int) -> StepVisual_TessellatedStructuredItem: ...
    def NbItems(self) -> int: ...
    def SetGeometricLink(self, theGeometricLink: StepShape_ManifoldSolidBrep) -> None: ...
    def SetItems(self, theItems: Any) -> None: ...
...
class StepVisual_TessellatedSurfaceSet(StepVisual_TessellatedItem):
    def __init__(self) -> None: ...
    def Coordinates(self) -> StepVisual_CoordinatesList: ...
    def Init(self, theRepresentationItem_Name: TCollection_HAsciiString, theCoordinates: StepVisual_CoordinatesList, thePnmax: int, theNormals: TColStd_HArray2OfReal) -> None: ...
...
class StepVisual_TessellatedWire(StepVisual_TessellatedItem):
    ...
    def Init(self, theRepresentationItem_Name: TCollection_HAsciiString, theItems: Any, theHasGeometricModelLink: bool, theGeometricModelLink: StepVisual_PathOrCompositeCurve) -> None: ...
    def Items(self) -> Any: ...
...
class StepVisual_TextStyleWithBoxCharacteristics(StepVisual_TextStyle):
    ...
    def Init(self, aName: TCollection_HAsciiString, aCharacterAppearance: StepVisual_TextStyleForDefinedFont, aCharacteristics: Any) -> None: ...
    def NbCharacteristics(self) -> int: ...
    def SetCharacteristics(self, aCharacteristics: Any) -> None: ...
...
class StepVisual_AnnotationFillAreaOccurrence(StepVisual_AnnotationOccurrence):
    ...
    def Init(self, theName: TCollection_HAsciiString, theStyles: Any, theItem: Standard_Transient, theFillStyleTarget: StepGeom_GeometricRepresentationItem) -> None: ...
...
class StepVisual_AnnotationPlane(StepVisual_AnnotationOccurrence):
    ...
    def Init(self, theName: TCollection_HAsciiString, theStyles: Any, theItem: Standard_Transient, theElements: Any) -> None: ...
    def NbElements(self) -> int: ...
    def SetElements(self, theElements: Any) -> None: ...
...
class StepVisual_CameraModelD3MultiClipping(StepVisual_CameraModelD3):
    def __init__(self) -> None: ...
    def Init(self, theName: TCollection_HAsciiString, theViewReferenceSystem: StepGeom_Axis2Placement3d, thePerspectiveOfVolume: StepVisual_ViewVolume, theShapeClipping: Any) -> None: ...
    def SetShapeClipping(self, theShapeClipping: Any) -> None: ...
    def ShapeClipping(self) -> Any: ...
...
class StepVisual_ComplexTriangulatedSurfaceSet(StepVisual_TessellatedSurfaceSet):
    ...
    def SetTriangleStrips(self, theTriangleStrips: TColStd_HArray1OfTransient) -> None: ...
...
class StepVisual_ContextDependentOverRidingStyledItem(StepVisual_OverRidingStyledItem):
    def __init__(self) -> None: ...
    def Init(self, aName: TCollection_HAsciiString, aStyles: Any, aItem: Standard_Transient, aOverRiddenStyle: StepVisual_StyledItem, aStyleContext: Any) -> None: ...
    def NbStyleContext(self) -> int: ...
    def SetStyleContext(self, aStyleContext: Any) -> None: ...
    def StyleContext(self) -> Any: ...
...
class StepVisual_RepositionedTessellatedGeometricSet(StepVisual_TessellatedGeometricSet):
    def __init__(self) -> None: ...
    def Init(self, theName: TCollection_HAsciiString, theItems: Any, theLocation: StepGeom_Axis2Placement3d) -> None: ...
    def Location(self) -> StepGeom_Axis2Placement3d: ...
    def SetLocation(self, theLocation: StepGeom_Axis2Placement3d) -> None: ...

class StepVisual_SurfaceStyleReflectanceAmbientDiffuseSpecular(StepVisual_SurfaceStyleReflectanceAmbientDiffuse):
    def __init__(self) -> None: ...
    def Init(self, theAmbientReflectance: float, theDiffuseReflectance: float, theSpecularReflectance: float, theSpecularExponent: float, theSpecularColour: StepVisual_Colour) -> None: ...
    def SetSpecularColour(self, theSpecularColour: StepVisual_Colour) -> None: ...
...
class StepVisual_TessellatedEdge(StepVisual_TessellatedStructuredItem):
    ...
    def HasGeometricLink(self) -> bool: ...
    def Init(self, theRepresentationItem_Name: TCollection_HAsciiString, theCoordinates: StepVisual_CoordinatesList, theHasGeometricLink: bool, theGeometricLink: StepVisual_EdgeOrCurve, theLineStrip: TColStd_HArray1OfInteger) -> None: ...
...
class StepVisual_TessellatedFace(StepVisual_TessellatedStructuredItem):
    ...
    def HasGeometricLink(self) -> bool: ...
    def Init(self, theRepresentationItem_Name: TCollection_HAsciiString, theCoordinates: StepVisual_CoordinatesList, thePnmax: int, theNormals: TColStd_HArray2OfReal, theHasGeometricLink: bool, theGeometricLink: StepVisual_FaceOrSurface) -> None: ...
    def NbNormals(self) -> int: ...
    def Normals(self) -> TColStd_HArray2OfReal: ...
    def Pnmax(self) -> int: ...
    def SetCoordinates(self, theCoordinates: StepVisual_CoordinatesList) -> None: ...
...
class StepVisual_TessellatedVertex(StepVisual_TessellatedStructuredItem):
    ...
    def Coordinates(self) -> StepVisual_CoordinatesList: ...
    def HasTopologicalLink(self) -> bool: ...
    def Init(self, theRepresentationItem_Name: TCollection_HAsciiString, theCoordinates: StepVisual_CoordinatesList, theHasTopologicalLink: bool, theTopologicalLink: StepShape_VertexPoint, thePointIndex: int) -> None: ...
...
class StepVisual_TriangulatedSurfaceSet(StepVisual_TessellatedSurfaceSet):
    def __init__(self) -> None: ...
    def Init(self, theRepresentationItemName: TCollection_HAsciiString, theTessellatedFaceCoordinates: StepVisual_CoordinatesList, theTessellatedFacePnmax: int, theTessellatedFaceNormals: TColStd_HArray2OfReal, thePnindex: TColStd_HArray1OfInteger, theTriangles: TColStd_HArray2OfInteger) -> None: ...
    def NbPnindex(self) -> int: ...
...
class StepVisual_ComplexTriangulatedFace(StepVisual_TessellatedFace):
    def __init__(self) -> None: ...
    def Init(self, theRepresentationItem_Name: TCollection_HAsciiString, theTessellatedFace_Coordinates: StepVisual_CoordinatesList, theTessellatedFace_Pnmax: int, theTessellatedFace_Normals: TColStd_HArray2OfReal, theHasTessellatedFace_GeometricLink: bool, theTessellatedFace_GeometricLink: StepVisual_FaceOrSurface, thePnindex: TColStd_HArray1OfInteger, theTriangleStrips: TColStd_HArray1OfTransient, theTriangleFans: TColStd_HArray1OfTransient) -> None: ...
    def NbPnindex(self) -> int: ...
    def NbTriangleFans(self) -> int: ...
    def NbTriangleStrips(self) -> int: ...
    def Pnindex(self) -> TColStd_HArray1OfInteger: ...
...
class StepVisual_TessellatedConnectingEdge(StepVisual_TessellatedEdge):
    ...
    def SetLineStripFace1(self, theLineStripFace1: TColStd_HArray1OfInteger) -> None: ...
    def SetLineStripFace2(self, theLineStripFace2: TColStd_HArray1OfInteger) -> None: ...
