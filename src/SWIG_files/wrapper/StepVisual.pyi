...
StepVisual_HArray1OfAnnotationPlaneElement = NewType("StepVisual_HArray1OfAnnotationPlaneElement", Any)
# the following typedef cannot be wrapped as is
StepVisual_HArray1OfBoxCharacteristicSelect = NewType("StepVisual_HArray1OfBoxCharacteristicSelect", Any)
# the following typedef cannot be wrapped as is
StepVisual_HArray1OfCameraModelD3MultiClippingInterectionSelect = NewType("StepVisual_HArray1OfCameraModelD3MultiClippingInterectionSelect", Any)
# the following typedef cannot be wrapped as is
StepVisual_HArray1OfCameraModelD3MultiClippingUnionSelect = NewType("StepVisual_HArray1OfCameraModelD3MultiClippingUnionSelect", Any)
# the following typedef cannot be wrapped as is
StepVisual_HArray1OfCurveStyleFontPattern = NewType("StepVisual_HArray1OfCurveStyleFontPattern", Any)
# the following typedef cannot be wrapped as is
StepVisual_HArray1OfDirectionCountSelect = NewType("StepVisual_HArray1OfDirectionCountSelect", Any)
# the following typedef cannot be wrapped as is
StepVisual_HArray1OfDraughtingCalloutElement = NewType("StepVisual_HArray1OfDraughtingCalloutElement", Any)
# the following typedef cannot be wrapped as is
StepVisual_HArray1OfFillStyleSelect = NewType("StepVisual_HArray1OfFillStyleSelect", Any)
# the following typedef cannot be wrapped as is
StepVisual_HArray1OfInvisibleItem = NewType("StepVisual_HArray1OfInvisibleItem", Any)
# the following typedef cannot be wrapped as is
StepVisual_HArray1OfLayeredItem = NewType("StepVisual_HArray1OfLayeredItem", Any)
# the following typedef cannot be wrapped as is
StepVisual_HArray1OfPresentationStyleAssignment = NewType("StepVisual_HArray1OfPresentationStyleAssignment", Any)
# the following typedef cannot be wrapped as is
StepVisual_HArray1OfPresentationStyleSelect = NewType("StepVisual_HArray1OfPresentationStyleSelect", Any)
# the following typedef cannot be wrapped as is
StepVisual_HArray1OfRenderingPropertiesSelect = NewType("StepVisual_HArray1OfRenderingPropertiesSelect", Any)
# the following typedef cannot be wrapped as is
StepVisual_HArray1OfStyleContextSelect = NewType("StepVisual_HArray1OfStyleContextSelect", Any)
# the following typedef cannot be wrapped as is
StepVisual_HArray1OfSurfaceStyleElementSelect = NewType("StepVisual_HArray1OfSurfaceStyleElementSelect", Any)
# the following typedef cannot be wrapped as is
StepVisual_HArray1OfTessellatedEdgeOrVertex = NewType("StepVisual_HArray1OfTessellatedEdgeOrVertex", Any)
# the following typedef cannot be wrapped as is
StepVisual_HArray1OfTessellatedStructuredItem = NewType("StepVisual_HArray1OfTessellatedStructuredItem", Any)
# the following typedef cannot be wrapped as is
StepVisual_HArray1OfTextOrCharacter = NewType("StepVisual_HArray1OfTextOrCharacter", Any)
...
class StepVisual_SurfaceStyleParameterLine(Standard_Transient):
    def __init__(self) -> None: ...
    def DirectionCounts(self) -> False: ...
...
class StepVisual_TessellatedShapeRepresentationWithAccuracyParameters(StepVisual_TessellatedShapeRepresentation):
    ...
    def TessellationAccuracyParametersValue(self, theNum: int) -> False: ...
...
class StepVisual_TextStyleWithBoxCharacteristics(StepVisual_TextStyle):
    def __init__(self) -> None: ...
    def Characteristics(self) -> False: ...
