...
class CDM_ListOfDocument:
    ...
    def Assign(self, theItem: CDM_ListOfDocument) -> CDM_ListOfDocument: ...
    def Clear(self) -> None: ...
...
class CDM_ListOfReferences:
    def Append(self, theItem: False) -> False: ...
    def Assign(self, theItem: CDM_ListOfReferences) -> CDM_ListOfReferences: ...
    def Clear(self) -> None: ...
    def First(self) -> False: ...
    def Last(self) -> False: ...
    def Prepend(self, theItem: False) -> False: ...
...
class CDM_Application(Standard_Transient):
    ...
    def EndOfUpdate(
        self, aDocument: CDM_Document, theStatus: bool, ErrorString: str
    ) -> None: ...
...
class CDM_Document(Standard_Transient):
    ...
    def CanCloseReference(
        self, aDocument: CDM_Document, aReferenceIdentifier: int
    ) -> bool: ...
    def Close(self) -> None: ...
    def CloseReference(
        self, aDocument: CDM_Document, aReferenceIdentifier: int
    ...
    def CopyReference(
        self, aFromDocument: CDM_Document, aReferenceIdentifier: int
    ) -> int: ...
    @overload
    ...
    def GetAlternativeDocument(
        self, aFormat: str, anAlternativeDocument: CDM_Document
    ) -> bool: ...
    ...
    @overload
    def Update(
        self, aToDocument: CDM_Document, aReferenceIdentifier: int, aModifContext: None
    ) -> None: ...
    @overload
