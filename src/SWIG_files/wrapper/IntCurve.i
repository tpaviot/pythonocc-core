...
class IntCurve_IntConicConic : public IntRes2d_Intersection {
	...
	:rtype: None") IntCurve_IntConicConic;
		 IntCurve_IntConicConic ();
...
class IntCurve_IntImpConicParConic : public IntRes2d_Intersection {
	...
	:rtype: float") FindV;
		...
		%feature("autodoc", "* Empty constructor.
	:rtype: None") IntCurve_IntImpConicParConic;
		 IntCurve_IntImpConicParConic ();
...
class IntCurve_PConic {
	...
	:rtype: None") IntCurve_PConic;
		...
		%feature("autodoc", ":rtype: float") Param1;
		Standard_Real Param1 ();

		/****************** Param2 ******************/
		%feature("compactdefaultargs") Param2;
		%feature("autodoc", ":rtype: float") Param2;
	...
	:rtype: GeomAbs_CurveType") TypeCurve;
