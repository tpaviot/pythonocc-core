...
Geom_HSequenceOfBSplineSurface = NewType("Geom_HSequenceOfBSplineSurface", Any)
...
class Geom_Curve(Geom_Geometry):
    ...
    def ParametricTransformation(self, T: gp_Trsf) -> False: ...
    def Period(self) -> False: ...
    def Reverse(self) -> None: ...
    def Reversed(self) -> Geom_Curve: ...
    def ReversedParameter(self, U: float) -> False: ...
    def TransformedParameter(self, U: float, T: gp_Trsf) -> False: ...
...
class Geom_Vector(Geom_Geometry):
    ...
    def Magnitude(self) -> False: ...
    def Reverse(self) -> None: ...
    def Reversed(self) -> Geom_Vector: ...
    def SquareMagnitude(self) -> False: ...
    def Vec(self) -> gp_Vec: ...
    def X(self) -> float: ...
    def Y(self) -> float: ...
    def Z(self) -> float: ...
...
class Geom_OffsetCurve(Geom_Curve):
    ...
    def EvalD3(self, U: float) -> False: ...
    def EvalDN(self, U: float, N: int) -> gp_Vec: ...
    def EvalRepresentation(self) -> False: ...
    def FirstParameter(self) -> float: ...
