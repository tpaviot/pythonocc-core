...
class Geom_OsculatingSurface(Standard_Transient):
    ...
    def UOscSurf(
        self, U: float, V: float, L: Geom_BSplineSurface
    ) -> Tuple[bool, bool]: ...
    def VOscSurf(
        self, U: float, V: float, L: Geom_BSplineSurface
    ) -> Tuple[bool, bool]: ...
...
class Geom_OffsetCurve(Geom_Curve):
    def __init__(
        ...
        Offset: float,
        V: gp_Dir,
        isNotCheckC0: Optional[bool] = False,
    ) -> None: ...
    ...
    def ReversedParameter(self, U: float) -> float: ...
    def SetBasisCurve(
        self, C: Geom_Curve, isNotCheckC0: Optional[bool] = False
    ) -> None: ...
    def SetDirection(self, V: gp_Dir) -> None: ...
...
class Geom_OffsetSurface(Geom_Surface):
    def __init__(
        self, S: Geom_Surface, Offset: float, isNotCheckC0: Optional[bool] = False
    ) -> None: ...
    def BasisSurface(self) -> Geom_Surface: ...
    def Bounds(self) -> Tuple[float, float, float, float]: ...
    def Continuity(self) -> GeomAbs_Shape: ...
    ...
    def ParametricTransformation(self, T: gp_Trsf) -> gp_GTrsf2d: ...
    def SetBasisSurface(
        self, S: Geom_Surface, isNotCheckC0: Optional[bool] = False
    ) -> None: ...
    def SetOffsetValue(self, D: float) -> None: ...
    ...
    def UOsculatingSurface(
        self, U: float, V: float, UOsculSurf: Geom_BSplineSurface
    ) -> Tuple[bool, bool]: ...
    def UPeriod(self) -> float: ...
    def UReverse(self) -> None: ...
    def UReversedParameter(self, U: float) -> float: ...
    ...
    def VOsculatingSurface(
        self, U: float, V: float, VOsculSurf: Geom_BSplineSurface
    ) -> Tuple[bool, bool]: ...
    def VPeriod(self) -> float: ...
    def VReverse(self) -> None: ...
    def VReversedParameter(self, V: float) -> float: ...
...
class Geom_BSplineCurve(Geom_BoundedCurve):
    ...
    def __init__(
        ...
        Degree: int,
        Periodic: Optional[bool] = False,
        CheckRational: Optional[bool] = True,
    ) -> None: ...
    def Continuity(self) -> GeomAbs_Shape: ...
    def Copy(self) -> Geom_Geometry: ...
    def D0(self, U: float, P: gp_Pnt) -> None: ...
    ...
    def InsertKnot(
        ...
        U: float,
        M: Optional[int] = 1,
        ParametricTolerance: Optional[float] = 0.0,
    ...
    def LocalD1(
        self, U: float, FromK1: int, ToK2: int, P: gp_Pnt, V1: gp_Vec
    ) -> None: ...
    def LocalD2(
        self, U: float, FromK1: int, ToK2: int, P: gp_Pnt, V1: gp_Vec, V2: gp_Vec
    ) -> None: ...
    def LocalD3(
        self,
        U: float,
    ...
    def LocateU(
        ...
        WithKnotRepetition: Optional[bool] = False,
    ) -> Tuple[int, int]: ...
    @staticmethod
    def MaxDegree() -> int: ...
    def MovePoint(
        self, U: float, P: gp_Pnt, Index1: int, Index2: int
    ) -> Tuple[int, int]: ...
    ...
    def Segment(
        ...
        U1: float,
        U2: float,
        theTolerance: Optional[float] = Precision.PConfusion(),
    ) -> None: ...
    @overload
...
class Geom_BSplineSurface(Geom_BoundedSurface):
    ...
    def __init__(
        ...
        UDegree: int,
        VDegree: int,
        UPeriodic: Optional[bool] = False,
        VPeriodic: Optional[bool] = False,
    ) -> None: ...
    @overload
    def __init__(
        self,
    ...
    def CheckAndSegment(
        ...
        V1: float,
        V2: float,
        theUTolerance: Optional[float] = Precision.PConfusion(),
        theVTolerance: Optional[float] = Precision.PConfusion(),
    ) -> None: ...
    def Continuity(self) -> GeomAbs_Shape: ...
    def Copy(self) -> Geom_Geometry: ...
    def D0(self, U: float, V: float, P: gp_Pnt) -> None: ...
    ...
    def InsertUKnot(
        self, U: float, M: int, ParametricTolerance: float, Add: Optional[bool] = True
    ) -> None: ...
    def InsertUKnots(
        self,
        Knots: TColStd_Array1OfReal,
    ...
    def InsertVKnot(
        self, V: float, M: int, ParametricTolerance: float, Add: Optional[bool] = True
    ) -> None: ...
    def InsertVKnots(
        self,
        Knots: TColStd_Array1OfReal,
    ...
    def LocalValue(
        self, U: float, V: float, FromUK1: int, ToUK2: int, FromVK1: int, ToVK2: int
    ) -> gp_Pnt: ...
    def LocateU(
        self,
        U: float,
...
class Geom_BezierCurve(Geom_BoundedCurve):
    ...
    @overload
    def __init__(
        self, CurvePoles: TColgp_Array1OfPnt, PoleWeights: TColStd_Array1OfReal
    ) -> None: ...
    def Continuity(self) -> GeomAbs_Shape: ...
    def Copy(self) -> Geom_Geometry: ...
    def D0(self, U: float, P: gp_Pnt) -> None: ...
...
class Geom_BezierSurface(Geom_BoundedSurface):
    ...
    @overload
    def __init__(
        self, SurfacePoles: TColgp_Array2OfPnt, PoleWeights: TColStd_Array2OfReal
    ) -> None: ...
    def Bounds(self) -> Tuple[float, float, float, float]: ...
    def Continuity(self) -> GeomAbs_Shape: ...
    def Copy(self) -> Geom_Geometry: ...
...
class Geom_RectangularTrimmedSurface(Geom_BoundedSurface):
    ...
    def __init__(
        ...
        V1: float,
        V2: float,
        USense: Optional[bool] = True,
        VSense: Optional[bool] = True,
    ) -> None: ...
    @overload
    def __init__(
        self,
    ...
    @overload
    def SetTrim(
        self, Param1: float, Param2: float, UTrim: bool, Sense: Optional[bool] = True
    ) -> None: ...
    def Transform(self, T: gp_Trsf) -> None: ...
    def TransformParameters(self, T: gp_Trsf) -> Tuple[float, float]: ...
    def UIso(self, U: float) -> Geom_Curve: ...
...
class Geom_TrimmedCurve(Geom_BoundedCurve):
    def __init__(
        ...
        U2: float,
        Sense: Optional[bool] = True,
        theAdjustPeriodic: Optional[bool] = True,
    ) -> None: ...
    def BasisCurve(self) -> Geom_Curve: ...
    def Continuity(self) -> GeomAbs_Shape: ...
    def Copy(self) -> Geom_Geometry: ...
