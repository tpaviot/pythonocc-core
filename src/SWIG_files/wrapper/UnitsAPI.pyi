...
class unitsapi:
    @staticmethod
    def AnyFromLS(aData: float, aUnit: str) -> False: ...
    @staticmethod
    def AnyFromSI(aData: float, aUnit: str) -> False: ...
    @staticmethod
    def AnyToAny(aData: float, aUnit1: str, aUnit2: str) -> False: ...
    @overload
    @staticmethod
    def AnyToLS(aData: float, aUnit: str) -> False: ...
    @overload
    @staticmethod
    def AnyToLS(aData: float, aUnit: str, aDim: Units_Dimensions) -> False: ...
    @overload
    @staticmethod
    def AnyToSI(aData: float, aUnit: str) -> False: ...
    @overload
    @staticmethod
    def AnyToSI(aData: float, aUnit: str, aDim: Units_Dimensions) -> False: ...
    @staticmethod
    def Check(aQuantity: str, aUnit: str) -> bool: ...
    @staticmethod
    def CurrentFromAny(aData: float, aQuantity: str, aUnit: str) -> False: ...
    @staticmethod
    def CurrentFromLS(aData: float, aQuantity: str) -> False: ...
    @staticmethod
    def CurrentFromSI(aData: float, aQuantity: str) -> False: ...
    @staticmethod
    def CurrentToAny(aData: float, aQuantity: str, aUnit: str) -> False: ...
    @staticmethod
    def CurrentToLS(aData: float, aQuantity: str) -> False: ...
    @staticmethod
    def CurrentToSI(aData: float, aQuantity: str) -> False: ...
    @staticmethod
    ...
    @staticmethod
    def LSToSI(aData: float, aQuantity: str) -> False: ...
    @staticmethod
    def LocalSystem() -> UnitsAPI_SystemUnits: ...
    @staticmethod
    def Reload() -> None: ...
    @staticmethod
    def SIToLS(aData: float, aQuantity: str) -> False: ...
    @staticmethod
    def Save() -> None: ...
    @staticmethod
