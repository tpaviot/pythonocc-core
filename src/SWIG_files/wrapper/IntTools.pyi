...
IntTools_MapIteratorOfMapOfCurveSample = NewType(
    "IntTools_MapIteratorOfMapOfCurveSample", Any
)
# the following typedef cannot be wrapped as is
IntTools_MapIteratorOfMapOfSurfaceSample = NewType(
    "IntTools_MapIteratorOfMapOfSurfaceSample", Any
)
# the following typedef cannot be wrapped as is
...
class IntTools_ListOfBox:
    ...
    def Assign(self, theItem: IntTools_ListOfBox) -> IntTools_ListOfBox: ...
    def Clear(self) -> None: ...
    ...
    def __init__(self) -> None: ...
    def __len__(self) -> int: ...
    def __iter__(self) -> Bnd_Box: ...

class IntTools_ListOfCurveRangeSample:
    def Append(
        self, theItem: IntTools_CurveRangeSample
    ) -> IntTools_CurveRangeSample: ...
    def Assign(
        self, theItem: IntTools_ListOfCurveRangeSample
    ...
    def __init__(self) -> None: ...
    def __len__(self) -> int: ...
    def __iter__(self) -> IntTools_CurveRangeSample: ...

class IntTools_ListOfSurfaceRangeSample:
    def Append(
        self, theItem: IntTools_SurfaceRangeSample
    ) -> IntTools_SurfaceRangeSample: ...
    def Assign(
        self, theItem: IntTools_ListOfSurfaceRangeSample
    ...
    def __init__(self) -> None: ...
    def __len__(self) -> int: ...
    def __iter__(self) -> IntTools_SurfaceRangeSample: ...

class IntTools_SequenceOfCommonPrts:
    def Assign(self, theItem: IntTools_CommonPrt) -> IntTools_CommonPrt: ...
    def Clear(self) -> None: ...
...
class IntTools_SequenceOfCurves:
    def Assign(self, theItem: IntTools_Curve) -> IntTools_Curve: ...
    def Clear(self) -> None: ...
...
class IntTools_SequenceOfPntOn2Faces:
    def Assign(self, theItem: IntTools_PntOn2Faces) -> IntTools_PntOn2Faces: ...
    def Clear(self) -> None: ...
...
class IntTools_SequenceOfRanges:
    def Assign(self, theItem: IntTools_Range) -> IntTools_Range: ...
    def Clear(self) -> None: ...
    def First(self) -> IntTools_Range: ...
    def IsDeletables(self) -> bool: ...
    def IsEmpty(self) -> bool: ...
...
class IntTools_SequenceOfRoots:
    def Assign(self, theItem: IntTools_Root) -> IntTools_Root: ...
    def Clear(self) -> None: ...
    def First(self) -> IntTools_Root: ...
    def IsDeletables(self) -> bool: ...
    def IsEmpty(self) -> bool: ...
...
class IntTools_BeanFaceIntersector:
    ...
    def SetBeanParameters(
        self, theFirstParOnCurve: float, theLastParOnCurve: float
    ) -> None: ...
...
class IntTools_Context(Standard_Transient):
    ...
    def ComputePE(
        self, theP: gp_Pnt, theTolP: float, theE: TopoDS_Edge
    ...
    def IsValidBlockForFace(
        self, aT1: float, aT2: float, aIC: IntTools_Curve, aF: TopoDS_Face, aTol: float
    ) -> bool: ...
    ...
    def IsValidPointForFace(
        self, aP3D: gp_Pnt, aF: TopoDS_Face, aTol: float
    ) -> bool: ...
    def IsValidPointForFaces(
        self, aP3D: gp_Pnt, aF1: TopoDS_Face, aF2: TopoDS_Face, aTol: float
    ) -> bool: ...
    @overload
    def IsVertexOnLine(
        self, aV: TopoDS_Vertex, aIC: IntTools_Curve, aTolC: float
    ) -> Tuple[bool, float]: ...
    @overload
    def IsVertexOnLine(
        self, aV: TopoDS_Vertex, aTolV: float, aIC: IntTools_Curve, aTolC: float
    ) -> Tuple[bool, float]: ...
    def OBB(
        self,
        theShape: TopoDS_Shape,
        theFuzzyValue: Optional[float] = Precision.Confusion(),
    ) -> Bnd_OBB: ...
...
class IntTools_Curve:
    ...
    def __init__(
        ...
        theTolerance: Optional[float] = 0.0,
        theTangentialTolerance: Optional[float] = 0.0,
    ) -> None: ...
    def Bounds(
        self, theFirstPnt: gp_Pnt, theLastPnt: gp_Pnt
...
class IntTools_FClass2d:
    ...
    def Perform(
        self, Puv: gp_Pnt2d, RecadreOnPeriodic: Optional[bool] = True
    ) -> TopAbs_State: ...
    def PerformInfinitePoint(self) -> TopAbs_State: ...
    def TestOnRestriction(
        self, Puv: gp_Pnt2d, Tol: float, RecadreOnPeriodic: Optional[bool] = True
    ) -> TopAbs_State: ...
...
class IntTools_FaceFace:
    ...
    def Perform(
        self, F1: TopoDS_Face, F2: TopoDS_Face, theToRunParallel: Optional[bool] = False
    ) -> None: ...
...
class IntTools_MarkedRangeSet:
    ...
    @overload
    def __init__(
        self, theFirstBoundary: float, theLastBoundary: float, theInitFlag: int
    ) -> None: ...
    @overload
    def __init__(
        self, theSortedArray: TColStd_Array1OfReal, theInitFlag: int
    ) -> None: ...
    ...
    @overload
    def InsertRange(
        self, theFirstBoundary: float, theLastBoundary: float, theFlag: int
    ) -> bool: ...
    @overload
    ...
    @overload
    def InsertRange(
        self, theRange: IntTools_Range, theFlag: int, theIndex: int
    ) -> bool: ...
    def Length(self) -> int: ...
...
class IntTools_SurfaceRangeLocalizeData:
    ...
    def AddBox(
        self, theRange: IntTools_SurfaceRangeSample, theBox: Bnd_Box
    ) -> None: ...
    def AddOutRange(self, theRange: IntTools_SurfaceRangeSample) -> None: ...
    def Assign(
        self, Other: IntTools_SurfaceRangeLocalizeData
    ...
    def SetFrame(
        self, theUMin: float, theUMax: float, theVMin: float, theVMax: float
    ) -> None: ...
    def SetGridDeflection(self, theDeflection: float) -> None: ...
    def SetGridPoint(
        self, theUIndex: int, theVIndex: int, thePoint: gp_Pnt
    ) -> None: ...
...
class IntTools_SurfaceRangeSample:
    ...
    @overload
    def __init__(
        self, theIndexU: int, theDepthU: int, theIndexV: int, theDepthV: int
    ) -> None: ...
    @overload
    def __init__(
        self, theRangeU: IntTools_CurveRangeSample, theRangeV: IntTools_CurveRangeSample
    ) -> None: ...
    @overload
    def __init__(self, Other: IntTools_SurfaceRangeSample) -> None: ...
    def Assign(
        self, Other: IntTools_SurfaceRangeSample
    ) -> IntTools_SurfaceRangeSample: ...
    ...
    def GetRangeU(
        self, theFirstU: float, theLastU: float, theNbSampleU: int
    ) -> IntTools_Range: ...
    def GetRangeV(
        self, theFirstV: float, theLastV: float, theNbSampleV: int
    ) -> IntTools_Range: ...
    def GetRanges(
        self, theRangeU: IntTools_CurveRangeSample, theRangeV: IntTools_CurveRangeSample
    ) -> None: ...
...
class IntTools_Tools:
    ...
    def ComputeTolerance(
        ...
        theFirst: float,
        theLast: float,
        theTolRange: Optional[float] = Precision.PConfusion(),
        theToRunParallel: Optional[bool] = False,
    ) -> Tuple[bool, float, float]: ...
    @staticmethod
    ...
    @staticmethod
    def IsInRange(
        theRRef: IntTools_Range, theR: IntTools_Range, theTol: float
    ) -> bool: ...
    @staticmethod
    ...
    @staticmethod
    def MakeFaceFromWireAndFace(
        aW: TopoDS_Wire, aF: TopoDS_Face, aFNew: TopoDS_Face
    ) -> None: ...
    @staticmethod
    def RejectLines(
        aSIn: IntTools_SequenceOfCurves, aSOut: IntTools_SequenceOfCurves
    ) -> None: ...
    @staticmethod
    def SegPln(
        theLin: gp_Lin,
...
class IntTools_WLineTool:
    @staticmethod
    def NotUseSurfacesForApprox(
        aF1: TopoDS_Face, aF2: TopoDS_Face, WL: IntPatch_WLine, ifprm: int, ilprm: int
    ) -> bool: ...
...
class IntTools_CurveRangeSample(IntTools_BaseRangeSample):
    ...
    def GetRange(
        self, theFirst: float, theLast: float, theNbSample: int
    ) -> IntTools_Range: ...
