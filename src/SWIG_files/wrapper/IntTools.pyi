...
class inttools:
    @staticmethod
    def Length(E: TopoDS_Edge) -> False: ...
...
class IntTools_MarkedRangeSet:
    ...
    def GetIndices(self, theValue: float) -> False: ...
    @overload
...
class IntTools_Tools:
    ...
    @staticmethod
    def ComputeIntRange(theTol1: float, theTol2: float, theAngle: float) -> False: ...
    @staticmethod
    def ComputeVV(V1: TopoDS_Vertex, V2: TopoDS_Vertex) -> int: ...
    @staticmethod
    def CurveTolerance(aC: Geom_Curve, aTolBase: float) -> False: ...
    @staticmethod
