...
class IntTools_Array1OfRange:
    ...
    def __iter__(self) -> typing.Iterator[IntTools_Range]: ...
...
class IntTools_Array1OfRoots:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[IntTools_Root]: ...
...
class inttools:
    @staticmethod
    def FindRootStates(aSeq: Any, anEpsNull: float) -> None: ...
    @staticmethod
    ...
    @staticmethod
    def RemoveIdenticalRoots(aSeq: Any, anEpsT: float) -> None: ...
    @staticmethod
    def SortRoots(aSeq: Any, anEpsT: float) -> None: ...
...
class IntTools_BeanFaceIntersector:
    ...
    def Result(self) -> Any: ...
    @overload
    def Result(self, theResults: Any) -> None: ...
...
class IntTools_CurveRangeLocalizeData:
    ...
    def ListRangeOut(self, theList: Any) -> None: ...
...
class IntTools_FaceFace:
    ...
    def SetFuzzyValue(self, theFuzz: float) -> None: ...
    def SetList(self, ListOfPnts: Any) -> None: ...
...
class IntTools_Tools:
    ...
    @staticmethod
    def ComputeTolerance(theCurve3D: Geom_Curve, theCurve2D: Geom2d_Curve, theSurf: Geom_Surface, theFirst: float, theLast: float, theTolRange: Optional[float] = ..., theToRunParallel: Optional[bool] = False) -> Tuple[bool, float, float]: ...
    @staticmethod
    ...
    @staticmethod
    def RejectLines(aSIn: Any, aSOut: Any) -> None: ...
    @staticmethod
    ...
    @staticmethod
    def SplitCurve(aC: IntTools_Curve, aS: Any) -> int: ...
    @staticmethod
...
class IntTools_WLineTool:
    @staticmethod
    def DecompositionOfWLine(theWLine: IntPatch_WLine, theSurface1: GeomAdaptor_Surface, theSurface2: GeomAdaptor_Surface, theFace1: TopoDS_Face, theFace2: TopoDS_Face, theLConstructor: GeomInt_LineConstructor, theAvoidLConstructor: bool, theTol: float, theNewLines: Any, arg9: IntTools_Context) -> bool: ...
    @staticmethod
