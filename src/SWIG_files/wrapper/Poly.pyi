...
class Poly_Array1OfTriangle:
    ...
    def __iter__(self) -> typing.Iterator[Poly_Triangle]: ...
...
Poly_MeshPurpose_NONE: int
Poly_MeshPurpose_Calculation: int
Poly_MeshPurpose_Presentation: int
Poly_MeshPurpose_Active: int
Poly_MeshPurpose_Loaded: int
Poly_MeshPurpose_AnyFallback: int
Poly_MeshPurpose_USER: int
...
class Poly_ArrayOfNodes():
    ...
    @overload
    def __init__(self, theBegin: Any, theLength: int) -> None: ...
    @overload
    def __init__(self, theOther: Poly_ArrayOfNodes) -> None: ...
...
class Poly_CoherentNode(gp_XYZ):
    ...
    def Clear(self, arg0: NCollection_BaseAllocator) -> None: ...
    def Dump(self) -> str: ...
...
class Poly_CoherentTriangulation(Standard_Transient):
    @overload
    def __init__(self, theAlloc: Optional[NCollection_BaseAllocator] = None) -> None: ...
    @overload
    def __init__(self, theTriangulation: Poly_Triangulation, theAlloc: Optional[NCollection_BaseAllocator] = None) -> None: ...
    ...
    def GetFreeNodes(self, lstNodes: TColStd_ListOfInteger) -> bool: ...
    ...
    def RemoveDegenerated(self, theTol: float, pLstRemovedNode: Optional[Any] = None) -> bool: ...
...
class Poly_PolygonOnTriangulation(Standard_Transient):
    ...
    def ChangeNodeArray(self) -> TColStd_Array1OfInteger: ...
    def ChangeNodes(self) -> TColStd_Array1OfInteger: ...
    def ChangeParameterArray(self) -> TColStd_Array1OfReal: ...
    def ChangeParameters(self) -> TColStd_Array1OfReal: ...
...
class Poly_Triangulation(Standard_Transient):
    ...
    @overload
    def Normal(self, theIndex: int, theVec3: Any) -> None: ...
    @overload
    ...
    @overload
    def SetNormal(self, theIndex: int, theNormal: Any) -> None: ...
    @overload
