...
Poly_HArray1OfTriangle = NewType("Poly_HArray1OfTriangle", Any)
...
class poly:
    ...
    @staticmethod
    def PointOnTriangle(P1: gp_XY, P2: gp_XY, P3: gp_XY, P: gp_XY, UV: gp_XY) -> False: ...
    @staticmethod
...
class Poly_ArrayOfNodes():
    ...
    @overload
    def __init__(self, theBegin: float, theLength: int) -> None: ...
    @overload
    def __init__(self, theOther: Poly_ArrayOfNodes) -> None: ...
...
class Poly_CoherentTriangulation(Standard_Transient):
    @overload
    def __init__(self, theAlloc: Optional[NCollection_BaseAllocator] = nullptr) -> None: ...
    @overload
    def __init__(self, theTriangulation: Poly_Triangulation, theAlloc: Optional[NCollection_BaseAllocator] = nullptr) -> None: ...
...
class Poly_Polygon3D(Standard_Transient):
    ...
    def ChangeNodes(self) -> False: ...
    def ChangeParameters(self) -> False: ...
...
class Poly_Triangle:
    ...
    def ChangeValue(self, theIndex: int) -> False: ...
    @overload
...
class Poly_Triangulation(Standard_Transient):
    ...
    def ChangeTriangles(self) -> False: ...
    def Clear(self) -> None: ...
    ...
    def InternalNormals(self) -> float: ...
    def InternalTriangles(self) -> False: ...
    ...
    def MapNodeArray(self) -> False: ...
    def MapNormalArray(self) -> float: ...
    def MapTriangleArray(self) -> False: ...
    def MapUVNodeArray(self) -> False: ...
    ...
    @overload
    def Normal(self, theIndex: int, theVec3: float) -> None: ...
    @overload
    ...
    @overload
    def SetNormal(self, theIndex: int, theNormal: float) -> None: ...
    @overload
    def SetNormal(self, theIndex: int, theNormal: gp_Dir) -> None: ...
    def SetNormals(self, theNormals: float) -> None: ...
