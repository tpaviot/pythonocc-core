...
class Poly_ArrayOfNodes():
    ...
    @overload
    def __init__(self, NCollection_AliasedArray(std::move(theOther): Poly_ArrayOfNodes) -> None: ...
...
class Poly_ArrayOfUVNodes():
    ...
    @overload
    def __init__(self, NCollection_AliasedArray(std::move(theOther): Poly_ArrayOfUVNodes) -> None: ...
