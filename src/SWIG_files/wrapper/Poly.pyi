...
# the following typedef cannot be wrapped as is
Poly_BaseIteratorOfCoherentTriangle = NewType(
    "Poly_BaseIteratorOfCoherentTriangle", Any
)
...
class Poly_ListOfTriangulation:
    ...
    def Assign(self, theItem: Poly_ListOfTriangulation) -> Poly_ListOfTriangulation: ...
    def Clear(self) -> None: ...
...
class poly:
    ...
    @overload
    @staticmethod
    def Dump(T: Poly_Triangulation) -> str: ...
    @overload
    @staticmethod
    def Dump(P: Poly_Polygon3D) -> str: ...
    @overload
    @staticmethod
    def Dump(P: Poly_Polygon2D) -> str: ...
    @staticmethod
    def Intersect(
    ...
    @staticmethod
    def IntersectTriLine(
        theStart: gp_XYZ, theDir: gp_Dir, theV0: gp_XYZ, theV1: gp_XYZ, theV2: gp_XYZ
    ) -> Tuple[int, float]: ...
    @staticmethod
    def PointOnTriangle(
        P1: gp_XY, P2: gp_XY, P3: gp_XY, P: gp_XY, UV: gp_XY
    ) -> float: ...
    @staticmethod
    def ReadPolygon2D(IS: str) -> Poly_Polygon2D: ...
    @staticmethod
    def ReadPolygon3D(IS: str) -> Poly_Polygon3D: ...
    @staticmethod
    def ReadTriangulation(IS: str) -> Poly_Triangulation: ...
    @overload
    @staticmethod
    def Write(T: Poly_Triangulation, Compact: Optional[bool] = True) -> str: ...
    @overload
    @staticmethod
    def Write(P: Poly_Polygon3D, Compact: Optional[bool] = True) -> str: ...
    @overload
    @staticmethod
    def Write(P: Poly_Polygon2D, Compact: Optional[bool] = True) -> str: ...
...
class Poly_CoherentNode(gp_XYZ):
    ...
    def AddTriangle(
        self, theTri: Poly_CoherentTriangle, theA: NCollection_BaseAllocator
    ) -> None: ...
    def Dump(self) -> str: ...
...
class Poly_CoherentTriangulation(Standard_Transient):
    ...
    def __init__(
        ...
        theAlloc: Optional[NCollection_BaseAllocator] = 0,
    ) -> None: ...
    def AddLink(
        self, theTri: Poly_CoherentTriangle, theConn: int
    ) -> Poly_CoherentLink: ...
    def AddTriangle(
        self, iNode0: int, iNode1: int, iNode2: int
    ...
    def Clone(
        self, theAlloc: NCollection_BaseAllocator
    ) -> Poly_CoherentTriangulation: ...
    def ComputeLinks(self) -> int: ...
    def Deflection(self) -> float: ...
    def Dump(self) -> str: ...
    def FindTriangle(
        self, theLink: Poly_CoherentLink, pTri_list: List[Poly_CoherentTriangle]
    ) -> bool: ...
    ...
    def ReplaceNodes(
        self, theTriangle: Poly_CoherentTriangle, iNode0: int, iNode1: int, iNode2: int
    ) -> bool: ...
...
class Poly_MergeNodesTool(Standard_Transient):
    def __init__(
        self,
        theSmoothAngle: float,
        theMergeTolerance: Optional[float] = 0.0,
        theNbFacets: Optional[int] = -1,
    ) -> None: ...
    ...
    def AddTriangulation(
        ...
        theTrsf: Optional[gp_Trsf] = gp_Trsf(),
        theToReverse: Optional[bool] = false,
    ) -> None: ...
...
class Poly_Polygon3D(Standard_Transient):
    ...
    @overload
    def __init__(
        self, Nodes: TColgp_Array1OfPnt, Parameters: TColStd_Array1OfReal
    ) -> None: ...
...
class Poly_PolygonOnTriangulation(Standard_Transient):
    ...
    @overload
    def __init__(
        self, Nodes: TColStd_Array1OfInteger, Parameters: TColStd_Array1OfReal
    ) -> None: ...
...
class Poly_Triangulation(Standard_Transient):
    ...
    def __init__(
        ...
        theNbTriangles: int,
        theHasUVNodes: bool,
        theHasNormals: Optional[bool] = false,
    ) -> None: ...
    @overload
    def __init__(
        self, Nodes: TColgp_Array1OfPnt, Triangles: Poly_Array1OfTriangle
    ) -> None: ...
    @overload
    def __init__(
        self,
    ...
    def DetachedLoadDeferredData(
        self, theFileSystem: Optional[OSD_FileSystem] = OSD_FileSystem()
    ) -> Poly_Triangulation: ...
    def DumpJson(self, depth: Optional[int] = -1) -> str: ...
    ...
    def MinMax(
        self, theBox: Bnd_Box, theTrsf: gp_Trsf, theIsAccurate: Optional[bool] = false
    ) -> bool: ...
...
class Poly_TriangulationParameters(Standard_Transient):
    def __init__(
        self,
        theDeflection: Optional[float] = -1,
        theAngle: Optional[float] = -1,
        theMinSize: Optional[float] = -1,
    ) -> None: ...
