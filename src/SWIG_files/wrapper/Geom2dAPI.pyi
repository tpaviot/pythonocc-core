...
class Geom2dAPI_InterCurveCurve:
    ...
    @overload
    def __init__(
        self, C1: Geom2d_Curve, C2: Geom2d_Curve, Tol: Optional[float] = 1.0e-6
    ) -> None: ...
    @overload
    ...
    def Segment(
        self, Index: int, Curve1: Geom2d_Curve, Curve2: Geom2d_Curve
    ) -> None: ...

class Geom2dAPI_Interpolate:
    @overload
    def __init__(
        self, Points: TColgp_HArray1OfPnt2d, PeriodicFlag: bool, Tolerance: float
    ) -> None: ...
    @overload
    def __init__(
        self,
...
class Geom2dAPI_ProjectPointOnCurve:
    ...
    @overload
    def __init__(
        self, P: gp_Pnt2d, Curve: Geom2d_Curve, Umin: float, Usup: float
    ) -> None: ...
    def Distance(self, Index: int) -> float: ...
