...
class GeomConvert {
	...
	:rtype: opencascade::handle<Geom_BSplineCurve>") SplitBSplineCurve;
	...
	:rtype: opencascade::handle<Geom_BSplineSurface>") SplitBSplineSurface;
...
class GeomConvert_ApproxCurve {
	...
	:param MaxDegree:
	:type MaxDegree: int
	:rtype: None") GeomConvert_ApproxCurve;
...
class GeomConvert_ApproxSurface {
	...
	:param PrecisCode:
	:type PrecisCode: int
	:rtype: None") GeomConvert_ApproxSurface;
...
class GeomConvert_BSplineCurveToBezierCurve {
	...
	:param Index:
	:type Index: int
	:rtype: opencascade::handle<Geom_BezierCurve>") Arc;
...
class GeomConvert_BSplineSurfaceKnotSplitting {
	...
	:rtype: None") GeomConvert_BSplineSurfaceKnotSplitting;
...
class GeomConvert_BSplineSurfaceToBezierSurface {
	...
	:param VIndex:
	:type VIndex: int
	:rtype: opencascade::handle<Geom_BezierSurface>") Patch;
...
class GeomConvert_CompCurveToBSplineCurve {
	...
	:rtype: bool") Add;
		...
		%feature("autodoc", ":rtype: opencascade::handle<Geom_BSplineCurve>") BSplineCurve;
