...
# the following typedef cannot be wrapped as is
TopTools_HArray1OfListOfShape = NewType("TopTools_HArray1OfListOfShape", Any)
# the following typedef cannot be wrapped as is
TopTools_HArray1OfShape = NewType("TopTools_HArray1OfShape", Any)
# the following typedef cannot be wrapped as is
TopTools_HArray2OfShape = NewType("TopTools_HArray2OfShape", Any)
# the following typedef cannot be wrapped as is
TopTools_HSequenceOfShape = NewType("TopTools_HSequenceOfShape", Any)
# the following typedef cannot be wrapped as is
