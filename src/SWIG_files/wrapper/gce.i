...
class gce_MakeMirror {
	public:
		...
		%feature("autodoc", ":rtype: gp_Trsf") Operator;
...
class gce_MakeMirror2d {
	public:
		/****************** Operator ******************/
		%feature("compactdefaultargs") Operator;
		%feature("autodoc", ":rtype: gp_Trsf2d") Operator;
		const gp_Trsf2d  Operator ();

		/****************** Value ******************/
		%feature("compactdefaultargs") Value;
		%feature("autodoc", "* Returns the constructed transformation.
	:rtype: gp_Trsf2d") Value;
	...
	:rtype: None") gce_MakeMirror2d;
		...
		%feature("autodoc", ":rtype:") operator gp_Trsf2d;
		 operator gp_Trsf2d ();
...
class gce_MakeTranslation {
	...
	:param Vect:
	:type Vect: gp_Vec
	:rtype: None") gce_MakeTranslation;
...
class gce_MakeTranslation2d {
	...
	:param Vect:
	:type Vect: gp_Vec2d
	:rtype: None") gce_MakeTranslation2d;
...
class gce_MakeCirc : public gce_Root {
	public:
		/****************** Operator ******************/
		%feature("compactdefaultargs") Operator;
		%feature("autodoc", ":rtype: gp_Circ") Operator;
	...
	:rtype: None") gce_MakeCirc;
		...
		%feature("autodoc", ":rtype:") operator gp_Circ;
		 operator gp_Circ ();
...
class gce_MakeCirc2d : public gce_Root {
	public:
		/****************** Operator ******************/
		%feature("compactdefaultargs") Operator;
		%feature("autodoc", ":rtype: gp_Circ2d") Operator;
		const gp_Circ2d  Operator ();

		/****************** Value ******************/
		%feature("compactdefaultargs") Value;
		%feature("autodoc", "* Returns the constructed circle. Exceptions StdFail_NotDone if no circle is constructed.
	:rtype: gp_Circ2d") Value;
	...
	:rtype: None") gce_MakeCirc2d;
		...
		%feature("autodoc", ":rtype:") operator gp_Circ2d;
		 operator gp_Circ2d ();
...
class gce_MakeCone : public gce_Root {
	public:
		/****************** Operator ******************/
		%feature("compactdefaultargs") Operator;
		%feature("autodoc", ":rtype: gp_Cone") Operator;
	...
	:rtype: None") gce_MakeCone;
		...
		%feature("autodoc", ":rtype:") operator gp_Cone;
		 operator gp_Cone ();
...
class gce_MakeCylinder : public gce_Root {
	public:
		/****************** Operator ******************/
		%feature("compactdefaultargs") Operator;
		%feature("autodoc", ":rtype: gp_Cylinder") Operator;
	...
	:rtype: None") gce_MakeCylinder;
		...
		%feature("autodoc", ":rtype:") operator gp_Cylinder;
		 operator gp_Cylinder ();
...
class gce_MakeDir : public gce_Root {
	...
	:rtype: None") gce_MakeDir;
		...
		%feature("autodoc", ":rtype:") operator gp_Dir;
		 operator gp_Dir ();
...
class gce_MakeDir2d : public gce_Root {
	...
	:rtype: None") gce_MakeDir2d;
		...
		%feature("autodoc", ":rtype:") operator gp_Dir2d;
		 operator gp_Dir2d ();
...
class gce_MakeElips : public gce_Root {
	public:
		/****************** Operator ******************/
		%feature("compactdefaultargs") Operator;
		%feature("autodoc", ":rtype: gp_Elips") Operator;
	...
	:rtype: None") gce_MakeElips;
		...
		%feature("autodoc", ":rtype:") operator gp_Elips;
		 operator gp_Elips ();
...
class gce_MakeElips2d : public gce_Root {
	public:
		/****************** Operator ******************/
		%feature("compactdefaultargs") Operator;
		%feature("autodoc", ":rtype: gp_Elips2d") Operator;
		const gp_Elips2d  Operator ();

		/****************** Value ******************/
		%feature("compactdefaultargs") Value;
		%feature("autodoc", "* Returns the constructed ellipse. Exceptions StdFail_NotDone if no ellipse is constructed.
	:rtype: gp_Elips2d") Value;
	...
	:rtype: None") gce_MakeElips2d;
		...
		%feature("autodoc", ":rtype:") operator gp_Elips2d;
		 operator gp_Elips2d ();
...
class gce_MakeHypr : public gce_Root {
	public:
		/****************** Operator ******************/
		%feature("compactdefaultargs") Operator;
		%feature("autodoc", ":rtype: gp_Hypr") Operator;
	...
	:rtype: None") gce_MakeHypr;
		...
		%feature("autodoc", ":rtype:") operator gp_Hypr;
		 operator gp_Hypr ();
...
class gce_MakeHypr2d : public gce_Root {
	public:
		/****************** Operator ******************/
		%feature("compactdefaultargs") Operator;
		%feature("autodoc", ":rtype: gp_Hypr2d") Operator;
		const gp_Hypr2d  Operator ();

		/****************** Value ******************/
		%feature("compactdefaultargs") Value;
		%feature("autodoc", "* Returns the constructed hyperbola. Exceptions StdFail_NotDone if no hyperbola is constructed.
	:rtype: gp_Hypr2d") Value;
	...
	:rtype: None") gce_MakeHypr2d;
		...
		%feature("autodoc", ":rtype:") operator gp_Hypr2d;
		 operator gp_Hypr2d ();
...
class gce_MakeLin : public gce_Root {
	public:
		/****************** Operator ******************/
		%feature("compactdefaultargs") Operator;
		%feature("autodoc", ":rtype: gp_Lin") Operator;
	...
	:rtype: None") gce_MakeLin;
		...
		%feature("autodoc", ":rtype:") operator gp_Lin;
		 operator gp_Lin ();
...
class gce_MakeLin2d : public gce_Root {
	...
	:rtype: None") gce_MakeLin2d;
		...
		%feature("autodoc", ":rtype:") operator gp_Lin2d;
		 operator gp_Lin2d ();
...
class gce_MakeParab : public gce_Root {
	public:
		/****************** Operator ******************/
		%feature("compactdefaultargs") Operator;
		%feature("autodoc", ":rtype: gp_Parab") Operator;
	...
	:rtype: None") gce_MakeParab;
		...
		%feature("autodoc", ":rtype:") operator gp_Parab;
		 operator gp_Parab ();
...
class gce_MakeParab2d : public gce_Root {
	public:
		/****************** Operator ******************/
		%feature("compactdefaultargs") Operator;
		%feature("autodoc", ":rtype: gp_Parab2d") Operator;
		const gp_Parab2d  Operator ();

		/****************** Value ******************/
		%feature("compactdefaultargs") Value;
		%feature("autodoc", "* Returns the constructed parabola. Exceptions StdFail_NotDone if no parabola is constructed.
	:rtype: gp_Parab2d") Value;
	...
	:rtype: None") gce_MakeParab2d;
		...
		%feature("autodoc", ":rtype:") operator gp_Parab2d;
		 operator gp_Parab2d ();
...
class gce_MakePln : public gce_Root {
	public:
		/****************** Operator ******************/
		%feature("compactdefaultargs") Operator;
		%feature("autodoc", ":rtype: gp_Pln") Operator;
	...
	:rtype: None") gce_MakePln;
		...
		%feature("autodoc", ":rtype:") operator gp_Pln;
		 operator gp_Pln ();
