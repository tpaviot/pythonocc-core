...
class IntPatch_ALineToWLine:
    ...
    @overload
    def MakeWLine(self, aline: IntPatch_ALine, theLines: Any) -> None: ...
    @overload
    def MakeWLine(self, aline: IntPatch_ALine, paraminf: float, paramsup: float, theLines: Any) -> None: ...
...
class IntPatch_BVHTraversal():
    ...
    def Clear(self) -> None: ...
    def Pairs(self) -> Any: ...
    def Perform(self, theSet1: IntPatch_PolyhedronBVH, theSet2: IntPatch_PolyhedronBVH, theSelfInterference: Optional[bool] = False) -> int: ...
    def RejectNode(self, theCMin1: BVH_Vec3d, theCMax1: BVH_Vec3d, theCMin2: BVH_Vec3d, theCMax2: BVH_Vec3d) -> Tuple[bool, float]: ...
...
class IntPatch_Intersection:
    ...
    @overload
    def Perform(self, S1: Adaptor3d_Surface, D1: Adaptor3d_TopolTool, S2: Adaptor3d_Surface, D2: Adaptor3d_TopolTool, TolArc: float, TolTang: float, LOfPnts: Any, isGeomInt: Optional[bool] = True, theIsReqToKeepRLine: Optional[bool] = False, theIsReqToPostWLProc: Optional[bool] = True) -> None: ...
    @overload
    ...
    def Point(self, Index: int) -> IntPatch_Point: ...
    @staticmethod
    def PrepareSurfaces(theS1: Adaptor3d_Surface, theD1: Adaptor3d_TopolTool, theS2: Adaptor3d_Surface, theD2: Adaptor3d_TopolTool, Tol: float, theSeqHS1: Any, theSeqHS2: Any) -> None: ...
    def SequenceOfLine(self) -> Any: ...
...
class IntPatch_LineConstructor:
    ...
    def Line(self, index: int) -> IntPatch_Line: ...
    def NbLines(self) -> int: ...
    def Perform(self, SL: Any, L: IntPatch_Line, S1: Adaptor3d_Surface, D1: Adaptor3d_TopolTool, S2: Adaptor3d_Surface, D2: Adaptor3d_TopolTool, Tol: float) -> None: ...
...
class IntPatch_PolyhedronTool:
    ...
    @staticmethod
    def ComponentsBounding(thePolyh: IntPatch_Polyhedron) -> Any: ...
    @staticmethod
...
class IntPatch_PrmPrmIntersection:
    ...
    @overload
    def Perform(self, Caro1: Adaptor3d_Surface, Domain1: Adaptor3d_TopolTool, Caro2: Adaptor3d_Surface, Domain2: Adaptor3d_TopolTool, TolTangency: float, Epsilon: float, Deflection: float, Increment: float, ListOfPnts: Any) -> None: ...
    @overload
...
class IntPatch_SpecialPoints:
    ...
    @staticmethod
    def AddPointOnUorVIso(theQSurf: Adaptor3d_Surface, thePSurf: Adaptor3d_Surface, theRefPt: IntSurf_PntOn2S, theIsU: bool, theIsoParameter: float, theToler: Any, theInitPoint: Any, theInfBound: Any, theSupBound: Any, theAddedPoint: IntSurf_PntOn2S, theIsReversed: Optional[bool] = False) -> bool: ...
    @staticmethod
    ...
    @staticmethod
    def AdjustPointAndVertex(theRefPoint: IntSurf_PntOn2S, theArrPeriods_list: list[float], theNewPoint: IntSurf_PntOn2S, theVertex: Optional[IntPatch_Point] = None) -> None: ...
    @staticmethod
...
class IntPatch_TheIWLineOfTheIWalking(Standard_Transient):
    def __init__(self, theAllocator: Optional[IntSurf_Allocator] = None) -> None: ...
...
class IntPatch_TheIWalking:
    ...
    @overload
    def Perform(self, Pnts1: Any, Pnts2: Any, Func: IntPatch_TheSurfFunction, S: Adaptor3d_Surface, Reversed: Optional[bool] = False) -> None: ...
    @overload
    def Perform(self, Pnts1: Any, Func: IntPatch_TheSurfFunction, S: Adaptor3d_Surface, Reversed: Optional[bool] = False) -> None: ...
...
class IntPatch_WLineTool:
    ...
    @staticmethod
    def ExtendTwoWLines(theSlin: Any, theS1: Adaptor3d_Surface, theS2: Adaptor3d_Surface, theToler3D: float, theArrPeriods: Any, theBoxS1: Bnd_Box2d, theBoxS2: Bnd_Box2d, theListOfCriticalPoints: Any) -> None: ...
    @staticmethod
    def JoinWLines(theSlin: Any, theSPnt: Any, theS1: Adaptor3d_Surface, theS2: Adaptor3d_Surface, theTol3D: float) -> None: ...
