...
class IntPatch_SequenceOfPathPointOfTheSOnBounds:
    def Assign(self, theItem: IntPatch_ThePathPointOfTheSOnBounds) -> IntPatch_ThePathPointOfTheSOnBounds: ...
    def Clear(self) -> None: ...
...
class IntPatch_SequenceOfSegmentOfTheSOnBounds:
    def Assign(self, theItem: IntPatch_TheSegmentOfTheSOnBounds) -> IntPatch_TheSegmentOfTheSOnBounds: ...
    def Clear(self) -> None: ...
