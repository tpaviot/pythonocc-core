...
class IntPatch_HCurve2dTool:
    ...
    @staticmethod
    def Period(C: Adaptor2d_Curve2d) -> False: ...
    @staticmethod
    def Resolution(C: Adaptor2d_Curve2d, R3d: float) -> False: ...
    @staticmethod
...
class IntPatch_HInterTool:
    ...
    @staticmethod
    def Parameter(V: Adaptor3d_HVertex, C: Adaptor2d_Curve2d) -> False: ...
    @staticmethod
    ...
    @staticmethod
    def Tolerance(V: Adaptor3d_HVertex, C: Adaptor2d_Curve2d) -> False: ...
    @staticmethod
...
class IntPatch_Intersection:
    ...
    @staticmethod
    def DefineUVMaxStep(theS1: Adaptor3d_Surface, theD1: Adaptor3d_TopolTool, theS2: Adaptor3d_Surface, theD2: Adaptor3d_TopolTool) -> False: ...
...
class IntPatch_PolyhedronBVH():
    ...
    def Center(self, theIndex: int, theAxis: int) -> False: ...
    def Clear(self) -> None: ...
...
class IntPatch_PolyhedronTool:
    ...
    @staticmethod
    def ComponentsBounding(thePolyh: IntPatch_Polyhedron) -> False: ...
    @staticmethod
    def DeflectionOverEstimation(thePolyh: IntPatch_Polyhedron) -> False: ...
    @staticmethod
...
class IntPatch_SpecialPoints:
    ...
    @staticmethod
    def AdjustPointAndVertex(theRefPoint: IntSurf_PntOn2S, theArrPeriods_list: List[float], theNewPoint: IntSurf_PntOn2S, theVertex: Optional[IntPatch_Point] = nullptr) -> None: ...
    @staticmethod
...
class IntPatch_TheIWLineOfTheIWalking(Standard_Transient):
    def __init__(self, theAllocator: Optional[IntSurf_Allocator] = nullptr) -> None: ...
...
class IntPatch_PointLine(IntPatch_Line):
    ...
    @staticmethod
    def CurvatureRadiusOfIntersLine(theS1: Adaptor3d_Surface, theS2: Adaptor3d_Surface, theUVPoint: IntSurf_PntOn2S) -> False: ...
