...
class Geom2d_OffsetCurve(Geom2d_Curve):
    def __init__(
        self, C: Geom2d_Curve, Offset: float, isNotCheckC0: Optional[bool] = False
    ) -> None: ...
    ...
    def ReversedParameter(self, U: float) -> float: ...
    def SetBasisCurve(
        self, C: Geom2d_Curve, isNotCheckC0: Optional[bool] = False
    ) -> None: ...
...
class Geom2d_BSplineCurve(Geom2d_BoundedCurve):
    ...
    def InsertKnot(
        self, U: float, M: Optional[int] = 1, ParametricTolerance: Optional[float] = 0.0
    ) -> None: ...
    def InsertKnots(
        self,
        Knots: TColStd_Array1OfReal,
    ...
    def InsertPoleAfter(
        self, Index: int, P: gp_Pnt2d, Weight: Optional[float] = 1.0
    ) -> None: ...
    ...
    def LocalD1(
        self, U: float, FromK1: int, ToK2: int, P: gp_Pnt2d, V1: gp_Vec2d
    ) -> None: ...
    def LocalD2(
        self, U: float, FromK1: int, ToK2: int, P: gp_Pnt2d, V1: gp_Vec2d, V2: gp_Vec2d
    ) -> None: ...
    def LocalD3(
        self,
        U: float,
    ...
    def MaxDegree() -> int: ...
    def MovePoint(
        self, U: float, P: gp_Pnt2d, Index1: int, Index2: int
    ) -> Tuple[int, int]: ...
...
class Geom2d_BezierCurve(Geom2d_BoundedCurve):
    ...
    @overload
    def __init__(
        self, CurvePoles: TColgp_Array1OfPnt2d, PoleWeights: TColStd_Array1OfReal
    ) -> None: ...
    def Continuity(self) -> GeomAbs_Shape: ...
    def Copy(self) -> Geom2d_Geometry: ...
    def D0(self, U: float, P: gp_Pnt2d) -> None: ...
...
class Geom2d_Circle(Geom2d_Conic):
    ...
    @overload
    def __init__(
        self, A: gp_Ax2d, Radius: float, Sense: Optional[bool] = True
    ) -> None: ...
    @overload
...
class Geom2d_Ellipse(Geom2d_Conic):
    ...
    @overload
    def __init__(
        self, Axis: gp_Ax22d, MajorRadius: float, MinorRadius: float
    ) -> None: ...
    def Copy(self) -> Geom2d_Geometry: ...
    def D0(self, U: float, P: gp_Pnt2d) -> None: ...
    def D1(self, U: float, P: gp_Pnt2d, V1: gp_Vec2d) -> None: ...
