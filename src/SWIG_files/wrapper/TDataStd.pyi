...
class TDataStd_ListOfByte:
    ...
    def Assign(self, theItem: TDataStd_ListOfByte) -> TDataStd_ListOfByte: ...
    def Clear(self) -> None: ...
    def First(self) -> str: ...
    def Last(self) -> str: ...
...
class TDataStd_ListOfExtendedString:
    def Append(self, theItem: str) -> str: ...
    def Assign(
        self, theItem: TDataStd_ListOfExtendedString
...
class TDataStd_AsciiString(TDF_Attribute):
    ...
    @staticmethod
    def Set(
        label: TDF_Label, guid: Standard_GUID, string: str
...
class TDataStd_BooleanArray(TDF_Attribute):
    ...
    @staticmethod
    def Set(
        label: TDF_Label, theGuid: Standard_GUID, lower: int, upper: int
...
class TDataStd_ByteArray(TDF_Attribute):
    def __init__(self) -> None: ...
    def ChangeArray(
        self, newArray: TColStd_HArray1OfByte, isCheckItems: Optional[bool] = True
    ) -> None: ...
    ...
    @staticmethod
    def Set(
        label: TDF_Label, lower: int, upper: int, isDelta: Optional[bool] = False
    ) -> TDataStd_ByteArray: ...
    @overload
    @staticmethod
    def Set(
...
class TDataStd_ChildNodeIterator:
    ...
    @overload
    def __init__(
        self, aTreeNode: TDataStd_TreeNode, allLevels: Optional[bool] = False
    ) -> None: ...
    def Initialize(
        self, aTreeNode: TDataStd_TreeNode, allLevels: Optional[bool] = False
    ) -> None: ...
...
class TDataStd_ExtStringArray(TDF_Attribute):
    ...
    def ChangeArray(
        ...
        isCheckItems: Optional[bool] = True,
    ) -> None: ...
    def DeltaOnModification(
        self, anOldAttribute: TDF_Attribute
    ) -> TDF_DeltaOnModification: ...
...
class TDataStd_IntPackedMap(TDF_Attribute):
    ...
    @staticmethod
    def Set(
        label: TDF_Label, isDelta: Optional[bool] = False
...
class TDataStd_IntegerArray(TDF_Attribute):
    ...
    def ChangeArray(
        self, newArray: TColStd_HArray1OfInteger, isCheckItems: Optional[bool] = True
    ) -> None: ...
    def DeltaOnModification(
        self, anOldAttribute: TDF_Attribute
    ) -> TDF_DeltaOnModification: ...
...
class TDataStd_NamedData(TDF_Attribute):
    ...
    def ChangeArraysOfIntegers(
        self, theArraysOfIntegers: TDataStd_DataMapOfStringHArray1OfInteger
    ) -> None: ...
    def ChangeArraysOfReals(
        self, theArraysOfReals: TDataStd_DataMapOfStringHArray1OfReal
    ) -> None: ...
    ...
    def SetArrayOfIntegers(
        self, theName: str, theArrayOfIntegers: TColStd_HArray1OfInteger
    ) -> None: ...
    def SetArrayOfReals(
        self, theName: str, theArrayOfReals: TColStd_HArray1OfReal
    ) -> None: ...
...
class TDataStd_RealArray(TDF_Attribute):
    ...
    def ChangeArray(
        self, newArray: TColStd_HArray1OfReal, isCheckItems: Optional[bool] = True
    ) -> None: ...
    def DeltaOnModification(
        self, anOldAttribute: TDF_Attribute
    ) -> TDF_DeltaOnModification: ...
...
class TDataStd_ReferenceArray(TDF_Attribute):
    ...
    def SetInternalArray(
        self, values: TDataStd_HLabelArray1, isCheckItems: Optional[bool] = True
    ) -> None: ...
...
class TDataStd_NoteBook(TDataStd_GenericEmpty):
    ...
    @overload
    def Append(
        self, value: float, isExported: Optional[bool] = False
    ) -> TDataStd_Real: ...
    @overload
    def Append(
        self, value: int, isExported: Optional[bool] = False
    ) -> TDataStd_Integer: ...
    def Dump(self) -> Tuple[Standard_OStream, str]: ...
    @staticmethod
