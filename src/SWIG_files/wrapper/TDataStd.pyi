...
class TDataStd_LabelArray1:
    ...
    def __iter__(self) -> typing.Iterator[TDF_Label]: ...
...
class TDataStd_ByteArray(TDF_Attribute):
    ...
    @overload
    def SetID(self) -> None: ...
    def SetValue(self, index: int, value: Any) -> None: ...
    def Upper(self) -> int: ...
...
class TDataStd_NamedData(TDF_Attribute):
    def __init__(self) -> None: ...
    def ChangeArraysOfIntegers(self, theArraysOfIntegers: Any) -> None: ...
    def ChangeArraysOfReals(self, theArraysOfReals: Any) -> None: ...
    ...
    def GetArraysOfIntegersContainer(self) -> Any: ...
    def GetArraysOfRealsContainer(self) -> Any: ...
    def GetByte(self, theName: str) -> Any: ...
    ...
    def SetByte(self, theName: str, theByte: Any) -> None: ...
