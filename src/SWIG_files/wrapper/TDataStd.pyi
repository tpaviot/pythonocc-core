...
TDataStd_HLabelArray1 = NewType("TDataStd_HLabelArray1", Any)
...
class TDataStd_ByteArray(TDF_Attribute):
    ...
    def SetID(self) -> None: ...
    def Upper(self) -> int: ...
    def Value(self, Index: int) -> False: ...
...
class TDataStd_HDataMapOfStringInteger(Standard_Transient):
    ...
    def __init__(self, NbBuckets: Optional[int] = 1) -> None: ...
    @overload
    def __init__(self, theOther: int) -> None: ...
...
class TDataStd_NamedData(TDF_Attribute):
    def __init__(self) -> None: ...
    def ChangeIntegers(self, theIntegers: int) -> None: ...
    def Clear(self) -> None: ...
    def Dump(self) -> Tuple[Standard_OStream, str]: ...
    def DumpJson(self, depth: Optional[int]=-1) -> str: ...
    def GetArrayOfIntegers(self, theName: str) -> False: ...
    def GetArrayOfReals(self, theName: str) -> False: ...
    def GetArraysOfIntegersContainer(self) -> False: ...
    def GetArraysOfRealsContainer(self) -> False: ...
    def GetByte(self, theName: str) -> False: ...
    def GetBytesContainer(self) -> False: ...
    @staticmethod
    def GetID() -> Standard_GUID: ...
    def GetInteger(self, theName: str) -> int: ...
    def GetIntegersContainer(self) -> int: ...
    def GetReal(self, theName: str) -> float: ...
    def GetRealsContainer(self) -> False: ...
    def GetString(self, theName: str) -> str: ...
    def GetStringsContainer(self) -> False: ...
