...
class StepBasic_ActionRequestAssignment(Standard_Transient):
    ...
    def Init(
        self, aAssignedActionRequest: StepBasic_VersionedActionRequest
    ) -> None: ...
    def SetAssignedActionRequest(
        self, AssignedActionRequest: StepBasic_VersionedActionRequest
    ) -> None: ...
...
class StepBasic_Address(Standard_Transient):
    ...
    def SetElectronicMailAddress(
        self, aElectronicMailAddress: TCollection_HAsciiString
    ) -> None: ...
    def SetFacsimileNumber(
        self, aFacsimileNumber: TCollection_HAsciiString
    ) -> None: ...
    def SetInternalLocation(
        self, aInternalLocation: TCollection_HAsciiString
    ) -> None: ...
    ...
    def SetTelephoneNumber(
        self, aTelephoneNumber: TCollection_HAsciiString
    ) -> None: ...
...
class StepBasic_ApplicationContextElement(Standard_Transient):
    ...
    def SetFrameOfReference(
        self, aFrameOfReference: StepBasic_ApplicationContext
    ) -> None: ...
...
class StepBasic_ApplicationProtocolDefinition(Standard_Transient):
    ...
    def SetApplicationInterpretedModelSchemaName(
        self, aApplicationInterpretedModelSchemaName: TCollection_HAsciiString
    ) -> None: ...
...
class StepBasic_Approval(Standard_Transient):
    def __init__(self) -> None: ...
    def Init(
        self, aStatus: StepBasic_ApprovalStatus, aLevel: TCollection_HAsciiString
    ) -> None: ...
...
class StepBasic_ApprovalDateTime(Standard_Transient):
    ...
    def Init(
        self, aDateTime: StepBasic_DateTimeSelect, aDatedApproval: StepBasic_Approval
    ) -> None: ...
...
class StepBasic_ApprovalPersonOrganization(Standard_Transient):
    ...
    def SetAuthorizedApproval(
        self, aAuthorizedApproval: StepBasic_Approval
    ) -> None: ...
    def SetPersonOrganization(
        self, aPersonOrganization: StepBasic_PersonOrganizationSelect
    ) -> None: ...
...
class StepBasic_CertificationAssignment(Standard_Transient):
    ...
    def SetAssignedCertification(
        self, AssignedCertification: StepBasic_Certification
    ) -> None: ...
...
class StepBasic_DateAndTime(Standard_Transient):
    ...
    def Init(
        self, aDateComponent: StepBasic_Date, aTimeComponent: StepBasic_LocalTime
    ) -> None: ...
...
class StepBasic_DateAndTimeAssignment(Standard_Transient):
    ...
    def Init(
        self, aAssignedDateAndTime: StepBasic_DateAndTime, aRole: StepBasic_DateTimeRole
    ) -> None: ...
    def Role(self) -> StepBasic_DateTimeRole: ...
    def SetAssignedDateAndTime(
        self, aAssignedDateAndTime: StepBasic_DateAndTime
    ) -> None: ...
...
class StepBasic_DateAssignment(Standard_Transient):
    ...
    def Init(
        self, aAssignedDate: StepBasic_Date, aRole: StepBasic_DateRole
    ) -> None: ...
...
class StepBasic_DimensionalExponents(Standard_Transient):
    ...
    def SetAmountOfSubstanceExponent(
        self, aAmountOfSubstanceExponent: float
    ) -> None: ...
...
class StepBasic_DocumentProductAssociation(Standard_Transient):
    ...
    def SetRelatedProduct(
        self, RelatedProduct: StepBasic_ProductOrFormationOrDefinition
    ) -> None: ...
...
class StepBasic_DocumentReference(Standard_Transient):
    ...
    def Init0(
        self, aAssignedDocument: StepBasic_Document, aSource: TCollection_HAsciiString
    ) -> None: ...
...
class StepBasic_DocumentRepresentationType(Standard_Transient):
    def __init__(self) -> None: ...
    def Init(
        self, aName: TCollection_HAsciiString, aRepresentedDocument: StepBasic_Document
    ) -> None: ...
    def Name(self) -> TCollection_HAsciiString: ...
    def RepresentedDocument(self) -> StepBasic_Document: ...
    def SetName(self, Name: TCollection_HAsciiString) -> None: ...
    def SetRepresentedDocument(
        self, RepresentedDocument: StepBasic_Document
    ) -> None: ...
...
class StepBasic_EffectivityAssignment(Standard_Transient):
    ...
    def SetAssignedEffectivity(
        self, AssignedEffectivity: StepBasic_Effectivity
    ) -> None: ...
...
class StepBasic_ExternallyDefinedItem(Standard_Transient):
    def __init__(self) -> None: ...
    def Init(
        self, aItemId: StepBasic_SourceItem, aSource: StepBasic_ExternalSource
    ) -> None: ...
...
class StepBasic_GeneralPropertyRelationship(Standard_Transient):
    def __init__(self) -> None: ...
    def Description(self) -> TCollection_HAsciiString: ...
    def HasDescription(self) -> bool: ...
    def Init(
    ...
    def SetDescription(self, Description: TCollection_HAsciiString) -> None: ...
    def SetName(self, Name: TCollection_HAsciiString) -> None: ...
    def SetRelatedGeneralProperty(
        self, RelatedGeneralProperty: StepBasic_GeneralProperty
    ) -> None: ...
    def SetRelatingGeneralProperty(
        self, RelatingGeneralProperty: StepBasic_GeneralProperty
    ) -> None: ...
...
class StepBasic_IdentificationAssignment(Standard_Transient):
    ...
    def Init(
        self, aAssignedId: TCollection_HAsciiString, aRole: StepBasic_IdentificationRole
    ) -> None: ...
...
class StepBasic_OrganizationAssignment(Standard_Transient):
    ...
    def SetAssignedOrganization(
        self, aAssignedOrganization: StepBasic_Organization
    ) -> None: ...
...
class StepBasic_Person(Standard_Transient):
    ...
    def SetPrefixTitles(
        self, aPrefixTitles: Interface_HArray1OfHAsciiString
    ) -> None: ...
    def SetSuffixTitles(
        self, aSuffixTitles: Interface_HArray1OfHAsciiString
    ) -> None: ...
...
class StepBasic_PersonAndOrganization(Standard_Transient):
    def __init__(self) -> None: ...
    def Init(
        self, aThePerson: StepBasic_Person, aTheOrganization: StepBasic_Organization
    ) -> None: ...
...
class StepBasic_PersonAndOrganizationAssignment(Standard_Transient):
    ...
    def SetAssignedPersonAndOrganization(
        self, aAssignedPersonAndOrganization: StepBasic_PersonAndOrganization
    ) -> None: ...
...
class StepBasic_Product(Standard_Transient):
    ...
    def SetDescription(self, aDescription: TCollection_HAsciiString) -> None: ...
    def SetFrameOfReference(
        self, aFrameOfReference: StepBasic_HArray1OfProductContext
    ) -> None: ...
    def SetId(self, aId: TCollection_HAsciiString) -> None: ...
    def SetName(self, aName: TCollection_HAsciiString) -> None: ...
...
class StepBasic_ProductDefinition(Standard_Transient):
    ...
    def SetDescription(self, aDescription: TCollection_HAsciiString) -> None: ...
    def SetFormation(
        self, aFormation: StepBasic_ProductDefinitionFormation
    ) -> None: ...
    def SetFrameOfReference(
        self, aFrameOfReference: StepBasic_ProductDefinitionContext
    ) -> None: ...
    def SetId(self, aId: TCollection_HAsciiString) -> None: ...
...
class StepBasic_ProductDefinitionFormationRelationship(Standard_Transient):
    ...
    def SetRelatedProductDefinitionFormation(
        self, RelatedProductDefinitionFormation: StepBasic_ProductDefinitionFormation
    ) -> None: ...
    def SetRelatingProductDefinitionFormation(
        self, RelatingProductDefinitionFormation: StepBasic_ProductDefinitionFormation
    ) -> None: ...
...
class StepBasic_ProductDefinitionReference(Standard_Transient):
    ...
    def SetIdOwningOrganizationName(
        self, theIdOwningOrganizationName: TCollection_HAsciiString
    ) -> None: ...
    def SetProductDefinitionFormationId(
        self, theProductDefinitionFormationId: TCollection_HAsciiString
    ) -> None: ...
    def SetProductDefinitionId(
        self, theProductDefinitionId: TCollection_HAsciiString
    ) -> None: ...
...
class StepBasic_ProductDefinitionRelationship(Standard_Transient):
    ...
    def SetRelatedProductDefinition(
        self, RelatedProductDefinition: StepBasic_ProductDefinition
    ) -> None: ...
    @overload
    def SetRelatedProductDefinition(
        self, RelatedProductDefinition: StepBasic_ProductDefinitionOrReference
    ) -> None: ...
    @overload
    def SetRelatingProductDefinition(
        self, RelatingProductDefinition: StepBasic_ProductDefinition
    ) -> None: ...
    @overload
    def SetRelatingProductDefinition(
        self, RelatingProductDefinition: StepBasic_ProductDefinitionOrReference
    ) -> None: ...
...
class StepBasic_RoleAssociation(Standard_Transient):
    def __init__(self) -> None: ...
    def Init(
        self, aRole: StepBasic_ObjectRole, aItemWithRole: StepBasic_RoleSelect
    ) -> None: ...
...
class StepBasic_SecurityClassification(Standard_Transient):
    ...
    def SetSecurityLevel(
        self, aSecurityLevel: StepBasic_SecurityClassificationLevel
    ) -> None: ...
...
class StepBasic_SecurityClassificationAssignment(Standard_Transient):
    ...
    def Init(
        self, aAssignedSecurityClassification: StepBasic_SecurityClassification
    ) -> None: ...
...
class StepBasic_CalendarDate(StepBasic_Date):
    ...
    def Init(
        self, aYearComponent: int, aDayComponent: int, aMonthComponent: int
    ) -> None: ...
...
class StepBasic_ConversionBasedUnit(StepBasic_NamedUnit):
    ...
    def SetConversionFactor(
        self, aConversionFactor: StepBasic_MeasureWithUnit
    ) -> None: ...
    def SetName(self, aName: TCollection_HAsciiString) -> None: ...
...
class StepBasic_DocumentFile(StepBasic_Document):
    ...
    def SetCharacterizedObject(
        self, CharacterizedObject: StepBasic_CharacterizedObject
    ) -> None: ...
...
class StepBasic_OrganizationalAddress(StepBasic_Address):
    ...
    def SetOrganizations(
        self, aOrganizations: StepBasic_HArray1OfOrganization
    ) -> None: ...
...
class StepBasic_ProductConceptContext(StepBasic_ApplicationContextElement):
    ...
    def SetMarketSegmentType(
        self, MarketSegmentType: TCollection_HAsciiString
    ) -> None: ...
...
class StepBasic_SiUnit(StepBasic_NamedUnit):
    ...
    def Init(
        self, hasAprefix: bool, aPrefix: StepBasic_SiPrefix, aName: StepBasic_SiUnitName
    ) -> None: ...
...
class StepBasic_SiUnitAndThermodynamicTemperatureUnit(StepBasic_SiUnit):
    ...
    def SetThermodynamicTemperatureUnit(
        self, aThermodynamicTemperatureUnit: StepBasic_ThermodynamicTemperatureUnit
    ) -> None: ...
...
class StepBasic_HArray1OfDerivedUnitElement(
    StepBasic_Array1OfDerivedUnitElement, Standard_Transient
):
    def __init__(self, theLower: int, theUpper: int) -> None: ...
...
class StepBasic_HArray1OfOrganization(
    StepBasic_Array1OfOrganization, Standard_Transient
):
    def __init__(self, theLower: int, theUpper: int) -> None: ...
