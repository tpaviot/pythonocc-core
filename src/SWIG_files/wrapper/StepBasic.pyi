...
class StepBasic_GeneralPropertyAssociation(Standard_Transient):
    def __init__(self) -> None: ...
    def Description(self) -> TCollection_HAsciiString: ...
    def GeneralProperty(self) -> StepBasic_GeneralProperty: ...
    def Init(self, aName: TCollection_HAsciiString, aDescription: TCollection_HAsciiString, aGeneralProperty: StepBasic_GeneralProperty, aPropertyDefinition: StepRepr_PropertyDefinition) -> None: ...
    def Name(self) -> TCollection_HAsciiString: ...
    def PropertyDefinition(self) -> StepRepr_PropertyDefinition: ...
    def SetDescription(self, Description: TCollection_HAsciiString) -> None: ...
    def SetGeneralProperty(self, GeneralProperty: StepBasic_GeneralProperty) -> None: ...
    def SetName(self, Name: TCollection_HAsciiString) -> None: ...
    def SetPropertyDefinition(self, PropertyDefinition: StepRepr_PropertyDefinition) -> None: ...
