...
StepBasic_HArray1OfApproval = NewType("StepBasic_HArray1OfApproval", Any)
# the following typedef cannot be wrapped as is
StepBasic_HArray1OfDerivedUnitElement = NewType("StepBasic_HArray1OfDerivedUnitElement", Any)
# the following typedef cannot be wrapped as is
StepBasic_HArray1OfDocument = NewType("StepBasic_HArray1OfDocument", Any)
# the following typedef cannot be wrapped as is
StepBasic_HArray1OfNamedUnit = NewType("StepBasic_HArray1OfNamedUnit", Any)
# the following typedef cannot be wrapped as is
StepBasic_HArray1OfOrganization = NewType("StepBasic_HArray1OfOrganization", Any)
# the following typedef cannot be wrapped as is
StepBasic_HArray1OfPerson = NewType("StepBasic_HArray1OfPerson", Any)
# the following typedef cannot be wrapped as is
StepBasic_HArray1OfProduct = NewType("StepBasic_HArray1OfProduct", Any)
# the following typedef cannot be wrapped as is
StepBasic_HArray1OfProductContext = NewType("StepBasic_HArray1OfProductContext", Any)
# the following typedef cannot be wrapped as is
StepBasic_HArray1OfProductDefinition = NewType("StepBasic_HArray1OfProductDefinition", Any)
# the following typedef cannot be wrapped as is
StepBasic_HArray1OfUncertaintyMeasureWithUnit = NewType("StepBasic_HArray1OfUncertaintyMeasureWithUnit", Any)
...
class StepBasic_GeneralPropertyRelationship(Standard_Transient):
    ...
    def Description(self) -> TCollection_HAsciiString: ...
    def HasDescription(self) -> bool: ...
    def Init(self, aName: TCollection_HAsciiString, hasDescription: bool, aDescription: TCollection_HAsciiString, aRelatingGeneralProperty: StepBasic_GeneralProperty, aRelatedGeneralProperty: StepBasic_GeneralProperty) -> None: ...
    def Name(self) -> TCollection_HAsciiString: ...
    def RelatedGeneralProperty(self) -> StepBasic_GeneralProperty: ...
    def RelatingGeneralProperty(self) -> StepBasic_GeneralProperty: ...
    def SetDescription(self, Description: TCollection_HAsciiString) -> None: ...
    def SetName(self, Name: TCollection_HAsciiString) -> None: ...
    def SetRelatedGeneralProperty(self, RelatedGeneralProperty: StepBasic_GeneralProperty) -> None: ...
    def SetRelatingGeneralProperty(self, RelatingGeneralProperty: StepBasic_GeneralProperty) -> None: ...
...
class StepBasic_Product(Standard_Transient):
    def __init__(self) -> None: ...
    def Description(self) -> TCollection_HAsciiString: ...
    def FrameOfReference(self) -> False: ...
...
class StepBasic_ConversionBasedUnit(StepBasic_NamedUnit):
    def __init__(self) -> None: ...
    def ConversionFactor(self) -> Standard_Transient: ...
    def Init(self, aDimensions: StepBasic_DimensionalExponents, aName: TCollection_HAsciiString, aConversionFactor: Standard_Transient) -> None: ...
    def Name(self) -> TCollection_HAsciiString: ...
    def SetConversionFactor(self, aConversionFactor: Standard_Transient) -> None: ...
    def SetName(self, aName: TCollection_HAsciiString) -> None: ...
