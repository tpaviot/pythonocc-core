...
class FEmTool_Assembly:
    def __init__(
        self, Dependence: TColStd_Array2OfInteger, Table: FEmTool_HAssemblyTable
    ) -> None: ...
    def AddConstraint(
        self,
    ...
    def AddMatrix(
        self, Element: int, Dimension1: int, Dimension2: int, Mat: math_Matrix
    ) -> None: ...
...
class FEmTool_Curve(Standard_Transient):
    def __init__(
        self, Dimension: int, NbElements: int, TheBase: PLib_Base, Tolerance: float
    ) -> None: ...
