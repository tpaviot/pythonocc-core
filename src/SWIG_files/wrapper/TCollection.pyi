...
class TCollection_AsciiString:
    ...
    def ChangeAll(
        self, aChar: str, NewChar: str, CaseSensitive: Optional[bool] = True
    ) -> None: ...
    def Clear(self) -> None: ...
    @overload
    ...
    @staticmethod
    def IsSameString(
        theString1: str, theString2: str, theIsCaseSensitive: bool
    ) -> bool: ...
    ...
    def Print(self) -> str: ...
    def Read(self, astream: str) -> None: ...
    ...
    def Token(
        self, separators: Optional[str] = "\t", whichone: Optional[int] = 1
    ) -> str: ...
...
class TCollection_ExtendedString:
    ...
    def Cat(self, other: str) -> str: ...
    def ChangeAll(
        self, aChar: Standard_ExtCharacter, NewChar: Standard_ExtCharacter
    ) -> None: ...
    def Clear(self) -> None: ...
    def Copy(self, fromwhere: str) -> None: ...
    def EndsWith(self, theEndString: str) -> bool: ...
    ...
    def Token(
        self, separators: Standard_ExtString, whichone: Optional[int] = 1
    ) -> str: ...
    def Trunc(self, ahowmany: int) -> None: ...
...
class TCollection_HAsciiString(Standard_Transient):
    ...
    @overload
    def __init__(
        self, aString: TCollection_HExtendedString, replaceNonAscii: str
    ) -> None: ...
    @overload
    def AssignCat(self, other: str) -> None: ...
    @overload
    ...
    def FirstLocationInSet(
        self, Set: TCollection_HAsciiString, FromIndex: int, ToIndex: int
    ) -> int: ...
    ...
    @overload
    def IsSameString(
        self, S: TCollection_HAsciiString, CaseSensitive: bool
    ) -> bool: ...
    def LeftAdjust(self) -> None: ...
    def LeftJustify(self, Width: int, Filler: str) -> None: ...
    def Length(self) -> int: ...
    @overload
    def Location(
        self, other: TCollection_HAsciiString, FromIndex: int, ToIndex: int
    ) -> int: ...
    @overload
    def Location(self, N: int, C: str, FromIndex: int, ToIndex: int) -> int: ...
    def LowerCase(self) -> None: ...
...
class TCollection_HExtendedString(Standard_Transient):
    ...
    def Cat(
        self, other: TCollection_HExtendedString
