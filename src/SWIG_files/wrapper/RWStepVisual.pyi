...
class RWStepVisual_RWTriangulatedSurfaceSet:
    def __init__(self) -> None: ...
    def ReadStep(self, theData: StepData_StepReaderData, theNum: int, theCheck: Interface_Check, theEnt: StepVisual_TriangulatedSurfaceSet) -> None: ...
    def Share(self, theEnt: StepVisual_TriangulatedSurfaceSet, theIter: Interface_EntityIterator) -> None: ...
    def WriteStep(self, theSW: StepData_StepWriter, theEnt: StepVisual_TriangulatedSurfaceSet) -> None: ...
