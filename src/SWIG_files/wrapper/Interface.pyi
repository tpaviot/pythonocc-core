...
class Interface_BitMap:
    ...
    @overload
    def __init__(
        self, other: Interface_BitMap, copied: Optional[bool] = False
    ) -> None: ...
...
class Interface_Category:
    ...
    def CatNum(
        self, theEnt: Standard_Transient, theShares: Interface_ShareTool
    ) -> int: ...
    def ClearNums(self) -> None: ...
    def Compute(
        self, theModel: Interface_InterfaceModel, theShares: Interface_ShareTool
    ) -> None: ...
    @staticmethod
    def Init() -> None: ...
    @staticmethod
...
class Interface_Check(Standard_Transient):
    ...
    @overload
    def AddFail(
        self, amess: TCollection_HAsciiString, orig: TCollection_HAsciiString
    ) -> None: ...
    @overload
    ...
    @overload
    def Complies(
        self, mess: TCollection_HAsciiString, incl: int, status: Interface_CheckStatus
    ) -> bool: ...
    def Entity(self) -> Standard_Transient: ...
    def Fail(
        self, num: int, final: Optional[bool] = True
    ) -> TCollection_HAsciiString: ...
    def Fails(
        self, final: Optional[bool] = True
    ...
    def Print(self, level: int, final: Optional[int] = 1) -> str: ...
    def Remove(
        self, mess: TCollection_HAsciiString, incl: int, status: Interface_CheckStatus
    ) -> bool: ...
...
class Interface_CheckIterator:
    ...
    def Checkeds(
        self, failsonly: bool, global_: bool
    ...
    @overload
    def Extract(
        self, mess: str, incl: int, status: Interface_CheckStatus
    ...
    def Number(self) -> int: ...
    @overload
    def Print(self, failsonly: bool, final: Optional[int] = 0) -> str: ...
    @overload
    def Print(
        self, model: Interface_InterfaceModel, failsonly: bool, final: Optional[int] = 0
    ) -> str: ...
...
class Interface_CheckTool:
    @overload
    def __init__(
        self, model: Interface_InterfaceModel, protocol: Interface_Protocol
    ) -> None: ...
    @overload
    ...
    def FillCheck(
        self, ent: Standard_Transient, sh: Interface_ShareTool, ach: Interface_Check
    ) -> None: ...
    @overload
    def Print(self, ach: Interface_Check) -> str: ...
    @overload
...
class Interface_CopyTool:
    @overload
    def __init__(
        self, amodel: Interface_InterfaceModel, lib: Interface_GeneralLib
    ) -> None: ...
    @overload
    def __init__(
        self, amodel: Interface_InterfaceModel, protocol: Interface_Protocol
    ) -> None: ...
    @overload
    ...
    def CompleteResult(
        self, withreports: Optional[bool] = False
    ...
    def LastCopiedAfter(
        self, numfrom: int, ent: Standard_Transient, res: Standard_Transient
    ) -> int: ...
    def Model(self) -> Interface_InterfaceModel: ...
...
class Interface_EntityCluster(Standard_Transient):
    ...
    @overload
    def __init__(
        self, ant: Standard_Transient, ec: Interface_EntityCluster
    ) -> None: ...
...
class Interface_EntityList:
    ...
    def SetValue(self, num: int, ent: Standard_Transient) -> None: ...
    def TypedEntity(
        self, atype: Standard_Type, num: Optional[int] = 0
    ) -> Standard_Transient: ...
    def Value(self, num: int) -> Standard_Transient: ...
...
class Interface_FileReaderData(Standard_Transient):
    @overload
    def AddParam(
        self, num: int, aval: str, atype: Interface_ParamType, nument: Optional[int] = 0
    ) -> None: ...
    @overload
    def AddParam(
        self, num: int, aval: str, atype: Interface_ParamType, nument: Optional[int] = 0
...
class Interface_FileReaderTool:
    def AnalyseRecord(
        self, num: int, anent: Standard_Transient, acheck: Interface_Check
    ) -> bool: ...
    ...
    def Recognize(
        self, num: int, ach: Interface_Check, ent: Standard_Transient
    ) -> bool: ...
    def RecognizeByLib(
        self,
        num: int,
    ...
    def SetData(
        self, reader: Interface_FileReaderData, protocol: Interface_Protocol
    ) -> None: ...
...
class Interface_GTool(Standard_Transient):
    ...
    def SetProtocol(
        self, proto: Interface_Protocol, enforce: Optional[bool] = False
    ) -> None: ...
...
class Interface_GeneralLib:
    ...
    def Protocol(self) -> Interface_Protocol: ...
    def Select(
        self, obj: Standard_Transient, module: Interface_GeneralModule
    ) -> Tuple[bool, int]: ...
    def SetComplete(self) -> None: ...
    @staticmethod
    def SetGlobal(
        amodule: Interface_GeneralModule, aprotocol: Interface_Protocol
    ) -> None: ...
    def Start(self) -> None: ...
...
class Interface_GeneralModule(Standard_Transient):
    ...
    def Share(
        self, iter: Interface_EntityIterator, shared: Standard_Transient
    ) -> None: ...
    def WhenDeleteCase(
        self, CN: int, ent: Standard_Transient, dispatched: bool
    ) -> None: ...

class Interface_GlobalNodeOfGeneralLib(Standard_Transient):
    def __init__(self) -> None: ...
    def Add(
        self, amodule: Interface_GeneralModule, aprotocol: Interface_Protocol
    ) -> None: ...
    def Module(self) -> Interface_GeneralModule: ...
...
class Interface_GlobalNodeOfReaderLib(Standard_Transient):
    def __init__(self) -> None: ...
    def Add(
        self, amodule: Interface_ReaderModule, aprotocol: Interface_Protocol
    ) -> None: ...
...
class Interface_Graph:
    ...
    def __init__(
        ...
        theModeStats: Optional[bool] = True,
    ) -> None: ...
    @overload
    def __init__(
        self,
    ...
    @overload
    def __init__(
        self, amodel: Interface_InterfaceModel, theModeStats: Optional[bool] = True
    ) -> None: ...
    @overload
    def __init__(
        self, agraph: Interface_Graph, copied: Optional[bool] = False
    ) -> None: ...
    ...
    @overload
    def GetFromEntity(
        self, ent: Standard_Transient, shared: bool, newstat: Optional[int] = 0
    ) -> None: ...
    @overload
    def GetFromEntity(
        self,
    ...
    def TypedSharings(
        self, ent: Standard_Transient, type: Standard_Type
    ) -> Interface_EntityIterator: ...
...
class Interface_IntList:
    ...
    def Internals(
        self, ents: TColStd_HArray1OfInteger, refs: TColStd_HArray1OfInteger
    ) -> int: ...
    def IsRedefined(self, num: Optional[int] = 0) -> bool: ...
    def Length(self) -> int: ...
    def List(
        self, number: int, copied: Optional[bool] = False
    ) -> Interface_IntList: ...
    def NbEntities(self) -> int: ...
    def Number(self) -> int: ...
    def Remove(self, num: int) -> bool: ...
...
class Interface_InterfaceModel(Standard_Transient):
    ...
    def AddReportEntity(
        self, rep: Interface_ReportEntity, semantic: Optional[bool] = False
    ) -> bool: ...
    @overload
    def AddWithRefs(
        self,
    ...
    def ChangeOrder(
        self, oldnum: int, newnum: int, count: Optional[int] = 1
    ) -> None: ...
    ...
    def FillSemanticChecks(
        self, checks: Interface_CheckIterator, clear: Optional[bool] = True
    ) -> None: ...
    ...
    def NextNumberForLabel(
        self, label: str, lastnum: Optional[int] = 0, exact: Optional[bool] = True
    ) -> int: ...
    def Number(self, anentity: Standard_Transient) -> int: ...
    def Print(self, ent: Standard_Transient, mode: Optional[int] = 0) -> str: ...
    ...
    def ReportEntity(
        self, num: int, semantic: Optional[bool] = False
    ...
    def Type(
        self, ent: Standard_Transient, num: Optional[int] = 1
    ) -> Standard_Type: ...
    def TypeName(
...
class Interface_MSG:
    ...
    @staticmethod
    def Intervalled(
        val: float, order: Optional[int] = 3, upper: Optional[bool] = False
    ) -> float: ...
    @staticmethod
    ...
    @staticmethod
    def Print(val: str, max: int, just: Optional[int] = -1) -> str: ...
    @staticmethod
    def PrintTrace() -> str: ...
    @overload
    @staticmethod
    ...
    def Value(self) -> str: ...
    @staticmethod
    def Write(rootkey: Optional[str] = "") -> Tuple[int, str]: ...
...
class Interface_ParamSet(Standard_Transient):
    ...
    @overload
    def Append(
        self, val: str, lnval: int, typ: Interface_ParamType, nument: int
    ) -> int: ...
    @overload
...
class Interface_ReaderLib:
    ...
    def Protocol(self) -> Interface_Protocol: ...
    def Select(
        self, obj: Standard_Transient, module: Interface_ReaderModule
    ) -> Tuple[bool, int]: ...
    def SetComplete(self) -> None: ...
    @staticmethod
    def SetGlobal(
        amodule: Interface_ReaderModule, aprotocol: Interface_Protocol
    ) -> None: ...
    def Start(self) -> None: ...
...
class Interface_ReportEntity(Standard_Transient):
    ...
    @overload
    def __init__(
        self, acheck: Interface_Check, concerned: Standard_Transient
    ) -> None: ...
...
class Interface_ShareFlags:
    ...
    @overload
    def __init__(
        self, amodel: Interface_InterfaceModel, gtool: Interface_GTool
    ) -> None: ...
    @overload
    def __init__(
        self, amodel: Interface_InterfaceModel, protocol: Interface_Protocol
...
class Interface_ShareTool:
    ...
    def All(
        self, ent: Standard_Transient, rootlast: Optional[bool] = True
    ) -> Interface_EntityIterator: ...
    def Graph(self) -> Interface_Graph: ...
    def IsShared(self, ent: Standard_Transient) -> bool: ...
    def Model(self) -> Interface_InterfaceModel: ...
    ...
    def Sharings(self, ent: Standard_Transient) -> Interface_EntityIterator: ...
    def TypedSharing(
        self, ent: Standard_Transient, atype: Standard_Type
    ) -> Standard_Transient: ...
...
class Interface_TypedValue(MoniTool_TypedValue):
    def __init__(
        self,
        name: str,
        type: Optional[Interface_ParamType] = Interface_ParamText,
        init: Optional[str] = "",
    ) -> None: ...
    @staticmethod
...
class Interface_UndefinedContent(Standard_Transient):
    def __init__(self) -> None: ...
    def AddEntity(
        self, ptype: Interface_ParamType, ent: Standard_Transient
    ) -> None: ...
    def AddLiteral(
        self, ptype: Interface_ParamType, val: TCollection_HAsciiString
    ) -> None: ...
    def EntityList(self) -> Interface_EntityList: ...
    def GetFromAnother(
        self, other: Interface_UndefinedContent, TC: Interface_CopyTool
    ) -> None: ...
    def IsParamEntity(self, num: int) -> bool: ...
    def NbLiterals(self) -> int: ...
    def NbParams(self) -> int: ...
    def ParamData(
        self, num: int, ent: Standard_Transient
    ) -> Tuple[bool, Interface_ParamType, str]: ...
    ...
    @overload
    def SetEntity(
        self, num: int, ptype: Interface_ParamType, ent: Standard_Transient
    ) -> None: ...
    @overload
    def SetEntity(self, num: int, ent: Standard_Transient) -> None: ...
    def SetLiteral(
        self, num: int, ptype: Interface_ParamType, val: TCollection_HAsciiString
    ) -> None: ...
...
class Interface_Static(Interface_TypedValue):
    ...
    @staticmethod
    def Init(
        family: str, name: str, type: Interface_ParamType, init: Optional[str] = ""
    ) -> bool: ...
    @overload
    @staticmethod
    ...
    @staticmethod
    def Items(
        mode: Optional[int] = 0, criter: Optional[str] = ""
    ) -> TColStd_HSequenceOfHAsciiString: ...
...
class Interface_HArray1OfHAsciiString(
    Interface_Array1OfHAsciiString, Standard_Transient
):
    def __init__(self, theLower: int, theUpper: int) -> None: ...
