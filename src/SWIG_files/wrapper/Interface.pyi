...
Interface_HArray1OfHAsciiString = NewType("Interface_HArray1OfHAsciiString", Any)
# the following typedef cannot be wrapped as is
Interface_HSequenceOfCheck = NewType("Interface_HSequenceOfCheck", Any)
# the following typedef cannot be wrapped as is
...
class Interface_Check(Standard_Transient):
    ...
    def Fails(self, final: Optional[bool] = true) -> False: ...
    ...
    def InfoMsgs(self, final: Optional[bool] = true) -> False: ...
    ...
    def Warnings(self, final: Optional[bool] = true) -> False: ...
...
class Interface_CheckIterator:
    ...
    def Checkeds(self, failsonly: bool, global_: bool) -> False: ...
    def Clear(self) -> None: ...
    def Complies(self, status: Interface_CheckStatus) -> bool: ...
    ...
    @overload
    def Print(self, model: Interface_InterfaceModel, failsonly: bool, final: Optional[int] = 0) -> str: ...
...
class Interface_Graph:
    ...
    def GetShareds(self, ent: Standard_Transient) -> False: ...
    def GetSharings(self, ent: Standard_Transient) -> False: ...
...
class Interface_MSG:
    ...
    def Destroy(self) -> None: ...
    @staticmethod
    def Intervalled(val: float, order: Optional[int] = 3, upper: Optional[bool] = false) -> False: ...
    @staticmethod
...
class Interface_Static(Interface_TypedValue):
    ...
    @staticmethod
    def Items(mode: Optional[int] = 0, criter: Optional[str] = "") -> False: ...
    def PrintStatic(self) -> str: ...
    @staticmethod
    def RVal(name: str) -> False: ...
    @staticmethod
