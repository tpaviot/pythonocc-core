...
class StepAP203_Array1OfApprovedItem:
    ...
    def __iter__(self) -> typing.Iterator[StepAP203_ApprovedItem]: ...
...
class StepAP203_Array1OfCertifiedItem:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepAP203_CertifiedItem]: ...
...
class StepAP203_Array1OfChangeRequestItem:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepAP203_ChangeRequestItem]: ...
...
class StepAP203_Array1OfClassifiedItem:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepAP203_ClassifiedItem]: ...
...
class StepAP203_Array1OfContractedItem:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepAP203_ContractedItem]: ...
...
class StepAP203_Array1OfDateTimeItem:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepAP203_DateTimeItem]: ...
...
class StepAP203_Array1OfPersonOrganizationItem:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepAP203_PersonOrganizationItem]: ...
...
class StepAP203_Array1OfSpecifiedItem:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepAP203_SpecifiedItem]: ...
...
class StepAP203_Array1OfStartRequestItem:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepAP203_StartRequestItem]: ...
...
class StepAP203_Array1OfWorkItem:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepAP203_WorkItem]: ...
...
class StepAP203_CcDesignApproval(StepBasic_ApprovalAssignment):
    def __init__(self) -> None: ...
    def Init(self, aApprovalAssignment_AssignedApproval: StepBasic_Approval, aItems: Any) -> None: ...
    def Items(self) -> Any: ...
    def SetItems(self, Items: Any) -> None: ...

class StepAP203_CcDesignCertification(StepBasic_CertificationAssignment):
    def __init__(self) -> None: ...
    def Init(self, aCertificationAssignment_AssignedCertification: StepBasic_Certification, aItems: Any) -> None: ...
    def Items(self) -> Any: ...
    def SetItems(self, Items: Any) -> None: ...

class StepAP203_CcDesignContract(StepBasic_ContractAssignment):
    def __init__(self) -> None: ...
    def Init(self, aContractAssignment_AssignedContract: StepBasic_Contract, aItems: Any) -> None: ...
    def Items(self) -> Any: ...
    def SetItems(self, Items: Any) -> None: ...

class StepAP203_CcDesignDateAndTimeAssignment(StepBasic_DateAndTimeAssignment):
    def __init__(self) -> None: ...
    def Init(self, aDateAndTimeAssignment_AssignedDateAndTime: StepBasic_DateAndTime, aDateAndTimeAssignment_Role: StepBasic_DateTimeRole, aItems: Any) -> None: ...
    def Items(self) -> Any: ...
    def SetItems(self, Items: Any) -> None: ...

class StepAP203_CcDesignPersonAndOrganizationAssignment(StepBasic_PersonAndOrganizationAssignment):
    def __init__(self) -> None: ...
    def Init(self, aPersonAndOrganizationAssignment_AssignedPersonAndOrganization: StepBasic_PersonAndOrganization, aPersonAndOrganizationAssignment_Role: StepBasic_PersonAndOrganizationRole, aItems: Any) -> None: ...
    def Items(self) -> Any: ...
    def SetItems(self, Items: Any) -> None: ...

class StepAP203_CcDesignSecurityClassification(StepBasic_SecurityClassificationAssignment):
    def __init__(self) -> None: ...
    def Init(self, aSecurityClassificationAssignment_AssignedSecurityClassification: StepBasic_SecurityClassification, aItems: Any) -> None: ...
    def Items(self) -> Any: ...
    def SetItems(self, Items: Any) -> None: ...

class StepAP203_CcDesignSpecificationReference(StepBasic_DocumentReference):
    def __init__(self) -> None: ...
    def Init(self, aDocumentReference_AssignedDocument: StepBasic_Document, aDocumentReference_Source: TCollection_HAsciiString, aItems: Any) -> None: ...
    def Items(self) -> Any: ...
    def SetItems(self, Items: Any) -> None: ...
...
class StepAP203_Change(StepBasic_ActionAssignment):
    def __init__(self) -> None: ...
    def Init(self, aActionAssignment_AssignedAction: StepBasic_Action, aItems: Any) -> None: ...
    def Items(self) -> Any: ...
    def SetItems(self, Items: Any) -> None: ...

class StepAP203_ChangeRequest(StepBasic_ActionRequestAssignment):
    def __init__(self) -> None: ...
    def Init(self, aActionRequestAssignment_AssignedActionRequest: StepBasic_VersionedActionRequest, aItems: Any) -> None: ...
    def Items(self) -> Any: ...
    def SetItems(self, Items: Any) -> None: ...
