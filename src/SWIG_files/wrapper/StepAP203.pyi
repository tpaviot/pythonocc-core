...
class StepAP203_Array1OfChangeRequestItem:
    ...
    def SetValue(
        self, theIndex: int, theValue: StepAP203_ChangeRequestItem
    ) -> None: ...
...
class StepAP203_Array1OfPersonOrganizationItem:
    ...
    def __setitem__(
        self, index: int, value: StepAP203_PersonOrganizationItem
    ) -> None: ...
    def __len__(self) -> int: ...
    ...
    def SetValue(
        self, theIndex: int, theValue: StepAP203_PersonOrganizationItem
    ) -> None: ...
...
class StepAP203_HArray1OfApprovedItem(
    StepAP203_Array1OfApprovedItem, Standard_Transient
):
    def __init__(self, theLower: int, theUpper: int) -> None: ...
