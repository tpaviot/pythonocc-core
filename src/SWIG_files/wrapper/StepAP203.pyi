...
StepAP203_HArray1OfApprovedItem = NewType("StepAP203_HArray1OfApprovedItem", Any)
# the following typedef cannot be wrapped as is
StepAP203_HArray1OfCertifiedItem = NewType("StepAP203_HArray1OfCertifiedItem", Any)
# the following typedef cannot be wrapped as is
StepAP203_HArray1OfChangeRequestItem = NewType("StepAP203_HArray1OfChangeRequestItem", Any)
# the following typedef cannot be wrapped as is
StepAP203_HArray1OfClassifiedItem = NewType("StepAP203_HArray1OfClassifiedItem", Any)
# the following typedef cannot be wrapped as is
StepAP203_HArray1OfContractedItem = NewType("StepAP203_HArray1OfContractedItem", Any)
# the following typedef cannot be wrapped as is
StepAP203_HArray1OfDateTimeItem = NewType("StepAP203_HArray1OfDateTimeItem", Any)
# the following typedef cannot be wrapped as is
StepAP203_HArray1OfPersonOrganizationItem = NewType("StepAP203_HArray1OfPersonOrganizationItem", Any)
# the following typedef cannot be wrapped as is
StepAP203_HArray1OfSpecifiedItem = NewType("StepAP203_HArray1OfSpecifiedItem", Any)
# the following typedef cannot be wrapped as is
StepAP203_HArray1OfStartRequestItem = NewType("StepAP203_HArray1OfStartRequestItem", Any)
# the following typedef cannot be wrapped as is
StepAP203_HArray1OfWorkItem = NewType("StepAP203_HArray1OfWorkItem", Any)
