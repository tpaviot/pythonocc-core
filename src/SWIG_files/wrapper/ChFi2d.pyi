...
class chfi2d:
    ...
    @staticmethod
    def FindConnectedEdges(
        F: TopoDS_Face, V: TopoDS_Vertex, E1: TopoDS_Edge, E2: TopoDS_Edge
...
class ChFi2d_AnaFilletAlgo:
    ...
    @overload
    def __init__(
        self, theEdge1: TopoDS_Edge, theEdge2: TopoDS_Edge, thePlane: gp_Pln
    ) -> None: ...
    @overload
