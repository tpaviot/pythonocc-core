...
class Bisector_FunctionInter(math_FunctionWithDerivative):
    ...
    @overload
    def __init__(
        self, C: Geom2d_Curve, Bis1: Bisector_Curve, Bis2: Bisector_Curve
    ) -> None: ...
    def Derivative(self, X: float) -> Tuple[bool, float]: ...
    def Perform(
        self, C: Geom2d_Curve, Bis1: Bisector_Curve, Bis2: Bisector_Curve
...
class Bisector_BisecPC(Bisector_Curve):
    ...
    @overload
    def __init__(
        self, Cu: Geom2d_Curve, P: gp_Pnt2d, Side: float, DistMax: Optional[float] = 500
    ) -> None: ...
    @overload
    def __init__(
        self, Cu: Geom2d_Curve, P: gp_Pnt2d, Side: float, UMin: float, UMax: float
    ) -> None: ...
    def Continuity(self) -> GeomAbs_Shape: ...
    def Copy(self) -> Geom2d_Geometry: ...
    def D0(self, U: float, P: gp_Pnt2d) -> None: ...
