...
class brepfeat:
    ...
    @staticmethod
    def ParametricMinMax(
        S: TopoDS_Shape, C: Geom_Curve, Ori: Optional[bool] = False
    ) -> Tuple[float, float, float, float, bool]: ...
    @staticmethod
    def SampleEdges(S: TopoDS_Shape, Pt: TColgp_SequenceOfPnt) -> None: ...
    @staticmethod
    def Tool(
        SRef: TopoDS_Shape, Fac: TopoDS_Face, Orf: TopAbs_Orientation
    ) -> TopoDS_Solid: ...
...
class BRepFeat_MakeCylindricalHole(BRepFeat_Builder):
    ...
    def Perform(
        ...
        PFrom: float,
        PTo: float,
        WithControl: Optional[bool] = True,
    ) -> None: ...
    def PerformBlind(
        self, Radius: float, Length: float, WithControl: Optional[bool] = True
    ) -> None: ...
    def PerformThruNext(
        self, Radius: float, WithControl: Optional[bool] = True
    ) -> None: ...
    def PerformUntilEnd(
        self, Radius: float, WithControl: Optional[bool] = True
    ) -> None: ...
...
class BRepFeat_MakeLinearForm(BRepFeat_RibSlot):
    ...
    def Propagate(
        self, L: TopTools_ListOfShape, F: TopoDS_Face, FPoint: gp_Pnt, LPoint: gp_Pnt
    ) -> Tuple[bool, bool]: ...
