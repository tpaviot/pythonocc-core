...
") FillSegments;
	...
	:param theSegments:
	:type theSegments: opencascade::handle<Graphic3d_ArrayOfSegments> &
	:param theBox:
	:type theBox: Bnd_OBB &
	:rtype: None
") FillSegments;
...
class StdPrs_ToolPoint {
	...
	:type aPoint: opencascade::handle<Geom_Point> &
	:param X:
	:type X: float &
	:param Y:
	:type Y: float &
...
") StdPrs_ToolRFace;
	...
	:param aSurface:
	:type aSurface: opencascade::handle<BRepAdaptor_HSurface> &
	:rtype: None
") StdPrs_ToolRFace;
...
") ClearOnOwnDeflectionChange;
	...
	:type theFace: TopoDS_Face &
	:param theTris:
	:type theTris: opencascade::handle<Poly_Triangulation> &
	:rtype: None
") ComputeNormals;
...
class StdPrs_WFDeflectionSurface : public Prs3d_Root {
	...
	:type aPresentation: opencascade::handle<Prs3d_Presentation> &
	:param aSurface:
	:type aSurface: opencascade::handle<Adaptor3d_HSurface> &
	:param aDrawer:
	:type aDrawer: opencascade::handle<Prs3d_Drawer> &
	:rtype: void
") Add;
...
class StdPrs_WFRestrictedFace : public Prs3d_Root {
	...
	:type thePresentation: opencascade::handle<Prs3d_Presentation> &
	:param theFace:
	:type theFace: opencascade::handle<BRepAdaptor_HSurface> &
	:param theDrawUIso:
