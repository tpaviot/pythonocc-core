...
/* handles */
%wrap_handle(DEBRepCascade_ConfigurationNode)
%wrap_handle(DEBRepCascade_Provider)
...
/****************************************
* class DEBRepCascade_ConfigurationNode *
****************************************/
...
%make_alias(DEBRepCascade_ConfigurationNode)

%extend DEBRepCascade_ConfigurationNode {
	%pythoncode {
...
%make_alias(DEBRepCascade_Provider)

%extend DEBRepCascade_Provider {
	%pythoncode {
	__repr__ = _dumps_object
	}
};
