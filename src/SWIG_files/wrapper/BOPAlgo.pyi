...
BOPAlgo_ListIteratorOfListOfCheckResult = NewType(
    "BOPAlgo_ListIteratorOfListOfCheckResult", Any
)
BOPAlgo_PArgumentAnalyzer = NewType(
    "BOPAlgo_PArgumentAnalyzer", BOPAlgo_ArgumentAnalyzer
)
...
class BOPAlgo_ListOfCheckResult:
    ...
    def Assign(
        self, theItem: BOPAlgo_ListOfCheckResult
    ...
    def __iter__(self) -> BOPAlgo_CheckResult: ...
...
class BOPAlgo_SectionAttribute:
    ...
    @overload
    def __init__(
        self, theAproximation: bool, thePCurveOnS1: bool, thePCurveOnS2: bool
    ) -> None: ...
    @overload
...
class BOPAlgo_Tools:
    ...
    def ClassifyFaces(
        ...
        theShapeBoxMap: Optional[
            TopTools_DataMapOfShapeBox
        ] = TopTools_DataMapOfShapeBox(),
        theSolidsIF: Optional[
            TopTools_DataMapOfShapeListOfShape
        ] = TopTools_DataMapOfShapeListOfShape(),
        theRange: Optional[Message_ProgressRange] = Message_ProgressRange(),
    ) -> None: ...
    @staticmethod
    def ComputeToleranceOfCB(
        theCB: BOPDS_CommonBlock, theDS: BOPDS_PDS, theContext: IntTools_Context
    ) -> float: ...
    @staticmethod
    def EdgesToWires(
        theEdges: TopoDS_Shape,
        theWires: TopoDS_Shape,
        theShared: Optional[bool] = False,
        theAngTol: Optional[float] = 1e-8,
    ) -> int: ...
    @staticmethod
    def FillInternals(
        theSolids: TopTools_ListOfShape,
    ...
    def TrsfToPoint(
        ...
        theBox2: Bnd_Box,
        theTrsf: gp_Trsf,
        thePoint: Optional[gp_Pnt] = gp_Pnt(0.0, 0.0, 0.0),
        theCriteria: Optional[float] = 1e5,
    ) -> bool: ...
    @staticmethod
    def WiresToFaces(
        theWires: TopoDS_Shape,
...
class BOPAlgo_MakePeriodic(BOPAlgo_Options):
    ...
    def MakePeriodic(
        self, theDirectionID: int, theIsPeriodic: bool, thePeriod: Optional[float] = 0.0
    ) -> None: ...
    def MakeXPeriodic(
        self, theIsPeriodic: bool, thePeriod: Optional[float] = 0.0
    ) -> None: ...
    def MakeYPeriodic(
        self, theIsPeriodic: bool, thePeriod: Optional[float] = 0.0
    ) -> None: ...
    ...
    def SetTrimmed(
        self, theDirectionID: int, theIsTrimmed: bool, theFirst: Optional[float] = 0.0
    ) -> None: ...
    def SetXTrimmed(
        self, theIsTrimmed: bool, theFirst: Optional[bool] = 0.0
    ) -> None: ...
    def SetYTrimmed(
        self, theIsTrimmed: bool, theFirst: Optional[bool] = 0.0
    ) -> None: ...
...
class BOPAlgo_WireSplitter(BOPAlgo_Algo):
    ...
    @staticmethod
    def SplitBlock(
        theF: TopoDS_Face, theCB: BOPTools_ConnexityBlock, theContext: IntTools_Context
    ) -> None: ...
...
class BOPAlgo_CellsBuilder(BOPAlgo_Builder):
    ...
    def __init__(self, theAllocator: NCollection_BaseAllocator) -> None: ...
    def AddAllToResult(
        self, theMaterial: Optional[int] = 0, theUpdate: Optional[bool] = False
    ) -> None: ...
    def AddToResult(
        self,
        theLSToTake: TopTools_ListOfShape,
        theLSToAvoid: TopTools_ListOfShape,
        theMaterial: Optional[int] = 0,
        theUpdate: Optional[bool] = False,
    ) -> None: ...
    def Clear(self) -> None: ...
    ...
    def RemoveFromResult(
        self, theLSToTake: TopTools_ListOfShape, theLSToAvoid: TopTools_ListOfShape
    ) -> None: ...
