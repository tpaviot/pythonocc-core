...
class BOPAlgo_ListIteratorOfListOfCheckResult:
...
class BOPAlgo_Tools:
    ...
    @overload
    @staticmethod
    def PerformCommonBlocks(theMBlocks: Any, theAllocator: NCollection_BaseAllocator, theDS: BOPDS_PDS, theContext: Optional[IntTools_Context] = IntTools_Context()) -> None: ...
    @overload
    @staticmethod
    def PerformCommonBlocks(theMBlocks: Any, theAllocator: NCollection_BaseAllocator, pDS: BOPDS_PDS, theContext: Optional[IntTools_Context] = IntTools_Context()) -> None: ...
    @staticmethod
