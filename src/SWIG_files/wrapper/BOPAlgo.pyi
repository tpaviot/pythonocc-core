...
class BOPAlgo_Builder(BOPAlgo_BuilderShape):
    ...
    def Arguments(self) -> TopTools_ListOfShape: ...
    @overload
    def BuildBOP(self, theObjects: TopTools_ListOfShape, theObjState: TopAbs_State, theTools: TopTools_ListOfShape, theToolsState: TopAbs_State, theRange: Message_ProgressRange, theReport: Optional[Message_Report] = nullptr) -> None: ...
    @overload
    def BuildBOP(self, theObjects: TopTools_ListOfShape, theTools: TopTools_ListOfShape, theOperation: BOPAlgo_Operation, theRange: Message_ProgressRange, theReport: Optional[Message_Report] = nullptr) -> None: ...
