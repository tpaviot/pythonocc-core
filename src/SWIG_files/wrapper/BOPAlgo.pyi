...
class BOPAlgo_CheckResult:
    ...
    def GetFaultyShapes1(self) -> False: ...
    def GetFaultyShapes2(self) -> False: ...
...
class BOPAlgo_MakeConnected(BOPAlgo_Options):
    ...
    def GetModified(self, theS: TopoDS_Shape) -> False: ...
    def GetOrigins(self, theS: TopoDS_Shape) -> False: ...
    def History(self) -> BRepTools_History: ...
    def MaterialsOnNegativeSide(self, theS: TopoDS_Shape) -> False: ...
    def MaterialsOnPositiveSide(self, theS: TopoDS_Shape) -> False: ...
...
class BOPAlgo_MakePeriodic(BOPAlgo_Options):
    ...
    def Clear(self) -> None: ...
    def ClearRepetitions(self) -> None: ...
    def GetTwins(self, theS: TopoDS_Shape) -> False: ...
    def History(self) -> BRepTools_History: ...
...
class BOPAlgo_Builder(BOPAlgo_BuilderShape):
    ...
    def Context(self) -> IntTools_Context: ...
    def Glue(self) -> BOPAlgo_GlueEnum: ...
    def Images(self) -> False: ...
    def NonDestructive(self) -> bool: ...
    def Origins(self) -> False: ...
    def PDS(self) -> BOPDS_PDS: ...
