...
"This package defines the intersection between two elements of the geometric processor :

Line, Circle, Ellipse, Parabola andHyperbola;

 One of these elements is known with his real type,the other one is known by an implicit quadratic equation (see class Conic).
 A particular case has been made for the intersection between two Lin2d, two Circ2d, a Lin2d and a Circ2d."
%enddef
