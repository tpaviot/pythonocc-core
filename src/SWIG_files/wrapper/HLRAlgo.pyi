...
class HLRAlgo_InterferenceList:
    ...
    def Assign(self, theItem: HLRAlgo_InterferenceList) -> HLRAlgo_InterferenceList: ...
    def Clear(self) -> None: ...
    ...
    def __init__(self) -> None: ...
    def __len__(self) -> int: ...
    def __iter__(self) -> HLRAlgo_Interference: ...

class HLRAlgo_ListOfBPoint:
    def Append(self, theItem: HLRAlgo_BiPoint) -> HLRAlgo_BiPoint: ...
    def Assign(self, theItem: HLRAlgo_ListOfBPoint) -> HLRAlgo_ListOfBPoint: ...
    def Clear(self) -> None: ...
    ...
    def __init__(self) -> None: ...
    def __len__(self) -> int: ...
    def __iter__(self) -> HLRAlgo_BiPoint: ...
