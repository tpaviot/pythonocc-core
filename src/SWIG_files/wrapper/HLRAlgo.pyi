...
HLRAlgo_HArray1OfPHDat = NewType("HLRAlgo_HArray1OfPHDat", Any)
# the following typedef cannot be wrapped as is
HLRAlgo_HArray1OfPINod = NewType("HLRAlgo_HArray1OfPINod", Any)
# the following typedef cannot be wrapped as is
HLRAlgo_HArray1OfPISeg = NewType("HLRAlgo_HArray1OfPISeg", Any)
# the following typedef cannot be wrapped as is
HLRAlgo_HArray1OfTData = NewType("HLRAlgo_HArray1OfTData", Any)
...
class HLRAlgo_PolyData(Standard_Transient):
    ...
    def PHDat(self) -> False: ...
    def TData(self) -> False: ...
...
class HLRAlgo_PolyInternalData(Standard_Transient):
    ...
    def PINod(self) -> False: ...
    def PISeg(self) -> False: ...
    @overload
