...
class StepAP209_Construct(STEPConstruct_Tool):
    ...
    def GetCurElemSection(self, ElemRepr: StepFEA_Curve3dElementRepresentation) -> Any: ...
    def GetElemGeomRelat(self) -> Any: ...
    def GetElementMaterial(self) -> Any: ...
    def GetElements1D(self, theFeaModel: StepFEA_FeaModel) -> Any: ...
    def GetElements2D(self, theFEAModel: StepFEA_FeaModel) -> Any: ...
    def GetElements3D(self, theFEAModel: StepFEA_FeaModel) -> Any: ...
