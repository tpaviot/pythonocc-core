...
class StepAP209_Construct(STEPConstruct_Tool):
    ...
    def GetCurElemSection(self, ElemRepr: StepFEA_Curve3dElementRepresentation) -> False: ...
    def GetElemGeomRelat(self) -> False: ...
    def GetElementMaterial(self) -> False: ...
    def GetElements1D(self, theFeaModel: StepFEA_FeaModel) -> False: ...
    def GetElements2D(self, theFEAModel: StepFEA_FeaModel) -> False: ...
    def GetElements3D(self, theFEAModel: StepFEA_FeaModel) -> False: ...
