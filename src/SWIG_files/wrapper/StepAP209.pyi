...
class StepAP209_Construct(STEPConstruct_Tool):
    ...
    def CreateAdding203Entities(
        self, PD: StepBasic_ProductDefinition, aModel: StepData_StepModel
    ) -> bool: ...
    ...
    @overload
    def FeaModel(
        self, PDF: StepBasic_ProductDefinitionFormation
    ) -> StepFEA_FeaModel: ...
    @overload
    ...
    def GetCurElemSection(
        self, ElemRepr: StepFEA_Curve3dElementRepresentation
    ...
    def GetElements1D(
        self, theFeaModel: StepFEA_FeaModel
    ...
    def GetShReprForElem(
        self, ElemRepr: StepFEA_ElementRepresentation
    ...
    @overload
    def IdealShape(
        self, PD: StepBasic_ProductDefinition
    ) -> StepShape_ShapeRepresentation: ...
    @overload
    def IdealShape(
        self, PDS: StepRepr_ProductDefinitionShape
    ) -> StepShape_ShapeRepresentation: ...
