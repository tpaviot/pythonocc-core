...
class Select3D_SensitiveFace(Select3D_SensitiveEntity):
    ...
    def GetConnected(self) -> Select3D_SensitiveEntity: ...
    @overload
    def GetPoints(self) -> TColgp_HArray1OfPnt: ...
    @overload
...
class Select3D_SensitiveGroup(Select3D_SensitiveSet):
    ...
    @overload
    def __init__(self, theOwnerId: SelectMgr_EntityOwner, theEntities: Any, theIsMustMatchAll: Optional[bool] = True) -> None: ...
    @overload
    def Add(self, theEntities: Any) -> None: ...
    @overload
...
class Select3D_SensitivePoly(Select3D_SensitiveSet):
    ...
    def NbSubElements(self) -> int: ...
    @overload
    def Points3D(self) -> TColgp_HArray1OfPnt: ...
    @overload
    def Points3D(self, aHArrayOfPnt: TColgp_HArray1OfPnt) -> None: ...
    def Size(self) -> int: ...
    def Swap(self, theIdx1: int, theIdx2: int) -> None: ...
...
class Select3D_SensitivePrimitiveArray(Select3D_SensitiveSet):
    ...
    def DumpJson(self, depth: Optional[int]=-1) -> str: ...
    def GetConnected(self) -> Select3D_SensitiveEntity: ...
    def GetVertex(self, theIndex: int) -> Any: ...
