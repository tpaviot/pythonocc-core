...
SelectBasics_SensitiveEntity = NewType(
...
class Select3D_SensitiveCylinder(Select3D_SensitiveEntity):
    def __init__(
        ...
        theHeight: float,
        theTrsf: gp_Trsf,
        theIsHollow: Optional[bool] = False,
    ) -> None: ...
...
class Select3D_SensitiveSegment(Select3D_SensitiveEntity):
    def __init__(
        self, theOwnerId: SelectMgr_EntityOwner, theFirstPnt: gp_Pnt, theLastPnt: gp_Pnt
    ) -> None: ...
    def BoundingBox(self) -> Select3D_BndBox3d: ...
    def CenterOfGeometry(self) -> gp_Pnt: ...
    def DumpJson(self, depth: Optional[int] = -1) -> str: ...
...
class Select3D_SensitiveSphere(Select3D_SensitiveEntity):
    def __init__(
        self, theOwnerId: SelectMgr_EntityOwner, theCenter: gp_Pnt, theRadius: float
    ) -> None: ...
    def BoundingBox(self) -> Select3D_BndBox3d: ...
    def CenterOfGeometry(self) -> gp_Pnt: ...
    def GetConnected(self) -> Select3D_SensitiveEntity: ...
...
class Select3D_SensitiveTriangle(Select3D_SensitiveEntity):
    def __init__(
        ...
        thePnt1: gp_Pnt,
        thePnt2: gp_Pnt,
        theType: Optional[Select3D_TypeOfSensitivity] = Select3D_TOS_INTERIOR,
    ) -> None: ...
    def BoundingBox(self) -> Select3D_BndBox3d: ...
...
class Select3D_InteriorSensitivePointSet(Select3D_SensitiveSet):
    def __init__(
        self, theOwnerId: SelectMgr_EntityOwner, thePoints: TColgp_Array1OfPnt
    ) -> None: ...
    def BoundingBox(self) -> Select3D_BndBox3d: ...
...
class Select3D_SensitiveGroup(Select3D_SensitiveSet):
    ...
    def __init__(
        self,
        theOwnerId: SelectMgr_EntityOwner,
        theIsMustMatchAll: Optional[bool] = True,
    ) -> None: ...
    @overload
    def __init__(
        self,
...
class Select3D_SensitivePoly(Select3D_SensitiveSet):
    ...
    def __init__(
        ...
        theU1: float,
        theU2: float,
        theIsFilled: Optional[bool] = False,
        theNbPnts: Optional[int] = 12,
    ) -> None: ...
    @overload
    def __init__(
        self,
...
class Select3D_SensitiveCurve(Select3D_SensitivePoly):
    ...
    def __init__(
        ...
        theOwnerId: SelectMgr_EntityOwner,
        theCurve: Geom_Curve,
        theNbPnts: Optional[int] = 17,
    ) -> None: ...
    @overload
    def __init__(
        self, theOwnerId: SelectMgr_EntityOwner, thePoints: TColgp_HArray1OfPnt
    ) -> None: ...
    @overload
    def __init__(
        self, theOwnerId: SelectMgr_EntityOwner, thePoints: TColgp_Array1OfPnt
