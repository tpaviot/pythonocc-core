...
class AppParCurves_Array1OfConstraintCouple:
    ...
    def SetValue(
        self, theIndex: int, theValue: AppParCurves_ConstraintCouple
    ) -> None: ...
...
class AppParCurves_SequenceOfMultiBSpCurve:
    def Assign(
        self, theItem: AppParCurves_MultiBSpCurve
...
class AppParCurves_SequenceOfMultiCurve:
    def Assign(self, theItem: AppParCurves_MultiCurve) -> AppParCurves_MultiCurve: ...
    def Clear(self) -> None: ...
    def First(self) -> AppParCurves_MultiCurve: ...
    def IsDeletables(self) -> bool: ...
    def IsEmpty(self) -> bool: ...
...
class appparcurves:
    @staticmethod
    def Bernstein(
        NbPoles: int, U: math_Vector, A: math_Matrix, DA: math_Matrix
    ) -> None: ...
    @staticmethod
...
class AppParCurves_MultiCurve:
    ...
    @overload
    def D2(
        self, CuIndex: int, U: float, Pt: gp_Pnt, V1: gp_Vec, V2: gp_Vec
    ) -> None: ...
    @overload
    def D2(
        self, CuIndex: int, U: float, Pt: gp_Pnt2d, V1: gp_Vec2d, V2: gp_Vec2d
    ) -> None: ...
    def Degree(self) -> int: ...
    ...
    def Transform2d(
        self, CuIndex: int, x: float, dx: float, y: float, dy: float
    ) -> None: ...
    @overload
