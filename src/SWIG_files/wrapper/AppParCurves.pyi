...
class AppParCurves_Array1OfConstraintCouple:
    ...
    def __iter__(self) -> typing.Iterator[AppParCurves_ConstraintCouple]: ...
...
class AppParCurves_Array1OfMultiBSpCurve:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[AppParCurves_MultiBSpCurve]: ...
...
class AppParCurves_Array1OfMultiCurve:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[AppParCurves_MultiCurve]: ...
...
class AppParCurves_Array1OfMultiPoint:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[AppParCurves_MultiPoint]: ...
...
class AppParCurves_MultiCurve:
    ...
    @overload
    def __init__(self, tabMU: Any) -> None: ...
    @overload
...
class AppParCurves_MultiBSpCurve(AppParCurves_MultiCurve):
    ...
    def __init__(self, NbPol: int) -> None: ...
    @overload
    def __init__(self, tabMU: Any, Knots: TColStd_Array1OfReal, Mults: TColStd_Array1OfInteger) -> None: ...
    @overload
