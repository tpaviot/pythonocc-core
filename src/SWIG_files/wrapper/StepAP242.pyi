...
class StepAP242_IdAttribute(Standard_Transient):
    ...
    def SetAttributeValue(
        self, theAttributeValue: TCollection_HAsciiString
    ) -> None: ...
    def SetIdentifiedItem(
        self, theIdentifiedItem: StepAP242_IdAttributeSelect
    ) -> None: ...
...
class StepAP242_ItemIdentifiedRepresentationUsage(Standard_Transient):
    ...
    def SetDefinition(
        self, theDefinition: StepAP242_ItemIdentifiedRepresentationUsageDefinition
    ) -> None: ...
    def SetDescription(self, theDescription: TCollection_HAsciiString) -> None: ...
    def SetIdentifiedItem(
        self, theIdentifiedItem: StepRepr_HArray1OfRepresentationItem
    ) -> None: ...
    def SetIdentifiedItemValue(
        self, num: int, theItem: StepRepr_RepresentationItem
    ) -> None: ...
    def SetName(self, theName: TCollection_HAsciiString) -> None: ...
    def SetUsedRepresentation(
        self, theUsedRepresentation: StepRepr_Representation
    ) -> None: ...
