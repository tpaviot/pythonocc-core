...
class StepAP242_ItemIdentifiedRepresentationUsage(Standard_Transient):
    ...
    def IdentifiedItem(self) -> Any: ...
    def IdentifiedItemValue(self, num: int) -> StepRepr_RepresentationItem: ...
    def Init(self, theName: TCollection_HAsciiString, theDescription: TCollection_HAsciiString, theDefinition: StepAP242_ItemIdentifiedRepresentationUsageDefinition, theUsedRepresentation: StepRepr_Representation, theIdentifiedItem: Any) -> None: ...
    ...
    def SetIdentifiedItem(self, theIdentifiedItem: Any) -> None: ...
