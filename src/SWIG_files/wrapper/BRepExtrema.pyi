...
class BRepExtrema_SeqOfSolution:
    ...
    def Prepend(
        self, theItem: BRepExtrema_SolutionElem
...
class BRepExtrema_DistanceSS:
    def __init__(
        ...
        theBox2: Bnd_Box,
        theDstRef: float,
        theDeflection: Optional[float] = Precision.Confusion(),
        theExtFlag: Optional[Extrema_ExtFlag] = Extrema_ExtFlag_MINMAX,
        theExtAlgo: Optional[Extrema_ExtAlgo] = Extrema_ExtAlgo_Grad,
    ) -> None: ...
...
class BRepExtrema_ExtPF:
    ...
    def __init__(
        ...
        TheFace: TopoDS_Face,
        TheFlag: Optional[Extrema_ExtFlag] = Extrema_ExtFlag_MINMAX,
        TheAlgo: Optional[Extrema_ExtAlgo] = Extrema_ExtAlgo_Grad,
    ) -> None: ...
    def Initialize(
        self,
        TheFace: TopoDS_Face,
...
class BRepExtrema_Poly:
    @staticmethod
    def Distance(
        S1: TopoDS_Shape, S2: TopoDS_Shape, P1: gp_Pnt, P2: gp_Pnt
    ) -> Tuple[bool, float]: ...
...
class BRepExtrema_ProximityDistTool:
    ...
    def LoadShapeLists(
        self, theShapeList1: BRepExtrema_ShapeList, theShapeList2: BRepExtrema_ShapeList
    ) -> None: ...
    def LoadTriangleSets(
        self, theSet1: BRepExtrema_TriangleSet, theSet2: BRepExtrema_TriangleSet
    ) -> None: ...
    def Perform(self) -> None: ...
    def ProximityDistance(self) -> float: ...
    def ProximityPoints(self, thePoint1: BVH_Vec3d, thePoint2: BVH_Vec3d) -> None: ...
    def RejectNode(
        self, theCornerMin: BVH_Vec3d, theCornerMax: BVH_Vec3d
    ) -> Tuple[bool, float]: ...

class BRepExtrema_ShapeProximity:
    @overload
    def __init__(
        self, theTolerance: Optional[float] = Precision.Infinite()
    ) -> None: ...
    @overload
    def __init__(
        self,
        ...
        theTolerance: Optional[float] = Precision.Infinite(),
    ) -> None: ...
...
class BRepExtrema_SelfIntersection(BRepExtrema_ElementFilter):
    ...
    @overload
    def __init__(
        self, theShape: TopoDS_Shape, theTolerance: Optional[float] = 0.0
    ) -> None: ...
