...
BRepExtrema_CellFilter = NewType('BRepExtrema_CellFilter', Any)
#the following typedef cannot be wrapped as is
BRepExtrema_ShapeList = NewType('BRepExtrema_ShapeList', Any)
#the following typedef cannot be wrapped as is
ProxPnt_Status = NewType('ProxPnt_Status', Any)
#the following typedef cannot be wrapped as is
...
class BRepExtrema_VertexInspector(NCollection_CellFilter_InspectorXYZ):
    def __init__(self) -> None: ...
