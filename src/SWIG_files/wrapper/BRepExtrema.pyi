...
class BRepExtrema_DistanceSS:
    def __init__(self, theS1: TopoDS_Shape, theS2: TopoDS_Shape, theBox1: Bnd_Box, theBox2: Bnd_Box, theDstRef: float, theDeflection: Optional[float] = precision_Confusion(), theExtFlag: Optional[Extrema_ExtFlag] = Extrema_ExtFlag_MINMAX, theExtAlgo: Optional[Extrema_ExtAlgo] = Extrema_ExtAlgo_Grad) -> None: ...
...
class BRepExtrema_ShapeProximity:
    ...
    @overload
    def __init__(self, theShape1: TopoDS_Shape, theShape2: TopoDS_Shape, theTolerance: Optional[float] = precision_Infinite()) -> None: ...
