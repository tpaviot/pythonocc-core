...
class math_IntegerVector:
    ...
    def GetValue(self, theIndex: int) -> int: ...
...
class math_Array1OfValueAndWeight:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[math_ValueAndWeight]: ...
...
class math_DoubleTab:
    ...
    @overload
    def Value(self, theRowIndex: int, theColIndex: int) -> Any: ...

class math_EigenValuesSearcher:
    def __init__(self, theDiagonal: TColStd_Array1OfReal, theSubdiagonal: TColStd_Array1OfReal) -> None: ...
...
class math_NewtonMinimum:
    def __init__(self, theFunction: math_MultipleVarFunctionWithHessian, theTolerance: Optional[float] = ..., theNbIterations: Optional[int] = 40, theConvexity: Optional[float] = 1.0e-6, theWithSingularity: Optional[bool] = True) -> None: ...
    def Dump(self) -> str: ...
...
class math_PSOParticlesPool:
    ...
    def GetBestParticle(self) -> Any: ...
    def GetParticle(self, theIdx: int) -> Any: ...
    def GetWorstParticle(self) -> Any: ...
