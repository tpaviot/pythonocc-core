...
class math:
    ...
    @staticmethod
    def KronrodPointsAndWeights(
        Index: int, Points: math_Vector, Weights: math_Vector
    ) -> bool: ...
    @staticmethod
    def KronrodPointsMax() -> int: ...
    @staticmethod
    def OrderedGaussPointsAndWeights(
        Index: int, Points: math_Vector, Weights: math_Vector
    ) -> bool: ...
...
class math_BFGS:
    def __init__(
        self,
        NbVariables: int,
        Tolerance: Optional[float] = 1.0e-8,
        NbIterations: Optional[int] = 200,
        ZEPS: Optional[float] = 1.0e-12,
    ) -> None: ...
    @overload
    ...
    def Perform(
        self, F: math_MultipleVarFunctionWithGradient, StartingPoint: math_Vector
    ) -> None: ...
    def SetBoundary(
        self, theLeftBorder: math_Vector, theRightBorder: math_Vector
    ) -> None: ...
...
class math_BracketMinimum:
    ...
    @overload
    def __init__(
        self, F: math_Function, A: float, B: float, FA: float, FB: float
    ) -> None: ...
...
class math_DoubleTab:
    @overload
    def __init__(
        self, LowerRow: int, UpperRow: int, LowerCol: int, UpperCol: int
    ) -> None: ...
    @overload
    def __init__(
        self, Tab: None, LowerRow: int, UpperRow: int, LowerCol: int, UpperCol: int
    ) -> None: ...
    @overload
...
class math_EigenValuesSearcher:
    def __init__(
        self, Diagonal: TColStd_Array1OfReal, Subdiagonal: TColStd_Array1OfReal
    ) -> None: ...
...
class math_FRPR:
    def __init__(
        ...
        theTolerance: float,
        theNbIterations: Optional[int] = 200,
        theZEPS: Optional[float] = 1.0e-12,
    ) -> None: ...
    @overload
    def Gradient(self) -> math_Vector: ...
    @overload
    ...
    def IsSolutionReached(
        self, theFunction: math_MultipleVarFunctionWithGradient
    ) -> bool: ...
    @overload
    def Location(self) -> math_Vector: ...
    @overload
...
class math_FunctionRoots:
    def __init__(
        ...
        B: float,
        NbSample: int,
        EpsX: Optional[float] = 0.0,
        EpsF: Optional[float] = 0.0,
        EpsNull: Optional[float] = 0.0,
...
class math_FunctionSetRoot:
    ...
    @overload
    def __init__(
        self, F: math_FunctionSetWithDerivatives, NbIterations: Optional[int] = 100
    ) -> None: ...
    @overload
    ...
    def Perform(
        ...
        theStartingPoint: math_Vector,
        theStopOnDivergent: Optional[bool] = False,
    ) -> None: ...
    @overload
    def Perform(
        self,
...
class math_Gauss:
    def __init__(
        self,
        A: math_Matrix,
        MinPivot: Optional[float] = 1.0e-20,
...
class math_GaussSingleIntegration:
    ...
    @overload
    def __init__(
        self, F: math_Function, Lower: float, Upper: float, Order: int
    ) -> None: ...
    @overload
    def __init__(
        self, F: math_Function, Lower: float, Upper: float, Order: int, Tol: float
    ) -> None: ...
    def IsDone(self) -> bool: ...
    def Value(self) -> float: ...
...
class math_GlobOptMin:
    def __init__(
        ...
        theC: Optional[float] = 9,
        theDiscretizationTol: Optional[float] = 1.0e-2,
        theSameTol: Optional[float] = 1.0e-7,
    ) -> None: ...
    ...
    def SetLocalParams(
        self, theLocalA: math_Vector, theLocalB: math_Vector
    ) -> None: ...
...
class math_Householder:
    @overload
    def __init__(
        self, A: math_Matrix, B: math_Matrix, EPS: Optional[float] = 1.0e-20
    ) -> None: ...
    @overload
    def __init__(
        self,
        ...
        lowerAcol: int,
        upperAcol: int,
        EPS: Optional[float] = 1.0e-20,
    ) -> None: ...
    @overload
    def __init__(
        self, A: math_Matrix, B: math_Vector, EPS: Optional[float] = 1.0e-20
    ) -> None: ...
...
class math_IntegerVector:
    ...
    @overload
    def Add(
        self, theLeft: math_IntegerVector, theRight: math_IntegerVector
    ) -> None: ...
...
class math_NewtonFunctionSetRoot:
    ...
    def __init__(
        ...
        theFTolerance: float,
        tehNbIterations: Optional[int] = 100,
    ) -> None: ...
    @overload
    def __init__(
        self,
        theFunction: math_FunctionSetWithDerivatives,
        theFTolerance: float,
        theNbIterations: Optional[int] = 100,
    ) -> None: ...
    @overload
    def Derivative(self) -> math_Matrix: ...
    @overload
...
class math_NewtonMinimum:
    def __init__(
        ...
        theTolerance: Optional[float] = Precision.Confusion(),
...
class math_PSO:
    def __init__(
        ...
        theNbParticles: Optional[int] = 32,
        theNbIter: Optional[int] = 100,
    ) -> None: ...
    @overload
    def Perform(
        self,
...
class math_SVD:
    ...
    def IsDone(self) -> bool: ...
    def PseudoInverse(
        self, Inv: math_Matrix, Eps: Optional[float] = 1.0e-6
    ) -> None: ...
    def Solve(
        self, B: math_Vector, X: math_Vector, Eps: Optional[float] = 1.0e-6
    ) -> None: ...
...
class math_TrigonometricFunctionRoots:
    ...
    @overload
    def __init__(
        self, D: float, E: float, InfBound: float, SupBound: float
    ) -> None: ...
    @overload
    def __init__(
        self, C: float, D: float, E: float, InfBound: float, SupBound: float
    ) -> None: ...
    def InfiniteRoots(self) -> bool: ...
    def IsDone(self) -> bool: ...
    def NbSolutions(self) -> int: ...
...
class math_Uzawa:
    ...
    def __init__(
        ...
        EpsLix: Optional[float] = 1.0e-06,
        EpsLic: Optional[float] = 1.0e-06,
        NbIterations: Optional[int] = 500,
    ) -> None: ...
    @overload
    def __init__(
        self,
...
class math_Vector:
    ...
    @overload
    def __init__(
        self, theLower: int, theUpper: int, theInitialValue: float
    ) -> None: ...
    @overload
