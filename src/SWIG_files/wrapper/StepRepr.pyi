...
class StepRepr_DataEnvironment(Standard_Transient):
    ...
    def SetDescription(self, Description: TCollection_HAsciiString) -> None: ...
    def SetElements(
        self, Elements: StepRepr_HArray1OfPropertyDefinitionRepresentation
    ) -> None: ...
    def SetName(self, Name: TCollection_HAsciiString) -> None: ...
...
class StepRepr_FunctionallyDefinedTransformation(Standard_Transient):
    ...
    def Description(self) -> TCollection_HAsciiString: ...
    def Init(
        self, aName: TCollection_HAsciiString, aDescription: TCollection_HAsciiString
    ) -> None: ...
    def Name(self) -> TCollection_HAsciiString: ...
...
class StepRepr_MaterialDesignation(Standard_Transient):
    ...
    def SetName(self, aName: TCollection_HAsciiString) -> None: ...
    def SetOfDefinition(
        self, aOfDefinition: StepRepr_CharacterizedDefinition
    ) -> None: ...
...
class StepRepr_ProductConcept(Standard_Transient):
    ...
    def SetMarketContext(
        self, MarketContext: StepBasic_ProductConceptContext
    ) -> None: ...
    def SetName(self, Name: TCollection_HAsciiString) -> None: ...
...
class StepRepr_PropertyDefinitionRelationship(Standard_Transient):
    ...
    def SetRelatedPropertyDefinition(
        self, RelatedPropertyDefinition: StepRepr_PropertyDefinition
    ) -> None: ...
    def SetRelatingPropertyDefinition(
        self, RelatingPropertyDefinition: StepRepr_PropertyDefinition
    ) -> None: ...
...
class StepRepr_PropertyDefinitionRepresentation(Standard_Transient):
    ...
    def SetUsedRepresentation(
        self, UsedRepresentation: StepRepr_Representation
    ) -> None: ...
...
class StepRepr_Representation(Standard_Transient):
    ...
    def SetContextOfItems(
        self, aContextOfItems: StepRepr_RepresentationContext
    ) -> None: ...
...
class StepRepr_RepresentationContext(Standard_Transient):
    ...
    def SetContextIdentifier(
        self, aContextIdentifier: TCollection_HAsciiString
    ) -> None: ...
...
class StepRepr_RepresentationContextReference(Standard_Transient):
    ...
    def SetContextIdentifier(
        self, theContextIdentifier: TCollection_HAsciiString
    ) -> None: ...
...
class StepRepr_RepresentationMap(Standard_Transient):
    ...
    def SetMappedRepresentation(
        self, aMappedRepresentation: StepRepr_Representation
    ) -> None: ...
...
class StepRepr_RepresentationReference(Standard_Transient):
    ...
    def SetContextOfItems(
        self, theContextOfItems: StepRepr_RepresentationContextReference
    ) -> None: ...
...
class StepRepr_ShapeAspect(Standard_Transient):
    ...
    def SetProductDefinitional(
        self, aProductDefinitional: StepData_Logical
    ) -> None: ...
...
class StepRepr_ShapeAspectRelationship(Standard_Transient):
    ...
    def SetRelatedShapeAspect(
        self, RelatedShapeAspect: StepRepr_ShapeAspect
    ) -> None: ...
    def SetRelatingShapeAspect(
        self, RelatingShapeAspect: StepRepr_ShapeAspect
    ) -> None: ...
...
class StepRepr_AssemblyComponentUsage(StepRepr_ProductDefinitionUsage):
    ...
    def SetReferenceDesignator(
        self, ReferenceDesignator: TCollection_HAsciiString
    ) -> None: ...
...
class StepRepr_CompoundRepresentationItem(StepRepr_RepresentationItem):
    ...
    def SetItemElement(
        self, item_element: StepRepr_HArray1OfRepresentationItem
    ) -> None: ...
    def SetItemElementValue(
        self, num: int, anelement: StepRepr_RepresentationItem
    ) -> None: ...
...
class StepRepr_MakeFromUsageOption(StepRepr_ProductDefinitionUsage):
    ...
    def SetRankingRationale(
        self, RankingRationale: TCollection_HAsciiString
    ) -> None: ...
...
class StepRepr_MaterialPropertyRepresentation(
    ...
    def SetDependentEnvironment(
        self, DependentEnvironment: StepRepr_DataEnvironment
    ) -> None: ...
...
class StepRepr_ReprItemAndMeasureWithUnit(StepRepr_RepresentationItem):
    ...
    def Init(
        self, aMWU: StepBasic_MeasureWithUnit, aRI: StepRepr_RepresentationItem
    ) -> None: ...
...
class StepRepr_ValueRepresentationItem(StepRepr_RepresentationItem):
    ...
    def SetValueComponentMember(
        self, theValueComponentMember: StepBasic_MeasureValueMember
    ) -> None: ...
...
class StepRepr_ReprItemAndLengthMeasureWithUnit(StepRepr_ReprItemAndMeasureWithUnit):
    ...
    def SetLengthMeasureWithUnit(
        self, aLMWU: StepBasic_LengthMeasureWithUnit
    ) -> None: ...
...
class StepRepr_ReprItemAndPlaneAngleMeasureWithUnit(
    ...
    def SetPlaneAngleMeasureWithUnit(
        self, aLMWU: StepBasic_PlaneAngleMeasureWithUnit
    ) -> None: ...
...
class StepRepr_HSequenceOfMaterialPropertyRepresentation(
    StepRepr_SequenceOfMaterialPropertyRepresentation, Standard_Transient
):
    @overload
    def __init__(self) -> None: ...
    @overload
    def __init__(
        self, other: StepRepr_SequenceOfMaterialPropertyRepresentation
    ) -> None: ...
    def Sequence(self) -> StepRepr_SequenceOfMaterialPropertyRepresentation: ...
    def Append(
        self, theSequence: StepRepr_SequenceOfMaterialPropertyRepresentation
    ) -> None: ...

class StepRepr_HSequenceOfRepresentationItem(
    StepRepr_SequenceOfRepresentationItem, Standard_Transient
):
    @overload
    def __init__(self) -> None: ...
    @overload
