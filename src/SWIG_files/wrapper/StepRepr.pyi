...
class StepRepr_DataEnvironment(Standard_Transient):
    ...
    def Init(self, aName: TCollection_HAsciiString, aDescription: TCollection_HAsciiString, aElements: Any) -> None: ...
    def Name(self) -> TCollection_HAsciiString: ...
    def SetDescription(self, Description: TCollection_HAsciiString) -> None: ...
...
class StepRepr_Representation(Standard_Transient):
    ...
    def Init(self, aName: TCollection_HAsciiString, aItems: Any, aContextOfItems: StepRepr_RepresentationContext) -> None: ...
    def Items(self) -> Any: ...
...
class StepRepr_RepresentationContextReference(Standard_Transient):
    def __init__(self) -> None: ...
    def ContextIdentifier(self) -> TCollection_HAsciiString: ...
    def Init(self, theContextIdentifier: TCollection_HAsciiString) -> None: ...
    def SetContextIdentifier(self, theContextIdentifier: TCollection_HAsciiString) -> None: ...
...
class StepRepr_RepresentationOrRepresentationReference(StepData_SelectType):
    def __init__(self) -> None: ...
    def CaseNum(self, ent: Standard_Transient) -> int: ...
    def Representation(self) -> StepRepr_Representation: ...
    def RepresentationReference(self) -> StepRepr_RepresentationReference: ...

class StepRepr_RepresentationReference(Standard_Transient):
    def __init__(self) -> None: ...
    def ContextOfItems(self) -> StepRepr_RepresentationContextReference: ...
    def Id(self) -> TCollection_HAsciiString: ...
    def Init(self, theId: TCollection_HAsciiString, theContextOfItems: StepRepr_RepresentationContextReference) -> None: ...
    def SetContextOfItems(self, theContextOfItems: StepRepr_RepresentationContextReference) -> None: ...
    def SetId(self, theId: TCollection_HAsciiString) -> None: ...
...
class StepRepr_BooleanRepresentationItem(StepRepr_RepresentationItem):
    def __init__(self) -> None: ...
    def Init(self, theName: TCollection_HAsciiString, theValue: bool) -> None: ...
...
class StepRepr_CharacterizedRepresentation(StepRepr_Representation):
    def __init__(self) -> None: ...
    def Description(self) -> TCollection_HAsciiString: ...
    def Init(self, theName: TCollection_HAsciiString, theDescription: TCollection_HAsciiString, theItems: Any, theContextOfItems: StepRepr_RepresentationContext) -> None: ...
...
class StepRepr_CompoundRepresentationItem(StepRepr_RepresentationItem):
    def __init__(self) -> None: ...
    def Init(self, aName: TCollection_HAsciiString, item_element: Any) -> None: ...
    def ItemElement(self) -> Any: ...
    def ItemElementValue(self, num: int) -> StepRepr_RepresentationItem: ...
    def NbItemElement(self) -> int: ...
    def SetItemElement(self, item_element: Any) -> None: ...
...
class StepRepr_GlobalUncertaintyAssignedContext(StepRepr_RepresentationContext):
    def __init__(self) -> None: ...
    def Init(self, aContextIdentifier: TCollection_HAsciiString, aContextType: TCollection_HAsciiString, aUncertainty: Any) -> None: ...
...
class StepRepr_GlobalUnitAssignedContext(StepRepr_RepresentationContext):
    def __init__(self) -> None: ...
    def Init(self, aContextIdentifier: TCollection_HAsciiString, aContextType: TCollection_HAsciiString, aUnits: Any) -> None: ...
...
class StepRepr_MakeFromUsageOption(StepRepr_ProductDefinitionUsage):
    def __init__(self) -> None: ...
    @overload
    def Init(self, aProductDefinitionRelationship_Id: TCollection_HAsciiString, aProductDefinitionRelationship_Name: TCollection_HAsciiString, hasProductDefinitionRelationship_Description: bool, aProductDefinitionRelationship_Description: TCollection_HAsciiString, aProductDefinitionRelationship_RelatingProductDefinition: StepBasic_ProductDefinition, aProductDefinitionRelationship_RelatedProductDefinition: StepBasic_ProductDefinition, aRanking: int, aRankingRationale: TCollection_HAsciiString, aQuantity: Standard_Transient) -> None: ...
    @overload
    def Init(self, aProductDefinitionRelationship_Id: TCollection_HAsciiString, aProductDefinitionRelationship_Name: TCollection_HAsciiString, hasProductDefinitionRelationship_Description: bool, aProductDefinitionRelationship_Description: TCollection_HAsciiString, aProductDefinitionRelationship_RelatingProductDefinition: StepBasic_ProductDefinitionOrReference, aProductDefinitionRelationship_RelatedProductDefinition: StepBasic_ProductDefinitionOrReference, aRanking: int, aRankingRationale: TCollection_HAsciiString, aQuantity: Standard_Transient) -> None: ...
    def Quantity(self) -> Standard_Transient: ...
    def Ranking(self) -> int: ...
    def RankingRationale(self) -> TCollection_HAsciiString: ...
    def SetQuantity(self, Quantity: Standard_Transient) -> None: ...
...
class StepRepr_RealRepresentationItem(StepRepr_RepresentationItem):
    def __init__(self) -> None: ...
    def Init(self, theName: TCollection_HAsciiString, theValue: float) -> None: ...
...
class StepRepr_ParallelOffset(StepRepr_DerivedShapeAspect):
    def __init__(self) -> None: ...
    def Init(self, theName: TCollection_HAsciiString, theDescription: TCollection_HAsciiString, theOfShape: StepRepr_ProductDefinitionShape, theProductDefinitional: StepData_Logical, theOffset: Standard_Transient) -> None: ...
    def Offset(self) -> Standard_Transient: ...
    def SetOffset(self, theOffset: Standard_Transient) -> None: ...
...
class StepRepr_QuantifiedAssemblyComponentUsage(StepRepr_AssemblyComponentUsage):
    def __init__(self) -> None: ...
    @overload
    def Init(self, aProductDefinitionRelationship_Id: TCollection_HAsciiString, aProductDefinitionRelationship_Name: TCollection_HAsciiString, hasProductDefinitionRelationship_Description: bool, aProductDefinitionRelationship_Description: TCollection_HAsciiString, aProductDefinitionRelationship_RelatingProductDefinition: StepBasic_ProductDefinition, aProductDefinitionRelationship_RelatedProductDefinition: StepBasic_ProductDefinition, hasAssemblyComponentUsage_ReferenceDesignator: bool, aAssemblyComponentUsage_ReferenceDesignator: TCollection_HAsciiString, aQuantity: Standard_Transient) -> None: ...
    @overload
    def Init(self, aProductDefinitionRelationship_Id: TCollection_HAsciiString, aProductDefinitionRelationship_Name: TCollection_HAsciiString, hasProductDefinitionRelationship_Description: bool, aProductDefinitionRelationship_Description: TCollection_HAsciiString, aProductDefinitionRelationship_RelatingProductDefinition: StepBasic_ProductDefinitionOrReference, aProductDefinitionRelationship_RelatedProductDefinition: StepBasic_ProductDefinitionOrReference, hasAssemblyComponentUsage_ReferenceDesignator: bool, aAssemblyComponentUsage_ReferenceDesignator: TCollection_HAsciiString, aQuantity: Standard_Transient) -> None: ...
    def Quantity(self) -> Standard_Transient: ...
    def SetQuantity(self, Quantity: Standard_Transient) -> None: ...
