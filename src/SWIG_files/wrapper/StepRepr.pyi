...
StepRepr_HArray1OfMaterialPropertyRepresentation = NewType("StepRepr_HArray1OfMaterialPropertyRepresentation", Any)
# the following typedef cannot be wrapped as is
StepRepr_HArray1OfPropertyDefinitionRepresentation = NewType("StepRepr_HArray1OfPropertyDefinitionRepresentation", Any)
# the following typedef cannot be wrapped as is
StepRepr_HArray1OfRepresentationItem = NewType("StepRepr_HArray1OfRepresentationItem", Any)
# the following typedef cannot be wrapped as is
StepRepr_HArray1OfShapeAspect = NewType("StepRepr_HArray1OfShapeAspect", Any)
# the following typedef cannot be wrapped as is
StepRepr_HSequenceOfMaterialPropertyRepresentation = NewType("StepRepr_HSequenceOfMaterialPropertyRepresentation", Any)
# the following typedef cannot be wrapped as is
StepRepr_HSequenceOfRepresentationItem = NewType("StepRepr_HSequenceOfRepresentationItem", Any)
