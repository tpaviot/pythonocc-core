...
class StepRepr_ReprItemAndMeasureWithUnitAndQRI(StepRepr_ReprItemAndMeasureWithUnit):
    def __init__(self) -> None: ...
    def GetQualifiedRepresentationItem(self) -> StepShape_QualifiedRepresentationItem: ...
    def Init(self, aMWU: StepBasic_MeasureWithUnit, aRI: StepRepr_RepresentationItem, aQRI: StepShape_QualifiedRepresentationItem) -> None: ...
    def SetQualifiedRepresentationItem(self, aQRI: StepShape_QualifiedRepresentationItem) -> None: ...
