...
class RWMesh_CafReader(Standard_Transient):
    ...
    def Perform(self, theFile: TCollection_AsciiString, theProgress: Message_ProgressRange) -> bool: ...
...
class RWMesh_MaterialMap(Standard_Transient):
    ...
    def CopyTexture(self, theResTexture: TCollection_AsciiString, theTexture: Image_Texture, theKey: TCollection_AsciiString) -> bool: ...
