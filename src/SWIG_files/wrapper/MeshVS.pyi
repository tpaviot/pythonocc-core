...
class MeshVS_PolyhedronVerts:
    ...
    def Assign(self, theItem: MeshVS_PolyhedronVerts) -> MeshVS_PolyhedronVerts: ...
    def Clear(self) -> None: ...
...
class MeshVS_DataSource(Standard_Transient):
    def Get3DGeom(
        self, ID: int, Data: MeshVS_HArray1OfSequenceOfInteger
    ) -> Tuple[bool, int]: ...
    ...
    def GetGeom(
        self, ID: int, IsElement: bool, Coords: TColStd_Array1OfReal
    ) -> Tuple[bool, int, MeshVS_EntityType]: ...
    def GetGeomType(
        self, ID: int, IsElement: bool
    ) -> Tuple[bool, MeshVS_EntityType]: ...
    def GetGroup(
        self, Id: int, Ids: TColStd_PackedMapOfInteger
    ) -> Tuple[bool, MeshVS_EntityType]: ...
    def GetGroupAddr(self, ID: int) -> None: ...
    def GetNodeNormal(
        self, ranknode: int, ElementId: int
    ) -> Tuple[bool, float, float, float]: ...
    def GetNodesByElement(
        self, ID: int, NodeIDs: TColStd_Array1OfInteger
    ) -> Tuple[bool, int]: ...
    def GetNormal(self, Id: int, Max: int) -> Tuple[bool, float, float, float]: ...
    def GetNormalsByElement(
        self, Id: int, IsNodal: bool, MaxNodes: int, Normals: TColStd_HArray1OfReal
    ) -> bool: ...
...
class MeshVS_Mesh(AIS_InteractiveObject):
    ...
    def AddBuilder(
        self, Builder: MeshVS_PrsBuilder, TreatAsHilighter: Optional[bool] = False
    ) -> None: ...
    ...
    def ComputeSelection(
        self, theSel: SelectMgr_Selection, theSelMode: int
    ) -> None: ...
    @overload
...
class MeshVS_MeshEntityOwner(SelectMgr_EntityOwner):
    ...
    def Clear(
        self, PM: PrsMgr_PresentationManager, Mode: Optional[int] = 0
    ) -> None: ...
...
class MeshVS_MeshOwner(SelectMgr_EntityOwner):
    ...
    def AddSelectedEntities(
        self, Nodes: TColStd_HPackedMapOfInteger, Elems: TColStd_HPackedMapOfInteger
    ) -> None: ...
    ...
    def HilightWithColor(
        self, thePM: PrsMgr_PresentationManager, theColor: Prs3d_Drawer, theMode: int
    ) -> None: ...
...
class MeshVS_PrsBuilder(Standard_Transient):
    ...
    def CustomSensitiveEntity(
        self, Owner: SelectMgr_EntityOwner, SelectMode: int
...
class MeshVS_SensitiveFace(Select3D_SensitiveFace):
    def __init__(
        ...
        theSensType: Optional[Select3D_TypeOfSensitivity] = Select3D_TOS_INTERIOR,
    ) -> None: ...

class MeshVS_SensitiveMesh(Select3D_SensitiveEntity):
    def __init__(
        self, theOwner: SelectMgr_EntityOwner, theMode: Optional[int] = 0
    ) -> None: ...
    def BoundingBox(self) -> Select3D_BndBox3d: ...
    def CenterOfGeometry(self) -> gp_Pnt: ...
    def GetConnected(self) -> Select3D_SensitiveEntity: ...
...
class MeshVS_SensitiveQuad(Select3D_SensitiveEntity):
    @overload
    def __init__(
        self, theOwner: SelectMgr_EntityOwner, theQuadVerts: TColgp_Array1OfPnt
    ) -> None: ...
    @overload
    def __init__(
        self,
...
class MeshVS_SensitiveSegment(Select3D_SensitiveSegment):
    def __init__(
        self, theOwner: SelectMgr_EntityOwner, theFirstPnt: gp_Pnt, theLastPnt: gp_Pnt
    ) -> None: ...
...
class MeshVS_Tool:
    @overload
    @staticmethod
    def CreateAspectFillArea3d(
        theDr: MeshVS_Drawer, UseDefaults: Optional[bool] = True
    ...
    def CreateAspectFillArea3d(
        ...
        UseDefaults: Optional[bool] = True,
    ) -> Graphic3d_AspectFillArea3d: ...
    @staticmethod
    def CreateAspectLine3d(
        theDr: MeshVS_Drawer, UseDefaults: Optional[bool] = True
    ) -> Graphic3d_AspectLine3d: ...
    @staticmethod
    def CreateAspectMarker3d(
        theDr: MeshVS_Drawer, UseDefaults: Optional[bool] = True
    ) -> Graphic3d_AspectMarker3d: ...
    @staticmethod
    def CreateAspectText3d(
        theDr: MeshVS_Drawer, UseDefaults: Optional[bool] = True
...
class MeshVS_TwoNodes:
    def __init__(
        self, aFirst: Optional[int] = 0, aSecond: Optional[int] = 0
    ) -> None: ...
...
class MeshVS_DeformedDataSource(MeshVS_DataSource):
    def __init__(
        self, theNonDeformDS: MeshVS_DataSource, theMagnify: float
    ) -> None: ...
    def Get3DGeom(
        self, ID: int, Data: MeshVS_HArray1OfSequenceOfInteger
    ) -> Tuple[bool, int]: ...
...
class MeshVS_ElementalColorPrsBuilder(MeshVS_PrsBuilder):
    def __init__(
        self,
        Parent: MeshVS_Mesh,
        Flags: Optional[int] = MeshVS_DMF_ElementalColorDataPrs,
        DS: Optional[MeshVS_DataSource] = 0,
        Id: Optional[int] = -1,
        Priority: Optional[int] = MeshVS_BP_ElemColor,
    ) -> None: ...
    def Build(
        self,
        Prs: Prs3d_Presentation,
    ...
    @overload
    def GetColor2(
        self, ID: int, theColor1: Quantity_Color, theColor2: Quantity_Color
    ) -> bool: ...
...
class MeshVS_MeshPrsBuilder(MeshVS_PrsBuilder):
    def __init__(
        self,
        Parent: MeshVS_Mesh,
        Flags: Optional[int] = MeshVS_DMF_OCCMask,
        DS: Optional[MeshVS_DataSource] = 0,
        Id: Optional[int] = -1,
        Priority: Optional[int] = MeshVS_BP_Mesh,
    ) -> None: ...
    @staticmethod
    def AddVolumePrs(
    ...
    def BuildHilightPrs(
        self, Prs: Prs3d_Presentation, IDs: TColStd_PackedMapOfInteger, IsElement: bool
    ) -> None: ...
    def BuildNodes(
        self,
        Prs: Prs3d_Presentation,
...
class MeshVS_NodalColorPrsBuilder(MeshVS_PrsBuilder):
    def __init__(
        self,
        Parent: MeshVS_Mesh,
        Flags: Optional[int] = MeshVS_DMF_NodalColorDataPrs,
        DS: Optional[MeshVS_DataSource] = 0,
        Id: Optional[int] = -1,
        Priority: Optional[int] = MeshVS_BP_NodalColor,
    ) -> None: ...
    def AddVolumePrs(
        self,
        theTopo: MeshVS_HArray1OfSequenceOfInteger,
...
class MeshVS_TextPrsBuilder(MeshVS_PrsBuilder):
    def __init__(
        ...
        Flags: Optional[int] = MeshVS_DMF_TextDataPrs,
        DS: Optional[MeshVS_DataSource] = 0,
        Id: Optional[int] = -1,
        Priority: Optional[int] = MeshVS_BP_Text,
    ) -> None: ...
    def Build(
        self,
        Prs: Prs3d_Presentation,
    ...
    def SetTexts(
        self, IsElement: bool, Map: MeshVS_DataMapOfIntegerAsciiString
    ) -> None: ...
...
class MeshVS_VectorPrsBuilder(MeshVS_PrsBuilder):
    def __init__(
        ...
        Flags: Optional[int] = MeshVS_DMF_VectorDataPrs,
        DS: Optional[MeshVS_DataSource] = 0,
        Id: Optional[int] = -1,
        Priority: Optional[int] = MeshVS_BP_Vector,
        IsSimplePrs: Optional[bool] = False,
    ) -> None: ...
    def Build(
        self,
        Prs: Prs3d_Presentation,
    ...
    def SetSimplePrsParams(
        self, theLineWidthParam: float, theStartParam: float, theEndParam: float
    ) -> None: ...
    def SetVector(self, IsElement: bool, ID: int, Vect: gp_Vec) -> None: ...
    def SetVectors(
        self, IsElement: bool, Map: MeshVS_DataMapOfIntegerVector
    ) -> None: ...
    @staticmethod
    def calculateArrow(
        Points: TColgp_Array1OfPnt, Length: float, ArrowPart: float
    ) -> float: ...

# harray1 classes

class MeshVS_HArray1OfSequenceOfInteger(
    MeshVS_Array1OfSequenceOfInteger, Standard_Transient
):
    def __init__(self, theLower: int, theUpper: int) -> None: ...
