...
MeshVS_HArray1OfSequenceOfInteger = NewType("MeshVS_HArray1OfSequenceOfInteger", Any)
# the following typedef cannot be wrapped as is
...
class MeshVS_Mesh(AIS_InteractiveObject):
    ...
    def GetOwnerMaps(self, IsElement: bool) -> False: ...
...
class MeshVS_DataSource3D(MeshVS_DataSource):
    @staticmethod
    def CreatePrismTopology(BasePoints: int) -> False: ...
    @staticmethod
    def CreatePyramidTopology(BasePoints: int) -> False: ...
    def GetPrismTopology(self, BasePoints: int) -> False: ...
    def GetPyramidTopology(self, BasePoints: int) -> False: ...
...
class MeshVS_ElementalColorPrsBuilder(MeshVS_PrsBuilder):
    def __init__(self, Parent: MeshVS_Mesh, Flags: Optional[int] = MeshVS_DMF_ElementalColorDataPrs, DS: Optional[MeshVS_DataSource] = nullptr, Id: Optional[int] = -1, Priority: Optional[int] = MeshVS_BP_ElemColor) -> None: ...
    def Build(self, Prs: Prs3d_Presentation, IDs: TColStd_PackedMapOfInteger, IDsToExclude: TColStd_PackedMapOfInteger, IsElement: bool, DisplayMode: int) -> None: ...
    ...
    def GetColors1(self) -> False: ...
    def GetColors2(self) -> False: ...
...
class MeshVS_MeshPrsBuilder(MeshVS_PrsBuilder):
    def __init__(self, Parent: MeshVS_Mesh, Flags: Optional[int] = MeshVS_DMF_OCCMask, DS: Optional[MeshVS_DataSource] = nullptr, Id: Optional[int] = -1, Priority: Optional[int] = MeshVS_BP_Mesh) -> None: ...
    def Build(self, Prs: Prs3d_Presentation, IDs: TColStd_PackedMapOfInteger, IDsToExclude: TColStd_PackedMapOfInteger, IsElement: bool, DisplayMode: int) -> None: ...
...
class MeshVS_NodalColorPrsBuilder(MeshVS_PrsBuilder):
    def __init__(self, Parent: MeshVS_Mesh, Flags: Optional[int] = MeshVS_DMF_NodalColorDataPrs, DS: Optional[MeshVS_DataSource] = nullptr, Id: Optional[int] = -1, Priority: Optional[int] = MeshVS_BP_NodalColor) -> None: ...
    def Build(self, Prs: Prs3d_Presentation, IDs: TColStd_PackedMapOfInteger, IDsToExclude: TColStd_PackedMapOfInteger, IsElement: bool, DisplayMode: int) -> None: ...
    def GetColor(self, ID: int, theColor: Quantity_Color) -> bool: ...
    def GetColorMap(self) -> False: ...
    def GetColors(self) -> False: ...
...
class MeshVS_TextPrsBuilder(MeshVS_PrsBuilder):
    def __init__(self, Parent: MeshVS_Mesh, Height: float, Color: Quantity_Color, Flags: Optional[int] = MeshVS_DMF_TextDataPrs, DS: Optional[MeshVS_DataSource] = nullptr, Id: Optional[int] = -1, Priority: Optional[int] = MeshVS_BP_Text) -> None: ...
    ...
    def GetTexts(self, IsElement: bool) -> False: ...
...
class MeshVS_VectorPrsBuilder(MeshVS_PrsBuilder):
    def __init__(self, Parent: MeshVS_Mesh, MaxLength: float, VectorColor: Quantity_Color, Flags: Optional[int] = MeshVS_DMF_VectorDataPrs, DS: Optional[MeshVS_DataSource] = nullptr, Id: Optional[int] = -1, Priority: Optional[int] = MeshVS_BP_Vector, IsSimplePrs: Optional[bool] = false) -> None: ...
    def Build(self, Prs: Prs3d_Presentation, IDs: TColStd_PackedMapOfInteger, IDsToExclude: TColStd_PackedMapOfInteger, IsElement: bool, theDisplayMode: int) -> None: ...
    ...
    def GetVectors(self, IsElement: bool) -> False: ...
    ...
    @staticmethod
    def calculateArrow(Points: TColgp_Array1OfPnt, Length: float, ArrowPart: float) -> False: ...
