...
class TPrsStd_AISPresentation(TDF_Attribute):
    ...
    def AddSelectionMode(
        self, theSelectionMode: int, theTransaction: Optional[bool] = True
    ) -> None: ...
...
class TPrsStd_AISViewer(TDF_Attribute):
    ...
    @staticmethod
    def New(
        access: TDF_Label, selector: AIS_InteractiveContext
    ) -> TPrsStd_AISViewer: ...
    @overload
    @staticmethod
...
class TPrsStd_ConstraintTools:
    @staticmethod
    def ComputeAngle(
        aConst: TDataXtd_Constraint, anAIS: AIS_InteractiveObject
    ) -> None: ...
    @staticmethod
    def ComputeAngleForOneFace(
        aConst: TDataXtd_Constraint, anAIS: AIS_InteractiveObject
    ) -> None: ...
    @staticmethod
    def ComputeCoincident(
        aConst: TDataXtd_Constraint, anAIS: AIS_InteractiveObject
    ) -> None: ...
    @staticmethod
    def ComputeConcentric(
        aConst: TDataXtd_Constraint, anAIS: AIS_InteractiveObject
    ) -> None: ...
    @staticmethod
    def ComputeDiameter(
    ...
    @staticmethod
    def ComputeEqualDistance(
        aConst: TDataXtd_Constraint, anAIS: AIS_InteractiveObject
    ) -> None: ...
    @staticmethod
    def ComputeEqualRadius(
        aConst: TDataXtd_Constraint, anAIS: AIS_InteractiveObject
    ) -> None: ...
    @staticmethod
    def ComputeFix(
    ...
    @staticmethod
    def ComputeTextAndValue(
        aConst: TDataXtd_Constraint, aText: str, anIsAngle: bool
    ) -> float: ...
    @staticmethod
    def UpdateOnlyValue(
        aConst: TDataXtd_Constraint, anAIS: AIS_InteractiveObject
