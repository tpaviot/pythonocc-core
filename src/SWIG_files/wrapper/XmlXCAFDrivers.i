...
""
%enddef
%module (package="OCC", docstring=XMLXCAFDRIVERSDOCSTRING) XmlXCAFDrivers
...
class XmlXCAFDrivers {
	public:
		...
		%feature("autodoc", "	* Depending from the ID, returns a list of storage or retrieval attribute drivers. Used for plugin. 
