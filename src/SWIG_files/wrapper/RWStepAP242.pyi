...
class RWStepAP242_RWDraughtingModelItemAssociation:
    ...
    def WriteStep(
        self, SW: StepData_StepWriter, ent: StepAP242_DraughtingModelItemAssociation
    ) -> None: ...
...
class RWStepAP242_RWGeometricItemSpecificUsage:
    ...
    def Share(
        self, ent: StepAP242_GeometricItemSpecificUsage, iter: Interface_EntityIterator
    ) -> None: ...
    def WriteStep(
        self, SW: StepData_StepWriter, ent: StepAP242_GeometricItemSpecificUsage
    ) -> None: ...
...
class RWStepAP242_RWIdAttribute:
    ...
    def Share(
        self, ent: StepAP242_IdAttribute, iter: Interface_EntityIterator
    ) -> None: ...
    def WriteStep(
        self, SW: StepData_StepWriter, ent: StepAP242_IdAttribute
    ) -> None: ...
...
class RWStepAP242_RWItemIdentifiedRepresentationUsage:
    ...
    def WriteStep(
        self, SW: StepData_StepWriter, ent: StepAP242_ItemIdentifiedRepresentationUsage
    ) -> None: ...
