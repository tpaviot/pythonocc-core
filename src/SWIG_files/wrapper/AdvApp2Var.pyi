...
class AdvApp2Var_ApproxAFunc2Var:
    ...
    @overload
    def UFrontError(self, Dimension: int) -> False: ...
    @overload
    def UFrontError(self, Dimension: int, Index: int) -> float: ...
    def VDegree(self) -> int: ...
    @overload
    def VFrontError(self, Dimension: int) -> False: ...
    @overload
...
class AdvApp2Var_Context:
    @overload
    def __init__(self) -> None: ...
    def CToler(self) -> False: ...
    def FToler(self) -> False: ...
    def FavorIso(self) -> int: ...
    def IToler(self) -> False: ...
    def TotalDimension(self) -> int: ...
    def TotalNumberSSP(self) -> int: ...
    def UGauss(self) -> False: ...
    def UJacDeg(self) -> int: ...
    def UJacMax(self) -> False: ...
    def ULimit(self) -> int: ...
    def UOrder(self) -> int: ...
    def URoots(self) -> False: ...
    def VGauss(self) -> False: ...
    def VJacDeg(self) -> int: ...
    def VJacMax(self) -> False: ...
    def VLimit(self) -> int: ...
    def VOrder(self) -> int: ...
    def VRoots(self) -> False: ...
...
class AdvApp2Var_Framework:
    ...
    def UEquation(self, IndexIso: int, IndexStrip: int) -> False: ...
    def UpdateInU(self, CuttingValue: float) -> None: ...
    def UpdateInV(self, CuttingValue: float) -> None: ...
    def VEquation(self, IndexIso: int, IndexStrip: int) -> False: ...
...
class AdvApp2Var_MathBase:
    ...
    @staticmethod
    def msc_(ndimen: int, vecte1: float, vecte2: float) -> False: ...
    @staticmethod
    def mvsheld_(n: int, is_: int, dtab: float, icle: int) -> int: ...
    @staticmethod
    def mzsnorm_(ndimen: int, vecteu: float) -> False: ...
    @staticmethod
    def pow__di(x: float, n: int) -> False: ...
