...
class AdvApp2Var_ApproxF2var:
    @staticmethod
    def mma1her_(arg0: int, arg1: float, arg2: int) -> int: ...
    @staticmethod
    def mma2ac1_(arg0: int, arg1: int, arg2: int, arg3: int, arg4: int, arg5: Any, arg6: Any, arg7: Any, arg8: Any, arg9: Any, arg10: Any, arg11: float) -> int: ...
    @staticmethod
    def mma2ac2_(arg0: int, arg1: int, arg2: int, arg3: int, arg4: int, arg5: int, arg6: Any, arg7: int, arg8: Any, arg9: Any, arg10: float) -> int: ...
    @staticmethod
    def mma2ac3_(arg0: int, arg1: int, arg2: int, arg3: int, arg4: int, arg5: int, arg6: Any, arg7: int, arg8: Any, arg9: Any, arg10: float) -> int: ...
    @staticmethod
    def mma2can_(arg0: int, arg1: int, arg2: int, arg3: int, arg4: int, arg5: int, arg6: int, arg7: Any, arg8: float, arg9: float, arg10: int) -> int: ...
    @staticmethod
    ...
    @staticmethod
    def mmapptt_(arg0: int, arg1: int, arg2: int, arg3: float, arg4: int) -> int: ...
...
class AdvApp2Var_Framework:
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, Frame: Any, UFrontier: Any, VFrontier: Any) -> None: ...
...
class AdvApp2Var_MathBase:
    ...
    @staticmethod
    def mmapcmp_(arg0: int, arg1: int, arg2: int, arg3: float, arg4: float) -> int: ...
    @staticmethod
    ...
    @staticmethod
    def mmdrc11_(arg0: int, arg1: int, arg2: int, arg3: float, arg4: float, arg5: float) -> int: ...
    @staticmethod
    ...
    @staticmethod
    def mmfmca9_(arg0: int, arg1: int, arg2: int, arg3: int, arg4: int, arg5: int, arg6: float, arg7: float) -> int: ...
    @staticmethod
    ...
    @staticmethod
    def mmfmcb5_(arg0: int, arg1: int, arg2: int, arg3: float, arg4: int, arg5: int, arg6: int, arg7: float, arg8: int) -> int: ...
    @staticmethod
    ...
    @staticmethod
    def mmjaccv_(ncoef: int, ndim: int, ider: int, crvlgd: Any, polaux: float, crvcan: float) -> int: ...
    @staticmethod
    ...
    @staticmethod
    def mmwprcs_(arg0: float, arg1: float, arg2: float, arg3: float, arg4: int, arg5: int) -> None: ...
    @staticmethod
...
class AdvApp2Var_Network:
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, Net: Any, TheU: TColStd_SequenceOfReal, TheV: TColStd_SequenceOfReal) -> None: ...
...
class AdvApp2Var_SysBase:
    def __init__(self) -> None: ...
    @staticmethod
    def macinit_(arg0: int, arg1: int) -> int: ...
    def macrai4_(self, nbelem: int, maxelm: int, itablo: int, iofset: Any, iercod: int) -> int: ...
    def macrar8_(self, nbelem: int, maxelm: int, xtablo: float, iofset: Any, iercod: int) -> int: ...
    def macrdi4_(self, nbelem: int, maxelm: int, itablo: int, iofset: Any, iercod: int) -> int: ...
    def macrdr8_(self, nbelem: int, maxelm: int, xtablo: float, iofset: Any, iercod: int) -> int: ...
    @staticmethod
    def maermsg_(cnompg: str, icoder: int, cnompg_len: int) -> int: ...
    def mainial_(self) -> int: ...
    @staticmethod
    def maitbr8_(itaill: int, xtab: float, xval: float) -> int: ...
    @staticmethod
    def maovsr8_(ivalcs: int) -> int: ...
    def mcrdelt_(self, iunit: int, isize: int, t: None, iofset: Any, iercod: int) -> int: ...
    @staticmethod
    def mcrfill_(size: int, tin: None, tout: None) -> int: ...
    def mcrrqst_(self, iunit: int, isize: int, t: None, iofset: Any, iercod: int) -> int: ...
    @staticmethod
    def mgenmsg_(nomprg: str, nomprg_len: int) -> int: ...
    @staticmethod
    def mgsomsg_(nomprg: str, nomprg_len: int) -> int: ...
    @staticmethod
    ...
    @staticmethod
    def mswrdbg_(ctexte: str, ctexte_len: int) -> int: ...
    @staticmethod
