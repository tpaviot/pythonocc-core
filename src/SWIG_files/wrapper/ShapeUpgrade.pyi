...
class shapeupgrade:
    ...
    def C0BSplineToSequenceOfC1BSplineCurve(
        BS: Geom_BSplineCurve, seqBS: TColGeom_HSequenceOfBoundedCurve
    ) -> bool: ...
    @overload
    @staticmethod
    def C0BSplineToSequenceOfC1BSplineCurve(
        BS: Geom2d_BSplineCurve, seqBS: TColGeom2d_HSequenceOfBoundedCurve
    ) -> bool: ...
...
class ShapeUpgrade_ShellSewing:
    def __init__(self) -> None: ...
    def ApplySewing(
        self, shape: TopoDS_Shape, tol: Optional[float] = 0.0
    ) -> TopoDS_Shape: ...
...
class ShapeUpgrade_UnifySameDomain(Standard_Transient):
    ...
    def __init__(
        self,
        aShape: TopoDS_Shape,
        UnifyEdges: Optional[bool] = True,
        UnifyFaces: Optional[bool] = True,
        ConcatBSplines: Optional[bool] = False,
    ) -> None: ...
...
class ShapeUpgrade_EdgeDivide(ShapeUpgrade_Tool):
    ...
    def SetSplitCurve2dTool(
        self, splitCurve2dTool: ShapeUpgrade_SplitCurve2d
    ) -> None: ...
    def SetSplitCurve3dTool(
        self, splitCurve3dTool: ShapeUpgrade_SplitCurve3d
    ) -> None: ...
...
class ShapeUpgrade_FaceDivide(ShapeUpgrade_Tool):
    ...
    def SetSplitSurfaceTool(
        self, splitSurfaceTool: ShapeUpgrade_SplitSurface
    ) -> None: ...
    def SetSurfaceSegmentMode(self, Segment: bool) -> None: ...
...
class ShapeUpgrade_FixSmallCurves(ShapeUpgrade_Tool):
    def __init__(self) -> None: ...
    def Approx(
        self, Curve3d: Geom_Curve, Curve2d: Geom2d_Curve, Curve2dR: Geom2d_Curve
...
class ShapeUpgrade_ShapeDivideContinuity(ShapeUpgrade_ShapeDivide):
    ...
    def SetBoundaryCriterion(
        self, Criterion: Optional[GeomAbs_Shape] = GeomAbs_C1
    ) -> None: ...
...
class ShapeUpgrade_WireDivide(ShapeUpgrade_Tool):
    ...
    def SetFixSmallCurveTool(
        self, FixSmallCurvesTool: ShapeUpgrade_FixSmallCurves
    ) -> None: ...
    def SetSplitCurve2dTool(
        self, splitCurve2dTool: ShapeUpgrade_SplitCurve2d
    ) -> None: ...
