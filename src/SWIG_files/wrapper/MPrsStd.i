...
"Storage  and Retrieval drivers  for graphicattributes.  Transient attributes are defined in package TPrsStd and persistent one are defined in spackage PPrsStd"
%enddef
