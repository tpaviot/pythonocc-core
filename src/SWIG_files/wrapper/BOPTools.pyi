...
class BOPTools_ListOfConnexityBlock:
    ...
    def Assign(self, theItem: BOPTools_ListOfConnexityBlock) -> BOPTools_ListOfConnexityBlock: ...
    def Clear(self) -> None: ...
...
class BOPTools_ListOfCoupleOfShape:
    ...
    def Assign(self, theItem: BOPTools_ListOfCoupleOfShape) -> BOPTools_ListOfCoupleOfShape: ...
    def Clear(self) -> None: ...
