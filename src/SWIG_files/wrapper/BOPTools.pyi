...
class BOPTools_IndexedDataMapOfSetShape:
    def __init__(self, *args: Any, **kwargs: Any) -> None: ...
    def __getattr__(self, name: str) -> Any: ...

class BOPTools_ListIteratorOfListOfConnexityBlock:
    def __init__(self, *args: Any, **kwargs: Any) -> None: ...
    def __getattr__(self, name: str) -> Any: ...

class BOPTools_ListIteratorOfListOfCoupleOfShape:
    def __init__(self, *args: Any, **kwargs: Any) -> None: ...
    def __getattr__(self, name: str) -> Any: ...

class BOPTools_MapOfSet:
    def __init__(self, *args: Any, **kwargs: Any) -> None: ...
    def __getattr__(self, name: str) -> Any: ...

class BOPTools_AlgoTools:
    @staticmethod
    def AreFacesSameDomain(theF1: TopoDS_Face, theF2: TopoDS_Face, theContext: IntTools_Context, theFuzz: Optional[float] = ...) -> bool: ...
    @overload
    @staticmethod
    ...
    @overload
    @staticmethod
    def ComputeVV(theV1: TopoDS_Vertex, theV2: TopoDS_Vertex, theFuzz: Optional[float] = ...) -> int: ...
    @staticmethod
    ...
    @staticmethod
    def GetFaceOff(theEdge: TopoDS_Edge, theFace: TopoDS_Face, theLCEF: Any, theFaceOff: TopoDS_Face, theContext: IntTools_Context) -> bool: ...
    @staticmethod
    ...
    @overload
    @staticmethod
    def MakeConnexityBlocks(theLS: TopTools_ListOfShape, theConnectionType: TopAbs_ShapeEnum, theElementType: TopAbs_ShapeEnum, theLCB: Any) -> None: ...
    @staticmethod
