...
class PCDM_SequenceOfReference:
    def Assign(self, theItem: PCDM_Reference) -> PCDM_Reference: ...
    def Clear(self) -> None: ...
...
class pcdm:
    ...
    @staticmethod
    def FileDriverType(
        aFileName: str, aBaseDriver: Storage_BaseDriver
    ) -> PCDM_TypeOfFileDriver: ...
    @overload
    @staticmethod
    def FileDriverType(
        theIStream: str, theBaseDriver: Storage_BaseDriver
    ) -> PCDM_TypeOfFileDriver: ...
...
class PCDM_ReadWriter(Standard_Transient):
    ...
    @staticmethod
    def Open(
        aDriver: Storage_BaseDriver, aFileName: str, anOpenMode: Storage_OpenMode
    ) -> None: ...
    def ReadDocumentVersion(
        self, aFileName: str, theMsgDriver: Message_Messenger
    ) -> int: ...
    def ReadExtensions(
        self,
        aFileName: str,
    ...
    def ReadReferenceCounter(
        self, theFileName: str, theMsgDriver: Message_Messenger
    ) -> int: ...
    def ReadReferences(
        self,
        aFileName: str,
    ...
    def WriteReferenceCounter(
        self, aData: Storage_Data, aDocument: CDM_Document
    ) -> None: ...
    def WriteReferences(
        self, aData: Storage_Data, aDocument: CDM_Document, theReferencerFileName: str
    ) -> None: ...
...
class PCDM_Reference:
    ...
    @overload
    def __init__(
        self, aReferenceIdentifier: int, aFileName: str, aDocumentVersion: int
    ) -> None: ...
...
class PCDM_StorageDriver(PCDM_Writer):
    ...
    @overload
    def Make(
        self, aDocument: CDM_Document, Documents: PCDM_SequenceOfDocument
    ) -> None: ...
    def SetFormat(self, aformat: str) -> None: ...
