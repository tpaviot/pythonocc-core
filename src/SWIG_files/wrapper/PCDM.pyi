...
class pcdm:
    @overload
    @staticmethod
    def FileDriverType(aFileName: TCollection_AsciiString, aBaseDriver: Storage_BaseDriver) -> PCDM_TypeOfFileDriver: ...
...
class PCDM_Reader(Standard_Transient):
    ...
    @overload
    def Read(self, aFileName: TCollection_ExtendedString, aNewDocument: CDM_Document, anApplication: CDM_Application, theFilter: Optional[PCDM_ReaderFilter] = PCDM_ReaderFilter(), theProgress: Optional[Message_ProgressRange] = Message_ProgressRange()) -> None: ...
...
class PCDM_ReaderFilter(Standard_Transient):
    ...
    @overload
    def __init__(self, theEntryToRead: TCollection_AsciiString) -> None: ...
    def AddPath(self, theEntryToRead: TCollection_AsciiString) -> None: ...
    @overload
    def AddRead(self, theRead: Standard_Type) -> None: ...
    @overload
    def AddRead(self, theRead: TCollection_AsciiString) -> None: ...
    @overload
    def AddSkipped(self, theSkipped: Standard_Type) -> None: ...
    @overload
    def AddSkipped(self, theSkipped: TCollection_AsciiString) -> None: ...
    def Clear(self) -> None: ...
    ...
    @overload
    def IsPassed(self, theEntry: TCollection_AsciiString) -> bool: ...
    @overload
    def IsPassed(self) -> bool: ...
    def IsPassedAttr(self, theAttributeType: TCollection_AsciiString) -> bool: ...
    @overload
    def IsSubPassed(self, theEntry: TCollection_AsciiString) -> bool: ...
    @overload
...
class PCDM_Writer(Standard_Transient):
    @overload
    def Write(self, aDocument: CDM_Document, aFileName: TCollection_ExtendedString, theRange: Optional[Message_ProgressRange] = Message_ProgressRange()) -> None: ...
