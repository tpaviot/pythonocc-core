...
class BRepMesh_EdgeTessellationExtractor(IMeshTools_CurveTessellator):
    def PointsNb(self) -> int: ...
    def Value(self, theIndex: int, thePoint: gp_Pnt) -> Tuple[bool, float]: ...
...
class BRepMesh_GeomTool:
    ...
    @staticmethod
    def IntSegSeg(theStartPnt1: gp_XY, theEndPnt1: gp_XY, theStartPnt2: gp_XY, theEndPnt2: gp_XY, isConsiderEndPointTouch: bool, isConsiderPointOnSegment: bool, theIntPnt: gp_Pnt2d) -> False: ...
    def NbPoints(self) -> int: ...
    @staticmethod
    def Normal(theSurface: BRepAdaptor_Surface, theParamU: float, theParamV: float, thePoint: gp_Pnt, theNormal: gp_Dir) -> bool: ...
    @staticmethod
...
BRepMesh_GeomTool_IntLinLin = BRepMesh_GeomTool.IntLinLin
BRepMesh_GeomTool_IntSegSeg = BRepMesh_GeomTool.IntSegSeg
BRepMesh_GeomTool_Normal = BRepMesh_GeomTool.Normal
