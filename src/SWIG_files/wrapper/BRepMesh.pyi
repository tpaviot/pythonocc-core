...
class BRepMesh_Deflection(Standard_Transient):
    @staticmethod
    def ComputeAbsoluteDeflection(theShape: TopoDS_Shape, theRelativeDeflection: float, theMaxShapeSize: float) -> False: ...
    @staticmethod
...
class BRepMesh_GeomTool:
    ...
    @staticmethod
    def CellsCount(theSurface: Adaptor3d_Surface, theVerticesNb: int, theDeflection: float, theRangeSplitter: BRepMesh_DefaultRangeSplitter) -> int: ...
    def NbPoints(self) -> int: ...
    @staticmethod
    def SquareDeflectionOfSegment(theFirstPoint: gp_Pnt, theLastPoint: gp_Pnt, theMidPoint: gp_Pnt) -> False: ...
...
class BRepMesh_ShapeTool(Standard_Transient):
    ...
    @staticmethod
    def MaxFaceTolerance(theFace: TopoDS_Face) -> False: ...
    @overload
    @staticmethod
