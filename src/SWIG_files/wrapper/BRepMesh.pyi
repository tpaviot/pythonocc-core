...
class BRepMesh_CircleTool:
    ...
    @overload
    def __init__(
        self, theReservedSize: int, theAllocator: NCollection_IncAllocator
    ) -> None: ...
    @overload
    def Bind(self, theIndex: int, theCircle: gp_Circ2d) -> None: ...
    @overload
    def Bind(
        self, theIndex: int, thePoint1: gp_XY, thePoint2: gp_XY, thePoint3: gp_XY
    ) -> bool: ...
    def Delete(self, theIndex: int) -> None: ...
    def IsEmpty(self) -> bool: ...
    @staticmethod
    def MakeCircle(
        thePoint1: gp_XY, thePoint2: gp_XY, thePoint3: gp_XY, theLocation: gp_XY
    ) -> Tuple[bool, float]: ...
...
class BRepMesh_DataStructureOfDelaun(Standard_Transient):
    def __init__(
        self,
        theAllocator: NCollection_IncAllocator,
        theReservedNodeSize: Optional[int] = 100,
    ) -> None: ...
    def AddElement(self, theElement: BRepMesh_Triangle) -> int: ...
    def AddLink(self, theLink: BRepMesh_Edge) -> int: ...
    def AddNode(
        self, theNode: BRepMesh_Vertex, isForceAdd: Optional[bool] = False
    ) -> int: ...
    ...
    def SubstituteElement(
        self, theIndex: int, theNewElement: BRepMesh_Triangle
    ) -> bool: ...
...
class BRepMesh_Deflection(Standard_Transient):
    @staticmethod
    def ComputeAbsoluteDeflection(
        theShape: TopoDS_Shape, theRelativeDeflection: float, theMaxShapeSize: float
    ) -> float: ...
    @staticmethod
    def IsConsistent(
        theCurrent: float,
...
class BRepMesh_Delaun:
    ...
    def Contains(
        self, theTriangleId: int, theVertex: BRepMesh_Vertex, theSqTolerance: float
    ) -> Tuple[bool, int]: ...
...
class BRepMesh_DiscretFactory:
    ...
    def Discret(
        self, theShape: TopoDS_Shape, theLinDeflection: float, theAngDeflection: float
    ...
    def SetDefault(
        self, theName: str, theFuncName: Optional[str] = "DISCRETALGO"
    ) -> bool: ...
...
class BRepMesh_GeomTool:
    ...
    def __init__(
        ...
        theMinPointsNb: Optional[int] = 2,
        theMinSize: Optional[float] = Precision.Confusion(),
    ) -> None: ...
    @overload
    def __init__(
        self,
    ...
    def AddPoint(
        self, thePoint: gp_Pnt, theParam: float, theIsReplace: Optional[bool] = True
    ) -> int: ...
    @staticmethod
    def CellsCount(
    ...
    @staticmethod
    def SquareDeflectionOfSegment(
        theFirstPoint: gp_Pnt, theLastPoint: gp_Pnt, theMidPoint: gp_Pnt
    ) -> float: ...
    @overload
    def Value(
        self, theIndex: int, theIsoParam: float, thePoint: gp_Pnt, theUV: gp_Pnt2d
    ) -> Tuple[bool, float]: ...
    @overload
    def Value(
        self,
...
class BRepMesh_MeshTool(Standard_Transient):
    ...
    def AddAndLegalizeTriangle(
        self, thePoint1: int, thePoint2: int, thePoint3: int
    ) -> None: ...
...
class BRepMesh_ShapeTool(Standard_Transient):
    ...
    def Range(
        ...
        isConsiderOrientation: Optional[bool] = False,
...
class BRepMesh_Vertex:
    ...
    @overload
    def __init__(
        self, theUV: gp_XY, theLocation3d: int, theMovability: BRepMesh_DegreeOfFreedom
    ) -> None: ...
    @overload
    def __init__(
        self, theU: float, theV: float, theMovability: BRepMesh_DegreeOfFreedom
    ) -> None: ...
...
class BRepMesh_IncrementalMesh(BRepMesh_DiscretRoot):
    ...
    def __init__(
        ...
        theAngDeflection: Optional[float] = 0.5,
        isInParallel: Optional[bool] = False,
    ) -> None: ...
    @overload
    def __init__(
        self,
