...
class BRepMesh_BaseMeshAlgo(IMeshTools_MeshAlgo):
    def Perform(self, theDFace: Any, theParameters: IMeshTools_Parameters, theRange: Optional[Message_ProgressRange] = Message_ProgressRange()) -> None: ...
...
class BRepMesh_CircleTool:
    ...
    def Select(self, thePoint: gp_XY) -> Any: ...
    @overload
...
class BRepMesh_Classifier(Standard_Transient):
    ...
    def RegisterWire(self, theWire: Any, theTolUV: Any, theRangeU: Any, theRangeV: Any) -> None: ...
...
class BRepMesh_CurveTessellator(IMeshTools_CurveTessellator):
    @overload
    def __init__(self, theEdge: Any, theParameters: IMeshTools_Parameters, theMinPointsNb: Optional[int] = 2) -> None: ...
    @overload
    def __init__(self, theEdge: Any, theOrientation: TopAbs_Orientation, theFace: Any, theParameters: IMeshTools_Parameters, theMinPointsNb: Optional[int] = 2) -> None: ...
...
class BRepMesh_DataStructureOfDelaun(Standard_Transient):
    ...
    def ElementNodes(self, theElement: BRepMesh_Triangle, arg1: Any) -> None: ...
...
class BRepMesh_DefaultRangeSplitter:
    ...
    def GetDFace(self) -> Any: ...
    def GetDelta(self) -> Any: ...
    def GetRangeU(self) -> Any: ...
    def GetRangeV(self) -> Any: ...
    def GetSurface(self) -> BRepAdaptor_Surface: ...
    def GetToleranceUV(self) -> Any: ...
    def IsValid(self) -> bool: ...
    def Point(self, thePoint2d: gp_Pnt2d) -> gp_Pnt: ...
    def Reset(self, theDFace: Any, theParameters: IMeshTools_Parameters) -> None: ...
...
class BRepMesh_Deflection(Standard_Transient):
    ...
    @overload
    @staticmethod
    def ComputeDeflection(theDEdge: Any, theMaxShapeSize: float, theParameters: IMeshTools_Parameters) -> None: ...
    @overload
    @staticmethod
    def ComputeDeflection(theDWire: Any, theParameters: IMeshTools_Parameters) -> None: ...
    @overload
    @staticmethod
    def ComputeDeflection(theDFace: Any, theParameters: IMeshTools_Parameters) -> None: ...
    @staticmethod
...
class BRepMesh_Delaun:
    ...
    @overload
    def __init__(self, theVertices: Any) -> None: ...
    @overload
    def __init__(self, theOldMesh: BRepMesh_DataStructureOfDelaun, theVertices: Any) -> None: ...
    @overload
    def __init__(self, theOldMesh: BRepMesh_DataStructureOfDelaun, theVertexIndices: Any) -> None: ...
    @overload
    def __init__(self, theOldMesh: BRepMesh_DataStructureOfDelaun, theVertexIndices: Any, theCellsCountU: int, theCellsCountV: int) -> None: ...
    def AddVertices(self, theVerticesIndices: Any, theRange: Optional[Message_ProgressRange] = Message_ProgressRange()) -> None: ...
    ...
    def Init(self, theVertices: Any) -> None: ...
    ...
    def SetAuxVertices(self, theSupVert: Any) -> None: ...
    def UseEdge(self, theEdge: int) -> bool: ...

class BRepMesh_DiscretAlgoFactory(Standard_Transient):
    ...
    def Factories() -> Any: ...
    @staticmethod
    def FindFactory(theName: str) -> BRepMesh_DiscretAlgoFactory: ...
    def Name(self) -> str: ...
    @staticmethod
    def RegisterFactory(theFactory: BRepMesh_DiscretAlgoFactory, theIsPreferred: Optional[bool] = False) -> None: ...
    @staticmethod
...
class BRepMesh_EdgeDiscret(IMeshTools_ModelAlgo):
    def __init__(self) -> None: ...
    @staticmethod
    def CreateEdgeTessellationExtractor(theDEdge: Any, theDFace: Any) -> IMeshTools_CurveTessellator: ...
    @overload
    @staticmethod
    def CreateEdgeTessellator(theDEdge: Any, theParameters: IMeshTools_Parameters, theMinPointsNb: Optional[int] = 2) -> IMeshTools_CurveTessellator: ...
    @overload
    @staticmethod
    def CreateEdgeTessellator(theDEdge: Any, theOrientation: TopAbs_Orientation, theDFace: Any, theParameters: IMeshTools_Parameters, theMinPointsNb: Optional[int] = 2) -> IMeshTools_CurveTessellator: ...
    @staticmethod
    def Tessellate2d(theDEdge: Any, theUpdateEnds: bool) -> None: ...
    @staticmethod
    def Tessellate3d(theDEdge: Any, theTessellator: IMeshTools_CurveTessellator, theUpdateEnds: bool) -> None: ...

class BRepMesh_FaceChecker(Standard_Transient):
    def __init__(self, theFace: Any, theParameters: IMeshTools_Parameters) -> None: ...
...
class BRepMesh_GeomTool:
    ...
    Same = IntFlag.Same
    @overload
    def __init__(self, theCurve: BRepAdaptor_Curve, theFirstParam: float, theLastParam: float, theLinDeflection: float, theAngDeflection: float, theMinPointsNb: Optional[int] = 2, theMinSize: Optional[float] = ...) -> None: ...
    @overload
    def __init__(self, theSurface: BRepAdaptor_Surface, theIsoType: GeomAbs_IsoType, theParamIso: float, theFirstParam: float, theLastParam: float, theLinDeflection: float, theAngDeflection: float, theMinPointsNb: Optional[int] = 2, theMinSize: Optional[float] = ...) -> None: ...
    def AddPoint(self, thePoint: gp_Pnt, theParam: float, theIsReplace: Optional[bool] = True) -> int: ...
    @staticmethod
    def CellsCount(theSurface: Adaptor3d_Surface, theVerticesNb: int, theDeflection: float, theRangeSplitter: BRepMesh_DefaultRangeSplitter) -> Any: ...
...
class BRepMesh_MeshTool(Standard_Transient):
    ...
    def AddTriangle(self, thePoint1: int, thePoint2: int, thePoint3: int, arg3: Any) -> None: ...
...
class BRepMesh_ShapeTool(Standard_Transient):
    ...
    @staticmethod
    def CheckAndUpdateFlags(theEdge: Any, thePCurve: Any) -> None: ...
    @staticmethod
...
class BRepMesh_Triangle:
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, arg0: int, arg1: bool, theMovability: BRepMesh_DegreeOfFreedom) -> None: ...
    def Edges(self, arg0: Any, arg1: bool) -> None: ...
    def Initialize(self, arg0: int, arg1: bool, theMovability: BRepMesh_DegreeOfFreedom) -> None: ...
...
class BRepMesh_Triangulator:
    def __init__(self, theXYZs: Any, theWires: Any, theNorm: gp_Dir) -> None: ...
    def Perform(self, thePolyTriangles: Any) -> bool: ...
    def SetMessenger(self, theMess: Message_Messenger) -> None: ...
    @staticmethod
    def ToPolyTriangulation(theNodes: TColgp_Array1OfPnt, thePolyTriangles: Any) -> Poly_Triangulation: ...
...
class BRepMesh_UVParamRangeSplitter(BRepMesh_DefaultRangeSplitter):
    def __init__(self) -> None: ...
    @overload
    def GetParametersU(self) -> Any: ...
    @overload
    def GetParametersU(self) -> Any: ...
    @overload
    def GetParametersV(self) -> Any: ...
    @overload
    def GetParametersV(self) -> Any: ...
    def Reset(self, theDFace: Any, theParameters: IMeshTools_Parameters) -> None: ...
