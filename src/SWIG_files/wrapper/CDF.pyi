...
class CDF_Application(CDM_Application):
    ...
    def SetDefaultFolder(self, aFolder: Any) -> bool: ...
...
class CDF_Store:
    ...
    def AssociatedStatusText(self) -> Any: ...
    ...
    def SetComment(self, aComment: Any) -> None: ...
    def SetCurrent(self, aPresentation: Any) -> None: ...
    @overload
    def SetFolder(self, aFolder: str) -> bool: ...
    @overload
    def SetFolder(self, aFolder: Any) -> bool: ...
    def SetMain(self) -> None: ...
    @overload
    def SetName(self, aName: Any) -> CDF_StoreSetNameStatus: ...
    @overload
    def SetName(self, aName: str) -> CDF_StoreSetNameStatus: ...
    def SetPreviousVersion(self, aPreviousVersion: Any) -> bool: ...
