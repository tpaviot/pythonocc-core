...
StepData_HArray1OfField = NewType("StepData_HArray1OfField", Any)
...
class StepData_ReadWriteModule(Interface_ReaderModule):
    ...
    def StepType(self, CN: int) -> False: ...
...
class StepData_StepWriter:
    ...
    @staticmethod
    def CleanTextForSend(theText: str) -> str: ...
