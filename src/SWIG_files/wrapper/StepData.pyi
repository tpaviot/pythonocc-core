...
class StepData_Field:
    ...
    def Entity(
        self, n1: Optional[int] = 1, n2: Optional[int] = 1
    ) -> Standard_Transient: ...
    ...
    def SetList2(
        self, siz1: int, siz2: int, f1: Optional[int] = 1, f2: Optional[int] = 1
    ) -> None: ...
    @overload
...
class StepData_GeneralModule(Interface_GeneralModule):
    ...
    def FillSharedCase(
        self, casenum: int, ent: Standard_Transient, iter: Interface_EntityIterator
    ) -> None: ...
...
class StepData_GlobalFactors:
    ...
    @staticmethod
    def Intance() -> StepData_GlobalFactors: ...
...
class StepData_GlobalNodeOfWriterLib(Standard_Transient):
    def __init__(self) -> None: ...
    def Add(
        self, amodule: StepData_ReadWriteModule, aprotocol: StepData_Protocol
    ) -> None: ...
...
class StepData_Protocol(Interface_Protocol):
    ...
    def BasicDescr(
        self, name: str, anylevel: Optional[bool] = True
    ) -> StepData_EDescr: ...
    ...
    def ECDescr(
        self, names: TColStd_SequenceOfAsciiString, anylevel: Optional[bool] = True
    ) -> StepData_ECDescr: ...
    def ESDescr(
        self, name: str, anylevel: Optional[bool] = True
    ) -> StepData_ESDescr: ...
...
class StepData_StepReaderData(Interface_FileReaderData):
    def __init__(
        ...
        nbtotal: int,
        nbpar: int,
        theSourceCodePage: Optional[Resource_FormatType] = Resource_FormatType_UTF8,
    ) -> None: ...
    def AddStepParam(
    ...
    def CheckDerived(
        ...
        mess: str,
        ach: Interface_Check,
        errstat: Optional[bool] = False,
    ) -> bool: ...
    def CheckNbParams(
        self, num: int, nbreq: int, ach: Interface_Check, mess: Optional[str] = ""
    ) -> bool: ...
    def ComplexType(self, num: int, types: TColStd_SequenceOfAsciiString) -> None: ...
    def FailEnumValue(
        self, num: int, nump: int, mess: str, ach: Interface_Check
    ) -> None: ...
    ...
    @overload
    def NamedForComplex(
        self, name: str, num0: int, ach: Interface_Check
    ) -> Tuple[bool, int]: ...
    @overload
    def NamedForComplex(
        self, theName: str, theShortName: str, num0: int, ach: Interface_Check
    ) -> Tuple[bool, int]: ...
    ...
    def ReadEnumParam(
        self, num: int, nump: int, mess: str, ach: Interface_Check, text: str
    ) -> bool: ...
    def ReadField(
        self,
        num: int,
    ...
    def ReadSubList(
        ...
        lenmin: Optional[int] = 0,
        lenmax: Optional[int] = 0,
    ) -> Tuple[bool, int]: ...
    def ReadTypedParam(
        self,
        num: int,
...
class StepData_StepReaderTool(Interface_FileReaderTool):
    def __init__(
        self, reader: StepData_StepReaderData, protocol: StepData_Protocol
    ) -> None: ...
    def AnalyseRecord(
    ...
    @overload
    def Prepare(
        self, reco: StepData_FileRecognizer, optimize: Optional[bool] = True
    ) -> None: ...
...
class StepData_StepWriter:
    ...
    def SendModel(
        self, protocol: StepData_Protocol, headeronly: Optional[bool] = False
    ) -> None: ...
...
class StepData_WriterLib:
    ...
    def Protocol(self) -> StepData_Protocol: ...
    def Select(
        self, obj: Standard_Transient, module: StepData_ReadWriteModule
    ) -> Tuple[bool, int]: ...
    def SetComplete(self) -> None: ...
    @staticmethod
    def SetGlobal(
        amodule: StepData_ReadWriteModule, aprotocol: StepData_Protocol
    ) -> None: ...
    def Start(self) -> None: ...
