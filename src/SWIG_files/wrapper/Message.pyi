...
class Message_CompositeAlerts(Standard_Transient):
    ...
    def Alerts(self, theGravity: Message_Gravity) -> False: ...
    @overload
    def Clear(self) -> None: ...
    @overload
...
class Message_Messenger(Standard_Transient):
    ...
    def ChangePrinters(self) -> False: ...
    def DumpJson(self, depth: Optional[int]=-1) -> str: ...
    def Printers(self) -> False: ...
...
class Message_Report(Standard_Transient):
    def __init__(self) -> None: ...
    def ActivateInMessenger(self, toActivate: bool, theMessenger: Optional[Message_Messenger] = nullptr) -> None: ...
    ...
    def DumpJson(self, depth: Optional[int]=-1) -> str: ...
    def GetAlerts(self, theGravity: Message_Gravity) -> False: ...
    @overload
    def HasAlert(self, theType: Standard_Type) -> bool: ...
    @overload
    def HasAlert(self, theType: Standard_Type, theGravity: Message_Gravity) -> bool: ...
    def IsActiveInMessenger(self, theMessenger: Optional[Message_Messenger] = nullptr) -> bool: ...
    def Limit(self) -> int: ...
    @overload
    ...
    def UpdateActiveInMessenger(self, theMessenger: Optional[Message_Messenger] = nullptr) -> None: ...
