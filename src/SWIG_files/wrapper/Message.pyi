...
class Message_ListOfAlert:
    ...
    def Assign(self, theItem: Message_ListOfAlert) -> Message_ListOfAlert: ...
    def Clear(self) -> None: ...
...
class Message_ListOfMsg:
    ...
    def Assign(self, theItem: Message_ListOfMsg) -> Message_ListOfMsg: ...
    def Clear(self) -> None: ...
...
Message_MetricType_ThreadCPUUserTime = (
    Message_MetricType.Message_MetricType_ThreadCPUUserTime
)
Message_MetricType_ThreadCPUSystemTime = (
    Message_MetricType.Message_MetricType_ThreadCPUSystemTime
)
Message_MetricType_ProcessCPUUserTime = (
    Message_MetricType.Message_MetricType_ProcessCPUUserTime
)
Message_MetricType_ProcessCPUSystemTime = (
    Message_MetricType.Message_MetricType_ProcessCPUSystemTime
)
...
class Message_Algorithm(Standard_Transient):
    ...
    @overload
    def AddStatus(
        self, theStatus: Message_ExecStatus, theOther: Message_Algorithm
    ) -> None: ...
    def ChangeStatus(self) -> Message_ExecStatus: ...
    def ClearStatus(self) -> None: ...
    def GetMessageNumbers(
        self, theStatus: Message_Status
    ...
    @staticmethod
    def PrepareReport(
        theError: TColStd_HPackedMapOfInteger, theMaxCount: int
    ) -> str: ...
    @overload
    @staticmethod
    def PrepareReport(
        theReportSeq: TColStd_SequenceOfHExtendedString, theMaxCount: int
    ) -> str: ...
    def SendMessages(
        self,
        theTraceLevel: Optional[Message_Gravity] = Message_Warning,
        theMaxCount: Optional[int] = 20,
    ) -> None: ...
    ...
    @overload
    def SetStatus(
        self, theStat: Message_Status, theStr: str, noRepetitions: Optional[bool] = True
    ) -> None: ...
    @overload
    def SetStatus(
        self, theStat: Message_Status, theStr: str, noRepetitions: Optional[bool] = True
    ...
    def SetStatus(
        ...
        noRepetitions: Optional[bool] = True,
    ) -> None: ...
    @overload
    def SetStatus(
        self, theStat: Message_Status, theStr: str, noRepetitions: Optional[bool] = True
...
class Message_CompositeAlerts(Standard_Transient):
    def __init__(self) -> None: ...
    def AddAlert(
        self, theGravity: Message_Gravity, theAlert: Message_Alert
    ) -> bool: ...
...
class Message_Level:
    ...
    def SetRootAlert(
        self, theAlert: Message_AlertExtended, isRequiredToStart: bool
    ) -> None: ...
...
class Message_MsgFile:
    ...
    @staticmethod
    def LoadFromEnv(
        theEnvName: str, theFileName: str, theLangExt: Optional[str] = ""
    ) -> bool: ...
    @staticmethod
...
class Message_Printer(Standard_Transient):
    ...
    def Send(self, theString: str, theGravity: Message_Gravity) -> None: ...
    def SendObject(
        self, theObject: Standard_Transient, theGravity: Message_Gravity
    ) -> None: ...
...
class Message_Report(Standard_Transient):
    ...
    def ActivateInMessenger(
        self, toActivate: bool, theMessenger: Optional[Message_Messenger] = None
    ) -> None: ...
    ...
    def IsActiveInMessenger(
        self, theMessenger: Optional[Message_Messenger] = None
    ) -> bool: ...
    def Limit(self) -> int: ...
    @overload
    ...
    @overload
    def SendMessages(
        self, theMessenger: Message_Messenger, theGravity: Message_Gravity
    ) -> None: ...
    def SetActiveMetric(
        self, theMetricType: Message_MetricType, theActivate: bool
    ) -> None: ...
...
class Message_AlertExtended(Message_Alert):
    ...
    def CompositeAlerts(
        self, theToCreate: Optional[bool] = False
...
class Message_AttributeMeter(Message_Attribute):
    ...
    @staticmethod
    def SetAlertMetrics(
        theAlert: Message_AlertExtended, theStartValue: bool
    ) -> None: ...
...
class Message_AttributeObject(Message_Attribute):
    def __init__(
        ...
        theName: Optional[str] = TCollection_AsciiString(),
    ) -> None: ...
    def DumpJson(self, depth: Optional[int] = -1) -> str: ...
...
class Message_PrinterOStream(Message_Printer):
    @overload
    def __init__(
        self, theTraceLevel: Optional[Message_Gravity] = Message_Info
    ) -> None: ...
    @overload
    def __init__(
        self,
        theFileName: str,
        theDoAppend: bool,
        theTraceLevel: Optional[Message_Gravity] = Message_Info,
    ) -> None: ...
    def Close(self) -> None: ...
    def GetStream(self) -> Standard_OStream: ...
    @staticmethod
    def SetConsoleTextColor(
        theOStream: Standard_OStream,
        theTextColor: Message_ConsoleColor,
        theIsIntenseText: Optional[bool] = false,
    ) -> None: ...
...
class Message_ProgressSentry(Message_ProgressScope):
    def __init__(
        ...
        theMax: float,
        theStep: float,
        theIsInf: Optional[bool] = False,
        theNewScopeSpan: Optional[float] = 0.0,
    ) -> None: ...
