...
# the following typedef cannot be wrapped as is
BRepCheck_IndexedDataMapOfShapeResult = NewType(
    "BRepCheck_IndexedDataMapOfShapeResult", Any
)

class BRepCheck_ListOfStatus:
    def Append(self, theItem: BRepCheck_Status) -> BRepCheck_Status: ...
    def Assign(self, theItem: BRepCheck_ListOfStatus) -> BRepCheck_ListOfStatus: ...
    def Clear(self) -> None: ...
    ...
    def __iter__(self) -> BRepCheck_Status: ...
...
BRepCheck_InvalidPointOnCurveOnSurface = (
    BRepCheck_Status.BRepCheck_InvalidPointOnCurveOnSurface
)
...
BRepCheck_InvalidImbricationOfWires = (
    BRepCheck_Status.BRepCheck_InvalidImbricationOfWires
)
...
BRepCheck_InvalidImbricationOfShells = (
    BRepCheck_Status.BRepCheck_InvalidImbricationOfShells
)
...
BRepCheck_InvalidPolygonOnTriangulation = (
    BRepCheck_Status.BRepCheck_InvalidPolygonOnTriangulation
)
...
class brepcheck:
    ...
    @staticmethod
    def SelfIntersection(
        W: TopoDS_Wire, F: TopoDS_Face, E1: TopoDS_Edge, E2: TopoDS_Edge
    ) -> bool: ...
...
class BRepCheck_Analyzer:
    def __init__(
        self,
        S: TopoDS_Shape,
        GeomControls: Optional[bool] = True,
        theIsParallel: Optional[bool] = False,
        theIsExact: Optional[bool] = False,
    ) -> None: ...
...
class BRepCheck_Wire(BRepCheck_Result):
    ...
    def Closed(self, Update: Optional[bool] = False) -> BRepCheck_Status: ...
    def Closed2d(
        self, F: TopoDS_Face, Update: Optional[bool] = False
    ) -> BRepCheck_Status: ...
    @overload
    def GeometricControls(self) -> bool: ...
    @overload
