...
class brepcheck:
    @staticmethod
    def PrecCurve(aAC3D: Adaptor3d_Curve) -> False: ...
    @staticmethod
    def PrecSurface(aAHSurf: Adaptor3d_Surface) -> False: ...
    @staticmethod
...
class BRepCheck_Result(Standard_Transient):
    ...
    @overload
    def StatusOnShape(self) -> False: ...
    @overload
    def StatusOnShape(self, theShape: TopoDS_Shape) -> False: ...
