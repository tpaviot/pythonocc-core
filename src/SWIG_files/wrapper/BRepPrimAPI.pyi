...
class BRepPrimAPI_MakeBox(BRepBuilderAPI_MakeShape):
    ...
    @overload
    def Init(
        self, thePnt: gp_Pnt, theDX: float, theDY: float, theDZ: float
    ) -> None: ...
    @overload
    def Init(self, thePnt1: gp_Pnt, thePnt2: gp_Pnt) -> None: ...
    @overload
    def Init(
        self, theAxes: gp_Ax2, theDX: float, theDY: float, theDZ: float
    ) -> None: ...
...
class BRepPrimAPI_MakeCone(BRepPrimAPI_MakeOneAxis):
    ...
    @overload
    def __init__(
        self, Axes: gp_Ax2, R1: float, R2: float, H: float, angle: float
    ) -> None: ...
...
class BRepPrimAPI_MakeRevol(BRepPrimAPI_MakeSweep):
    @overload
    def __init__(
        self, S: TopoDS_Shape, A: gp_Ax1, D: float, Copy: Optional[bool] = False
    ) -> None: ...
    @overload
    def __init__(
        self, S: TopoDS_Shape, A: gp_Ax1, Copy: Optional[bool] = False
    ) -> None: ...
    def Build(
        self, theRange: Optional[Message_ProgressRange] = Message_ProgressRange()
    ) -> None: ...
...
class BRepPrimAPI_MakeRevolution(BRepPrimAPI_MakeOneAxis):
    ...
    @overload
    def __init__(
        self, Meridian: Geom_Curve, VMin: float, VMax: float, angle: float
    ) -> None: ...
    @overload
    ...
    @overload
    def __init__(
        self, Axes: gp_Ax2, Meridian: Geom_Curve, VMin: float, VMax: float
    ) -> None: ...
    @overload
    def __init__(
        self, Axes: gp_Ax2, Meridian: Geom_Curve, VMin: float, VMax: float, angle: float
    ) -> None: ...
    def OneAxis(self) -> None: ...
...
class BRepPrimAPI_MakeSphere(BRepPrimAPI_MakeOneAxis):
    ...
    @overload
    def __init__(
        self, R: float, angle1: float, angle2: float, angle3: float
    ) -> None: ...
    @overload
    ...
    @overload
    def __init__(
        self, Center: gp_Pnt, R: float, angle1: float, angle2: float
    ) -> None: ...
    @overload
    def __init__(
        self, Center: gp_Pnt, R: float, angle1: float, angle2: float, angle3: float
    ) -> None: ...
    @overload
    ...
    @overload
    def __init__(
        self, Axis: gp_Ax2, R: float, angle1: float, angle2: float
    ) -> None: ...
    @overload
    def __init__(
        self, Axis: gp_Ax2, R: float, angle1: float, angle2: float, angle3: float
    ) -> None: ...
    def OneAxis(self) -> None: ...
...
class BRepPrimAPI_MakeTorus(BRepPrimAPI_MakeOneAxis):
    ...
    @overload
    def __init__(
        self, R1: float, R2: float, angle1: float, angle2: float, angle: float
    ) -> None: ...
    @overload
    ...
    @overload
    def __init__(
        self, Axes: gp_Ax2, R1: float, R2: float, angle1: float, angle2: float
    ) -> None: ...
    @overload
    def __init__(
        self,
