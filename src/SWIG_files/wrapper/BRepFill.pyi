...
class BRepFill_ListOfOffsetWire:
    ...
    def Assign(self, theItem: BRepFill_ListOfOffsetWire) -> BRepFill_ListOfOffsetWire: ...
    def Clear(self) -> None: ...
...
class BRepFill_SequenceOfEdgeFaceAndOrder:
    def Assign(self, theItem: BRepFill_EdgeFaceAndOrder) -> BRepFill_EdgeFaceAndOrder: ...
    def Clear(self) -> None: ...
