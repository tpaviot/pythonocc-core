...
class BRepFill_AdvancedEvolved:
    def __init__(self) -> None: ...
    def IsDone(self, theErrorCode: Optional[int] = None) -> bool: ...
...
class BRepFill_Sweep:
    ...
    def Build(self, ReversedEdges: TopTools_MapOfShape, Tapes: Any, Rails: Any, Transition: Optional[BRepFill_TransitionStyle] = BRepFill_Modified, Continuity: Optional[GeomAbs_Shape] = GeomAbs_C2, Approx: Optional[GeomFill_ApproxStyle] = GeomFill_Location, Degmax: Optional[int] = 11, Segmax: Optional[int] = 30) -> None: ...
    def ErrorOnSurface(self) -> float: ...
...
class BRepFill_NSections(BRepFill_SectionLaw):
    ...
    @overload
    def __init__(self, S: TopTools_SequenceOfShape, Trsfs: Any, P: TColStd_SequenceOfReal, VF: float, VL: float, Build: Optional[bool] = True) -> None: ...
    def ConcatenedLaw(self) -> GeomFill_SectionLaw: ...
    def Continuity(self, Index: int, TolAngular: float) -> GeomAbs_Shape: ...
