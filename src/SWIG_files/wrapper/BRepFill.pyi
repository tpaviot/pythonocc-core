...
BRepFill_IndexedDataMapOfOrientedShapeListOfShape = NewType(
    "BRepFill_IndexedDataMapOfOrientedShapeListOfShape", Any
)

class BRepFill_ListOfOffsetWire:
    def Append(self, theItem: BRepFill_OffsetWire) -> BRepFill_OffsetWire: ...
    def Assign(
        self, theItem: BRepFill_ListOfOffsetWire
    ...
    def __iter__(self) -> BRepFill_OffsetWire: ...

class BRepFill_SequenceOfEdgeFaceAndOrder:
    def Assign(
        self, theItem: BRepFill_EdgeFaceAndOrder
...
class BRepFill_SequenceOfFaceAndOrder:
    def Assign(self, theItem: BRepFill_FaceAndOrder) -> BRepFill_FaceAndOrder: ...
    def Clear(self) -> None: ...
...
class BRepFill_SequenceOfSection:
    def Assign(self, theItem: BRepFill_Section) -> BRepFill_Section: ...
    def Clear(self) -> None: ...
...
BRepFill_ThruSectionErrorStatus_Done = (
    BRepFill_ThruSectionErrorStatus.BRepFill_ThruSectionErrorStatus_Done
)
BRepFill_ThruSectionErrorStatus_NotDone = (
    BRepFill_ThruSectionErrorStatus.BRepFill_ThruSectionErrorStatus_NotDone
)
BRepFill_ThruSectionErrorStatus_NotSameTopology = (
    BRepFill_ThruSectionErrorStatus.BRepFill_ThruSectionErrorStatus_NotSameTopology
)
...
BRepFill_ThruSectionErrorStatus_WrongUsage = (
    BRepFill_ThruSectionErrorStatus.BRepFill_ThruSectionErrorStatus_WrongUsage
)
BRepFill_ThruSectionErrorStatus_Null3DCurve = (
    BRepFill_ThruSectionErrorStatus.BRepFill_ThruSectionErrorStatus_Null3DCurve
)
BRepFill_ThruSectionErrorStatus_Failed = (
    BRepFill_ThruSectionErrorStatus.BRepFill_ThruSectionErrorStatus_Failed
)
...
class brepfill:
    @staticmethod
    def Axe(
        Spine: TopoDS_Shape, Profile: TopoDS_Wire, AxeProf: gp_Ax3, Tol: float
    ) -> bool: ...
    @staticmethod
    ...
    @staticmethod
    def InsertACR(
        wire: TopoDS_Wire, ACRcuts: TColStd_Array1OfReal, prec: float
    ) -> TopoDS_Wire: ...
    @staticmethod
...
class BRepFill_AdvancedEvolved:
    ...
    def Perform(
        ...
        theTolerance: float,
        theSolidReq: Optional[bool] = True,
    ) -> None: ...
...
class BRepFill_ComputeCLine:
    ...
    def __init__(
        ...
        degreemin: Optional[int] = 3,
        degreemax: Optional[int] = 8,
        Tolerance3d: Optional[float] = 1.0e-5,
        Tolerance2d: Optional[float] = 1.0e-5,
        cutting: Optional[bool] = False,
        FirstC: Optional[AppParCurves_Constraint] = AppParCurves_TangencyPoint,
        LastC: Optional[AppParCurves_Constraint] = AppParCurves_TangencyPoint,
    ) -> None: ...
    @overload
    def __init__(
        self,
        degreemin: Optional[int] = 3,
        degreemax: Optional[int] = 8,
        Tolerance3d: Optional[float] = 1.0e-05,
        Tolerance2d: Optional[float] = 1.0e-05,
        cutting: Optional[bool] = False,
        FirstC: Optional[AppParCurves_Constraint] = AppParCurves_TangencyPoint,
        LastC: Optional[AppParCurves_Constraint] = AppParCurves_TangencyPoint,
    ) -> None: ...
...
class BRepFill_CurveConstraint(GeomPlate_CurveConstraint):
    ...
    def __init__(
        ...
        Order: int,
        NPt: Optional[int] = 10,
        TolDist: Optional[float] = 0.0001,
        TolAng: Optional[float] = 0.01,
        TolCurv: Optional[float] = 0.1,
    ) -> None: ...
    @overload
    def __init__(
        self,
...
class BRepFill_Draft:
    ...
    @overload
    def Perform(
        self, Surface: Geom_Surface, KeepInsideSurface: Optional[bool] = True
    ) -> None: ...
    @overload
    def Perform(
        self, StopShape: TopoDS_Shape, KeepOutSide: Optional[bool] = True
    ) -> None: ...
    def SetDraft(self, IsInternal: Optional[bool] = False) -> None: ...
    def SetOptions(
        self,
        Style: Optional[BRepFill_TransitionStyle] = BRepFill_Right,
        AngleMin: Optional[float] = 0.01,
        AngleMax: Optional[float] = 3.0,
    ) -> None: ...
    def Shape(self) -> TopoDS_Shape: ...
...
class BRepFill_EdgeFaceAndOrder:
    ...
    @overload
    def __init__(
        self, anEdge: TopoDS_Edge, aFace: TopoDS_Face, anOrder: GeomAbs_Shape
    ) -> None: ...
...
class BRepFill_Evolved:
    ...
    def GeneratedShapes(
        self, SpineShape: TopoDS_Shape, ProfShape: TopoDS_Shape
...
class BRepFill_Filling:
    def __init__(
        ...
        NbPtsOnCur: Optional[int] = 15,
        NbIter: Optional[int] = 2,
        Anisotropie: Optional[bool] = False,
        Tol2d: Optional[float] = 0.00001,
        Tol3d: Optional[float] = 0.0001,
        TolAng: Optional[float] = 0.01,
        TolCurv: Optional[float] = 0.1,
        MaxDeg: Optional[int] = 8,
        MaxSegments: Optional[int] = 9,
    ) -> None: ...
    @overload
    def Add(
        self, anEdge: TopoDS_Edge, Order: GeomAbs_Shape, IsBound: Optional[bool] = True
    ) -> int: ...
    @overload
    def Add(
        self,
    ...
    @overload
    def Add(
        self, U: float, V: float, Support: TopoDS_Face, Order: GeomAbs_Shape
    ) -> int: ...
    def Build(self) -> None: ...
    ...
    def SetApproxParam(
        self, MaxDeg: Optional[int] = 8, MaxSegments: Optional[int] = 9
    ) -> None: ...
    def SetConstrParam(
        self,
        Tol2d: Optional[float] = 0.00001,
...
class BRepFill_LocationLaw(Standard_Transient):
    ...
    def IsG1(
        self,
        Index: int,
        SpatialTolerance: Optional[float] = 1.0e-7,
...
class BRepFill_MultiLine(AppCont_Function):
    ...
    def Curves(
        self, Curve: Geom_Curve, PCurve1: Geom2d_Curve, PCurve2: Geom2d_Curve
    ) -> None: ...
    ...
    def Value3dOnF1OnF2(
        self, U: float, P3d: gp_Pnt, PF1: gp_Pnt2d, PF2: gp_Pnt2d
    ) -> None: ...
...
class BRepFill_OffsetWire:
    ...
    def __init__(
        ...
        Spine: TopoDS_Face,
        Join: Optional[GeomAbs_JoinType] = GeomAbs_Arc,
        IsOpenResult: Optional[bool] = False,
    ) -> None: ...
...
class BRepFill_Pipe:
    ...
    def __init__(
        ...
        ForceApproxC1: Optional[bool] = False,
        GeneratePartCase: Optional[bool] = False,
    ) -> None: ...
...
class BRepFill_PipeShell(Standard_Transient):
    ...
    def Add(
        self,
        Profile: TopoDS_Shape,
        WithContact: Optional[bool] = False,
        WithCorrection: Optional[bool] = False,
    ) -> None: ...
    @overload
    def Add(
        self,
    ...
    def Set(
        ...
        CurvilinearEquivalence: Optional[bool] = True,
        KeepContact: Optional[BRepFill_TypeOfContact] = BRepFill_NoContact,
    ) -> None: ...
    ...
    def SetTolerance(
        self,
        Tol3d: Optional[float] = 1.0e-4,
        BoundTol: Optional[float] = 1.0e-4,
        TolAngular: Optional[float] = 1.0e-2,
    ) -> None: ...
    def SetTransition(
        self,
        Mode: Optional[BRepFill_TransitionStyle] = BRepFill_Modified,
        Angmin: Optional[float] = 1.0e-2,
        Angmax: Optional[float] = 6.0,
    ) -> None: ...
    def Shape(self) -> TopoDS_Shape: ...
    def Simulate(
        self, NumberOfSection: int, Sections: TopTools_ListOfShape
    ) -> None: ...
...
class BRepFill_Sweep:
    ...
    def Build(
        ...
        Transition: Optional[BRepFill_TransitionStyle] = BRepFill_Modified,
        Continuity: Optional[GeomAbs_Shape] = GeomAbs_C2,
        Approx: Optional[GeomFill_ApproxStyle] = GeomFill_Location,
        Degmax: Optional[int] = 11,
        Segmax: Optional[int] = 30,
    ) -> None: ...
    def ErrorOnSurface(self) -> float: ...
    ...
    def SetAngularControl(
        self, AngleMin: Optional[float] = 0.01, AngleMax: Optional[float] = 6.0
    ) -> None: ...
    ...
    def SetTolerance(
        self,
        Tol3d: float,
        BoundTol: Optional[float] = 1.0,
        Tol2d: Optional[float] = 1.0e-5,
        TolAngular: Optional[float] = 1.0e-2,
    ) -> None: ...
    def Shape(self) -> TopoDS_Shape: ...
...
class BRepFill_TrimSurfaceTool:
    ...
    def IntersectWith(
        self, EdgeOnF1: TopoDS_Edge, EdgeOnF2: TopoDS_Edge, Points: TColgp_SequenceOfPnt
    ) -> None: ...
...
class BRepFill_NSections(BRepFill_SectionLaw):
    @overload
    def __init__(
        self, S: TopTools_SequenceOfShape, Build: Optional[bool] = True
    ) -> None: ...
    @overload
    def __init__(
        self,
...
class BRepFill_ShapeLaw(BRepFill_SectionLaw):
    ...
    @overload
    def __init__(
        self, W: TopoDS_Wire, L: Law_Function, Build: Optional[bool] = True
    ) -> None: ...
    def ConcatenedLaw(self) -> GeomFill_SectionLaw: ...
    def Continuity(self, Index: int, TolAngular: float) -> GeomAbs_Shape: ...
    def D0(self, Param: float, S: TopoDS_Shape) -> None: ...
