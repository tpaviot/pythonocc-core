...
"Handles local properties of curves and surfaces.Given a curve and a parameter value the following computations
are available :
...
Given a surface and 2 parameters the following computations are available :
