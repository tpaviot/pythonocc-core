...
Units_QuantitiesSequence = NewType("Units_QuantitiesSequence", Any)
# the following typedef cannot be wrapped as is
Units_TokensSequence = NewType("Units_TokensSequence", Any)
# the following typedef cannot be wrapped as is
Units_UnitsSequence = NewType("Units_UnitsSequence", Any)
...
class units:
    @staticmethod
    def Convert(avalue: float, afirstunit: str, asecondunit: str) -> False: ...
    @staticmethod
    ...
    @overload
    @staticmethod
    def FromSI(aData: float, aUnit: str) -> False: ...
    @overload
    @staticmethod
    def FromSI(aData: float, aUnit: str, aDim: Units_Dimensions) -> False: ...
    @staticmethod
    ...
    @overload
    @staticmethod
    def ToSI(aData: float, aUnit: str) -> False: ...
    @overload
    @staticmethod
    def ToSI(aData: float, aUnit: str, aDim: Units_Dimensions) -> False: ...
    @staticmethod
...
class Units_Token(Standard_Transient):
    ...
    def Divided(self, avalue: float) -> False: ...
    def Dump(self, ashift: int, alevel: int) -> None: ...
    @overload
    def IsEqual(self, astring: str) -> bool: ...
    @overload
    ...
    def Multiplied(self, avalue: float) -> False: ...
...
class Units_Unit(Standard_Transient):
    ...
    def SymbolsSequence(self) -> False: ...
    def Token(self) -> Units_Token: ...
    @overload
    def Value(self) -> float: ...
    @overload
...
class Units_UnitsSystem(Standard_Transient):
    ...
    def ActiveUnit(self, aquantity: str) -> str: ...
    def ActiveUnitsSequence(self) -> False: ...
    ...
    def QuantitiesSequence(self) -> False: ...
