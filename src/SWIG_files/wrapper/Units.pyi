...
class Units_Quantity(Standard_Transient):
    def __init__(self, aname: str, adimensions: Units_Dimensions, aunitssequence: Any) -> None: ...
...
class Units_Sentence:
    ...
    def Sequence(self) -> Any: ...
    @overload
    def Sequence(self, asequenceoftokens: Any) -> None: ...
...
class Units_UnitsSystem(Standard_Transient):
    ...
    def QuantitiesSequence(self) -> Any: ...
...
class Units_UnitSentence(Units_Sentence):
    ...
    def __init__(self, astring: str) -> None: ...
    @overload
    def __init__(self, astring: str, aquantitiessequence: Any) -> None: ...
    def Analyse(self) -> None: ...
    def SetUnits(self, aquantitiessequence: Any) -> None: ...
