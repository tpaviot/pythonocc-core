...
StepDimTol_HArray1OfDatumReference = NewType("StepDimTol_HArray1OfDatumReference", Any)
# the following typedef cannot be wrapped as is
StepDimTol_HArray1OfDatumReferenceCompartment = NewType("StepDimTol_HArray1OfDatumReferenceCompartment", Any)
# the following typedef cannot be wrapped as is
StepDimTol_HArray1OfDatumReferenceElement = NewType("StepDimTol_HArray1OfDatumReferenceElement", Any)
# the following typedef cannot be wrapped as is
StepDimTol_HArray1OfDatumReferenceModifier = NewType("StepDimTol_HArray1OfDatumReferenceModifier", Any)
# the following typedef cannot be wrapped as is
StepDimTol_HArray1OfDatumSystemOrReference = NewType("StepDimTol_HArray1OfDatumSystemOrReference", Any)
# the following typedef cannot be wrapped as is
StepDimTol_HArray1OfGeometricToleranceModifier = NewType("StepDimTol_HArray1OfGeometricToleranceModifier", Any)
# the following typedef cannot be wrapped as is
StepDimTol_HArray1OfToleranceZoneTarget = NewType("StepDimTol_HArray1OfToleranceZoneTarget", Any)
...
class StepDimTol_DatumOrCommonDatum(StepData_SelectType):
    ...
    def CommonDatumList(self) -> False: ...
    def Datum(self) -> StepDimTol_Datum: ...
...
class StepDimTol_ToleranceZone(StepRepr_ShapeAspect):
    def __init__(self) -> None: ...
    def DefiningTolerance(self) -> False: ...
...
class StepDimTol_GeometricToleranceWithDatumReference(StepDimTol_GeometricTolerance):
    def __init__(self) -> None: ...
    def DatumSystem(self) -> False: ...
    def DatumSystemAP242(self) -> False: ...
