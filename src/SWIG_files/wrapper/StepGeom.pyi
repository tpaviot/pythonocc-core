...
class StepGeom_Array1OfPcurveOrSurface:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepGeom_PcurveOrSurface]: ...
...
class StepGeom_Array1OfSurfaceBoundary:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepGeom_SurfaceBoundary]: ...
...
class StepGeom_Array1OfTrimmingSelect:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[StepGeom_TrimmingSelect]: ...
...
class StepGeom_GeomRepContextAndGlobUnitAssCtxAndGlobUncertaintyAssCtx(StepRepr_RepresentationContext):
    ...
    @overload
    def Init(self, aContextIdentifier: TCollection_HAsciiString, aContextType: TCollection_HAsciiString, aCoordinateSpaceDimension: int, aUnits: Any, anUncertainty: Any) -> None: ...
    ...
    def SetUncertainty(self, aUncertainty: Any) -> None: ...
    def SetUnits(self, aUnits: Any) -> None: ...
...
class StepGeom_GeometricRepresentationContextAndGlobalUnitAssignedContext(StepRepr_RepresentationContext):
    ...
    @overload
    def Init(self, aContextIdentifier: TCollection_HAsciiString, aContextType: TCollection_HAsciiString, aCoordinateSpaceDimension: int, aUnits: Any) -> None: ...
    def NbUnits(self) -> int: ...
    def SetCoordinateSpaceDimension(self, aCoordinateSpaceDimension: int) -> None: ...
    def SetGeometricRepresentationContext(self, aGeometricRepresentationContext: StepGeom_GeometricRepresentationContext) -> None: ...
    def SetGlobalUnitAssignedContext(self, aGlobalUnitAssignedContext: StepRepr_GlobalUnitAssignedContext) -> None: ...
...
class StepGeom_Direction(StepGeom_GeometricRepresentationItem):
    def __init__(self) -> None: ...
    def DirectionRatios(self) -> Any: ...
    def DirectionRatiosValue(self, theInd: int) -> float: ...
    def Init(self, theName: TCollection_HAsciiString, theDirectionRatios: TColStd_HArray1OfReal) -> None: ...
    def Init2D(self, theName: TCollection_HAsciiString, theDirectionRatios1: float, theDirectionRatios2: float) -> None: ...
    def Init3D(self, theName: TCollection_HAsciiString, theDirectionRatios1: float, theDirectionRatios2: float, theDirectionRatios3: float) -> None: ...
    def NbDirectionRatios(self) -> int: ...
    @overload
    def SetDirectionRatios(self, theDirectionRatios: TColStd_HArray1OfReal) -> None: ...
    @overload
    def SetDirectionRatios(self, theDirectionRatios: Any) -> None: ...
    def SetNbDirectionRatios(self, theSize: int) -> None: ...
...
class StepGeom_SuParameters(StepGeom_GeometricRepresentationItem):
    ...
    def Init(self, theRepresentationItem_Name: TCollection_HAsciiString, theA: float, theAlpha: float, theB: float, theBeta: float, theC: float, theGamma: float) -> None: ...
...
class StepGeom_CartesianPoint(StepGeom_Point):
    ...
    def CoordinatesValue(self, theInd: int) -> float: ...
    def Init(self, theName: TCollection_HAsciiString, theCoordinates: TColStd_HArray1OfReal) -> None: ...
    def Init2D(self, theName: TCollection_HAsciiString, theX: float, theY: float) -> None: ...
    def Init3D(self, theName: TCollection_HAsciiString, theX: float, theY: float, theZ: float) -> None: ...
    def NbCoordinates(self) -> int: ...
    @overload
    def SetCoordinates(self, theCoordinates: TColStd_HArray1OfReal) -> None: ...
    @overload
    def SetCoordinates(self, theCoordinates: Any) -> None: ...
    def SetNbCoordinates(self, theSize: int) -> None: ...
...
class StepGeom_SurfaceCurve(StepGeom_Curve):
    def __init__(self) -> None: ...
    def AssociatedGeometry(self) -> Any: ...
    def AssociatedGeometryValue(self, num: int) -> StepGeom_PcurveOrSurface: ...
    def Curve3d(self) -> StepGeom_Curve: ...
    def Init(self, aName: TCollection_HAsciiString, aCurve3d: StepGeom_Curve, aAssociatedGeometry: Any, aMasterRepresentation: StepGeom_PreferredSurfaceCurveRepresentation) -> None: ...
    def MasterRepresentation(self) -> StepGeom_PreferredSurfaceCurveRepresentation: ...
    def NbAssociatedGeometry(self) -> int: ...
    def SetAssociatedGeometry(self, aAssociatedGeometry: Any) -> None: ...
...
class StepGeom_BSplineCurve(StepGeom_BoundedCurve):
    ...
    def ControlPointsList(self) -> Any: ...
    def ControlPointsListValue(self, num: int) -> StepGeom_CartesianPoint: ...
    def CurveForm(self) -> StepGeom_BSplineCurveForm: ...
    def Degree(self) -> int: ...
    def Init(self, aName: TCollection_HAsciiString, aDegree: int, aControlPointsList: Any, aCurveForm: StepGeom_BSplineCurveForm, aClosedCurve: StepData_Logical, aSelfIntersect: StepData_Logical) -> None: ...
    def NbControlPointsList(self) -> int: ...
    def SelfIntersect(self) -> StepData_Logical: ...
    def SetClosedCurve(self, aClosedCurve: StepData_Logical) -> None: ...
    def SetControlPointsList(self, aControlPointsList: Any) -> None: ...
...
class StepGeom_BSplineSurface(StepGeom_BoundedSurface):
    ...
    def Init(self, aName: TCollection_HAsciiString, aUDegree: int, aVDegree: int, aControlPointsList: Any, aSurfaceForm: StepGeom_BSplineSurfaceForm, aUClosed: StepData_Logical, aVClosed: StepData_Logical, aSelfIntersect: StepData_Logical) -> None: ...
...
class StepGeom_CompositeCurve(StepGeom_BoundedCurve):
    def __init__(self) -> None: ...
    def Init(self, aName: TCollection_HAsciiString, aSegments: Any, aSelfIntersect: StepData_Logical) -> None: ...
    def NbSegments(self) -> int: ...
    def Segments(self) -> Any: ...
    def SegmentsValue(self, num: int) -> StepGeom_CompositeCurveSegment: ...
    def SelfIntersect(self) -> StepData_Logical: ...
    def SetSegments(self, aSegments: Any) -> None: ...
    def SetSelfIntersect(self, aSelfIntersect: StepData_Logical) -> None: ...
...
class StepGeom_CurveBoundedSurface(StepGeom_BoundedSurface):
    ...
    def Init(self, aRepresentationItem_Name: TCollection_HAsciiString, aBasisSurface: StepGeom_Surface, aBoundaries: Any, aImplicitOuter: bool) -> None: ...
    def SetBasisSurface(self, BasisSurface: StepGeom_Surface) -> None: ...
    def SetBoundaries(self, Boundaries: Any) -> None: ...
...
class StepGeom_Polyline(StepGeom_BoundedCurve):
    def __init__(self) -> None: ...
    def Init(self, aName: TCollection_HAsciiString, aPoints: Any) -> None: ...
    def NbPoints(self) -> int: ...
    def Points(self) -> Any: ...
    def PointsValue(self, num: int) -> StepGeom_CartesianPoint: ...
    def SetPoints(self, aPoints: Any) -> None: ...

class StepGeom_RectangularCompositeSurface(StepGeom_BoundedSurface):
    def __init__(self) -> None: ...
    def Init(self, aName: TCollection_HAsciiString, aSegments: Any) -> None: ...
...
class StepGeom_TrimmedCurve(StepGeom_BoundedCurve):
    def __init__(self) -> None: ...
    def BasisCurve(self) -> StepGeom_Curve: ...
    def Init(self, aName: TCollection_HAsciiString, aBasisCurve: StepGeom_Curve, aTrim1: Any, aTrim2: Any, aSenseAgreement: bool, aMasterRepresentation: StepGeom_TrimmingPreference) -> None: ...
    ...
    def SetTrim1(self, aTrim1: Any) -> None: ...
    def SetTrim2(self, aTrim2: Any) -> None: ...
    def Trim1(self) -> Any: ...
...
class StepGeom_BSplineCurveWithKnots(StepGeom_BSplineCurve):
    def __init__(self) -> None: ...
    def Init(self, aName: TCollection_HAsciiString, aDegree: int, aControlPointsList: Any, aCurveForm: StepGeom_BSplineCurveForm, aClosedCurve: StepData_Logical, aSelfIntersect: StepData_Logical, aKnotMultiplicities: TColStd_HArray1OfInteger, aKnots: TColStd_HArray1OfReal, aKnotSpec: StepGeom_KnotType) -> None: ...
...
class StepGeom_BSplineCurveWithKnotsAndRationalBSplineCurve(StepGeom_BSplineCurve):
    ...
    @overload
    def Init(self, aName: TCollection_HAsciiString, aDegree: int, aControlPointsList: Any, aCurveForm: StepGeom_BSplineCurveForm, aClosedCurve: StepData_Logical, aSelfIntersect: StepData_Logical, aBSplineCurveWithKnots: StepGeom_BSplineCurveWithKnots, aRationalBSplineCurve: StepGeom_RationalBSplineCurve) -> None: ...
    @overload
    def Init(self, aName: TCollection_HAsciiString, aDegree: int, aControlPointsList: Any, aCurveForm: StepGeom_BSplineCurveForm, aClosedCurve: StepData_Logical, aSelfIntersect: StepData_Logical, aKnotMultiplicities: TColStd_HArray1OfInteger, aKnots: TColStd_HArray1OfReal, aKnotSpec: StepGeom_KnotType, aWeightsData: TColStd_HArray1OfReal) -> None: ...
    def KnotMultiplicities(self) -> TColStd_HArray1OfInteger: ...
    def KnotMultiplicitiesValue(self, num: int) -> int: ...
    def KnotSpec(self) -> StepGeom_KnotType: ...
    def Knots(self) -> TColStd_HArray1OfReal: ...
...
class StepGeom_BezierCurveAndRationalBSplineCurve(StepGeom_BSplineCurve):
    ...
    @overload
    def Init(self, aName: TCollection_HAsciiString, aDegree: int, aControlPointsList: Any, aCurveForm: StepGeom_BSplineCurveForm, aClosedCurve: StepData_Logical, aSelfIntersect: StepData_Logical, aBezierCurve: StepGeom_BezierCurve, aRationalBSplineCurve: StepGeom_RationalBSplineCurve) -> None: ...
    @overload
    def Init(self, aName: TCollection_HAsciiString, aDegree: int, aControlPointsList: Any, aCurveForm: StepGeom_BSplineCurveForm, aClosedCurve: StepData_Logical, aSelfIntersect: StepData_Logical, aWeightsData: TColStd_HArray1OfReal) -> None: ...
    def NbWeightsData(self) -> int: ...
    def RationalBSplineCurve(self) -> StepGeom_RationalBSplineCurve: ...
...
class StepGeom_BezierSurfaceAndRationalBSplineSurface(StepGeom_BSplineSurface):
    ...
    @overload
    def Init(self, aName: TCollection_HAsciiString, aUDegree: int, aVDegree: int, aControlPointsList: Any, aSurfaceForm: StepGeom_BSplineSurfaceForm, aUClosed: StepData_Logical, aVClosed: StepData_Logical, aSelfIntersect: StepData_Logical, aWeightsData: TColStd_HArray2OfReal) -> None: ...
    def NbWeightsDataI(self) -> int: ...
    def NbWeightsDataJ(self) -> int: ...
    def RationalBSplineSurface(self) -> StepGeom_RationalBSplineSurface: ...
...
class StepGeom_QuasiUniformCurveAndRationalBSplineCurve(StepGeom_BSplineCurve):
    def __init__(self) -> None: ...
    @overload
    def Init(self, aName: TCollection_HAsciiString, aDegree: int, aControlPointsList: Any, aCurveForm: StepGeom_BSplineCurveForm, aClosedCurve: StepData_Logical, aSelfIntersect: StepData_Logical, aQuasiUniformCurve: StepGeom_QuasiUniformCurve, aRationalBSplineCurve: StepGeom_RationalBSplineCurve) -> None: ...
    @overload
    def Init(self, aName: TCollection_HAsciiString, aDegree: int, aControlPointsList: Any, aCurveForm: StepGeom_BSplineCurveForm, aClosedCurve: StepData_Logical, aSelfIntersect: StepData_Logical, aWeightsData: TColStd_HArray1OfReal) -> None: ...
    def NbWeightsData(self) -> int: ...
...
class StepGeom_UniformCurveAndRationalBSplineCurve(StepGeom_BSplineCurve):
    def __init__(self) -> None: ...
    @overload
    def Init(self, aName: TCollection_HAsciiString, aDegree: int, aControlPointsList: Any, aCurveForm: StepGeom_BSplineCurveForm, aClosedCurve: StepData_Logical, aSelfIntersect: StepData_Logical, aUniformCurve: StepGeom_UniformCurve, aRationalBSplineCurve: StepGeom_RationalBSplineCurve) -> None: ...
    @overload
    def Init(self, aName: TCollection_HAsciiString, aDegree: int, aControlPointsList: Any, aCurveForm: StepGeom_BSplineCurveForm, aClosedCurve: StepData_Logical, aSelfIntersect: StepData_Logical, aWeightsData: TColStd_HArray1OfReal) -> None: ...
    def NbWeightsData(self) -> int: ...
    def RationalBSplineCurve(self) -> StepGeom_RationalBSplineCurve: ...
