...
TopOpeBRepTool_IndexedDataMapOfShapeBox = NewType(
    "TopOpeBRepTool_IndexedDataMapOfShapeBox", Any
)
# the following typedef cannot be wrapped as is
TopOpeBRepTool_IndexedDataMapOfShapeBox2d = NewType(
    "TopOpeBRepTool_IndexedDataMapOfShapeBox2d", Any
)
# the following typedef cannot be wrapped as is
TopOpeBRepTool_IndexedDataMapOfShapeconnexity = NewType(
    "TopOpeBRepTool_IndexedDataMapOfShapeconnexity", Any
)
TopOpeBRepTool_PShapeClassifier = NewType(
    "TopOpeBRepTool_PShapeClassifier", TopOpeBRepTool_ShapeClassifier
)
TopOpeBRepTool_PSoClassif = NewType(
    "TopOpeBRepTool_PSoClassif", BRepClass3d_SolidClassifier
)
...
class TopOpeBRepTool_ListOfC2DF:
    ...
    def Assign(
        self, theItem: TopOpeBRepTool_ListOfC2DF
    ...
    def __iter__(self) -> TopOpeBRepTool_C2DF: ...
...
class TopOpeBRepTool_BoxSort:
    ...
    def AddBoxes(
        ...
        S: TopoDS_Shape,
        TS: TopAbs_ShapeEnum,
        TA: Optional[TopAbs_ShapeEnum] = TopAbs_SHAPE,
    ) -> None: ...
    def AddBoxesMakeCOB(
        self,
        S: TopoDS_Shape,
...
class TopOpeBRepTool_C2DF:
    ...
    @overload
    def __init__(
        self, PC: Geom2d_Curve, f2d: float, l2d: float, tol: float, F: TopoDS_Face
    ) -> None: ...
...
class TopOpeBRepTool_CLASSI:
    ...
    def ClassiBnd2d(
        self, S1: TopoDS_Shape, S2: TopoDS_Shape, tol: float, checklarge: bool
    ) -> int: ...
    def Classilist(
        self, lS: TopTools_ListOfShape, mapgreasma: TopTools_DataMapOfShapeListOfShape
    ) -> bool: ...
...
class TopOpeBRepTool_CORRISO:
    ...
    def EdgeOUTofBoundsUV(
        self, E: TopoDS_Edge, onU: bool, tolx: float
    ) -> Tuple[int, float]: ...
    @overload
    def EdgeWithFaultyUV(self, E: TopoDS_Edge) -> Tuple[bool, int]: ...
    @overload
    def EdgeWithFaultyUV(
        self, EdsToCheck: TopTools_ListOfShape, nfybounds: int, fyE: TopoDS_Shape
    ) -> Tuple[bool, int]: ...
    ...
    def EdgesWithFaultyUV(
        ...
        nfybounds: int,
        FyEds: TopTools_DataMapOfOrientedShapeInteger,
        stopatfirst: Optional[bool] = False,
    ) -> bool: ...
    ...
    def PurgeFyClosingE(
        self, ClEds: TopTools_ListOfShape, fyClEds: TopTools_ListOfShape
    ) -> bool: ...
    ...
    def TrslUV(
        self, onU: bool, FyEds: TopTools_DataMapOfOrientedShapeInteger
    ) -> bool: ...
...
class TopOpeBRepTool_GeomTool:
    def __init__(
        self,
        TypeC3D: Optional[TopOpeBRepTool_OutCurveType] = TopOpeBRepTool_BSPLINE1,
        CompC3D: Optional[bool] = True,
        CompPC1: Optional[bool] = True,
        CompPC2: Optional[bool] = True,
    ) -> None: ...
...
class TopOpeBRepTool_PurgeInternalEdges:
    def __init__(
        self, theShape: TopoDS_Shape, PerformNow: Optional[bool] = True
    ) -> None: ...
...
class TopOpeBRepTool_REGUS:
    ...
    def MapS(self) -> bool: ...
    def NearestF(
        self, e: TopoDS_Edge, lof: TopTools_ListOfShape, ffound: TopoDS_Face
    ) -> bool: ...
    ...
    @staticmethod
    def WireToFace(
        Fanc: TopoDS_Face, nWs: TopTools_ListOfShape, nFs: TopTools_ListOfShape
    ) -> bool: ...

class TopOpeBRepTool_REGUW:
    def __init__(self, FRef: TopoDS_Face) -> None: ...
    def AddNewConnexity(
        self, v: TopoDS_Vertex, OriKey: int, e: TopoDS_Edge
    ) -> bool: ...
    ...
    @overload
    def REGU(
        self, istep: int, Scur: TopoDS_Shape, Splits: TopTools_ListOfShape
    ) -> bool: ...
    @overload
    def REGU(self) -> bool: ...
...
class TopOpeBRepTool_ShapeClassifier:
    ...
    def StateShapeReference(
        self, S: TopoDS_Shape, AvoidS: TopoDS_Shape
    ) -> TopAbs_State: ...
    @overload
    def StateShapeReference(
        self, S: TopoDS_Shape, LAvoidS: TopTools_ListOfShape
    ) -> TopAbs_State: ...
    @overload
    def StateShapeShape(
        self, S: TopoDS_Shape, SRef: TopoDS_Shape, samedomain: Optional[int] = 0
    ) -> TopAbs_State: ...
    @overload
    def StateShapeShape(
        self, S: TopoDS_Shape, AvoidS: TopoDS_Shape, SRef: TopoDS_Shape
    ) -> TopAbs_State: ...
    @overload
    def StateShapeShape(
        self, S: TopoDS_Shape, LAvoidS: TopTools_ListOfShape, SRef: TopoDS_Shape
    ) -> TopAbs_State: ...
...
class TopOpeBRepTool_ShapeTool:
    ...
    @staticmethod
    def EdgeData(
        BRAC: BRepAdaptor_Curve, P: float, T: gp_Dir, N: gp_Dir
    ) -> Tuple[float, float]: ...
    @overload
    @staticmethod
    def EdgeData(
        E: TopoDS_Shape, P: float, T: gp_Dir, N: gp_Dir
    ) -> Tuple[float, float]: ...
    @staticmethod
...
class TopOpeBRepTool_TOOL:
    ...
    @staticmethod
    def CurvF(
        F: TopoDS_Face, uv: gp_Pnt2d, tg0: gp_Dir
    ) -> Tuple[bool, float, bool]: ...
    @staticmethod
    def EdgeONFace(
        par: float, ed: TopoDS_Edge, uv: gp_Pnt2d, fa: TopoDS_Face
    ) -> Tuple[bool, bool]: ...
    @staticmethod
    def Getduv(
        f: TopoDS_Face, uv: gp_Pnt2d, dir: gp_Vec, factor: float, duv: gp_Dir2d
    ) -> bool: ...
    @staticmethod
    def Getstp3dF(
        p: gp_Pnt, f: TopoDS_Face, uv: gp_Pnt2d
    ...
    @staticmethod
    def IsonCLO(
        PC: Geom2d_Curve, onU: bool, xfirst: float, xperiod: float, xtol: float
    ) -> bool: ...
    @overload
    @staticmethod
    def IsonCLO(
        C2DF: TopOpeBRepTool_C2DF, onU: bool, xfirst: float, xperiod: float, xtol: float
    ) -> bool: ...
    @overload
    @staticmethod
    ...
    @staticmethod
    def Matter(
        xx1: gp_Dir, nt1: gp_Dir, xx2: gp_Dir, nt2: gp_Dir, tola: float
    ) -> Tuple[bool, float]: ...
    @overload
    @staticmethod
    def Matter(
        f1: TopoDS_Face, f2: TopoDS_Face, e: TopoDS_Edge, pare: float, tola: float
    ) -> Tuple[bool, float]: ...
    @staticmethod
    def MatterKPtg(
        f1: TopoDS_Face, f2: TopoDS_Face, e: TopoDS_Edge
    ) -> Tuple[bool, float]: ...
    @staticmethod
    def MkShell(lF: TopTools_ListOfShape, She: TopoDS_Shape) -> None: ...
    @staticmethod
    def NgApp(
        par: float, E: TopoDS_Edge, F: TopoDS_Face, tola: float, ngApp: gp_Dir
    ) -> bool: ...
    @staticmethod
    ...
    @staticmethod
    def OriinSor(
        sub: TopoDS_Shape, S: TopoDS_Shape, checkclo: Optional[bool] = False
    ) -> int: ...
    @staticmethod
    ...
    @staticmethod
    def ParE2d(
        p2d: gp_Pnt2d, e: TopoDS_Edge, f: TopoDS_Face
    ) -> Tuple[bool, float, float]: ...
    @staticmethod
    ...
    @staticmethod
    def Tg2dApp(
        iv: int, E: TopoDS_Edge, C2DF: TopOpeBRepTool_C2DF, factor: float
    ) -> gp_Vec2d: ...
    @staticmethod
    ...
    @staticmethod
    def UVISO(
        PC: Geom2d_Curve, d2d: gp_Dir2d, o2d: gp_Pnt2d
    ) -> Tuple[bool, bool, bool]: ...
    @overload
    @staticmethod
    def UVISO(
        C2DF: TopOpeBRepTool_C2DF, d2d: gp_Dir2d, o2d: gp_Pnt2d
    ) -> Tuple[bool, bool, bool]: ...
    @overload
    @staticmethod
    def UVISO(
        E: TopoDS_Edge, F: TopoDS_Face, d2d: gp_Dir2d, o2d: gp_Pnt2d
    ) -> Tuple[bool, bool, bool]: ...
    @staticmethod
    ...
    @staticmethod
    def XX(
        uv: gp_Pnt2d, f: TopoDS_Face, par: float, e: TopoDS_Edge, xx: gp_Dir
    ) -> bool: ...
    @staticmethod
    ...
    @staticmethod
    def tryNgApp(
        par: float, E: TopoDS_Edge, F: TopoDS_Face, tola: float, ng: gp_Dir
    ) -> bool: ...
    @staticmethod
    ...
    @staticmethod
    def uvApp(
        f: TopoDS_Face, e: TopoDS_Edge, par: float, eps: float, uvapp: gp_Pnt2d
    ) -> bool: ...
