...
class TopOpeBRepTool_BoxSort:
    ...
    def Clear(self) -> None: ...
    def Compare(self, S: TopoDS_Shape) -> False: ...
    def HAB(self) -> False: ...
...
class TopOpeBRepTool_CORRISO:
    ...
    def TrslUV(self, onU: bool, FyEds: int) -> bool: ...
...
class TopOpeBRepTool_ShapeTool:
    ...
    @staticmethod
    def PeriodizeParameter(par: float, EE: TopoDS_Shape, FF: TopoDS_Shape) -> False: ...
    @staticmethod
    def Pnt(S: TopoDS_Shape) -> gp_Pnt: ...
    @overload
    @staticmethod
    def Resolution3d(SU: Geom_Surface, Tol2d: float) -> False: ...
    @overload
    @staticmethod
    def Resolution3d(F: TopoDS_Face, Tol2d: float) -> False: ...
    @staticmethod
    def Resolution3dU(SU: Geom_Surface, Tol2d: float) -> False: ...
    @staticmethod
    def Resolution3dV(SU: Geom_Surface, Tol2d: float) -> False: ...
    @staticmethod
    ...
    @staticmethod
    def Tolerance(S: TopoDS_Shape) -> False: ...
...
class TopOpeBRepTool_TOOL:
    ...
    @overload
    @staticmethod
    def Matter(d1: gp_Vec, d2: gp_Vec, ref: gp_Vec) -> False: ...
    @overload
    @staticmethod
    def Matter(d1: gp_Vec2d, d2: gp_Vec2d) -> False: ...
    @staticmethod
    ...
    @staticmethod
    def ParE(Iv: int, E: TopoDS_Edge) -> False: ...
    @staticmethod
    ...
    @staticmethod
    def TolP(E: TopoDS_Edge, F: TopoDS_Face) -> False: ...
    @staticmethod
    def TolUV(F: TopoDS_Face, tol3d: float) -> False: ...
    @staticmethod
    ...
    @staticmethod
    def minDUV(F: TopoDS_Face) -> False: ...
    @staticmethod
...
class TopOpeBRepTool_connexity:
    ...
    def ChangeItem(self, OriKey: int) -> False: ...
