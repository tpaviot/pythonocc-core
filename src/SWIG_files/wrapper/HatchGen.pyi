...
class HatchGen_Domains:
    def Assign(self, theItem: HatchGen_Domain) -> HatchGen_Domain: ...
    def Clear(self) -> None: ...
...
class HatchGen_PointsOnElement:
    def Assign(self, theItem: HatchGen_PointOnElement) -> HatchGen_PointOnElement: ...
    def Clear(self) -> None: ...
...
class HatchGen_PointsOnHatching:
    def Assign(self, theItem: HatchGen_PointOnHatching) -> HatchGen_PointOnHatching: ...
    def Clear(self) -> None: ...
    ...
    def Lower(self) -> int: ...
    def Prepend(
        self, theItem: HatchGen_PointOnHatching
...
class HatchGen_Domain:
    ...
    @overload
    def __init__(
        self, P1: HatchGen_PointOnHatching, P2: HatchGen_PointOnHatching
    ) -> None: ...
    @overload
