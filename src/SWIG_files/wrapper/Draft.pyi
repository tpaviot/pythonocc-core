...
class Draft_IndexedDataMapOfEdgeEdgeInfo:
    def __init__(self, *args: Any, **kwargs: Any) -> None: ...
    def __getattr__(self, name: str) -> Any: ...

class Draft_IndexedDataMapOfFaceFaceInfo:
    def __init__(self, *args: Any, **kwargs: Any) -> None: ...
    def __getattr__(self, name: str) -> Any: ...

class Draft_IndexedDataMapOfVertexVertexInfo:
    def __init__(self, *args: Any, **kwargs: Any) -> None: ...
    def __getattr__(self, name: str) -> Any: ...
...
class Draft_VertexInfo:
    ...
    def ChangeParameter(self, E: TopoDS_Edge) -> Any: ...
