...
class Contap_TheIWalking:
    ...
    @overload
    def Perform(self, Pnts1: Any, Pnts2: Any, Func: Contap_SurfFunction, S: Adaptor3d_Surface, Reversed: Optional[bool] = False) -> None: ...
    @overload
    def Perform(self, Pnts1: Any, Func: Contap_SurfFunction, S: Adaptor3d_Surface, Reversed: Optional[bool] = False) -> None: ...
