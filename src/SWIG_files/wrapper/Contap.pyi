...
class Contap_SequenceOfPathPointOfTheSearch:
    def Assign(self, theItem: Contap_ThePathPointOfTheSearch) -> Contap_ThePathPointOfTheSearch: ...
    def Clear(self) -> None: ...
...
class Contap_SequenceOfSegmentOfTheSearch:
    def Assign(self, theItem: Contap_TheSegmentOfTheSearch) -> Contap_TheSegmentOfTheSearch: ...
    def Clear(self) -> None: ...
...
class Contap_TheSequenceOfLine:
    def Assign(self, theItem: Contap_Line) -> Contap_Line: ...
    def Clear(self) -> None: ...
...
class Contap_TheSequenceOfPoint:
    def Assign(self, theItem: Contap_Point) -> Contap_Point: ...
    def Clear(self) -> None: ...
