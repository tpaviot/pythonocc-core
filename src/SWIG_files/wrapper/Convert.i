...
class Convert_GridPolynomialToPoles {
	...
	:param MaxUDegree:
	:type MaxUDegree: Standard_Integer
	:param MaxVDegree:
	:type MaxVDegree: Standard_Integer
	:param NumCoeff:
...
") Convert_GridPolynomialToPoles;
	...
	:param NbUSurfaces:
	:type NbUSurfaces: Standard_Integer
	:param NBVSurfaces:
	:type NBVSurfaces: Standard_Integer
	:param UContinuity:
	:type UContinuity: Standard_Integer
	:param VContinuity:
	:type VContinuity: Standard_Integer
	:param MaxUDegree:
	:type MaxUDegree: Standard_Integer
	:param MaxVDegree:
	:type MaxVDegree: Standard_Integer
