...
class StdPrs_BRepFont(Standard_Transient):
    ...
    @overload
    def __init__(self, theFontName: NCollection_String, theFontAspect: Any, theSize: float, theStrictLevel: Optional[Any] = Font_StrictLevel_Any) -> None: ...
    @overload
    def AdvanceX(self, theUCharNext: Any) -> float: ...
    @overload
    def AdvanceX(self, theUChar: Any, theUCharNext: Any) -> float: ...
    @overload
    def AdvanceY(self, theUCharNext: Any) -> float: ...
    @overload
    def AdvanceY(self, theUChar: Any, theUCharNext: Any) -> float: ...
    def Ascender(self) -> float: ...
    def Descender(self) -> float: ...
    def FTFont(self) -> Any: ...
    @staticmethod
    def FindAndCreate(theFontName: str, theFontAspect: Any, theSize: float, theStrictLevel: Optional[Any] = Font_StrictLevel_Any) -> StdPrs_BRepFont: ...
    def FindAndInit(self, theFontName: str, theFontAspect: Any, theSize: float, theStrictLevel: Optional[Any] = Font_StrictLevel_Any) -> bool: ...
    @overload
    def Init(self, theFontPath: NCollection_String, theSize: float, theFaceId: int) -> bool: ...
    @overload
    def Init(self, theFontName: NCollection_String, theFontAspect: Any, theSize: float) -> bool: ...
    def LineSpacing(self) -> float: ...
    def Mutex(self) -> Any: ...
    def PointSize(self) -> float: ...
    def Release(self) -> None: ...
    def RenderGlyph(self, theChar: Any) -> TopoDS_Shape: ...
...
class StdPrs_BRepTextBuilder:
    @overload
    def Perform(self, theFont: StdPrs_BRepFont, theFormatter: Any, thePenLoc: Optional[gp_Ax3] = gp_Ax3()) -> TopoDS_Shape: ...
    @overload
...
class StdPrs_Isolines(Prs3d_Root):
    ...
    @overload
    @staticmethod
    def Add(theFace: TopoDS_Face, theDrawer: Prs3d_Drawer, theDeflection: float, theUPolylines: Any, theVPolylines: Any) -> None: ...
    @overload
    @staticmethod
    def AddOnSurface(thePresentation: Prs3d_Presentation, theFace: TopoDS_Face, theDrawer: Prs3d_Drawer, theDeflection: float) -> None: ...
    @overload
    @staticmethod
    def AddOnSurface(theFace: TopoDS_Face, theDrawer: Prs3d_Drawer, theDeflection: float, theUPolylines: Any, theVPolylines: Any) -> None: ...
    @overload
    @staticmethod
    ...
    @overload
    @staticmethod
    def AddOnTriangulation(theFace: TopoDS_Face, theDrawer: Prs3d_Drawer, theUPolylines: Any, theVPolylines: Any) -> None: ...
    @overload
    @staticmethod
...
class StdPrs_WFDeflectionRestrictedFace(Prs3d_Root):
    ...
    @overload
    @staticmethod
    def Add(aPresentation: Prs3d_Presentation, aFace: BRepAdaptor_Surface, DrawUIso: bool, DrawVIso: bool, Deflection: float, NBUiso: int, NBViso: int, aDrawer: Prs3d_Drawer, Curves: Any) -> None: ...
    @staticmethod
...
class StdPrs_WFRestrictedFace(Prs3d_Root):
    @overload
    @staticmethod
    def Add(thePresentation: Prs3d_Presentation, theFace: BRepAdaptor_Surface, theDrawUIso: bool, theDrawVIso: bool, theNbUIso: int, theNbVIso: int, theDrawer: Prs3d_Drawer, theCurves: Any) -> None: ...
    @overload
    @staticmethod
