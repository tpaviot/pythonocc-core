...
UIndex: int
VIndex: int
UFlatKnots: NCollection_Array1<double>
VFlatKnots: NCollection_Array1<double>
Poles: NCollection_Array2<gp_Pnt>
Weights: NCollection_Array2<double> *
CachePoles: NCollection_Array2<gp_Pnt>
CacheWeights: NCollection_Array2<double> *
...
theUIndex: int
theVIndex: int
theUFlatKnots: NCollection_Array1<double>
theVFlatKnots: NCollection_Array1<double>
thePoles: NCollection_Array2<gp_Pnt>
theWeights: NCollection_Array2<double> *
...
") CacheD0;
		static void CacheD0(const double U, const double V, const int UDegree, const int VDegree, const double UCacheParameter, const double VCacheParameter, const double USpanLenght, const double VSpanLength, const NCollection_Array2<gp_Pnt> & Poles, const NCollection_Array2<double> * Weights, gp_Pnt & Point);
...
") CoefsD0;
		static void CoefsD0(const double U, const double V, const NCollection_Array2<gp_Pnt> & Poles, const NCollection_Array2<double> * Weights, gp_Pnt & Point);
...
Calls CacheD0 for Bezier Surfaces Arrays computed with the method PolesCoefficients. Warning: To be used for BezierSurfaces ONLY!!!.
") CoefsD1;
		static void CoefsD1(const double U, const double V, const NCollection_Array2<gp_Pnt> & Poles, const NCollection_Array2<double> * Weights, gp_Pnt & Point, gp_Vec & VecU, gp_Vec & VecV);
...
Calls CacheD0 for Bezier Surfaces Arrays computed with the method PolesCoefficients. Warning: To be used for BezierSurfaces ONLY!!!.
") CoefsD2;
		static void CoefsD2(const double U, const double V, const NCollection_Array2<gp_Pnt> & Poles, const NCollection_Array2<double> * Weights, gp_Pnt & Point, gp_Vec & VecU, gp_Vec & VecV, gp_Vec & VecUU, gp_Vec & VecUV, gp_Vec & VecVV);
...
UBSplineDegree: int
VBSplineDegree: int
UBSplineKnots: NCollection_Array1<double>
VBSplineKnots: NCollection_Array1<double>
UMults: NCollection_Array1<int> *
VMults: NCollection_Array1<int> *
Poles: NCollection_Array2<gp_Pnt>
Weights: NCollection_Array2<double> *
...
UNewDegree: int
VNewDegree: int
NewNumerator: NCollection_Array2<gp_Pnt>
NewDenominator: NCollection_Array2<double>
...
") GetPoles;
		static void GetPoles(const NCollection_Array1<double> & FP, NCollection_Array2<gp_Pnt> & Poles, const bool UDirection);
...
Get from FP the coordinates of the poles.
") GetPoles;
		static void GetPoles(const NCollection_Array1<double> & FP, NCollection_Array2<gp_Pnt> & Poles, NCollection_Array2<double> & Weights, const bool UDirection);
...
") HomogeneousD0;
		static void HomogeneousD0(const double U, const double V, const int UIndex, const int VIndex, const NCollection_Array2<gp_Pnt> & Poles, const NCollection_Array2<double> * Weights, const NCollection_Array1<double> & UKnots, const NCollection_Array1<double> & VKnots, const NCollection_Array1<int> * UMults, const NCollection_Array1<int> * VMults, const int UDegree, const int VDegree, const bool URat, const bool VRat, const bool UPer, const bool VPer, Standard_Real &OutValue, gp_Pnt & P);
...
Makes an homogeneous evaluation of Poles and Weights any and returns in P the Numerator value and in W the Denominator value if Weights are present otherwise returns 1.0e0.
") HomogeneousD1;
		static void HomogeneousD1(const double U, const double V, const int UIndex, const int VIndex, const NCollection_Array2<gp_Pnt> & Poles, const NCollection_Array2<double> * Weights, const NCollection_Array1<double> & UKnots, const NCollection_Array1<double> & VKnots, const NCollection_Array1<int> * UMults, const NCollection_Array1<int> * VMults, const int UDegree, const int VDegree, const bool URat, const bool VRat, const bool UPer, const bool VPer, gp_Pnt & N, gp_Vec & Nu, gp_Vec & Nv, Standard_Real &OutValue, Standard_Real &OutValue, Standard_Real &OutValue);
...
NewPoles: NCollection_Array2<gp_Pnt>
NewWeights: NCollection_Array2<double> *
...
UFlatKnots: NCollection_Array1<double>
VFlatKnots: NCollection_Array1<double>
UParameters: NCollection_Array1<double>
VParameters: NCollection_Array1<double>
Poles: NCollection_Array2<gp_Pnt>
Weights: NCollection_Array2<double>
...
") Interpolate;
		static void Interpolate(const int UDegree, const int VDegree, const NCollection_Array1<double> & UFlatKnots, const NCollection_Array1<double> & VFlatKnots, const NCollection_Array1<double> & UParameters, const NCollection_Array1<double> & VParameters, NCollection_Array2<gp_Pnt> & Poles, NCollection_Array2<double> & Weights, Standard_Integer &OutValue);
...
") Interpolate;
		static void Interpolate(const int UDegree, const int VDegree, const NCollection_Array1<double> & UFlatKnots, const NCollection_Array1<double> & VFlatKnots, const NCollection_Array1<double> & UParameters, const NCollection_Array1<double> & VParameters, NCollection_Array2<gp_Pnt> & Poles, Standard_Integer &OutValue);
...
") IsRational;
		static bool IsRational(const NCollection_Array2<double> & Weights, const int I1, const int I2, const int J1, const int J2, const double Epsilon = 0.0);
...
CWeights: NCollection_Array1<double> *
...
") Iso;
		static void Iso(const double Param, const bool IsU, const NCollection_Array2<gp_Pnt> & Poles, const NCollection_Array2<double> * Weights, const NCollection_Array1<double> & Knots, const NCollection_Array1<int> * Mults, const int Degree, const bool Periodic, NCollection_Array1<gp_Pnt> & CPoles, NCollection_Array1<double> * CWeights);
...
") MovePoint;
		static void MovePoint(const double U, const double V, const gp_Vec & Displ, const int UIndex1, const int UIndex2, const int VIndex1, const int VIndex2, const int UDegree, const int VDegree, const bool Rational, const NCollection_Array2<gp_Pnt> & Poles, const NCollection_Array2<double> & Weights, const NCollection_Array1<double> & UFlatKnots, const NCollection_Array1<double> & VFlatKnots, Standard_Integer &OutValue, Standard_Integer &OutValue, Standard_Integer &OutValue, Standard_Integer &OutValue, NCollection_Array2<gp_Pnt> & NewPoles);
...
") Resolution;
		static void Resolution(const NCollection_Array2<gp_Pnt> & Poles, const NCollection_Array2<double> * Weights, const NCollection_Array1<double> & UKnots, const NCollection_Array1<double> & VKnots, const NCollection_Array1<int> & UMults, const NCollection_Array1<int> & VMults, const int UDegree, const int VDegree, const bool URat, const bool VRat, const bool UPer, const bool VPer, const double Tolerance3D, Standard_Real &OutValue, Standard_Real &OutValue);
...
") Reverse;
		static void Reverse(NCollection_Array2<gp_Pnt> & Poles, const int Last, const bool UDirection);
...
") Reverse;
		static void Reverse(NCollection_Array2<double> & Weights, const int Last, const bool UDirection);
...
") SetPoles;
		static void SetPoles(const NCollection_Array2<gp_Pnt> & Poles, NCollection_Array1<double> & FP, const bool UDirection);
...
Copy in FP the coordinates of the poles.
") SetPoles;
		static void SetPoles(const NCollection_Array2<gp_Pnt> & Poles, const NCollection_Array2<double> & Weights, NCollection_Array1<double> & FP, const bool UDirection);
...
theDegreeU: int
thePeriodicU: bool
theFlatKnotsU: NCollection_Array1<double>
theDegreeV: int
thePeriodicV: bool
theFlatKnotsV: NCollection_Array1<double>
theWeights: NCollection_Array2<double> * (optional, default to nullptr)
