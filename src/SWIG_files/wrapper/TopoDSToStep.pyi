...
class TopoDSToStep_Tool:
    ...
    @overload
    def __init__(
        self, M: MoniTool_DataMapOfShapeTransient, FacetedContext: bool
    ) -> None: ...
    def Bind(
...
class TopoDSToStep_MakeStepEdge(TopoDSToStep_Root):
    ...
    @overload
    def __init__(
        self, E: TopoDS_Edge, T: TopoDSToStep_Tool, FP: Transfer_FinderProcess
    ) -> None: ...
...
class TopoDSToStep_MakeStepFace(TopoDSToStep_Root):
    ...
    @overload
    def __init__(
        self, F: TopoDS_Face, T: TopoDSToStep_Tool, FP: Transfer_FinderProcess
    ) -> None: ...
...
class TopoDSToStep_MakeStepVertex(TopoDSToStep_Root):
    ...
    @overload
    def __init__(
        self, V: TopoDS_Vertex, T: TopoDSToStep_Tool, FP: Transfer_FinderProcess
    ) -> None: ...
...
class TopoDSToStep_MakeStepWire(TopoDSToStep_Root):
    ...
    @overload
    def __init__(
        self, W: TopoDS_Wire, T: TopoDSToStep_Tool, FP: Transfer_FinderProcess
    ) -> None: ...
...
class TopoDSToStep_WireframeBuilder(TopoDSToStep_Root):
    ...
    @overload
    def __init__(
        self, S: TopoDS_Shape, T: TopoDSToStep_Tool, FP: Transfer_FinderProcess
    ) -> None: ...
    def Error(self) -> TopoDSToStep_BuilderError: ...
