...
class TopoDSToStep_WireframeBuilder(TopoDSToStep_Root):
    ...
    def Error(self) -> TopoDSToStep_BuilderError: ...
    def GetTrimmedCurveFromEdge(self, E: TopoDS_Edge, F: TopoDS_Face, M: MoniTool_DataMapOfShapeTransient, L: TColStd_HSequenceOfTransient, theLocalFactors: Optional[StepData_Factors] = StepData_Factors()) -> bool: ...
    def GetTrimmedCurveFromFace(self, F: TopoDS_Face, M: MoniTool_DataMapOfShapeTransient, L: TColStd_HSequenceOfTransient, theLocalFactors: Optional[StepData_Factors] = StepData_Factors()) -> bool: ...
    def GetTrimmedCurveFromShape(self, S: TopoDS_Shape, M: MoniTool_DataMapOfShapeTransient, L: TColStd_HSequenceOfTransient, theLocalFactors: Optional[StepData_Factors] = StepData_Factors()) -> bool: ...
