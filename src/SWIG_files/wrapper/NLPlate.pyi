...
class NLPlate_StackOfPlate:
    ...
    def Assign(self, theItem: NLPlate_StackOfPlate) -> NLPlate_StackOfPlate: ...
    def Clear(self) -> None: ...
...
class NLPlate_NLPlate:
    ...
    def IncrementalSolve(
        self,
        ord: Optional[int] = 2,
        InitialConsraintOrder: Optional[int] = 1,
        NbIncrements: Optional[int] = 4,
        UVSliding: Optional[bool] = False,
    ) -> None: ...
    def Init(self) -> None: ...
    ...
    def Solve(
        self, ord: Optional[int] = 2, InitialConsraintOrder: Optional[int] = 1
    ) -> None: ...
    def Solve2(
        self, ord: Optional[int] = 2, InitialConsraintOrder: Optional[int] = 1
    ) -> None: ...
...
class NLPlate_HPG0G2Constraint(NLPlate_HPG0G1Constraint):
    def __init__(
        self, UV: gp_XY, Value: gp_XYZ, D1T: Plate_D1, D2T: Plate_D2
    ) -> None: ...
    def ActiveOrder(self) -> int: ...
    def G2Target(self) -> Plate_D2: ...
...
class NLPlate_HPG3Constraint(NLPlate_HPG2Constraint):
    def __init__(
        self, UV: gp_XY, D1T: Plate_D1, D2T: Plate_D2, D3T: Plate_D3
    ) -> None: ...
    def ActiveOrder(self) -> int: ...
    def G3Target(self) -> Plate_D3: ...
...
class NLPlate_HPG0G3Constraint(NLPlate_HPG0G2Constraint):
    def __init__(
        self, UV: gp_XY, Value: gp_XYZ, D1T: Plate_D1, D2T: Plate_D2, D3T: Plate_D3
    ) -> None: ...
    def ActiveOrder(self) -> int: ...
    def G3Target(self) -> Plate_D3: ...
