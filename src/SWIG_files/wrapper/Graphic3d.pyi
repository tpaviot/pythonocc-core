...
class Graphic3d_Structure(Standard_Transient):
    ...
    def Transform(self, theTrsf: TopLoc_Datum3D) -> None: ...
    def TransformPersistence(self) -> Graphic3d_TransformPers: ...
    def Transformation(self) -> TopLoc_Datum3D: ...
    @staticmethod
...
class Graphic3d_TransformPers(Standard_Transient):
    ...
    @staticmethod
    def FromDeprecatedParams(theFlag: Graphic3d_TransModeFlags, thePoint: gp_Pnt) -> Graphic3d_TransformPers: ...
    @overload
    @staticmethod
...
Graphic3d_TransformPers_FromDeprecatedParams = Graphic3d_TransformPers.FromDeprecatedParams
