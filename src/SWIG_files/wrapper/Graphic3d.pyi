...
class Graphic3d_ShaderFlags(IntEnum):
    ...
    Graphic3d_ShaderFlags_VertColorFrontOnly: int = ...
...
class Graphic3d_ArrayOfPrimitives(Standard_Transient):
    ...
    @overload
    def AddVertex(self, theVertex: float) -> int: ...
    @overload
...
class Graphic3d_BSDF:
    def __init__(self) -> None: ...
    @staticmethod
    def CreateDiffuse(theWeight: float) -> Graphic3d_BSDF: ...
    @staticmethod
    def CreateGlass(theWeight: float, theAbsorptionColor: float, theAbsorptionCoeff: float, theRefractionIndex: float) -> Graphic3d_BSDF: ...
    @staticmethod
    def CreateMetallic(theWeight: float, theFresnel: Graphic3d_Fresnel, theRoughness: float) -> Graphic3d_BSDF: ...
    @staticmethod
    def CreateMetallicRoughness(thePbr: Graphic3d_PBRMaterial) -> Graphic3d_BSDF: ...
    @staticmethod
    def CreateTransparent(theWeight: float, theAbsorptionColor: float, theAbsorptionCoeff: float) -> Graphic3d_BSDF: ...
    def DumpJson(self, depth: Optional[int]=-1) -> str: ...
...
class Graphic3d_CLight(Standard_Transient):
    ...
    def Name(self) -> str: ...
    def PackedColor(self) -> float: ...
    def PackedDirection(self) -> float: ...
    def PackedDirectionRange(self) -> float: ...
    def PackedParams(self) -> float: ...
    @overload
...
class Graphic3d_Camera(Standard_Transient):
    ...
    def OrientationMatrix(self) -> False: ...
    def OrientationMatrixF(self) -> float: ...
    def OrthogonalizeUp(self) -> None: ...
    def OrthogonalizedUp(self) -> gp_Dir: ...
    def Project(self, thePnt: gp_Pnt) -> gp_Pnt: ...
    def ProjectionMatrix(self) -> False: ...
    def ProjectionMatrixF(self) -> float: ...
    def ProjectionState(self) -> False: ...
    def ProjectionStereoLeft(self) -> False: ...
    def ProjectionStereoLeftF(self) -> float: ...
    def ProjectionStereoRight(self) -> False: ...
    def ProjectionStereoRightF(self) -> float: ...
    ...
    def StereoProjectionF(self, theProjL: float, theHeadToEyeL: float, theProjR: float, theHeadToEyeR: float) -> None: ...
...
class Graphic3d_CameraTile:
    ...
    def DumpJson(self, depth: Optional[int]=-1) -> str: ...
    def IsValid(self) -> bool: ...
    def OffsetLowerLeft(self) -> False: ...
...
class Graphic3d_ClipPlane(Standard_Transient):
    ...
    def ReversedEquation(self) -> False: ...
...
class Graphic3d_CullingTool:
    ...
    def CameraDirection(self) -> False: ...
    def CameraEye(self) -> False: ...
    def ProjectionMatrix(self) -> False: ...
    ...
    def WorldViewMatrix(self) -> False: ...
    def WorldViewProjState(self) -> Graphic3d_WorldViewProjState: ...
...
class Graphic3d_FrameStats(Standard_Transient):
    ...
    def ChangeCounter(self, theCounter: Graphic3d_FrameStatsCounter) -> False: ...
    def ChangeDataFrames(self) -> False: ...
    def ChangeTimer(self, theTimer: Graphic3d_FrameStatsTimer) -> False: ...
    def CounterValue(self, theCounter: Graphic3d_FrameStatsCounter) -> False: ...
...
class Graphic3d_FrameStatsData:
    ...
    @overload
    def __init__(self, theOther: Graphic3d_FrameStatsData) -> None: ...
    def CounterValue(self, theIndex: Graphic3d_FrameStatsCounter) -> False: ...
...
class Graphic3d_Fresnel:
    ...
    @staticmethod
    def CreateSchlick(theSpecularColor: float) -> Graphic3d_Fresnel: ...
    def DumpJson(self, depth: Optional[int]=-1) -> str: ...
...
class Graphic3d_Layer(Standard_Transient):
    ...
    def Structures(self, thePriority: Graphic3d_DisplayPriority) -> False: ...
...
class Graphic3d_MarkerImage(Standard_Transient):
    ...
    @staticmethod
    def StandardMarker(theMarkerType: Aspect_TypeOfMarker, theScale: float, theColor: float) -> Graphic3d_MarkerImage: ...
...
class Graphic3d_PBRMaterial:
    ...
    @overload
    def SetColor(self, theColor: Quantity_Color) -> None: ...
    def SetEmission(self, theEmission: float) -> None: ...
...
class Graphic3d_ShaderProgram(Standard_Transient):
    ...
    def PushVariableMat3(self, theName: str, theValue: float) -> bool: ...
    def PushVariableMat4(self, theName: str, theValue: float) -> bool: ...
    def PushVariableVec2(self, theName: str, theValue: float) -> bool: ...
    def PushVariableVec3(self, theName: str, theValue: float) -> bool: ...
    def PushVariableVec4(self, theName: str, theValue: float) -> bool: ...
    ...
    def ShaderObjects(self) -> False: ...
    @staticmethod
    def ShadersFolder() -> str: ...
    def TextureSetBits(self) -> int: ...
    def Variables(self) -> False: ...
    def VertexAttributes(self) -> False: ...
...
class Graphic3d_TextureParams(Standard_Transient):
    ...
    def GenPlaneS(self) -> float: ...
    def GenPlaneT(self) -> float: ...
    ...
    def SetGenMode(self, theMode: Graphic3d_TypeOfTextureMode, thePlaneS: float, thePlaneT: float) -> None: ...
    ...
    def SetTranslation(self, theVec: float) -> None: ...
...
class Graphic3d_TransformPers(Standard_Transient):
    ...
    def ComputeApply(self, theCamera: Graphic3d_Camera, theViewportWidth: int, theViewportHeight: int, theAnchor: Optional[gp_Pnt] = nullptr) -> False: ...
    ...
    def persistentScale(self, theCamera: Graphic3d_Camera, theViewportWidth: int, theViewportHeight: int) -> False: ...
...
class Graphic3d_WorldViewProjState:
    ...
    def DumpJson(self, depth: Optional[int]=-1) -> str: ...
    @overload
    def Initialize(self, theCamera: Optional[Standard_Transient] = nullptr) -> None: ...
...
class Graphic3d_CView(Graphic3d_DataStructureManager):
    ...
    def GraduatedTrihedronMinMaxValues(self, theMin: float, theMax: float) -> None: ...
    ...
    def SubviewMargins(self) -> False: ...
    def SubviewOffset(self) -> False: ...
    def SubviewResized(self, theWindow: Aspect_NeutralWindow) -> None: ...
    def SubviewSize(self) -> False: ...
    def SubviewTopLeft(self) -> False: ...
...
class Graphic3d_FrameStatsDataTmp(Graphic3d_FrameStatsData):
    def __init__(self) -> None: ...
    def ChangeCounterValue(self, theIndex: Graphic3d_FrameStatsCounter) -> False: ...
    def ChangeFrameRate(self) -> False: ...
    def ChangeFrameRateCpu(self) -> False: ...
    def ChangeImmediateFrameRate(self) -> False: ...
    def ChangeImmediateFrameRateCpu(self) -> False: ...
    def ChangeTimer(self, theTimer: Graphic3d_FrameStatsTimer) -> OSD_Timer: ...
    def ChangeTimerValue(self, theIndex: Graphic3d_FrameStatsTimer) -> False: ...
    def Reset(self) -> None: ...

class Graphic3d_MediaTextureSet(Graphic3d_TextureSet, Media_IFrameQueue):
    def __init__(self) -> None: ...
    def Duration(self) -> float: ...
    def FrameSize(self) -> False: ...
    def Input(self) -> str: ...
