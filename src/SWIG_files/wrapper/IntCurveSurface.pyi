...
class IntCurveSurface_TheHCurveTool:
    ...
    @overload
    @staticmethod
    def SamplePars(C: Adaptor3d_Curve, U0: float, U1: float, Defl: float, NbMin: int) -> TColStd_HArray1OfReal: ...
    @overload
    @staticmethod
...
class IntCurveSurface_ThePolygonToolOfHInter:
    ...
    @staticmethod
    def DeflectionOverEstimation(thePolygon: IntCurveSurface_ThePolygonOfHInter) -> False: ...
    @staticmethod
...
class IntCurveSurface_ThePolyhedronToolOfHInter:
    ...
    @staticmethod
    def ComponentsBounding(thePolyh: IntCurveSurface_ThePolyhedronOfHInter) -> False: ...
    @staticmethod
    def DeflectionOverEstimation(thePolyh: IntCurveSurface_ThePolyhedronOfHInter) -> False: ...
    @staticmethod
    def Dump(thePolyh: IntCurveSurface_ThePolyhedronOfHInter) -> None: ...
    @staticmethod
    def GetBorderDeflection(thePolyh: IntCurveSurface_ThePolyhedronOfHInter) -> False: ...
    @staticmethod
