...
class IntCurveSurface_TheInterferenceOfHInter(Intf_Interference):
    ...
    @overload
    def __init__(self, theLins: Any, thePolyh: IntCurveSurface_ThePolyhedronOfHInter) -> None: ...
    @overload
    ...
    @overload
    def __init__(self, theLins: Any, thePolyh: IntCurveSurface_ThePolyhedronOfHInter, theBoundSB: Bnd_BoundSortBox) -> None: ...
    @overload
    ...
    @overload
    def Perform(self, theLins: Any, thePolyh: IntCurveSurface_ThePolyhedronOfHInter) -> None: ...
    @overload
    ...
    @overload
    def Perform(self, theLins: Any, thePolyh: IntCurveSurface_ThePolyhedronOfHInter, theBoundSB: Bnd_BoundSortBox) -> None: ...
...
class IntCurveSurface_ThePolyhedronToolOfHInter:
    ...
    @staticmethod
    def ComponentsBounding(thePolyh: IntCurveSurface_ThePolyhedronOfHInter) -> Any: ...
    @staticmethod
