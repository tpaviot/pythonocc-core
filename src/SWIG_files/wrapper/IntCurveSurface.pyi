...
class IntCurveSurface_SequenceOfPnt:
    def Assign(
        self, theItem: IntCurveSurface_IntersectionPoint
    ...
    def SetValue(
        self, theIndex: int, theValue: IntCurveSurface_IntersectionPoint
    ) -> None: ...
    def Size(self) -> int: ...
...
class IntCurveSurface_SequenceOfSeg:
    def Assign(
        self, theItem: IntCurveSurface_IntersectionSegment
    ...
    def Reverse(self) -> None: ...
    def SetValue(
        self, theIndex: int, theValue: IntCurveSurface_IntersectionSegment
    ) -> None: ...
    def Size(self) -> int: ...
    def UpdateUpperBound(self, int) -> None: ...
    def UpdateLowerBound(self, int) -> None: ...
...
class IntCurveSurface_IntersectionPoint:
    ...
    def Values(
        self, P: gp_Pnt
    ) -> Tuple[float, float, float, IntCurveSurface_TransitionOnCurve]: ...
    def W(self) -> float: ...
...
class IntCurveSurface_TheExactHInter:
    ...
    @overload
    def __init__(
        self, F: IntCurveSurface_TheCSFunctionOfHInter, TolTangency: float
    ) -> None: ...
...
class IntCurveSurface_TheInterferenceOfHInter(Intf_Interference):
    ...
    @overload
    def __init__(
        self, theLin: gp_Lin, thePolyh: IntCurveSurface_ThePolyhedronOfHInter
    ) -> None: ...
    @overload
    def __init__(
        self, theLins: Intf_Array1OfLin, thePolyh: IntCurveSurface_ThePolyhedronOfHInter
    ) -> None: ...
    @overload
    def __init__(
        self,
...
class IntCurveSurface_ThePolygonOfHInter:
    ...
    @overload
    def __init__(
        self, Curve: Adaptor3d_Curve, U1: float, U2: float, NbPnt: int
    ) -> None: ...
    @overload
...
class IntCurveSurface_ThePolygonToolOfHInter:
    @staticmethod
    def BeginOfSeg(
        thePolygon: IntCurveSurface_ThePolygonOfHInter, Index: int
    ) -> gp_Pnt: ...
    @staticmethod
...
class IntCurveSurface_ThePolyhedronToolOfHInter:
    ...
    @staticmethod
    def IsOnBound(
        thePolyh: IntCurveSurface_ThePolyhedronOfHInter, Index1: int, Index2: int
    ) -> bool: ...
    @staticmethod
    def NbTriangles(thePolyh: IntCurveSurface_ThePolyhedronOfHInter) -> int: ...
    @staticmethod
    def Point(
        thePolyh: IntCurveSurface_ThePolyhedronOfHInter, Index: int
    ) -> gp_Pnt: ...
    @staticmethod
    def TriConnex(
        thePolyh: IntCurveSurface_ThePolyhedronOfHInter,
