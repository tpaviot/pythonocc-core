...
class bsplclib:
    ...
    @staticmethod
    def UnitWeights(theNbElems: int) -> Any: ...
    @staticmethod
    def UnitWeightsData() -> Any: ...
    @overload
    @staticmethod
...
class BSplCLib_EvaluatorFunction:
    def Evaluate(self, theDerivativeRequest: int, theStartEnd: Any, theParameter: float) -> Tuple[float, int]: ...
