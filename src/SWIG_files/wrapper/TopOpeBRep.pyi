...
TopOpeBRep_HArray1OfLineInter = NewType("TopOpeBRep_HArray1OfLineInter", Any)
# the following typedef cannot be wrapped as is
TopOpeBRep_HArray1OfVPointInter = NewType("TopOpeBRep_HArray1OfVPointInter", Any)
...
class TopOpeBRep_FacesFiller:
    ...
    @staticmethod
    def VPParamOnER(vp: TopOpeBRep_VPointInter, Lrest: TopOpeBRep_LineInter) -> False: ...
    @overload
...
class TopOpeBRep_VPointInter:
    ...
    @overload
    def Dump(self, F1: TopoDS_Face, F2: TopoDS_Face) -> Tuple[Standard_OStream, str]: ...
    def Edge(self, I: int) -> TopoDS_Shape: ...
    @overload
