...
TopOpeBRep_PEdgesIntersector = NewType(
    "TopOpeBRep_PEdgesIntersector", TopOpeBRep_EdgesIntersector
)
TopOpeBRep_PFacesFiller = NewType("TopOpeBRep_PFacesFiller", TopOpeBRep_FacesFiller)
TopOpeBRep_PFacesIntersector = NewType(
    "TopOpeBRep_PFacesIntersector", TopOpeBRep_FacesIntersector
)
TopOpeBRep_PIntRes2d_IntersectionPoint = NewType(
    "TopOpeBRep_PIntRes2d_IntersectionPoint", IntRes2d_IntersectionPoint
)
...
TopOpeBRep_PThePointOfIntersection = NewType(
    "TopOpeBRep_PThePointOfIntersection", IntPatch_Point
)
...
class TopOpeBRep_ListOfBipoint:
    ...
    def Assign(self, theItem: TopOpeBRep_ListOfBipoint) -> TopOpeBRep_ListOfBipoint: ...
    def Clear(self) -> None: ...
    ...
    def __init__(self) -> None: ...
    def __len__(self) -> int: ...
    def __iter__(self) -> TopOpeBRep_Bipoint: ...

class TopOpeBRep_SequenceOfPoint2d:
    def Assign(self, theItem: TopOpeBRep_Point2d) -> TopOpeBRep_Point2d: ...
    def Clear(self) -> None: ...
...
class topopebrep:
    @staticmethod
    def Print(TLC: TopOpeBRep_TypeLineCurve) -> Tuple[Standard_OStream, str]: ...
...
class TopOpeBRep_DSFiller:
    ...
    def Insert(
        ...
        orientFORWARD: Optional[bool] = True,
    ) -> None: ...
    def Insert1d(
        self,
        S1: TopoDS_Shape,
        ...
        F2: TopoDS_Face,
        HDS: TopOpeBRepDS_HDataStructure,
        orientFORWARD: Optional[bool] = False,
    ) -> None: ...
    def Insert2d(
        self, S1: TopoDS_Shape, S2: TopoDS_Shape, HDS: TopOpeBRepDS_HDataStructure
    ) -> None: ...
...
class TopOpeBRep_EdgesIntersector:
    ...
    def Dump(
        self, str: str, ie1: Optional[int] = 0, ie2: Optional[int] = 0
    ) -> None: ...
    ...
    def Perform(
        self, E1: TopoDS_Shape, E2: TopoDS_Shape, ReduceSegments: Optional[bool] = True
    ) -> None: ...
    @overload
    ...
    def ReduceSegment(
        self, P1: TopOpeBRep_Point2d, P2: TopOpeBRep_Point2d, Pn: TopOpeBRep_Point2d
    ) -> bool: ...
    ...
    @overload
    def SetFaces(
        self, F1: TopoDS_Shape, F2: TopoDS_Shape, B1: Bnd_Box, B2: Bnd_Box
    ) -> None: ...
...
class TopOpeBRep_FFDumper(Standard_Transient):
    ...
    def DumpDSP(
        self, VP: TopOpeBRep_VPointInter, GK: TopOpeBRepDS_Kind, G: int, newinDS: bool
    ) -> None: ...
    @overload
...
class TopOpeBRep_FFTransitionTool:
    ...
    @staticmethod
    def ProcessEdgeTransition(
        P: TopOpeBRep_VPointInter, Index: int, LineOrientation: TopAbs_Orientation
    ) -> TopOpeBRepDS_Transition: ...
    @staticmethod
    def ProcessFaceTransition(
        L: TopOpeBRep_LineInter, Index: int, FaceOrientation: TopAbs_Orientation
    ) -> TopOpeBRepDS_Transition: ...
    @overload
    @staticmethod
    def ProcessLineTransition(
        P: TopOpeBRep_VPointInter, Index: int, EdgeOrientation: TopAbs_Orientation
    ) -> TopOpeBRepDS_Transition: ...
    @overload
    @staticmethod
    def ProcessLineTransition(
        P: TopOpeBRep_VPointInter, L: TopOpeBRep_LineInter
    ) -> TopOpeBRepDS_Transition: ...
...
class TopOpeBRep_FaceEdgeIntersector:
    ...
    @overload
    def IsVertex(
        self, S: TopoDS_Shape, P: gp_Pnt, Tol: float, V: TopoDS_Vertex
    ) -> bool: ...
    @overload
    ...
    def Transition(
        self, Index: int, FaceOrientation: TopAbs_Orientation
    ) -> TopOpeBRepDS_Transition: ...
...
class TopOpeBRep_FacesFiller:
    ...
    def FaceFaceTransition(
        self, L: TopOpeBRep_LineInter, I: int
    ) -> TopOpeBRepDS_Transition: ...
    @overload
    ...
    @overload
    def GetFFGeometry(
        self, DSP: TopOpeBRepDS_Point, K: TopOpeBRepDS_Kind
    ) -> Tuple[bool, int]: ...
    @overload
    def GetFFGeometry(
        self, VP: TopOpeBRep_VPointInter, K: TopOpeBRepDS_Kind
    ) -> Tuple[bool, int]: ...
    def GetGeometry(
        self,
    ...
    @staticmethod
    def IsVPtransLok(
        L: TopOpeBRep_LineInter, iVP: int, SI12: int, T: TopOpeBRepDS_Transition
    ) -> bool: ...
    @staticmethod
    ...
    def MakeGeometry(
        self, VP: TopOpeBRep_VPointInter, ShapeIndex: int, K: TopOpeBRepDS_Kind
    ) -> int: ...
    ...
    def ProcessVPR(
        self, FF: TopOpeBRep_FacesFiller, VP: TopOpeBRep_VPointInter
    ) -> None: ...
    ...
    @staticmethod
    def TransvpOK(
        L: TopOpeBRep_LineInter, iVP: int, SI: int, isINOUT: bool
    ) -> bool: ...
    @staticmethod
    def VPParamOnER(
        vp: TopOpeBRep_VPointInter, Lrest: TopOpeBRep_LineInter
    ) -> float: ...
    @overload
    ...
    @overload
    def VP_Position(
        self, VP: TopOpeBRep_VPointInter, VPC: TopOpeBRep_VPointInterClassifier
    ) -> None: ...
...
class TopOpeBRep_FacesIntersector:
    ...
    @overload
    def Perform(
        self, S1: TopoDS_Shape, S2: TopoDS_Shape, B1: Bnd_Box, B2: Bnd_Box
    ) -> None: ...
...
class TopOpeBRep_GeomTool:
    ...
    @staticmethod
    def MakeCurve(
        min: float, max: float, L: TopOpeBRep_LineInter, C: Geom_Curve
    ) -> None: ...
    @staticmethod
    def MakeCurves(
        min: float,
...
class TopOpeBRep_Hctxff2d(Standard_Transient):
    ...
    def SetHSurfaces(
        self, S1: BRepAdaptor_Surface, S2: BRepAdaptor_Surface
    ) -> None: ...
...
class TopOpeBRep_LineInter:
    ...
    def DumpLineTransitions(self) -> Tuple[Standard_OStream, str]: ...
    ...
    def SetLine(
        self, L: IntPatch_Line, S1: BRepAdaptor_Surface, S2: BRepAdaptor_Surface
    ) -> None: ...
...
class TopOpeBRep_ShapeIntersector:
    ...
    def InitIntersection(
        self, S1: TopoDS_Shape, S2: TopoDS_Shape, F1: TopoDS_Face, F2: TopoDS_Face
    ) -> None: ...
...
class TopOpeBRep_VPointInter:
    ...
    @overload
    def Dump(self, I: int, F: TopoDS_Face) -> Tuple[Standard_OStream, str]: ...
    @overload
    def Dump(
        self, F1: TopoDS_Face, F2: TopoDS_Face
...
class TopOpeBRep_VPointInterIterator:
    ...
    @overload
    def Init(
        self, LI: TopOpeBRep_LineInter, checkkeep: Optional[bool] = False
    ) -> None: ...
    @overload
    def Init(self) -> None: ...
    def More(self) -> bool: ...
...
class TopOpeBRep_HArray1OfVPointInter(
    TopOpeBRep_Array1OfVPointInter, Standard_Transient
):
    def __init__(self, theLower: int, theUpper: int) -> None: ...
