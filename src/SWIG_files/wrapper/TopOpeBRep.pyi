...
class TopOpeBRep_Array1OfLineInter:
    ...
    def __iter__(self) -> typing.Iterator[TopOpeBRep_LineInter]: ...
...
class TopOpeBRep_Array1OfVPointInter:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[TopOpeBRep_VPointInter]: ...
...
class TopOpeBRep_FacesFiller:
    ...
    def GetGeometry(self, IT: Any, VP: TopOpeBRep_VPointInter, K: TopOpeBRepDS_Kind) -> Tuple[bool, int]: ...
