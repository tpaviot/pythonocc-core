...
") ChFiDS_ElSpine;
		...
		%feature("autodoc", "	:rtype: opencascade::handle<ChFiDS_SurfData>
") ChangeNext;
...
") ChangePCurve;
		...
		%feature("autodoc", "	:rtype: opencascade::handle<ChFiDS_HData>
") ChangeSetOfSurfData;
		opencascade::handle<ChFiDS_HData> & ChangeSetOfSurfData ();
		%feature("compactdefaultargs") ChangeSpine;
		%feature("autodoc", "	:rtype: opencascade::handle<ChFiDS_Spine>
") ChangeSpine;
