...
") IsInterference;
	...
	:type N: opencascade::handle<HLRBRep_AreaLimit> &
	:rtype: None
") Next;
		void Next (const opencascade::handle<HLRBRep_AreaLimit> & N);
		%feature("compactdefaultargs") Next;
		%feature("autodoc", "	:rtype: opencascade::handle<HLRBRep_AreaLimit>
") Next;
		opencascade::handle<HLRBRep_AreaLimit> Next ();
		%feature("compactdefaultargs") Previous;
		%feature("autodoc", "	:param P:
	:type P: opencascade::handle<HLRBRep_AreaLimit> &
	:rtype: None
") Previous;
...
") Poles;
	...
	:type aCurve: opencascade::handle<Geom_BSplineCurve> &
	:param TP:
	:type TP: TColgp_Array1OfPnt2d
	:rtype: None
") Poles;
...
") Update;
	...
	:param DS:
	:type DS: opencascade::handle<HLRBRep_Data> &
	:param dv:
	:type dv: int
	:param de:
	:type de: int
...
") Torus;
		...
		%feature("autodoc", "	:rtype: opencascade::handle<HLRAlgo_WiresBlock>
") Wires;
...
") HCompound;
	...
	:param A:
	:type A: opencascade::handle<HLRBRep_Algo> &
	:rtype: None
") HLRBRep_HLRToShape;
...
class HLRBRep_InternalAlgo : public Standard_Transient {
	public:
		...
		%feature("autodoc", "	:rtype: opencascade::handle<HLRBRep_Data>
") DataStructure;
...
") HLRBRep_InternalAlgo;
	...
	:type A: opencascade::handle<HLRBRep_InternalAlgo> &
	:rtype: None
") HLRBRep_InternalAlgo;
...
") HideAll;
	...
	:param S:
	:type S: opencascade::handle<HLRTopoBRep_OutLiner> &
	:rtype: int
") Index;
...
") InitEdgeStatus;
	...
	:type S: opencascade::handle<HLRTopoBRep_OutLiner> &
	:param SData:
	:type SData: opencascade::handle<Standard_Transient> &
...
class HLRBRep_PolyAlgo : public Standard_Transient {
	public:
		...
		%feature("autodoc", "	:rtype: opencascade::handle<HLRAlgo_PolyAlgo>
") Algo;
...
") HLRBRep_PolyAlgo;
		...
		%feature("compactdefaultargs") HLRBRep_PolyAlgo;
		%feature("autodoc", "	:param A:
	:type A: opencascade::handle<HLRBRep_PolyAlgo> &
	:rtype: None
") HLRBRep_PolyAlgo;
...
") Shape;
		...
		%feature("compactdefaultargs") Shape;
		%feature("autodoc", "	:rtype: opencascade::handle<HLRTopoBRep_OutLiner>
") Shape;
		const opencascade::handle<HLRTopoBRep_OutLiner> & Shape ();
		%feature("compactdefaultargs") ShapeData;
		%feature("autodoc", "	:param SD:
	:type SD: opencascade::handle<Standard_Transient> &
	:rtype: None
") ShapeData;
