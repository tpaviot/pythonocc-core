...
class blendfunc:
    @staticmethod
    def ComputeDNormal(
        Surf: Adaptor3d_Surface, p2d: gp_Pnt2d, Normal: gp_Vec, DNu: gp_Vec, DNv: gp_Vec
    ) -> bool: ...
    @staticmethod
    def ComputeNormal(
        Surf: Adaptor3d_Surface, p2d: gp_Pnt2d, Normal: gp_Vec
    ) -> bool: ...
    @staticmethod
    ...
    @staticmethod
    def GetShape(
        SectShape: BlendFunc_SectionShape, MaxAng: float
...
class BlendFunc_CSConstRad(Blend_CSFunction):
    def __init__(
        self, S: Adaptor3d_Surface, C: Adaptor3d_Curve, CGuide: Adaptor3d_Curve
    ) -> None: ...
    def Derivatives(self, X: math_Vector, D: math_Matrix) -> bool: ...
    def GetBounds(self, InfBound: math_Vector, SupBound: math_Vector) -> None: ...
    def GetMinimalWeight(self, Weigths: TColStd_Array1OfReal) -> None: ...
...
class BlendFunc_ChAsym(Blend_Function):
    def __init__(
        self, S1: Adaptor3d_Surface, S2: Adaptor3d_Surface, C: Adaptor3d_Curve
    ) -> None: ...
    ...
    @overload
    def Section(
        self, Param: float, U1: float, V1: float, U2: float, V2: float, C: gp_Lin
    ) -> Tuple[float, float]: ...
    @overload
    def Section(
        self,
...
class BlendFunc_ConstRad(Blend_Function):
    ...
    @overload
    def Section(
        self, Param: float, U1: float, V1: float, U2: float, V2: float, C: gp_Circ
    ) -> Tuple[float, float]: ...
    @overload
    def Section(
        self,
...
class BlendFunc_Chamfer(BlendFunc_GenChamfer):
    def __init__(
        self, S1: Adaptor3d_Surface, S2: Adaptor3d_Surface, CG: Adaptor3d_Curve
    ) -> None: ...
    def Derivatives(self, X: math_Vector, D: math_Matrix) -> bool: ...
    def GetSectionSize(self) -> float: ...
    def IsSolution(self, Sol: math_Vector, Tol: float) -> bool: ...
