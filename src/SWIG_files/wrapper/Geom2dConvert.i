...
class Geom2dConvert {
	...
	:param tabBS:
	:type tabBS: opencascade::handle<TColGeom2d_HArray1OfBSplineCurve> &
	:param Tolerance:
	...
	:param Tolerance:
	:type Tolerance: float
	:rtype: void") C0BSplineToC1BSplineCurve;
	...
	:type ArrayOfConcatenated: opencascade::handle<TColGeom2d_HArray1OfBSplineCurve> &
	:param ClosedFlag:
	...
	:rtype: opencascade::handle<Geom2d_BSplineCurve>") CurveToBSplineCurve;
	...
	:rtype: opencascade::handle<Geom2d_BSplineCurve>") SplitBSplineCurve;
...
class Geom2dConvert_ApproxCurve {
	...
	:param MaxDegree:
	:type MaxDegree: int
	:rtype: None") Geom2dConvert_ApproxCurve;
...
class Geom2dConvert_BSplineCurveKnotSplitting {
	...
	:param BasisCurve:
	:type BasisCurve: opencascade::handle<Geom2d_BSplineCurve> &
	:param ContinuityRange:
	:type ContinuityRange: int
	:rtype: None") Geom2dConvert_BSplineCurveKnotSplitting;
...
class Geom2dConvert_BSplineCurveToBezierCurve {
	...
	:param Index:
	:type Index: int
	:rtype: opencascade::handle<Geom2d_BezierCurve>") Arc;
	...
	:param BasisCurve:
	:type BasisCurve: opencascade::handle<Geom2d_BSplineCurve> &
	:rtype: None") Geom2dConvert_BSplineCurveToBezierCurve;
...
class Geom2dConvert_CompCurveToBSplineCurve {
	...
	:param NewCurve:
	:type NewCurve: opencascade::handle<Geom2d_BoundedCurve> &
	:param Tolerance:
	:type Tolerance: float
	...
	:rtype: bool") Add;
		...
		%feature("autodoc", ":rtype: opencascade::handle<Geom2d_BSplineCurve>") BSplineCurve;
	...
	:param Parameterisation: default value is Convert_TgtThetaOver2
	:type Parameterisation: Convert_ParameterisationType
	:rtype: None") Geom2dConvert_CompCurveToBSplineCurve;
	...
	:param BasisCurve:
	:type BasisCurve: opencascade::handle<Geom2d_BoundedCurve> &
	:param Parameterisation: default value is Convert_TgtThetaOver2
	:type Parameterisation: Convert_ParameterisationType
	:rtype: None") Geom2dConvert_CompCurveToBSplineCurve;
