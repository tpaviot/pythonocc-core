...
class IntCurve_PConicTool:
    ...
    @staticmethod
    def EpsX(C: IntCurve_PConic) -> False: ...
    @overload
    @staticmethod
...
class IntCurve_ProjectOnPConicTool:
    @overload
    @staticmethod
    def FindParameter(C: IntCurve_PConic, Pnt: gp_Pnt2d, Tol: float) -> False: ...
    @overload
    @staticmethod
    def FindParameter(C: IntCurve_PConic, Pnt: gp_Pnt2d, LowParameter: float, HighParameter: float, Tol: float) -> False: ...
