...
class Geom2dHatch_Element:
    ...
    def __init__(
        ...
        Orientation: Optional[TopAbs_Orientation] = TopAbs_FORWARD,
    ) -> None: ...
...
class Geom2dHatch_Hatcher:
    def __init__(
        ...
        Confusion2d: float,
        Confusion3d: float,
        KeepPnt: Optional[bool] = False,
        KeepSeg: Optional[bool] = False,
    ) -> None: ...
    @overload
    def AddElement(
        self,
...
class Geom2dHatch_Intersector(Geom2dInt_GInter):
    ...
    def LocalGeometry(
        self, E: Geom2dAdaptor_Curve, U: float, T: gp_Dir2d, N: gp_Dir2d
    ) -> float: ...
    def Perform(
        self, L: gp_Lin2d, P: float, Tol: float, E: Geom2dAdaptor_Curve
    ) -> None: ...
