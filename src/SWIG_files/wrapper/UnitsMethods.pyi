...
class unitsmethods:
    ...
    @staticmethod
    def GetCasCadeLengthUnit(theBaseUnit: Optional[UnitsMethods_LengthUnit] = UnitsMethods_LengthUnit_Millimeter) -> False: ...
    @staticmethod
    def GetLengthFactorValue(theUnit: int) -> False: ...
    @staticmethod
    ...
    @staticmethod
    def GetLengthUnitScale(theFromUnit: UnitsMethods_LengthUnit, theToUnit: UnitsMethods_LengthUnit) -> False: ...
    @staticmethod
