...
class AppDef_Array1OfMultiPointConstraint:
    ...
    def __iter__(self) -> typing.Iterator[AppDef_MultiPointConstraint]: ...
...
class AppDef_BSpParFunctionOfMyBSplGradientOfBSplineCompute(math_MultipleVarFunctionWithGradient):
    def __init__(self, SSP: AppDef_MultiLine, FirstPoint: int, LastPoint: int, TheConstraints: Any, Parameters: math_Vector, Knots: TColStd_Array1OfReal, Mults: TColStd_Array1OfInteger, NbPol: int) -> None: ...
...
class AppDef_MultiLine:
    ...
    @overload
    def __init__(self, tabMultiP: Any) -> None: ...
    @overload
...
class AppDef_MyBSplGradientOfBSplineCompute:
    @overload
    def __init__(self, SSP: AppDef_MultiLine, FirstPoint: int, LastPoint: int, TheConstraints: Any, Parameters: math_Vector, Knots: TColStd_Array1OfReal, Mults: TColStd_Array1OfInteger, Deg: int, Tol3d: float, Tol2d: float, NbIterations: Optional[int] = 1) -> None: ...
    @overload
    def __init__(self, SSP: AppDef_MultiLine, FirstPoint: int, LastPoint: int, TheConstraints: Any, Parameters: math_Vector, Knots: TColStd_Array1OfReal, Mults: TColStd_Array1OfInteger, Deg: int, Tol3d: float, Tol2d: float, NbIterations: int, lambda1: float, lambda2: float) -> None: ...
...
class AppDef_MyGradientOfCompute:
    def __init__(self, SSP: AppDef_MultiLine, FirstPoint: int, LastPoint: int, TheConstraints: Any, Parameters: math_Vector, Deg: int, Tol3d: float, Tol2d: float, NbIterations: Optional[int] = 200) -> None: ...
    def AverageError(self) -> float: ...
    def Error(self, Index: int) -> float: ...
    def IsDone(self) -> bool: ...
    def MaxError2d(self) -> float: ...
...
class AppDef_ParFunctionOfMyGradientOfCompute(math_MultipleVarFunctionWithGradient):
    def __init__(self, SSP: AppDef_MultiLine, FirstPoint: int, LastPoint: int, TheConstraints: Any, Parameters: math_Vector, Deg: int) -> None: ...
...
class AppDef_ResConstraintOfMyGradientOfCompute:
    def __init__(self, SSP: AppDef_MultiLine, SCurv: AppParCurves_MultiCurve, FirstPoint: int, LastPoint: int, Constraints: Any, Bern: math_Matrix, DerivativeBern: math_Matrix, Tolerance: Optional[float] = 1.0e-10) -> None: ...
...
class AppDef_SmoothCriterion(Standard_Transient):
    ...
    def InputVector(self, X: math_Vector, AssTable: Any) -> None: ...
...
class AppDef_Variational:
    ...
    def SetConstraints(self, aConstrainst: Any) -> bool: ...
