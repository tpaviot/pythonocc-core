...
AppDef_HArray1OfMultiPointConstraint = NewType("AppDef_HArray1OfMultiPointConstraint", Any)
...
class AppDef_SmoothCriterion(Standard_Transient):
    def AssemblyTable(self) -> False: ...
    def Curve(self) -> FEmTool_Curve: ...
    def DependenceTable(self) -> False: ...
    def EstLength(self) -> False: ...
