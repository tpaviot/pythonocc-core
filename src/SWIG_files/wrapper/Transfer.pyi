...
Transfer_HSequenceOfBinder = NewType("Transfer_HSequenceOfBinder", Any)
# the following typedef cannot be wrapped as is
Transfer_HSequenceOfFinder = NewType("Transfer_HSequenceOfFinder", Any)
# the following typedef cannot be wrapped as is
...
class Transfer_ResultFromModel(Standard_Transient):
    ...
    def CheckedList(self, check: Interface_CheckStatus, result: bool) -> False: ...
    ...
    def Results(self, level: int) -> False: ...
    ...
    def TransferredList(self, level: Optional[int] = 2) -> False: ...
...
class Transfer_TransientProcess(Transfer_ProcessForTransient):
    ...
    def PrintStats(self, mode: int) -> str: ...
    def PrintTrace(self, start: Standard_Transient) -> str: ...
    def RootsForTransfer(self) -> False: ...
