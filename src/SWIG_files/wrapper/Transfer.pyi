...
Transfer_TransferMapOfProcessForFinder = NewType(
    "Transfer_TransferMapOfProcessForFinder", Any
)
# the following typedef cannot be wrapped as is
Transfer_TransferMapOfProcessForTransient = NewType(
    "Transfer_TransferMapOfProcessForTransient", Any
)
...
class Transfer_DispatchControl(Interface_CopyControl):
    def __init__(
        self, model: Interface_InterfaceModel, TP: Transfer_TransientProcess
    ) -> None: ...
...
class Transfer_MapContainer(Standard_Transient):
    ...
    def SetMapObjects(
        self, theMapObjects: TColStd_DataMapOfTransientTransient
    ) -> None: ...
...
class Transfer_ProcessForTransient(Standard_Transient):
    ...
    @overload
    def __init__(
        self, printer: Message_Messenger, nb: Optional[int] = 10000
    ) -> None: ...
    ...
    def AddMultiple(
        self, start: Standard_Transient, res: Standard_Transient
    ) -> None: ...
    @overload
    def AddWarning(
        self, start: Standard_Transient, mess: str, orig: Optional[str] = ""
    ...
    def CheckListOne(
        self, start: Standard_Transient, level: int, erronly: bool
    ) -> Interface_CheckIterator: ...
    def CheckNum(self, start: Standard_Transient) -> int: ...
    def Clean(self) -> None: ...
    def Clear(self) -> None: ...
    def CompleteResult(
        self, withstart: Optional[bool] = False
    ...
    def FindTypedTransient(
        self, start: Standard_Transient, atype: Standard_Type, val: Standard_Transient
    ) -> bool: ...
    def GetTypedTransient(
        self, binder: Transfer_Binder, atype: Standard_Type, val: Standard_Transient
    ) -> bool: ...
    ...
    def Recognize(self, start: Standard_Transient) -> bool: ...
    def RemoveResult(
        self, start: Standard_Transient, level: int, compute: Optional[bool] = True
    ) -> None: ...
    def ResetNestingLevel(self) -> None: ...
    def Resize(self, nb: int) -> None: ...
    def ResultOne(
        self, start: Standard_Transient, level: int, withstart: Optional[bool] = False
    ) -> Transfer_IteratorOfProcessForTransient: ...
    ...
    def StartTrace(
        self, binder: Transfer_Binder, start: Standard_Transient, level: int, mode: int
    ) -> None: ...
...
class Transfer_ResultFromModel(Standard_Transient):
    def __init__(self) -> None: ...
    def CheckList(
        self, erronly: bool, level: Optional[int] = 2
    ) -> Interface_CheckIterator: ...
    def CheckStatus(self) -> Interface_CheckStatus: ...
    def CheckedList(
        self, check: Interface_CheckStatus, result: bool
...
class Transfer_TransferInput:
    ...
    @overload
    def FillModel(
        self, proc: Transfer_TransientProcess, amodel: Interface_InterfaceModel
    ) -> None: ...
    @overload
    def FillModel(
        self,
        ...
        roots: Optional[bool] = True,
    ) -> None: ...
    @overload
    def FillModel(
        self, proc: Transfer_FinderProcess, amodel: Interface_InterfaceModel
    ) -> None: ...
    @overload
    def FillModel(
        self,
...
class Transfer_TransferOutput:
    @overload
    def __init__(
        self, actor: Transfer_ActorOfTransientProcess, amodel: Interface_InterfaceModel
    ) -> None: ...
    @overload
    def __init__(
        self, proc: Transfer_TransientProcess, amodel: Interface_InterfaceModel
    ...
    def ListForStatus(
        self, normal: bool, roots: Optional[bool] = True
    ) -> Interface_EntityIterator: ...
    def Model(self) -> Interface_InterfaceModel: ...
    def ModelForStatus(
        self, protocol: Interface_Protocol, normal: bool, roots: Optional[bool] = True
...
class Transfer_IteratorOfProcessForFinder(Transfer_TransferIterator):
    ...
    def Filter(
        self, list: Transfer_HSequenceOfFinder, keep: Optional[bool] = True
    ) -> None: ...
...
class Transfer_IteratorOfProcessForTransient(Transfer_TransferIterator):
    ...
    def Filter(
        self, list: TColStd_HSequenceOfTransient, keep: Optional[bool] = True
    ) -> None: ...
    def HasStarting(self) -> bool: ...
...
class Transfer_SimpleBinderOfTransient(Transfer_Binder):
    ...
    @staticmethod
    def GetTypedResult(
        bnd: Transfer_Binder, atype: Standard_Type, res: Standard_Transient
    ) -> bool: ...
...
class Transfer_TransientProcess(Transfer_ProcessForTransient):
    ...
    def SetModel(self, model: Interface_InterfaceModel) -> None: ...
    def TypedSharings(
        self, start: Standard_Transient, type: Standard_Type
    ) -> Interface_EntityIterator: ...
