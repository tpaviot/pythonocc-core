...
class Transfer_ActorOfTransientProcess(Transfer_ActorOfProcessForTransient):
    def __init__(self) -> None: ...
    def GetProcessingFlags(self) -> Any: ...
    def GetShapeFixParameters(self) -> Resource_DataMapOfAsciiStringAsciiString: ...
    def SetProcessingFlags(self, theFlags: Any) -> None: ...
    @overload
    def SetShapeFixParameters(self, theParameters: Resource_DataMapOfAsciiStringAsciiString) -> None: ...
    @overload
    def SetShapeFixParameters(self, theParameters: Resource_DataMapOfAsciiStringAsciiString) -> None: ...
...
class Transfer_IteratorOfProcessForFinder(Transfer_TransferIterator):
    ...
    def Filter(self, list: Any, keep: Optional[bool] = True) -> None: ...
