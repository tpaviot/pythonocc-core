...
class ShapeAnalysis_CheckSmallFace:
    ...
    def CheckSplittingVertices(self, F: TopoDS_Face, MapEdges: TopTools_DataMapOfShapeListOfShape, MapParam: Any, theAllVert: TopoDS_Compound) -> int: ...
...
class ShapeAnalysis_Wire(Standard_Transient):
    ...
    @overload
    def CheckIntersectingEdges(self, num: int, points2d: Any, points3d: TColgp_SequenceOfPnt, errors: TColStd_SequenceOfReal) -> bool: ...
    @overload
    def CheckIntersectingEdges(self, num: int) -> bool: ...
    @overload
    def CheckIntersectingEdges(self, num1: int, num2: int, points2d: Any, points3d: TColgp_SequenceOfPnt, errors: TColStd_SequenceOfReal) -> bool: ...
    @overload
    ...
    @overload
    def CheckSelfIntersectingEdge(self, num: int, points2d: Any, points3d: TColgp_SequenceOfPnt) -> bool: ...
    @overload
