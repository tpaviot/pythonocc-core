...
class shapeanalysis:
    ...
    @staticmethod
    def FindBounds(
        shape: TopoDS_Shape, V1: TopoDS_Vertex, V2: TopoDS_Vertex
    ) -> None: ...
    @staticmethod
...
class ShapeAnalysis_CheckSmallFace:
    ...
    def CheckStripEdges(
        self, E1: TopoDS_Edge, E2: TopoDS_Edge, tol: float
    ) -> Tuple[bool, float]: ...
    def CheckStripFace(
        self,
        F: TopoDS_Face,
    ...
    def IsSpotFace(
        self, F: TopoDS_Face, spot: gp_Pnt, tol: Optional[float] = -1.0
    ) -> Tuple[int, float]: ...
...
class ShapeAnalysis_Curve:
    ...
    @staticmethod
    def GetSamplePoints(
        curve: Geom2d_Curve, first: float, last: float, seq: TColgp_SequenceOfPnt2d
    ) -> bool: ...
    @overload
    @staticmethod
    def GetSamplePoints(
        curve: Geom_Curve, first: float, last: float, seq: TColgp_SequenceOfPnt
    ) -> bool: ...
    @staticmethod
    ...
    @staticmethod
    def IsPlanar(
        pnts: TColgp_Array1OfPnt, Normal: gp_XYZ, preci: Optional[float] = 0
    ) -> bool: ...
    @overload
    @staticmethod
    def IsPlanar(
        curve: Geom_Curve, Normal: gp_XYZ, preci: Optional[float] = 0
    ) -> bool: ...
    @overload
    def NextProject(
        self,
        ...
        cf: float,
        cl: float,
        AdjustToEnds: Optional[bool] = True,
    ) -> Tuple[float, float]: ...
    @overload
    def NextProject(
        self,
    ...
    def ProjectAct(
        self, C3D: Adaptor3d_Curve, P3D: gp_Pnt, preci: float, proj: gp_Pnt
    ) -> Tuple[float, float]: ...
    def SelectForwardSeam(self, C1: Geom2d_Curve, C2: Geom2d_Curve) -> int: ...
    def ValidateRange(
        self, Crv: Geom_Curve, prec: float
...
class ShapeAnalysis_Edge:
    ...
    @overload
    def BoundUV(
        self, edge: TopoDS_Edge, face: TopoDS_Face, first: gp_Pnt2d, last: gp_Pnt2d
    ) -> bool: ...
    @overload
    def BoundUV(
        self,
    ...
    def CheckOverlapping(
        ...
        theDomainDist: Optional[float] = 0.0,
    ) -> Tuple[bool, float]: ...
    def CheckPCurveRange(
        self, theFirst: float, theLast: float, thePC: Geom2d_Curve
    ) -> bool: ...
    @overload
    def CheckSameParameter(
        self, edge: TopoDS_Edge, NbControl: Optional[int] = 23
    ) -> Tuple[bool, float]: ...
    @overload
    def CheckSameParameter(
        self,
        theEdge: TopoDS_Edge,
        theFace: TopoDS_Face,
        theNbControl: Optional[int] = 23,
    ) -> Tuple[bool, float]: ...
    @overload
    def CheckVertexTolerance(
        self, edge: TopoDS_Edge, face: TopoDS_Face
    ) -> Tuple[bool, float, float]: ...
    @overload
    def CheckVertexTolerance(self, edge: TopoDS_Edge) -> Tuple[bool, float, float]: ...
    def CheckVerticesWithCurve3d(
        self, edge: TopoDS_Edge, preci: Optional[float] = -1, vtx: Optional[int] = 0
    ) -> bool: ...
    @overload
    ...
    def Curve3d(
        self, edge: TopoDS_Edge, C3d: Geom_Curve, orient: Optional[bool] = True
    ) -> Tuple[bool, float, float]: ...
...
class ShapeAnalysis_FreeBounds:
    ...
    def __init__(
        ...
        shape: TopoDS_Shape,
        toler: float,
        splitclosed: Optional[bool] = False,
        splitopen: Optional[bool] = True,
    ) -> None: ...
    @overload
    def __init__(
        self,
...
class ShapeAnalysis_FreeBoundsProperties:
    ...
    @overload
    def CheckNotches(
        self, fbData: ShapeAnalysis_FreeBoundData, prec: Optional[float] = 0.0
    ) -> bool: ...
    @overload
    def CheckNotches(
        self,
...
class ShapeAnalysis_Geom:
    ...
    @staticmethod
    def PositionTrsf(
        coefs: TColStd_HArray2OfReal, trsf: gp_Trsf, unit: float, prec: float
    ) -> bool: ...
...
class ShapeAnalysis_ShapeTolerance:
    def __init__(self) -> None: ...
    def AddTolerance(
        self, shape: TopoDS_Shape, type: Optional[TopAbs_ShapeEnum] = TopAbs_SHAPE
    ) -> None: ...
    ...
    def InTolerance(
        ...
        valmin: float,
        valmax: float,
        type: Optional[TopAbs_ShapeEnum] = TopAbs_SHAPE,
...
class ShapeAnalysis_Surface(Standard_Transient):
    ...
    @overload
    def IsDegenerated(
        self, p2d1: gp_Pnt2d, p2d2: gp_Pnt2d, tol: float, ratio: float
    ) -> bool: ...
    ...
    def NextValueOfUV(
        ...
        P3D: gp_Pnt,
        preci: float,
        maxpreci: Optional[float] = -1.0,
    ) -> gp_Pnt2d: ...
    @overload
    def ProjectDegenerated(
        self, P3d: gp_Pnt, preci: float, neighbour: gp_Pnt2d, result: gp_Pnt2d
    ) -> bool: ...
    @overload
    def ProjectDegenerated(
        self,
    ...
    def Singularity(
        self, num: int, P3d: gp_Pnt, firstP2d: gp_Pnt2d, lastP2d: gp_Pnt2d
...
class ShapeAnalysis_Wire(Standard_Transient):
    ...
    @overload
    def __init__(
        self, wire: TopoDS_Wire, face: TopoDS_Face, precision: float
    ) -> None: ...
    @overload
    def __init__(
        self, sbwd: ShapeExtend_WireData, face: TopoDS_Face, precision: float
    ) -> None: ...
    ...
    @overload
    def CheckLacking(
        self, num: int, Tolerance: float, p2d1: gp_Pnt2d, p2d2: gp_Pnt2d
    ) -> bool: ...
    @overload
    ...
    def CheckNotchedEdges(
        self, num: int, Tolerance: Optional[float] = 0.0
    ) -> Tuple[bool, int, float]: ...
    @overload
    def CheckOrder(
        self, isClosed: Optional[bool] = True, mode3d: Optional[bool] = True
    ) -> bool: ...
    @overload
    def CheckOrder(
        self,
        sawo: ShapeAnalysis_WireOrder,
        isClosed: Optional[bool] = True,
        theMode3D: Optional[bool] = True,
        theModeBoth: Optional[bool] = False,
    ) -> bool: ...
    def CheckOuterBound(self, APIMake: Optional[bool] = True) -> bool: ...
    @overload
    def CheckSeam(
        self, num: int, C1: Geom2d_Curve, C2: Geom2d_Curve
    ) -> Tuple[bool, float, float]: ...
    @overload
    ...
    def CheckShapeConnect(
        self, shape: TopoDS_Shape, prec: Optional[float] = 0.0
    ) -> bool: ...
    @overload
    def CheckShapeConnect(
        self, shape: TopoDS_Shape, prec: Optional[float] = 0.0
...
class ShapeAnalysis_WireOrder:
    ...
    @overload
    def __init__(
        self, theMode3D: bool, theTolerance: float, theModeBoth: Optional[bool] = False
    ) -> None: ...
    @overload
    ...
    @overload
    def Add(
        self, theStart3d: gp_XYZ, theEnd3d: gp_XYZ, theStart2d: gp_XY, theEnd2d: gp_XY
    ) -> None: ...
...
class ShapeAnalysis_TransferParametersProj(ShapeAnalysis_TransferParameters):
    ...
    @staticmethod
    def CopyNMVertex(
        theVert: TopoDS_Vertex, toedge: TopoDS_Edge, fromedge: TopoDS_Edge
    ) -> TopoDS_Vertex: ...
    @overload
    @staticmethod
    def CopyNMVertex(
        theVert: TopoDS_Vertex, toFace: TopoDS_Face, fromFace: TopoDS_Face
    ) -> TopoDS_Vertex: ...
    ...
    @overload
    def Perform(
        self, Papams: TColStd_HSequenceOfReal, To2d: bool
    ) -> TColStd_HSequenceOfReal: ...
    @overload
    def Perform(self, Param: float, To2d: bool) -> float: ...
    def TransferRange(
        self, newEdge: TopoDS_Edge, prevPar: float, currPar: float, Is2d: bool
    ) -> None: ...
...
class ShapeAnalysis_HSequenceOfFreeBounds(
    ShapeAnalysis_SequenceOfFreeBounds, Standard_Transient
):
    @overload
    def __init__(self) -> None: ...
    @overload
