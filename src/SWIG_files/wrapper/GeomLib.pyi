...
GeomLib_DenominatorMultiplierPtr = NewType(
    "GeomLib_DenominatorMultiplierPtr", GeomLib_DenominatorMultiplier
)
...
class geomlib:
    @staticmethod
    def AdjustExtremity(
        Curve: Geom_BoundedCurve, P1: gp_Pnt, P2: gp_Pnt, T1: gp_Vec, T2: gp_Vec
    ) -> None: ...
    @staticmethod
    def AxeOfInertia(
        Points: TColgp_Array1OfPnt, Axe: gp_Ax2, Tol: Optional[float] = 1.0e-7
    ) -> bool: ...
    @staticmethod
    def BuildCurve3d(
        Tolerance: float,
        ...
        MaxSegment: Optional[int] = 30,
    ) -> Tuple[float, float]: ...
    @staticmethod
    def CancelDenominatorDerivative(
        BSurf: Geom_BSplineSurface, UDirection: bool, VDirection: bool
    ) -> None: ...
    @staticmethod
    def DensifyArray1OfReal(
        MinNumPoints: int,
        InParameters: TColStd_Array1OfReal,
        OutParameters: TColStd_HArray1OfReal,
    ) -> None: ...
    @staticmethod
    def EvalMaxDistanceAlongParameter(
    ...
    @staticmethod
    def ExtendCurveToPoint(
        Curve: Geom_BoundedCurve, Point: gp_Pnt, Cont: int, After: bool
    ) -> None: ...
    @staticmethod
    def ExtendSurfByLength(
        Surf: Geom_BoundedSurface, Length: float, Cont: int, InU: bool, After: bool
    ) -> None: ...
    @staticmethod
    def FuseIntervals(
        ...
        Confusion: Optional[float] = 1.0e-9,
        IsAdjustToFirstInterval: Optional[bool] = False,
    ) -> None: ...
    @staticmethod
    def GTransform(Curve: Geom2d_Curve, GTrsf: gp_GTrsf2d) -> Geom2d_Curve: ...
    @staticmethod
    def Inertia(
        Points: TColgp_Array1OfPnt, Bary: gp_Pnt, XDir: gp_Dir, YDir: gp_Dir
    ) -> Tuple[float, float, float]: ...
    @staticmethod
    def IsBSplUClosed(
        S: Geom_BSplineSurface, U1: float, U2: float, Tol: float
    ) -> bool: ...
    @staticmethod
    def IsBSplVClosed(
        S: Geom_BSplineSurface, V1: float, V2: float, Tol: float
    ) -> bool: ...
    @staticmethod
    def IsBzUClosed(
        S: Geom_BezierSurface, U1: float, U2: float, Tol: float
    ) -> bool: ...
    @staticmethod
    def IsBzVClosed(
        S: Geom_BezierSurface, V1: float, V2: float, Tol: float
    ) -> bool: ...
    @staticmethod
    def IsClosed(S: Geom_Surface, Tol: float) -> Tuple[bool, bool]: ...
    @staticmethod
    def NormEstim(
        theSurf: Geom_Surface, theUV: gp_Pnt2d, theTol: float, theNorm: gp_Dir
    ) -> int: ...
    @staticmethod
    def RemovePointsFromArray(
        NumPoints: int,
        InParameters: TColStd_Array1OfReal,
        OutParameters: TColStd_HArray1OfReal,
    ) -> None: ...
...
class GeomLib_Check2dBSplineCurve:
    def __init__(
        self, Curve: Geom2d_BSplineCurve, Tolerance: float, AngularTolerance: float
    ) -> None: ...
...
class GeomLib_CheckBSplineCurve:
    def __init__(
        self, Curve: Geom_BSplineCurve, Tolerance: float, AngularTolerance: float
    ) -> None: ...
    def FixTangent(self, FirstFlag: bool, LastFlag: bool) -> None: ...
...
class GeomLib_DenominatorMultiplier:
    def __init__(
        self, Surface: Geom_BSplineSurface, KnotVector: TColStd_Array1OfReal
    ) -> None: ...
...
class GeomLib_Tool:
    ...
    def ComputeDeviation(
        ...
        theNbIters: Optional[int] = 100,
        thePrmOnCurve: Optional[float] = None,
        thePtOnCurve: Optional[gp_Pnt2d] = None,
        theVecCurvLine: Optional[gp_Vec2d] = None,
        theLine: Optional[gp_Lin2d] = None,
    ) -> float: ...
    @overload
    @staticmethod
    def ComputeDeviation(
        ...
        theNbIters: Optional[int] = 10,
        thePrmOnCurve: Optional[float] = None,
    ) -> float: ...
    @overload
    @staticmethod
    def Parameter(
        Curve: Geom_Curve, Point: gp_Pnt, MaxDist: float
    ) -> Tuple[bool, float]: ...
    @overload
    @staticmethod
    def Parameter(
        Curve: Geom2d_Curve, Point: gp_Pnt2d, MaxDist: float
    ) -> Tuple[bool, float]: ...
    @staticmethod
    def Parameters(
        Surface: Geom_Surface, Point: gp_Pnt, MaxDist: float
