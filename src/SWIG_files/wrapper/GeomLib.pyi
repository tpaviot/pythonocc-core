...
class GeomLib_Array1OfMat:
    ...
    def __iter__(self) -> typing.Iterator[gp_Mat]: ...
...
class GeomLib_CheckCurveOnSurface:
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, theCurve: Adaptor3d_Curve, theTolRange: Optional[float] = ...) -> None: ...
    def ErrorStatus(self) -> int: ...
    @overload
    def Init(self, theCurve: Adaptor3d_Curve, theTolRange: Optional[float] = ...) -> None: ...
    @overload
    def Init(self) -> None: ...
    def IsDone(self) -> bool: ...
...
class GeomLib_Tool:
    @overload
    @staticmethod
    def ComputeDeviation(theCurve: Geom2dAdaptor_Curve, theFPar: float, theLPar: float, theStartParameter: float, theNbIters: Optional[int] = 100, thePrmOnCurve: Optional[Any] = None, thePtOnCurve: Optional[gp_Pnt2d] = None, theVecCurvLine: Optional[gp_Vec2d] = None, theLine: Optional[gp_Lin2d] = None) -> float: ...
    @overload
    @staticmethod
    def ComputeDeviation(theCurve: Geom2dAdaptor_Curve, theFPar: float, theLPar: float, theNbSubIntervals: int, theNbIters: Optional[int] = 10, thePrmOnCurve: Optional[Any] = None) -> float: ...
    @overload
    @staticmethod
