...
class StepToTopoDS_CartesianPointHasher:
    @staticmethod
    def HashCode(
        theCartesianPoint: StepGeom_CartesianPoint, theUpperBound: int
    ) -> int: ...
    @staticmethod
...
class StepToTopoDS_MakeTransformed(StepToTopoDS_Root):
    ...
    @overload
    def Compute(
        self, Origin: StepGeom_Axis2Placement3d, Target: StepGeom_Axis2Placement3d
    ) -> bool: ...
    @overload
...
class StepToTopoDS_TranslateCompositeCurve(StepToTopoDS_Root):
    ...
    @overload
    def __init__(
        self, CC: StepGeom_CompositeCurve, TP: Transfer_TransientProcess
    ) -> None: ...
    @overload
    def __init__(
        self,
...
class StepToTopoDS_TranslateCurveBoundedSurface(StepToTopoDS_Root):
    ...
    @overload
    def __init__(
        self, CBS: StepGeom_CurveBoundedSurface, TP: Transfer_TransientProcess
    ) -> None: ...
    def Init(
        self, CBS: StepGeom_CurveBoundedSurface, TP: Transfer_TransientProcess
    ) -> bool: ...
...
class StepToTopoDS_TranslateEdge(StepToTopoDS_Root):
    ...
    @overload
    def __init__(
        self, E: StepShape_Edge, T: StepToTopoDS_Tool, NMTool: StepToTopoDS_NMTool
    ) -> None: ...
    ...
    def MakePCurve(
        self, PCU: StepGeom_Pcurve, ConvSurf: Geom_Surface
    ) -> Geom2d_Curve: ...
...
class StepToTopoDS_TranslateVertex(StepToTopoDS_Root):
    ...
    @overload
    def __init__(
        self, V: StepShape_Vertex, T: StepToTopoDS_Tool, NMTool: StepToTopoDS_NMTool
    ) -> None: ...
