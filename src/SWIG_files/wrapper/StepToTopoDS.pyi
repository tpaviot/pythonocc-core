...
class StepToTopoDS_NMTool:
    ...
    @overload
    def __init__(self, MapOfRI: Any, MapOfRINames: Any) -> None: ...
    @overload
    ...
    def Init(self, MapOfRI: Any, MapOfRINames: Any) -> None: ...
...
class StepToTopoDS_Tool:
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, Map: Any, TP: Transfer_TransientProcess) -> None: ...
    @overload
    ...
    def Init(self, Map: Any, TP: Transfer_TransientProcess) -> None: ...
