...
class ChFiDS_ElSpine(Adaptor3d_Curve):
    ...
    def EvalD1(self, theAbsC: float) -> False: ...
    def EvalD2(self, theAbsC: float) -> False: ...
    def EvalD3(self, theAbsC: float) -> False: ...
    @overload
...
class ChFiDS_Map:
    ...
    def FindFromIndex(self, I: int) -> False: ...
    def FindFromKey(self, S: TopoDS_Shape) -> False: ...
...
class ChFiDS_Spine(Standard_Transient):
    ...
    def ChangeElSpines(self) -> False: ...
    def ChangeOffsetElSpines(self) -> False: ...
    def Circle(self) -> gp_Circ: ...
...
class ChFiDS_Stripe(Standard_Transient):
    ...
    def ChangeSetOfSurfData(self) -> False: ...
...
class ChFiDS_StripeMap:
    ...
    def Extent(self) -> int: ...
    def FindFromIndex(self, I: int) -> False: ...
    def FindFromKey(self, V: TopoDS_Vertex) -> False: ...
