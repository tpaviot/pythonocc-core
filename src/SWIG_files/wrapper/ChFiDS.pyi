...
class ChFiDS_SecArray1:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[ChFiDS_CircSection]: ...
...
class ChFiDS_ElSpine(Adaptor3d_Curve):
    ...
    def EvalD0(self, theAbsC: float) -> gp_Pnt: ...
    def EvalD1(self, theAbsC: float) -> Any: ...
    def EvalD2(self, theAbsC: float) -> Any: ...
    def EvalD3(self, theAbsC: float) -> Any: ...
    @overload
...
class ChFiDS_Spine(Standard_Transient):
    ...
    def ChangeElSpines(self) -> Any: ...
    def ChangeOffsetElSpines(self) -> Any: ...
    def Circle(self) -> gp_Circ: ...
...
class ChFiDS_Stripe(Standard_Transient):
    ...
    def ChangeSetOfSurfData(self) -> Any: ...
...
class ChFiDS_StripeMap:
    ...
    def Clear(self) -> None: ...
    def Extent(self) -> int: ...
    def FindFromIndex(self, I: int) -> Any: ...
    def FindFromKey(self, V: TopoDS_Vertex) -> Any: ...
