...
ChFiDS_IndexedDataMapOfVertexListOfStripe = NewType(
    "ChFiDS_IndexedDataMapOfVertexListOfStripe", Any
)

class ChFiDS_ListOfHElSpine:
    def Append(self, theItem: False) -> False: ...
    def Assign(self, theItem: ChFiDS_ListOfHElSpine) -> ChFiDS_ListOfHElSpine: ...
    def Clear(self) -> None: ...
...
class ChFiDS_ListOfStripe:
    def Append(self, theItem: False) -> False: ...
    def Assign(self, theItem: ChFiDS_ListOfStripe) -> ChFiDS_ListOfStripe: ...
    def Clear(self) -> None: ...
    def First(self) -> False: ...
    def Last(self) -> False: ...
    def Prepend(self, theItem: False) -> False: ...
...
class ChFiDS_Regularities:
    ...
    def Assign(self, theItem: ChFiDS_Regularities) -> ChFiDS_Regularities: ...
    def Clear(self) -> None: ...
    ...
    def __init__(self) -> None: ...
    def __len__(self) -> int: ...
    def __iter__(self) -> ChFiDS_Regul: ...
...
ChFiDS_ConstThroatWithPenetrationChamfer = (
    ChFiDS_ChamfMode.ChFiDS_ConstThroatWithPenetrationChamfer
)
...
class ChFiDS_CommonPoint:
    ...
    def Reset(self) -> None: ...
    def SetArc(
        self, Tol: float, A: TopoDS_Edge, Param: float, TArc: TopAbs_Orientation
    ) -> None: ...
...
class ChFiDS_ElSpine(Adaptor3d_Curve):
    ...
    def D3(
        self, AbsC: float, P: gp_Pnt, V1: gp_Vec, V2: gp_Vec, V3: gp_Vec
    ) -> None: ...
...
class ChFiDS_Map:
    ...
    def Fill(
        self, S: TopoDS_Shape, T1: TopAbs_ShapeEnum, T2: TopAbs_ShapeEnum
    ) -> None: ...
...
class ChFiDS_Spine(Standard_Transient):
    ...
    @overload
    def Parameter(
        self, Index: int, AbsC: float, Oriented: Optional[bool] = True
    ) -> float: ...
    def Period(self) -> float: ...
...
class ChFiDS_SurfData(Standard_Transient):
    ...
    @overload
    def Get2dPoints(
        self, P2df1: gp_Pnt2d, P2dl1: gp_Pnt2d, P2df2: gp_Pnt2d, P2dl2: gp_Pnt2d
    ) -> None: ...
