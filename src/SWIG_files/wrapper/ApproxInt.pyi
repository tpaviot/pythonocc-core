...
class ApproxInt_KnotTools:
    @staticmethod
    def BuildCurvature(theCoords: Any, theDim: int, thePars: math_Vector, theCurv: TColStd_Array1OfReal) -> float: ...
    @staticmethod
    def BuildKnots(thePntsXYZ: TColgp_Array1OfPnt, thePntsU1V1: TColgp_Array1OfPnt2d, thePntsU2V2: TColgp_Array1OfPnt2d, thePars: math_Vector, theApproxXYZ: bool, theApproxU1V1: bool, theApproxU2V2: bool, theMinNbPnts: int, theKnots: Any) -> None: ...
    @staticmethod
