...
class VrmlData_Node(Standard_Transient):
    def Clone(self, arg0: VrmlData_Node) -> VrmlData_Node: ...
    @staticmethod
    ...
    @staticmethod
    def ReadInteger(theBuffer: VrmlData_InBuffer, theResult: Any) -> VrmlData_ErrorStatus: ...
    @staticmethod
    def ReadMultiString(theBuffer: VrmlData_InBuffer, theRes: TColStd_ListOfAsciiString) -> VrmlData_ErrorStatus: ...
...
class VrmlData_Scene:
    @overload
    def __init__(self, arg0: Optional[NCollection_IncAllocator] = None) -> None: ...
    ...
    def Dump(self) -> str: ...
    @overload
    def FindNode(self, theName: str, theType: Optional[Standard_Type] = None) -> VrmlData_Node: ...
    @overload
    def FindNode(self, theName: str, theLocation: gp_Trsf) -> VrmlData_Node: ...
    def GetIterator(self) -> Any: ...
    def GetLineError(self) -> int: ...
    def GetShape(self, M: Any) -> TopoDS_Shape: ...
    def IsDummyWrite(self) -> bool: ...
    def NamedNodesIterator(self) -> Any: ...
    def ReadArrIndex(self, theBuffer: VrmlData_InBuffer, theArr: int, theNBl: Any) -> VrmlData_ErrorStatus: ...
    @staticmethod
    ...
    def SetVrmlDir(self, arg0: str) -> None: ...
    def Status(self) -> VrmlData_ErrorStatus: ...
    def VrmlDirIterator(self) -> Any: ...
    def WorldInfo(self) -> VrmlData_WorldInfo: ...
    def WriteArrIndex(self, thePrefix: str, theArr: int, theNbBl: int) -> VrmlData_ErrorStatus: ...
    def WriteLine(self, theLine0: str, theLine1: Optional[str] = None, theIndent: Optional[int] = 0) -> VrmlData_ErrorStatus: ...
    def WriteNode(self, thePrefix: str, arg1: VrmlData_Node) -> VrmlData_ErrorStatus: ...
    def WriteXYZ(self, theXYZ: gp_XYZ, isScale: bool, thePostfix: Optional[str] = None) -> VrmlData_ErrorStatus: ...

class VrmlData_ShapeConvert:
    def __init__(self, theScene: VrmlData_Scene, theScale: Optional[float] = 1) -> None: ...
    def AddShape(self, theShape: TopoDS_Shape, theName: Optional[str] = None) -> None: ...
...
class VrmlData_Group(VrmlData_Node):
    ...
    def Shape(self, theShape: TopoDS_Shape, pMapApp: Any) -> None: ...
    def Write(self, thePrefix: str) -> VrmlData_ErrorStatus: ...
...
class VrmlData_TextureCoordinate(VrmlData_Node):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, theScene: VrmlData_Scene, theName: str, nPoints: Optional[int] = 0, arrPoints: Optional[gp_XY] = None) -> None: ...
    def AllocateValues(self, theLength: int) -> bool: ...
    def Clone(self, theOther: VrmlData_Node) -> VrmlData_Node: ...
    def Length(self) -> int: ...
    def Points(self) -> gp_XY: ...
    def Read(self, theBuffer: VrmlData_InBuffer) -> VrmlData_ErrorStatus: ...
    def SetPoints(self, nPoints: int, arrPoints: gp_XY) -> None: ...

class VrmlData_UnknownNode(VrmlData_Node):
    @overload
    def __init__(self) -> None: ...
    @overload
    def __init__(self, theScene: VrmlData_Scene, theName: Optional[str] = None, theTitle: Optional[str] = None) -> None: ...
...
class VrmlData_Color(VrmlData_ArrayVec3d):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, theScene: VrmlData_Scene, theName: str, nColors: Optional[int] = 0, arrColors: Optional[gp_XYZ] = None) -> None: ...
    def Clone(self, theOther: VrmlData_Node) -> VrmlData_Node: ...
    def Color(self, i: int) -> Quantity_Color: ...
    def Read(self, theBuffer: VrmlData_InBuffer) -> VrmlData_ErrorStatus: ...
    def SetColors(self, nColors: int, arrColors: gp_XYZ) -> None: ...
    def Write(self, thePrefix: str) -> VrmlData_ErrorStatus: ...
...
class VrmlData_Coordinate(VrmlData_ArrayVec3d):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, theScene: VrmlData_Scene, theName: str, nPoints: Optional[int] = 0, arrPoints: Optional[gp_XYZ] = None) -> None: ...
    def Clone(self, theOther: VrmlData_Node) -> VrmlData_Node: ...
...
class VrmlData_ImageTexture(VrmlData_Texture):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, theScene: VrmlData_Scene, theName: str, theURL: Optional[str] = None, theRepS: Optional[bool] = False, theRepT: Optional[bool] = False) -> None: ...
    def Clone(self, theOther: VrmlData_Node) -> VrmlData_Node: ...
    def Read(self, theBuffer: VrmlData_InBuffer) -> VrmlData_ErrorStatus: ...
    def URL(self) -> TColStd_ListOfAsciiString: ...
    def Write(self, thePrefix: str) -> VrmlData_ErrorStatus: ...
...
class VrmlData_IndexedLineSet(VrmlData_Geometry):
    ...
    def ArrayColorInd(self, arrColorInd: int) -> int: ...
    def Clone(self, theOther: VrmlData_Node) -> VrmlData_Node: ...
    ...
    def Polygons(self, arrPolygons: int) -> int: ...
    def Read(self, theBuffer: VrmlData_InBuffer) -> VrmlData_ErrorStatus: ...
...
class VrmlData_Normal(VrmlData_ArrayVec3d):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, theScene: VrmlData_Scene, theName: str, nVec: Optional[int] = 0, arrVec: Optional[gp_XYZ] = None) -> None: ...
    def Clone(self, theOther: VrmlData_Node) -> VrmlData_Node: ...
...
class VrmlData_IndexedFaceSet(VrmlData_Faceted):
    ...
    def ArrayColorInd(self, arrColorInd: int) -> int: ...
    def ArrayNormalInd(self, arrNormalInd: int) -> int: ...
    def ArrayTextureCoordInd(self, arrTextureCoordInd: int) -> int: ...
    def Clone(self, theOther: VrmlData_Node) -> VrmlData_Node: ...
    def Colors(self) -> VrmlData_Color: ...
    def Coordinates(self) -> VrmlData_Coordinate: ...
    def GetColor(self, iFace: int, iVertex: int) -> Quantity_Color: ...
