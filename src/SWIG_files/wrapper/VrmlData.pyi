...
class VrmlData_Node(Standard_Transient):
    ...
    ) -> Tuple[VrmlData_ErrorStatus, bool]: ...
    def ReadNode(
        self,
        theBuffer: VrmlData_InBuffer,
        theNode: VrmlData_Node,
        Type: Optional[Standard_Type] = None,
    ) -> VrmlData_ErrorStatus: ...
    @staticmethod
    def ReadString(
        theBuffer: VrmlData_InBuffer, theRes: str
    ) -> VrmlData_ErrorStatus: ...
...
class VrmlData_Scene:
    def AddNode(
        self, theN: VrmlData_Node, isTopLevel: Optional[bool] = True
    ) -> VrmlData_Node: ...
    def Allocator(self) -> NCollection_IncAllocator: ...
    @overload
    def FindNode(
        self, theName: str, theType: Optional[Standard_Type] = 0
    ) -> VrmlData_Node: ...
    @overload
    ...
    def ReadArrIndex(
        self, theBuffer: VrmlData_InBuffer, theArr: int, theNBl: int
    ) -> VrmlData_ErrorStatus: ...
    @staticmethod
    def ReadLine(theBuffer: VrmlData_InBuffer) -> VrmlData_ErrorStatus: ...
    def ReadReal(
        self, theBuffer: VrmlData_InBuffer, isApplyScale: bool, isOnlyPositive: bool
    ) -> Tuple[VrmlData_ErrorStatus, float]: ...
    @staticmethod
    ...
    def WriteArrIndex(
        self, thePrefix: str, theArr: int, theNbBl: int
    ) -> VrmlData_ErrorStatus: ...
    def WriteLine(
        self, theLine0: str, theLine1: Optional[str] = 0, theIndent: Optional[int] = 0
    ) -> VrmlData_ErrorStatus: ...
    def WriteXYZ(
        self, theXYZ: gp_XYZ, isScale: bool, thePostfix: Optional[str] = 0
    ) -> VrmlData_ErrorStatus: ...

class VrmlData_ShapeConvert:
    def __init__(
        self, theScene: VrmlData_Scene, theScale: Optional[float] = 1
    ) -> None: ...
    ...
    def Convert(
        ...
        theDeflection: Optional[float] = 0.01,
        theDeflAngle: Optional[float] = 20 * M_PI / 180,
    ) -> None: ...
...
class VrmlData_Group(VrmlData_Node):
    ...
    def __init__(
        ...
        theName: str,
        isTransform: Optional[bool] = False,
    ) -> None: ...
    ...
    def Shape(
        self, theShape: TopoDS_Shape, pMapApp: VrmlData_DataMapOfShapeAppearance
    ) -> None: ...
    def Write(self, thePrefix: str) -> VrmlData_ErrorStatus: ...
...
class VrmlData_Material(VrmlData_Node):
    ...
    def __init__(
        ...
        theScene: VrmlData_Scene,
        theName: str,
        theAmbientIntensity: Optional[float] = -1,
        theShininess: Optional[float] = -1,
        theTransparency: Optional[float] = -1,
    ) -> None: ...
...
class VrmlData_UnknownNode(VrmlData_Node):
    ...
    def __init__(
        self,
        theScene: VrmlData_Scene,
        theName: Optional[str] = 0,
        theTitle: Optional[str] = 0,
    ) -> None: ...
...
class VrmlData_Box(VrmlData_Geometry):
    ...
    def __init__(
        ...
        theScene: VrmlData_Scene,
        theName: str,
        sizeX: Optional[float] = 2,
        sizeY: Optional[float] = 2,
        sizeZ: Optional[float] = 2,
    ) -> None: ...
    def Clone(self, theOther: VrmlData_Node) -> VrmlData_Node: ...
    def Read(self, theBuffer: VrmlData_InBuffer) -> VrmlData_ErrorStatus: ...
...
class VrmlData_Cone(VrmlData_Geometry):
    ...
    def __init__(
        ...
        theScene: VrmlData_Scene,
        theName: str,
        theBottomRadius: Optional[float] = 1,
        theHeight: Optional[float] = 2,
    ) -> None: ...
...
class VrmlData_ImageTexture(VrmlData_Texture):
    ...
    def __init__(
        ...
        theScene: VrmlData_Scene,
        theName: str,
        theURL: Optional[str] = 0,
        theRepS: Optional[bool] = False,
        theRepT: Optional[bool] = False,
    ) -> None: ...
    def Clone(self, theOther: VrmlData_Node) -> VrmlData_Node: ...
    def Read(self, theBuffer: VrmlData_InBuffer) -> VrmlData_ErrorStatus: ...
    def URL(self) -> False: ...
...
class VrmlData_IndexedLineSet(VrmlData_Geometry):
    ...
    def __init__(
        ...
        theScene: VrmlData_Scene,
        theName: str,
        isColorPerVertex: Optional[bool] = True,
    ) -> None: ...
...
class VrmlData_Sphere(VrmlData_Geometry):
    ...
    @overload
    def __init__(
        self, theScene: VrmlData_Scene, theName: str, theRadius: Optional[float] = 1
    ) -> None: ...
    def Clone(self, theOther: VrmlData_Node) -> VrmlData_Node: ...
    def Radius(self) -> float: ...
    def Read(self, theBuffer: VrmlData_InBuffer) -> VrmlData_ErrorStatus: ...
...
class VrmlData_IndexedFaceSet(VrmlData_Faceted):
    ...
    def __init__(
        ...
        theScene: VrmlData_Scene,
        theName: str,
        isCCW: Optional[bool] = True,
        isSolid: Optional[bool] = True,
        isConvex: Optional[bool] = True,
        theCreaseAngle: Optional[float] = 0,
    ) -> None: ...
    def ArrayColorInd(self, arrColorInd: int) -> False: ...
