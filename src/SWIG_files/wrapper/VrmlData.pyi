...
class VrmlData_Node(Standard_Transient):
    ...
    def ReadNode(self, theBuffer: VrmlData_InBuffer, theNode: VrmlData_Node, Type: Optional[Standard_Type] = nullptr) -> VrmlData_ErrorStatus: ...
    @staticmethod
...
class VrmlData_Scene:
    ...
    def Dump(self) -> str: ...
    @overload
    def FindNode(self, theName: str, theType: Optional[Standard_Type] = nullptr) -> VrmlData_Node: ...
    @overload
    ...
    def WriteLine(self, theLine0: str, theLine1: Optional[str] = nullptr, theIndent: Optional[int] = 0) -> VrmlData_ErrorStatus: ...
    def WriteXYZ(self, theXYZ: gp_XYZ, isScale: bool, thePostfix: Optional[str] = nullptr) -> VrmlData_ErrorStatus: ...

class VrmlData_ShapeConvert:
    def __init__(self, theScene: VrmlData_Scene, theScale: Optional[float] = 1) -> None: ...
    def AddShape(self, theShape: TopoDS_Shape, theName: Optional[str] = nullptr) -> None: ...
...
class VrmlData_UnknownNode(VrmlData_Node):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, theScene: VrmlData_Scene, theName: Optional[str] = nullptr, theTitle: Optional[str] = nullptr) -> None: ...
...
class VrmlData_ImageTexture(VrmlData_Texture):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, theScene: VrmlData_Scene, theName: str, theURL: Optional[str] = nullptr, theRepS: Optional[bool] = false, theRepT: Optional[bool] = false) -> None: ...
    def Clone(self, theOther: VrmlData_Node) -> VrmlData_Node: ...
    def Read(self, theBuffer: VrmlData_InBuffer) -> VrmlData_ErrorStatus: ...
