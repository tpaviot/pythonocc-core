...
TDocStd_FormatVersion_LOWER: int
TDocStd_FormatVersion_UPPER: int
...
class TDocStd_Application(CDF_Application):
    ...
    @overload
    def Open(self, theIStream: str, theDoc: TDocStd_Document, theFilter: PCDM_ReaderFilter, theRange: Optional[Message_ProgressRange] = Message_ProgressRange()) -> PCDM_ReaderStatus: ...
    @overload
    def Open(self, theIStream: str, theDoc: TDocStd_Document, theRange: Optional[Message_ProgressRange] = Message_ProgressRange()) -> PCDM_ReaderStatus: ...
    ...
    @overload
    def SaveAs(self, theDoc: TDocStd_Document, theRange: Optional[Message_ProgressRange] = Message_ProgressRange()) -> Tuple[PCDM_StoreStatus, str]: ...
    @overload
    ...
    @overload
    def SaveAs(self, theDoc: TDocStd_Document, theStatusMessage: str, theRange: Optional[Message_ProgressRange] = Message_ProgressRange()) -> Tuple[PCDM_StoreStatus, str]: ...
...
class TDocStd_MultiTransactionManager(Standard_Transient):
    ...
    def GetAvailableRedos(self) -> Any: ...
    def GetAvailableUndos(self) -> Any: ...
    def GetUndoLimit(self) -> int: ...
    def HasOpenCommand(self) -> bool: ...
    def IsNestedTransactionMode(self) -> bool: ...
    def ModificationMode(self) -> bool: ...
