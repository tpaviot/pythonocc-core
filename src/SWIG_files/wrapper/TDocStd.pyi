...
class TDocStd_Document(CDM_Document):
    ...
    def GetModified(self) -> False: ...
    def GetName(self) -> str: ...
    def GetPath(self) -> str: ...
    def GetRedos(self) -> False: ...
    def GetSavedTime(self) -> int: ...
    def GetUndoLimit(self) -> int: ...
    def GetUndos(self) -> False: ...
...
class TDocStd_Modified(TDF_Attribute):
    ...
    @overload
    @staticmethod
    def Get(access: TDF_Label) -> False: ...
    @overload
    def Get(self) -> False: ...
    @staticmethod
...
class TDocStd_MultiTransactionManager(Standard_Transient):
    ...
    def Documents(self) -> False: ...
    def DumpTransaction(self) -> str: ...
    def GetAvailableRedos(self) -> False: ...
    def GetAvailableUndos(self) -> False: ...
    def GetUndoLimit(self) -> int: ...
    def HasOpenCommand(self) -> bool: ...
    def IsNestedTransactionMode(self) -> bool: ...
    def ModificationMode(self) -> bool: ...
