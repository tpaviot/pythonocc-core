...
class TopOpeBRepBuild_AreaBuilder:
    ...
    def ADD_LISTOFLoop_TO_LISTOFLoop(self, LOL1: Any, LOL2: Any, s: Optional[None] = None, s1: Optional[None] = None, s2: Optional[None] = None) -> None: ...
    def ADD_Loop_TO_LISTOFLoop(self, L: TopOpeBRepBuild_Loop, LOL: Any, s: Optional[None] = None) -> None: ...
    ...
    def REM_Loop_FROM_LISTOFLoop(self, ITLOL: Any, LOL: Any, s: Optional[None] = None) -> None: ...
...
class TopOpeBRepBuild_Builder:
    ...
    def ChangeMSplit(self, s: TopAbs_State) -> Any: ...
    ...
    def MSplit(self, s: TopAbs_State) -> Any: ...
...
class TopOpeBRepBuild_Tools:
    ...
    @staticmethod
    def FindState(aVertex: TopoDS_Shape, aState: TopAbs_State, aShapeEnum: TopAbs_ShapeEnum, aMapVertexEdges: TopTools_IndexedDataMapOfShapeListOfShape, aMapProcessedVertices: TopTools_MapOfShape, aMapVs: Any) -> None: ...
    @staticmethod
    def FindState1(anEdge: TopoDS_Shape, aState: TopAbs_State, aMapEdgesFaces: TopTools_IndexedDataMapOfShapeListOfShape, aMapProcessedVertices: TopTools_MapOfShape, aMapVs: Any) -> None: ...
    @staticmethod
    def FindState2(anEdge: TopoDS_Shape, aState: TopAbs_State, aMapEdgesFaces: TopTools_IndexedDataMapOfShapeListOfShape, aMapProcessedEdges: TopTools_MapOfShape, aMapVs: Any) -> None: ...
    @staticmethod
    def FindStateThroughVertex(aShape: TopoDS_Shape, aShapeClassifier: TopOpeBRepTool_ShapeClassifier, aMapOfShapeWithState: Any, anAvoidSubshMap: TopTools_MapOfShape) -> TopAbs_State: ...
    @staticmethod
    ...
    @staticmethod
    def PropagateState(aSplEdgesState: Any, anEdgesToRestMap: TopTools_IndexedMapOfShape, aShapeEnum1: TopAbs_ShapeEnum, aShapeEnum2: TopAbs_ShapeEnum, aShapeClassifier: TopOpeBRepTool_ShapeClassifier, aMapOfShapeWithState: Any, anUnkStateShapes: TopTools_MapOfShape) -> None: ...
    @staticmethod
    def PropagateStateForWires(aFacesToRestMap: TopTools_IndexedMapOfShape, aMapOfShapeWithState: Any) -> None: ...
    @staticmethod
    def SpreadStateToChild(aShape: TopoDS_Shape, aState: TopAbs_State, aMapOfShapeWithState: Any) -> None: ...
    @staticmethod
...
class TopOpeBRepBuild_Tools2d:
    @staticmethod
    def DumpMapOfShapeVertexInfo(aMap: Any) -> None: ...
    @staticmethod
    def MakeMapOfShapeVertexInfo(aWire: TopoDS_Wire, aMap: Any) -> None: ...
    @staticmethod
...
class TopOpeBRepBuild_PaveSet(TopOpeBRepBuild_LoopSet):
    ...
    @staticmethod
    def SortPave(Lin: Any, Lout: Any) -> None: ...
