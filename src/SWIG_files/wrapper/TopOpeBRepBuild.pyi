...
TopOpeBRepBuild_IndexedDataMapOfShapeVertexInfo = NewType(
    "TopOpeBRepBuild_IndexedDataMapOfShapeVertexInfo", Any
)
...
TopOpeBRepBuild_PWireEdgeSet = NewType(
    "TopOpeBRepBuild_PWireEdgeSet", TopOpeBRepBuild_WireEdgeSet
)

class TopOpeBRepBuild_ListOfListOfLoop:
    def Append(
        self, theItem: TopOpeBRepBuild_ListOfLoop
    ) -> TopOpeBRepBuild_ListOfLoop: ...
    def Assign(
        self, theItem: TopOpeBRepBuild_ListOfListOfLoop
    ...
    def __iter__(self) -> TopOpeBRepBuild_ListOfLoop: ...
...
class TopOpeBRepBuild_ListOfPave:
    def Append(self, theItem: False) -> False: ...
    def Assign(
        self, theItem: TopOpeBRepBuild_ListOfPave
...
class TopOpeBRepBuild_ListOfShapeListOfShape:
    def Append(
        self, theItem: TopOpeBRepBuild_ShapeListOfShape
    ) -> TopOpeBRepBuild_ShapeListOfShape: ...
    def Assign(
        self, theItem: TopOpeBRepBuild_ListOfShapeListOfShape
    ...
    def __init__(self) -> None: ...
    def __len__(self) -> int: ...
    def __iter__(self) -> TopOpeBRepBuild_ShapeListOfShape: ...
...
class TopOpeBRepBuild_Builder:
    ...
    def AddONPatchesSFS(
        self, G: TopOpeBRepBuild_GTopo, SFS: TopOpeBRepBuild_ShellFaceSet
    ) -> None: ...
    ...
    def ChangeSplit(
        self, S: TopoDS_Shape, TB: TopAbs_State
    ...
    def FindSameDomainSameOrientation(
        self, LSO: TopTools_ListOfShape, LDO: TopTools_ListOfShape
    ) -> None: ...
    def FindSameRank(
        self, L1: TopTools_ListOfShape, R: int, L2: TopTools_ListOfShape
    ) -> None: ...
    ...
    @staticmethod
    def GCopyList(
        Lin: TopTools_ListOfShape, i1: int, i2: int, Lou: TopTools_ListOfShape
    ) -> None: ...
    @overload
    @staticmethod
    ...
    def GFillPointTopologyPVS(
        self, E: TopoDS_Shape, G: TopOpeBRepBuild_GTopo, PVS: TopOpeBRepBuild_PaveSet
    ) -> None: ...
    @overload
    def GFillPointTopologyPVS(
        self,
    ...
    @overload
    def GFindSamDomSODO(
        self, S: TopoDS_Shape, LSO: TopTools_ListOfShape, LDO: TopTools_ListOfShape
    ) -> None: ...
    @overload
    def GFindSamDomSODO(
        self, LSO: TopTools_ListOfShape, LDO: TopTools_ListOfShape
    ...
    def GKeepShape(
        self, S: TopoDS_Shape, Lref: TopTools_ListOfShape, T: TopAbs_State
    ) -> bool: ...
    def GKeepShape1(
        self, S: TopoDS_Shape, Lref: TopTools_ListOfShape, T: TopAbs_State
    ) -> Tuple[bool, TopAbs_State]: ...
    def GKeepShapes(
        self,
        S: TopoDS_Shape,
    ...
    def GPVSMakeEdges(
        self, EF: TopoDS_Shape, PVS: TopOpeBRepBuild_PaveSet, LOE: TopTools_ListOfShape
    ) -> None: ...
    ...
    def GSplitEdge(
        self, E: TopoDS_Shape, G: TopOpeBRepBuild_GTopo, LSclass: TopTools_ListOfShape
    ) -> None: ...
    def GSplitEdgeWES(
        self,
        E: TopoDS_Shape,
    ...
    def GSplitFace(
        self, F: TopoDS_Shape, G: TopOpeBRepBuild_GTopo, LSclass: TopTools_ListOfShape
    ) -> None: ...
    def GSplitFaceSFS(
        self,
        F1: TopoDS_Shape,
    ...
    def GdumpEDGVER(
        self, E: TopoDS_Shape, V: TopoDS_Shape, str: Optional[None] = None
    ) -> None: ...
    ...
    def GdumpSAMDOM(
        self, L: TopTools_ListOfShape, str: Optional[None] = None
    ) -> None: ...
    ...
    @overload
    def GdumpSHASTA(
        self, iS: int, T: TopAbs_State, a: Optional[str] = "", b: Optional[str] = ""
    ) -> None: ...
    @overload
    def GdumpSHASTA(
        self,
    ...
    @overload
    def KPclasSS(
        self, S1: TopoDS_Shape, exceptLS1: TopTools_ListOfShape, S2: TopoDS_Shape
    ) -> TopAbs_State: ...
    @overload
    def KPclasSS(
        self, S1: TopoDS_Shape, exceptS1: TopoDS_Shape, S2: TopoDS_Shape
    ) -> TopAbs_State: ...
    @overload
    ...
    def KPclassFF(
        self, F1: TopoDS_Shape, F2: TopoDS_Shape
    ) -> Tuple[TopAbs_State, TopAbs_State]: ...
    def KPisdisj(self) -> int: ...
    def KPisdisjanalyse(
        self, ST1: TopAbs_State, ST2: TopAbs_State
    ) -> Tuple[int, int, int]: ...
    ...
    def KPiskoleFF(
        self, F1: TopoDS_Shape, F2: TopoDS_Shape
    ) -> Tuple[bool, TopAbs_State, TopAbs_State]: ...
    def KPiskoleanalyse(
        self, FT1: TopAbs_State, FT2: TopAbs_State, ST1: TopAbs_State, ST2: TopAbs_State
    ) -> Tuple[int, int, int]: ...
    def KPiskolesh(
        self, S: TopoDS_Shape, LS: TopTools_ListOfShape, LF: TopTools_ListOfShape
    ) -> bool: ...
    def KPiskoletge(self) -> int: ...
    def KPiskoletgeanalyse(
        self, Conf: TopOpeBRepDS_Config, ST1: TopAbs_State, ST2: TopAbs_State
    ) -> int: ...
    def KPiskoletgesh(
        self, S: TopoDS_Shape, LS: TopTools_ListOfShape, LF: TopTools_ListOfShape
    ) -> bool: ...
    ...
    @overload
    def KPlhg(
        self, S: TopoDS_Shape, T: TopAbs_ShapeEnum, L: TopTools_ListOfShape
    ) -> int: ...
    @overload
    ...
    def KeepShape(
        self, S: TopoDS_Shape, LS: TopTools_ListOfShape, T: TopAbs_State
    ) -> bool: ...
    def MSplit(
        self, s: TopAbs_State
    ) -> TopOpeBRepDS_DataMapOfShapeListOfShapeOn1State: ...
    def MakeEdges(
        self, E: TopoDS_Shape, B: TopOpeBRepBuild_EdgeBuilder, L: TopTools_ListOfShape
    ) -> None: ...
    def MakeFaces(
        self, F: TopoDS_Shape, B: TopOpeBRepBuild_FaceBuilder, L: TopTools_ListOfShape
    ) -> None: ...
    def MakeShells(
        self, B: TopOpeBRepBuild_SolidBuilder, L: TopTools_ListOfShape
    ) -> None: ...
    def MakeSolids(
        self, B: TopOpeBRepBuild_SolidBuilder, L: TopTools_ListOfShape
    ) -> None: ...
    ...
    def MergeEdges(
        ...
        onB: Optional[bool] = False,
        onAB: Optional[bool] = False,
    ) -> None: ...
    def MergeFaces(
        self,
    ...
    def MergeShapes(
        self, S1: TopoDS_Shape, TB1: TopAbs_State, S2: TopoDS_Shape, TB2: TopAbs_State
    ) -> None: ...
    ...
    @overload
    def Perform(
        self, HDS: TopOpeBRepDS_HDataStructure, S1: TopoDS_Shape, S2: TopoDS_Shape
    ) -> None: ...
    @staticmethod
    ...
    def RegularizeFace(
        self, FF: TopoDS_Shape, newFace: TopoDS_Shape, LOF: TopTools_ListOfShape
    ) -> None: ...
    def RegularizeFaces(
        self,
        FF: TopoDS_Shape,
    ...
    def RegularizeSolid(
        self, SS: TopoDS_Shape, newSolid: TopoDS_Shape, LOS: TopTools_ListOfShape
    ) -> None: ...
    ...
    def ShapePosition(
        self, S: TopoDS_Shape, LS: TopTools_ListOfShape
    ) -> TopAbs_State: ...
...
class TopOpeBRepBuild_BuilderON:
    ...
    def GFillONParts2dWES2(
        self, I: TopOpeBRepDS_Interference, EspON: TopoDS_Shape
    ) -> None: ...
...
class TopOpeBRepBuild_CorrectFace2d:
    ...
    def SetMapOfTrans2dInfo(
        self, aMap: TopTools_IndexedDataMapOfShapeShape
    ) -> None: ...
...
class TopOpeBRepBuild_FaceBuilder:
    ...
    def InitFaceBuilder(
        self, ES: TopOpeBRepBuild_WireEdgeSet, F: TopoDS_Shape, ForceClass: bool
    ) -> None: ...
...
class TopOpeBRepBuild_FuseFace:
    ...
    @overload
    def __init__(
        self, LIF: TopTools_ListOfShape, LRF: TopTools_ListOfShape, CXM: int
    ) -> None: ...
...
class TopOpeBRepBuild_GTool:
    ...
    @staticmethod
    def GComDiff(
        s1: TopAbs_ShapeEnum, s2: TopAbs_ShapeEnum
...
class TopOpeBRepBuild_GTopo:
    ...
    def ChangeConfig(
        self, C1: TopOpeBRepDS_Config, C2: TopOpeBRepDS_Config
    ) -> None: ...
...
class TopOpeBRepBuild_HBuilder(Standard_Transient):
    ...
    def EdgeCurveAncestors(
        self, E: TopoDS_Shape, F1: TopoDS_Shape, F2: TopoDS_Shape
    ) -> Tuple[bool, int]: ...
    ...
    def Merged(
        self, S: TopoDS_Shape, ToBuild: TopAbs_State
    ) -> TopTools_ListOfShape: ...
...
class TopOpeBRepBuild_LoopClassifier:
    def Compare(
        self, L1: TopOpeBRepBuild_Loop, L2: TopOpeBRepBuild_Loop
    ) -> TopAbs_State: ...
...
class TopOpeBRepBuild_ShapeSet:
    def __init__(
        self, SubShapeType: TopAbs_ShapeEnum, checkshape: Optional[bool] = True
    ) -> None: ...
    ...
    @overload
    def CheckShape(
        self, S: TopoDS_Shape, checkgeom: Optional[bool] = False
    ) -> bool: ...
    @overload
    ...
    def MakeNeighboursList(
        self, E: TopoDS_Shape, V: TopoDS_Shape
    ) -> TopTools_ListOfShape: ...
    ...
    @overload
    def SName(
        self, S: TopoDS_Shape, sb: Optional[str] = "", sa: Optional[str] = ""
    ) -> str: ...
    @overload
    def SName(
        self, S: TopTools_ListOfShape, sb: Optional[str] = "", sa: Optional[str] = ""
    ) -> str: ...
    @overload
    def SNameori(
        self, S: TopoDS_Shape, sb: Optional[str] = "", sa: Optional[str] = ""
...
class TopOpeBRepBuild_SolidBuilder:
    ...
    @overload
    def __init__(
        self, FS: TopOpeBRepBuild_ShellFaceSet, ForceClass: Optional[bool] = False
    ) -> None: ...
    def Face(self) -> TopoDS_Shape: ...
    def InitFace(self) -> int: ...
    ...
    def InitSolidBuilder(
        self, FS: TopOpeBRepBuild_ShellFaceSet, ForceClass: bool
    ) -> None: ...
...
class TopOpeBRepBuild_Tools:
    ...
    def CorrectCurveOnSurface(
        aS: TopoDS_Shape, aTolMax: Optional[float] = 0.0001
    ) -> None: ...
    @staticmethod
    def CorrectFace2d(
    ...
    @staticmethod
    def GetNormalInNearestPoint(
        aFace: TopoDS_Face, anEdge: TopoDS_Edge, aNormal: gp_Vec
    ) -> None: ...
    @staticmethod
    def GetNormalToFaceOnEdge(
        aFObj: TopoDS_Face, anEdgeObj: TopoDS_Edge, aDirNormal: gp_Vec
    ) -> None: ...
    @staticmethod
    def GetTangentToEdge(anEdgeObj: TopoDS_Edge, aTangent: gp_Vec) -> bool: ...
    @staticmethod
    def GetTangentToEdgeEdge(
        aFObj: TopoDS_Face,
    ...
    @staticmethod
    def PropagateStateForWires(
        aFacesToRestMap: TopTools_IndexedMapOfShape,
        aMapOfShapeWithState: TopOpeBRepDS_IndexedDataMapOfShapeWithState,
    ) -> None: ...
    @staticmethod
    def SpreadStateToChild(
        aShape: TopoDS_Shape,
        aState: TopAbs_State,
        aMapOfShapeWithState: TopOpeBRepDS_IndexedDataMapOfShapeWithState,
    ) -> None: ...
    @staticmethod
    def UpdateEdgeOnFace(
        aEdgeToUpdate: TopoDS_Edge, OldFace: TopoDS_Face, NewFace: TopoDS_Face
    ) -> None: ...
    @staticmethod
    def UpdateEdgeOnPeriodicalFace(
        aEdgeToUpdate: TopoDS_Edge, OldFace: TopoDS_Face, NewFace: TopoDS_Face
    ) -> None: ...
    @staticmethod
    def UpdatePCurves(
        aWire: TopoDS_Wire, fromFace: TopoDS_Face, toFace: TopoDS_Face
    ) -> None: ...

class TopOpeBRepBuild_Tools2d:
    @staticmethod
    def DumpMapOfShapeVertexInfo(
        aMap: TopOpeBRepBuild_IndexedDataMapOfShapeVertexInfo,
    ) -> None: ...
    @staticmethod
    def MakeMapOfShapeVertexInfo(
        aWire: TopoDS_Wire, aMap: TopOpeBRepBuild_IndexedDataMapOfShapeVertexInfo
    ) -> None: ...
    @staticmethod
...
class TopOpeBRepBuild_CompositeClassifier(TopOpeBRepBuild_LoopClassifier):
    ...
    def CompareElementToShape(
        self, E: TopoDS_Shape, B: TopoDS_Shape
    ) -> TopAbs_State: ...
...
class TopOpeBRepBuild_PaveClassifier(TopOpeBRepBuild_LoopClassifier):
    ...
    @staticmethod
    def AdjustCase(
        p1: float, o: TopAbs_Orientation, first: float, period: float, tol: float
    ) -> Tuple[float, int]: ...
...
class TopOpeBRepBuild_PaveSet(TopOpeBRepBuild_LoopSet):
    ...
    @staticmethod
    def SortPave(
        Lin: TopOpeBRepBuild_ListOfPave, Lout: TopOpeBRepBuild_ListOfPave
    ) -> None: ...
...
class TopOpeBRepBuild_ShellFaceClassifier(TopOpeBRepBuild_CompositeClassifier):
    ...
    def CompareElementToShape(
        self, F: TopoDS_Shape, S: TopoDS_Shape
    ) -> TopAbs_State: ...
    def CompareShapes(self, B1: TopoDS_Shape, B2: TopoDS_Shape) -> TopAbs_State: ...
