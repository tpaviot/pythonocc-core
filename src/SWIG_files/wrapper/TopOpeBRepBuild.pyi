...
class TopOpeBRepBuild_Builder:
    ...
    def ChangeMSplit(self, s: TopAbs_State) -> False: ...
    def ChangeSplit(self, S: TopoDS_Shape, TB: TopAbs_State) -> False: ...
    ...
    def GdumpEDG(self, S: TopoDS_Shape, str: Optional[None] = nullptr) -> None: ...
    def GdumpEDGVER(self, E: TopoDS_Shape, V: TopoDS_Shape, str: Optional[None] = nullptr) -> None: ...
    ...
    def GdumpSHA(self, S: TopoDS_Shape, str: Optional[None] = nullptr) -> None: ...
    def GdumpSHAORI(self, S: TopoDS_Shape, str: Optional[None] = nullptr) -> None: ...
    def GdumpSHAORIGEO(self, S: TopoDS_Shape, str: Optional[None] = nullptr) -> None: ...
    ...
    def MSplit(self, s: TopAbs_State) -> False: ...
    ...
    def Merged(self, S: TopoDS_Shape, TB: TopAbs_State) -> False: ...
    def NewEdges(self, I: int) -> False: ...
    def NewFaces(self, I: int) -> False: ...
    ...
    def Splits(self, S: TopoDS_Shape, TB: TopAbs_State) -> False: ...
    @staticmethod
...
class TopOpeBRepBuild_CorrectFace2d:
    ...
    def MapOfTrans2dInfo(self) -> False: ...
...
class TopOpeBRepBuild_FuseFace:
    ...
    def LExternEdge(self) -> False: ...
    def LExternVertex(self) -> False: ...
    def LFuseFace(self) -> False: ...
    def LInternEdge(self) -> False: ...
    def LInternVertex(self) -> False: ...
    def LModifEdge(self) -> False: ...
    def LModifVertex(self) -> False: ...
...
class TopOpeBRepBuild_GTopo:
    ...
    def Dump(self, s: Optional[None] = nullptr) -> str: ...
    @staticmethod
...
class TopOpeBRepBuild_HBuilder(Standard_Transient):
    ...
    def ChangeNewEdges(self, I: int) -> False: ...
    def Clear(self) -> None: ...
    ...
    def GetDSFaceFromDSEdge(self, indexEdg: int, rank: int) -> False: ...
    ...
    def MergeSolid(self, S: TopoDS_Shape, TB: TopAbs_State) -> None: ...
    def MergeSolids(self, S1: TopoDS_Shape, TB1: TopAbs_State, S2: TopoDS_Shape, TB2: TopAbs_State) -> None: ...
    def Merged(self, S: TopoDS_Shape, ToBuild: TopAbs_State) -> False: ...
    ...
    def Perform(self, HDS: TopOpeBRepDS_HDataStructure, S1: TopoDS_Shape, S2: TopoDS_Shape) -> None: ...
    def Section(self) -> False: ...
    def Splits(self, S: TopoDS_Shape, ToBuild: TopAbs_State) -> False: ...
...
class TopOpeBRepBuild_LoopSet:
    def __init__(self) -> None: ...
    def ChangeListOfLoop(self) -> False: ...
...
class TopOpeBRepBuild_ShapeSet:
    ...
    def ChangeStartShapes(self) -> False: ...
    @overload
    ...
    def MakeNeighboursList(self, E: TopoDS_Shape, V: TopoDS_Shape) -> False: ...
...
class TopOpeBRepBuild_VertexInfo:
    ...
    def ChangeEdgesOut(self) -> False: ...
    def CurrentOut(self) -> TopoDS_Edge: ...
    def Dump(self) -> None: ...
    def EdgesIn(self) -> False: ...
    def EdgesOut(self) -> False: ...
    def FoundOut(self) -> int: ...
    def ListPassed(self) -> False: ...
...
class TopOpeBRepBuild_ShellFaceSet(TopOpeBRepBuild_ShapeSet):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, S: TopoDS_Shape, Addr: Optional[None] = nullptr) -> None: ...
    def AddElement(self, S: TopoDS_Shape) -> None: ...
    def AddShape(self, S: TopoDS_Shape) -> None: ...
    def AddStartElement(self, S: TopoDS_Shape) -> None: ...
    def DumpSS(self) -> None: ...
...
class TopOpeBRepBuild_WireEdgeSet(TopOpeBRepBuild_ShapeSet):
    def __init__(self, F: TopoDS_Shape, Addr: Optional[None] = nullptr) -> None: ...
    def AddElement(self, S: TopoDS_Shape) -> None: ...
    def AddShape(self, S: TopoDS_Shape) -> None: ...
    def AddStartElement(self, S: TopoDS_Shape) -> None: ...
    def DumpSS(self) -> None: ...
