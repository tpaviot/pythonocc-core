...
class TopOpeBRepBuild_ListOfListOfLoop:
    ...
    def Assign(self, theItem: TopOpeBRepBuild_ListOfListOfLoop) -> TopOpeBRepBuild_ListOfListOfLoop: ...
    def Clear(self) -> None: ...
...
class TopOpeBRepBuild_ListOfLoop:
    ...
    def Assign(self, theItem: TopOpeBRepBuild_ListOfLoop) -> TopOpeBRepBuild_ListOfLoop: ...
    def Clear(self) -> None: ...
...
class TopOpeBRepBuild_ListOfPave:
    def Append(self, theItem: False) -> False: ...
    def Assign(self, theItem: TopOpeBRepBuild_ListOfPave) -> TopOpeBRepBuild_ListOfPave: ...
    def Clear(self) -> None: ...
    def First(self) -> False: ...
    def Last(self) -> False: ...
    def Prepend(self, theItem: False) -> False: ...
...
class TopOpeBRepBuild_ListOfShapeListOfShape:
    ...
    def Assign(self, theItem: TopOpeBRepBuild_ListOfShapeListOfShape) -> TopOpeBRepBuild_ListOfShapeListOfShape: ...
    def Clear(self) -> None: ...
