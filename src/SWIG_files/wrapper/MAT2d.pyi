...
class MAT2d_Circuit(Standard_Transient):
    ...
    def Perform(self, aFigure: Any, IsClosed: TColStd_SequenceOfBoolean, IndRefLine: int, Trigo: bool) -> None: ...
