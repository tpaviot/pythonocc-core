...
class MAT2d_SequenceOfSequenceOfCurve:
    def Assign(self, theItem: TColGeom2d_SequenceOfCurve) -> TColGeom2d_SequenceOfCurve: ...
    def Clear(self) -> None: ...
...
class MAT2d_SequenceOfSequenceOfGeometry:
    def Assign(self, theItem: TColGeom2d_SequenceOfGeometry) -> TColGeom2d_SequenceOfGeometry: ...
    def Clear(self) -> None: ...
