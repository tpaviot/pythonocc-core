...
class MAT2d_SequenceOfSequenceOfCurve:
    def Assign(
        self, theItem: TColGeom2d_SequenceOfCurve
...
class MAT2d_SequenceOfSequenceOfGeometry:
    def Assign(
        self, theItem: TColGeom2d_SequenceOfGeometry
    ...
    def Reverse(self) -> None: ...
    def SetValue(
        self, theIndex: int, theValue: TColGeom2d_SequenceOfGeometry
    ) -> None: ...
    def Size(self) -> int: ...
    def UpdateUpperBound(self, int) -> None: ...
    def UpdateLowerBound(self, int) -> None: ...
...
class MAT2d_Circuit(Standard_Transient):
    def __init__(
        self,
        aJoinType: Optional[GeomAbs_JoinType] = GeomAbs_Arc,
...
class MAT2d_MiniPath:
    ...
    def Perform(
        self, Figure: MAT2d_SequenceOfSequenceOfGeometry, IndStart: int, Sense: bool
    ) -> None: ...
...
class MAT2d_Tool2d:
    ...
    def Distance(
        self, abisector: MAT_Bisector, param1: float, param2: float
    ) -> float: ...
    ...
    def IntersectBisector(
        self, bisectorone: MAT_Bisector, bisectortwo: MAT_Bisector
    ) -> Tuple[float, int]: ...
    def NumberOfItems(self) -> int: ...
