...
class GeomInt_IntSS:
	...
	@overload
	def Perform(self, HS1: GeomAdaptor_HSurface, HS2: GeomAdaptor_HSurface, Tol: float, Approx: Optional[bool] = True, ApproxS1: Optional[bool] = False, ApproxS2: Optional[bool] = False) -> None: ...
	@overload
	...
	@overload
	def Perform(self, HS1: GeomAdaptor_HSurface, HS2: GeomAdaptor_HSurface, Tol: float, U1: float, V1: float, U2: float, V2: float, Approx: Optional[bool] = True, ApproxS1: Optional[bool] = False, ApproxS2: Optional[bool] = False) -> None: ...
	...
	@staticmethod
	def TreatRLine(theRL: IntPatch_RLine, theHS1: GeomAdaptor_HSurface, theHS2: GeomAdaptor_HSurface, theC3d: Geom_Curve, theC2d1: Geom2d_Curve, theC2d2: Geom2d_Curve) -> float: ...
	@staticmethod
...
class GeomInt_LineTool:
	@staticmethod
	def DecompositionOfWLine(theWLine: IntPatch_WLine, theSurface1: GeomAdaptor_HSurface, theSurface2: GeomAdaptor_HSurface, aTolSum: float, theLConstructor: GeomInt_LineConstructor, theNewLines: IntPatch_SequenceOfLine) -> bool: ...
	@staticmethod
