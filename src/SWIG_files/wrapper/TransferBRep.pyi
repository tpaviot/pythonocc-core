...
TransferBRep_HSequenceOfTransferResultInfo = NewType("TransferBRep_HSequenceOfTransferResultInfo", Any)
...
class transferbrep:
    ...
    @staticmethod
    def Checked(chl: Interface_CheckIterator, alsoshapes: Optional[bool] = false) -> False: ...
    @staticmethod
    def CheckedShapes(chl: Interface_CheckIterator) -> False: ...
    @staticmethod
    ...
    @overload
    @staticmethod
    def Shapes(TP: Transfer_TransientProcess, rootsonly: Optional[bool] = true) -> False: ...
    @staticmethod
...
class TransferBRep_TransferResultInfo(Standard_Transient):
    def __init__(self) -> None: ...
    def Clear(self) -> None: ...
    def NoResult(self) -> False: ...
    def NoResultFail(self) -> False: ...
    def NoResultWarning(self) -> False: ...
    def NoResultWarningFail(self) -> False: ...
    def Result(self) -> False: ...
    def ResultFail(self) -> False: ...
    def ResultWarning(self) -> False: ...
    def ResultWarningFail(self) -> False: ...
