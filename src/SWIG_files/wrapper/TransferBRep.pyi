...
class transferbrep:
    @staticmethod
    def CheckObject(
        chl: Interface_CheckIterator, obj: Standard_Transient
    ) -> Interface_CheckIterator: ...
    @staticmethod
    def Checked(
        chl: Interface_CheckIterator, alsoshapes: Optional[bool] = False
    ...
    @staticmethod
    def ResultFromShape(
        FP: Transfer_FinderProcess, shape: TopoDS_Shape
    ) -> Transfer_Binder: ...
    @staticmethod
    def SetShapeResult(
        TP: Transfer_TransientProcess, ent: Standard_Transient, result: TopoDS_Shape
    ) -> None: ...
    @staticmethod
    def SetTransientFromShape(
        FP: Transfer_FinderProcess, shape: TopoDS_Shape, result: Standard_Transient
    ) -> None: ...
    @staticmethod
    def ShapeMapper(
        FP: Transfer_FinderProcess, shape: TopoDS_Shape
    ...
    @staticmethod
    def ShapeResult(
        TP: Transfer_TransientProcess, ent: Standard_Transient
    ) -> TopoDS_Shape: ...
    @staticmethod
    def ShapeState(
        FP: Transfer_FinderProcess, shape: TopoDS_Shape
    ...
    @staticmethod
    def Shapes(
        TP: Transfer_TransientProcess, rootsonly: Optional[bool] = True
    ) -> TopTools_HSequenceOfShape: ...
    @overload
    @staticmethod
    def Shapes(
        TP: Transfer_TransientProcess, list: TColStd_HSequenceOfTransient
    ) -> TopTools_HSequenceOfShape: ...
    @overload
    @staticmethod
    def TransferResultInfo(
...
class TransferBRep_HSequenceOfTransferResultInfo(
    TransferBRep_SequenceOfTransferResultInfo, Standard_Transient
):
    @overload
    def __init__(self) -> None: ...
    @overload
    ...
    def Append(
        self, theSequence: TransferBRep_SequenceOfTransferResultInfo
    ) -> None: ...
