...
class transferbrep:
    ...
    @overload
    @staticmethod
    def TransferResultInfo(TP: Transfer_TransientProcess, EntityTypes: TColStd_HSequenceOfTransient, InfoSeq: Any) -> None: ...
    @overload
    @staticmethod
    def TransferResultInfo(FP: Transfer_FinderProcess, ShapeTypes: TColStd_HSequenceOfInteger, InfoSeq: Any) -> None: ...
    @staticmethod
...
class TransferBRep_TransferResultInfo(Standard_Transient):
    def __init__(self) -> None: ...
    def Clear(self) -> None: ...
    def NoResult(self) -> Any: ...
    def NoResultFail(self) -> Any: ...
    def NoResultWarning(self) -> Any: ...
    def NoResultWarningFail(self) -> Any: ...
    def Result(self) -> Any: ...
    def ResultFail(self) -> Any: ...
    def ResultWarning(self) -> Any: ...
    def ResultWarningFail(self) -> Any: ...
