...
Storage_HArrayOfCallBack = NewType("Storage_HArrayOfCallBack", Any)
# the following typedef cannot be wrapped as is
Storage_HArrayOfSchema = NewType("Storage_HArrayOfSchema", Any)
# the following typedef cannot be wrapped as is
Storage_HPArray = NewType("Storage_HPArray", Any)
# the following typedef cannot be wrapped as is
Storage_HSeqOfRoot = NewType("Storage_HSeqOfRoot", Any)
# the following typedef cannot be wrapped as is
