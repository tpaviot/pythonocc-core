...
class AIS_GraphicTool:
    ...
    @staticmethod
    def GetLineWidth(aDrawer: Prs3d_Drawer, TheTypeOfAttributes: AIS_TypeOfAttribute) -> False: ...
    @staticmethod
...
class AIS_InteractiveContext(Standard_Transient):
    ...
    def Disconnect(self, theAssembly: AIS_InteractiveObject, theObjToDisconnect: Optional[AIS_InteractiveObject] = nullptr) -> None: ...
    @overload
    ...
    def Width(self, aniobj: AIS_InteractiveObject) -> False: ...
...
class AIS_ViewController(Aspect_WindowInputListener):
    ...
    def ChangeMouseGestureMap(self) -> int: ...
    def ChangeMouseSelectionSchemes(self) -> int: ...
    ...
    def MouseGestureMap(self) -> int: ...
    def MouseSelectionSchemes(self) -> int: ...
...
class AIS_ColorScale(AIS_InteractiveObject):
    ...
    @staticmethod
    def MakeUniformColors(theNbColors: int, theLightness: float, theHueFrom: float, theHueTo: float) -> False: ...
    ...
    @staticmethod
    def hueToValidRange(theHue: float) -> False: ...
...
class AIS_PointCloud(AIS_InteractiveObject):
    ...
    @overload
    def SetPoints(self, theCoords: TColgp_HArray1OfPnt, theColors: Optional[Quantity_HArray1OfColor] = nullptr, theNormals: Optional[TColgp_HArray1OfDir] = nullptr) -> None: ...
    def UnsetColor(self) -> None: ...
