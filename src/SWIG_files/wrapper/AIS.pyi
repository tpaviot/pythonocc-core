...
AIS_DisplayStatus = PrsMgr_DisplayStatus
...
AIS_NavigationMode_LOWER: int
AIS_NavigationMode_UPPER: int
...
AIS_RotationMode_LOWER: int
AIS_RotationMode_UPPER: int
...
class AIS_ColoredDrawer(Prs3d_Drawer):
    ...
    def SetOwnColor(self, arg0: Quantity_Color) -> None: ...
...
class AIS_InteractiveContext(Standard_Transient):
    ...
    @overload
    def DisplayedObjects(self, aListOfIO: Any) -> None: ...
    @overload
    def DisplayedObjects(self, theWhichKind: AIS_KindOfInteractive, theWhichSignature: int, theListOfIO: Any) -> None: ...
    ...
    @overload
    def ErasedObjects(self, theListOfIO: Any) -> None: ...
    @overload
    def ErasedObjects(self, theWhichKind: AIS_KindOfInteractive, theWhichSignature: int, theListOfIO: Any) -> None: ...
    ...
    @overload
    def Load(self, theObj: AIS_InteractiveObject, theSelectionMode: int, arg2: bool) -> None: ...
    ...
    @overload
    def ObjectsByDisplayStatus(self, theStatus: PrsMgr_DisplayStatus, theListOfIO: Any) -> None: ...
    @overload
    def ObjectsByDisplayStatus(self, WhichKind: AIS_KindOfInteractive, WhichSignature: int, theStatus: PrsMgr_DisplayStatus, theListOfIO: Any) -> None: ...
    def ObjectsForView(self, theListOfIO: Any, theView: V3d_View, theIsVisibleInView: bool, theStatus: Optional[PrsMgr_DisplayStatus] = PrsMgr_DisplayStatus_None) -> None: ...
    def ObjectsInside(self, aListOfIO: Any, WhichKind: Optional[AIS_KindOfInteractive] = AIS_KindOfInteractive_None, WhichSignature: Optional[int] = -1) -> None: ...
    ...
    @overload
    def Select(self, theOwners: Any, theSelScheme: AIS_SelectionScheme) -> AIS_StatusOfPick: ...
    @overload
    ...
    def SelectPoint(self, thePnt: Any, theView: V3d_View, theSelScheme: Optional[AIS_SelectionScheme] = AIS_SelectionScheme_Replace) -> AIS_StatusOfPick: ...
    ...
    def SelectRectangle(self, thePntMin: Any, thePntMax: Any, theView: V3d_View, theSelScheme: Optional[AIS_SelectionScheme] = AIS_SelectionScheme_Replace) -> AIS_StatusOfPick: ...
...
class AIS_InteractiveObject(SelectMgr_SelectableObject):
    ...
    def ProcessDragging(self, theCtx: AIS_InteractiveContext, theView: V3d_View, theOwner: SelectMgr_EntityOwner, theDragFrom: Any, theDragTo: Any, theAction: AIS_DragAction) -> bool: ...
...
class AIS_LightSourceOwner(SelectMgr_EntityOwner):
    ...
    def HandleMouseClick(self, thePoint: Any, theButton: Aspect_VKeyMouse, theModifiers: Aspect_VKeyFlags, theIsDoubleClick: bool) -> bool: ...
...
class AIS_Selection(Standard_Transient):
    ...
    def SelectOwners(self, thePickedOwners: Any, theSelScheme: AIS_SelectionScheme, theToAllowSelOverlap: bool, theFilter: SelectMgr_Filter) -> None: ...
...
class AIS_ViewController(Aspect_WindowInputListener):
    ...
    def ChangeMouseGestureMap(self) -> Any: ...
    def ChangeMouseSelectionSchemes(self) -> Any: ...
    ...
    def MouseGestureMap(self) -> Any: ...
    def MouseSelectionSchemes(self) -> Any: ...
    ...
    def PickPoint(self, thePnt: gp_Pnt, theCtx: AIS_InteractiveContext, theView: V3d_View, theCursor: Any, theToStickToPickRay: bool) -> bool: ...
    def PreviousMoveTo(self) -> Any: ...
    ...
    @overload
    def SelectInViewer(self, thePnt: Any, theScheme: Optional[AIS_SelectionScheme] = AIS_SelectionScheme_Replace) -> None: ...
    @overload
    def SelectInViewer(self, thePnts: Any, theScheme: Optional[AIS_SelectionScheme] = AIS_SelectionScheme_Replace) -> None: ...
    ...
    def UpdateMouseClick(self, thePoint: Any, theButton: Aspect_VKeyMouse, theModifiers: Aspect_VKeyFlags, theIsDoubleClick: bool) -> bool: ...
    ...
    def UpdatePolySelection(self, thePnt: Any, theToAppend: bool) -> None: ...
    def UpdateRubberBand(self, thePntFrom: Any, thePntTo: Any) -> None: ...
...
class AIS_ColorScale(AIS_InteractiveObject):
    ...
    def ComputeSelection(self, arg0: SelectMgr_Selection, arg1: int) -> None: ...
    @overload
    @staticmethod
    def FindColor(theValue: float, theMin: float, theMax: float, theColorsCount: int, theColorHlsMin: Any, theColorHlsMax: Any, theColor: Quantity_Color) -> bool: ...
    @overload
    @staticmethod
    ...
    @overload
    def GetColors(self, theColors: Any) -> None: ...
    @overload
    ...
    @staticmethod
    def MakeUniformColors(theNbColors: int, theLightness: float, theHueFrom: float, theHueTo: float) -> Any: ...
    ...
    def SetColors(self, theSeq: Any) -> None: ...
...
class AIS_Line(AIS_InteractiveObject):
    ...
    def SetWidth(self, aValue: float) -> None: ...
    def Signature(self) -> int: ...
    def StartPoint(self) -> Geom_Point: ...
    def Type(self) -> AIS_KindOfInteractive: ...
    def UnsetColor(self) -> None: ...
    def UnsetWidth(self) -> None: ...
...
class AIS_Manipulator(AIS_InteractiveObject):
    ...
    @overload
    def Attach(self, theObject: AIS_InteractiveObject, theOptions: Optional[Any] = OptionsForAttach()) -> None: ...
    @overload
    def Attach(self, theObject: Any, theOptions: Optional[Any] = OptionsForAttach()) -> None: ...
    ...
    def HilightSelected(self, thePM: PrsMgr_PresentationManager, theSeq: Any) -> None: ...
    ...
    def SetSkinMode(self, theSkinMode: Any) -> None: ...
...
class AIS_MediaPlayer(AIS_InteractiveObject):
    ...
    def PresentFrame(self, theLeftCorner: Any, theMaxSize: Any) -> bool: ...
    def SetCallback(self, theCallbackFunction: Any, theCallbackUserPtr: None) -> None: ...
...
class AIS_RubberBand(AIS_InteractiveObject):
    ...
    def AddPoint(self, thePoint: Any) -> None: ...
...
class AIS_Trihedron(AIS_InteractiveObject):
    ...
    def HilightOwnerWithColor(self, thePM: PrsMgr_PresentationManager, theStyle: Prs3d_Drawer, theOwner: SelectMgr_EntityOwner) -> None: ...
    def HilightSelected(self, thePM: PrsMgr_PresentationManager, theOwners: Any) -> None: ...
