...
class AIS_ListOfInteractive:
    ...
    def Assign(self, theItem: AIS_ListOfInteractive) -> AIS_ListOfInteractive: ...
    def Clear(self) -> None: ...
...
class AIS_NListOfEntityOwner:
    def Append(self, theItem: False) -> False: ...
    def Assign(self, theItem: AIS_NListOfEntityOwner) -> AIS_NListOfEntityOwner: ...
    def Clear(self) -> None: ...
    def First(self) -> False: ...
    def Last(self) -> False: ...
    def Prepend(self, theItem: False) -> False: ...
...
AIS_KindOfInteractive_LightSource = (
    AIS_KindOfInteractive.AIS_KindOfInteractive_LightSource
)
...
AIS_NavigationMode_FirstPersonWalk = (
    AIS_NavigationMode.AIS_NavigationMode_FirstPersonWalk
)
...
AIS_TrihedronSelectionMode_Origin = (
    AIS_TrihedronSelectionMode.AIS_TrihedronSelectionMode_Origin
)
AIS_TrihedronSelectionMode_Axes = (
    AIS_TrihedronSelectionMode.AIS_TrihedronSelectionMode_Axes
)
...
class AIS_Animation(Standard_Transient):
    ...
    def Replace(
        self, theAnimationOld: AIS_Animation, theAnimationNew: AIS_Animation
    ) -> bool: ...
    ...
    def StartTimer(
        ...
        thePlaySpeed: float,
        theToUpdate: bool,
        theToStopTimer: Optional[bool] = False,
    ) -> None: ...
    def Stop(self) -> None: ...
...
class AIS_ExclusionFilter(SelectMgr_Filter):
    ...
    def __init__(
        ...
        ExclusionFlagOn: Optional[bool] = True,
    ) -> None: ...
    @overload
    def __init__(
        self,
    ...
    @overload
    def Add(
        self, TypeToExclude: AIS_KindOfInteractive, SignatureInType: int
    ) -> bool: ...
    def Clear(self) -> None: ...
    ...
    def ListOfSignature(
        self, aType: AIS_KindOfInteractive, TheStoredList: TColStd_ListOfInteger
    ) -> None: ...
...
class AIS_GraphicTool:
    ...
    @staticmethod
    def GetLineAtt(
        aDrawer: Prs3d_Drawer, TheTypeOfAttributes: AIS_TypeOfAttribute
    ) -> Tuple[Quantity_NameOfColor, float, Aspect_TypeOfLine]: ...
    @overload
    @staticmethod
    def GetLineColor(
        aDrawer: Prs3d_Drawer, TheTypeOfAttributes: AIS_TypeOfAttribute
...
class AIS_InteractiveContext(Standard_Transient):
    ...
    def ActivatedModes(
        self, anIobj: AIS_InteractiveObject, theList: TColStd_ListOfInteger
    ) -> None: ...
    def AddFilter(self, theFilter: SelectMgr_Filter) -> None: ...
    def AddOrRemoveCurrentObject(
        self, theObj: AIS_InteractiveObject, theIsToUpdateViewer: bool
    ) -> None: ...
    @overload
    def AddOrRemoveSelected(
        self, theObject: AIS_InteractiveObject, theToUpdateViewer: bool
    ) -> None: ...
    @overload
    def AddOrRemoveSelected(
        self, theOwner: SelectMgr_EntityOwner, theToUpdateViewer: bool
    ) -> None: ...
    @overload
    ...
    def ClearPrs(
        self, theIObj: AIS_InteractiveObject, theMode: int, theToUpdateViewer: bool
    ) -> None: ...
    ...
    def Disconnect(
        ...
        theObjToDisconnect: Optional[AIS_InteractiveObject] = None,
    ) -> None: ...
    @overload
    def Display(
        self, theIObj: AIS_InteractiveObject, theToUpdateViewer: bool
    ) -> None: ...
    @overload
    def Display(
        self,
        ...
        theDispStatus: Optional[PrsMgr_DisplayStatus] = PrsMgr_DisplayStatus_None,
    ) -> None: ...
    @overload
    def Display(
        self,
    ...
    def DisplayActiveSensitive(
        self, anObject: AIS_InteractiveObject, aView: V3d_View
    ) -> None: ...
    def DisplayAll(self, theToUpdateViewer: bool) -> None: ...
    def DisplayMode(self) -> int: ...
    def DisplayPriority(
        self, theIObj: AIS_InteractiveObject
    ...
    @overload
    def FitSelected(
        self, theView: V3d_View, theMargin: float, theToUpdate: bool
    ) -> None: ...
    @overload
    ...
    @overload
    def HighlightStyle(
        self, theObj: AIS_InteractiveObject, theStyle: Prs3d_Drawer
    ) -> bool: ...
    @overload
    def HighlightStyle(
        self, theOwner: SelectMgr_EntityOwner, theStyle: Prs3d_Drawer
    ) -> bool: ...
    def Hilight(
        self, theObj: AIS_InteractiveObject, theIsToUpdateViewer: bool
    ) -> None: ...
    ...
    def HilightNextDetected(
        self, theView: V3d_View, theToRedrawImmediate: Optional[bool] = True
    ) -> int: ...
    ...
    def ImmediateAdd(
        self, theObj: AIS_InteractiveObject, theMode: Optional[int] = 0
    ) -> bool: ...
    ...
    def IsoOnTriangulation(
        self, theIsEnabled: bool, theObject: AIS_InteractiveObject
    ) -> None: ...
    @overload
    ...
    @overload
    def Load(
        self, theObj: AIS_InteractiveObject, theSelectionMode: Optional[int] = -1
    ) -> None: ...
    ...
    @overload
    def MoveTo(
        self, theXPix: int, theYPix: int, theView: V3d_View, theToRedrawOnUpdate: bool
    ) -> AIS_StatusOfDetection: ...
    @overload
    def MoveTo(
        self, theAxis: gp_Ax1, theView: V3d_View, theToRedrawOnUpdate: bool
    ) -> AIS_StatusOfDetection: ...
    ...
    def ObjectsByDisplayStatus(
        self, theStatus: PrsMgr_DisplayStatus, theListOfIO: AIS_ListOfInteractive
    ) -> None: ...
    @overload
    def ObjectsByDisplayStatus(
        self,
    ...
    def ObjectsForView(
        ...
        theStatus: Optional[PrsMgr_DisplayStatus] = PrsMgr_DisplayStatus_None,
    ) -> None: ...
    def ObjectsInside(
        self,
        aListOfIO: AIS_ListOfInteractive,
        WhichKind: Optional[AIS_KindOfInteractive] = AIS_KindOfInteractive_None,
        WhichSignature: Optional[int] = -1,
    ) -> None: ...
    def PickingStrategy(self) -> SelectMgr_PickingStrategy: ...
    def PixelTolerance(self) -> int: ...
    def PlaneSize(self) -> Tuple[bool, float, float]: ...
    def PolygonOffsets(
        self, anObj: AIS_InteractiveObject
    ...
    def RecomputePrsOnly(
        ...
        theIObj: AIS_InteractiveObject,
        theToUpdateViewer: bool,
        theAllModes: Optional[bool] = False,
    ) -> None: ...
    ...
    def SelectDetected(
        self, theSelScheme: Optional[AIS_SelectionScheme] = AIS_SelectionScheme_Replace
    ) -> AIS_StatusOfPick: ...
    def SelectPoint(
        self,
        thePnt: Graphic3d_Vec2i,
        theView: V3d_View,
        theSelScheme: Optional[AIS_SelectionScheme] = AIS_SelectionScheme_Replace,
    ) -> AIS_StatusOfPick: ...
    def SelectPolygon(
        self,
        thePolyline: TColgp_Array1OfPnt2d,
    ...
    def SetAngleAndDeviation(
        self, theIObj: AIS_InteractiveObject, theAngle: float, theToUpdateViewer: bool
    ) -> None: ...
    ...
    def SetDisplayPriority(
        self, theIObj: AIS_InteractiveObject, thePriority: Graphic3d_DisplayPriority
    ) -> None: ...
    @overload
    def SetDisplayPriority(
        self, theIObj: AIS_InteractiveObject, thePriority: int
    ) -> None: ...
    ...
    def SetHighlightStyle(
        self, theStyleType: Prs3d_TypeOfHighlight, theStyle: Prs3d_Drawer
    ) -> None: ...
    @overload
    def SetHighlightStyle(self, theStyle: Prs3d_Drawer) -> None: ...
    def SetIsoNumber(
        self, NbIsos: int, WhichIsos: Optional[AIS_TypeOfIso] = AIS_TOI_Both
    ) -> None: ...
    ...
    def SetLocation(
        self, theObject: AIS_InteractiveObject, theLocation: TopLoc_Location
    ) -> None: ...
    def SetMaterial(
        self,
        theIObj: AIS_InteractiveObject,
    ...
    @overload
    def SetPlaneSize(
        self, theSizeX: float, theSizeY: float, theToUpdateViewer: bool
    ) -> None: ...
    @overload
    ...
    @overload
    def SetSelected(
        self, theOwners: SelectMgr_EntityOwner, theToUpdateViewer: bool
    ) -> None: ...
    @overload
    def SetSelected(
        self, theObject: AIS_InteractiveObject, theToUpdateViewer: bool
    ...
    def SetSelectedAspect(
        self, theAspect: Prs3d_BasicAspect, theToUpdateViewer: bool
    ) -> None: ...
    def SetSelectedState(
        self, theOwner: SelectMgr_EntityOwner, theIsSelected: bool
    ) -> bool: ...
    ...
    def SetSelectionModeActive(
        ...
        theMode: int,
        theToActivate: bool,
        theConcurrency: Optional[
            AIS_SelectionModesConcurrency
        ] = AIS_SelectionModesConcurrency_Multiple,
        theIsForce: Optional[bool] = False,
    ) -> None: ...
    def SetSelectionSensitivity(
        self, theObject: AIS_InteractiveObject, theMode: int, theNewSensitivity: int
    ) -> None: ...
    ...
    def SetTransformPersistence(
        self, theObject: AIS_InteractiveObject, theTrsfPers: Graphic3d_TransformPers
    ) -> None: ...
    def SetTransparency(
        self, theIObj: AIS_InteractiveObject, theValue: float, theToUpdateViewer: bool
    ) -> None: ...
    def SetTrihedronSize(self, theSize: float, theToUpdateViewer: bool) -> None: ...
    def SetViewAffinity(
        self, theIObj: AIS_InteractiveObject, theView: V3d_View, theIsVisible: bool
    ) -> None: ...
    def SetWidth(
        self, theIObj: AIS_InteractiveObject, theValue: float, theToUpdateViewer: bool
    ) -> None: ...
...
class AIS_LightSourceOwner(SelectMgr_EntityOwner):
    def __init__(
        self, theObject: AIS_LightSource, thePriority: Optional[int] = 5
    ) -> None: ...
...
class AIS_PointCloudOwner(SelectMgr_EntityOwner):
    ...
    def Unhilight(
        self, thePrsMgr: PrsMgr_PresentationManager, theMode: int
    ) -> None: ...
...
class AIS_ViewController(Aspect_WindowInputListener):
    ...
    def AddTouchPoint(
        ...
        theClearBefore: Optional[bool] = false,
    ) -> None: ...
    def ChangeInputBuffer(
        self, theType: AIS_ViewInputBufferType
    ) -> AIS_ViewInputBuffer: ...
    ...
    def FetchNavigationKeys(
        self, theCrouchRatio: float, theRunRatio: float
    ) -> AIS_WalkDelta: ...
    ...
    def FlushViewEvents(
        ...
        theCtx: AIS_InteractiveContext,
        theView: V3d_View,
        theToHandle: Optional[bool] = False,
    ) -> None: ...
    def GravityPoint(
        self, theCtx: AIS_InteractiveContext, theView: V3d_View
    ) -> gp_Pnt: ...
    ...
    def KeyDown(
        self, theKey: Aspect_VKey, theTime: float, thePressure: Optional[float] = 1.0
    ) -> None: ...
    def KeyFromAxis(
        self,
    ...
    def OnSubviewChanged(
        self, theCtx: AIS_InteractiveContext, theOldView: V3d_View, theNewView: V3d_View
    ) -> None: ...
    ...
    def RemoveTouchPoint(
        self, theId: int, theClearSelectPnts: Optional[bool] = false
    ) -> bool: ...
    ...
    def SelectInViewer(
        self,
        thePnt: Graphic3d_Vec2i,
        theScheme: Optional[AIS_SelectionScheme] = AIS_SelectionScheme_Replace,
    ) -> None: ...
    ...
    def UpdatePolySelection(
        self, thePnt: Graphic3d_Vec2i, theToAppend: bool
    ) -> None: ...
    def UpdateRubberBand(
        self, thePntFrom: Graphic3d_Vec2i, thePntTo: Graphic3d_Vec2i
    ) -> None: ...
    def UpdateTouchPoint(self, theId: int, thePnt: Graphic3d_Vec2d) -> None: ...
    def UpdateViewOrientation(
        self, theOrientation: V3d_TypeOfOrientation, theToFitAll: bool
    ) -> None: ...
    ...
    def handleCameraActions(
        self, theCtx: AIS_InteractiveContext, theView: V3d_View, theWalk: AIS_WalkDelta
    ) -> None: ...
    def handleMoveTo(
        self, theCtx: AIS_InteractiveContext, theView: V3d_View
    ) -> None: ...
    ...
    def handleOrbitRotation(
        self, theView: V3d_View, thePnt: gp_Pnt, theToLockZUp: bool
    ) -> None: ...
    ...
    def handleZFocusScroll(
        self, theView: V3d_View, theParams: Aspect_ScrollDelta
    ) -> None: ...
    def handleZRotate(self, theView: V3d_View) -> None: ...
    def handleZoom(
        self, theView: V3d_View, theParams: Aspect_ScrollDelta, thePnt: gp_Pnt
    ) -> None: ...
...
class AIS_ViewCubeSensitive(Select3D_SensitivePrimitiveArray):
    def __init__(
        self, theOwner: SelectMgr_EntityOwner, theTris: Graphic3d_ArrayOfTriangles
    ) -> None: ...
    def Matches(
        self,
...
class AIS_Axis(AIS_InteractiveObject):
    ...
    @overload
    def __init__(
        self, aComponent: Geom_Axis2Placement, anAxisType: AIS_TypeOfAxis
    ) -> None: ...
    @overload
...
class AIS_Circle(AIS_InteractiveObject):
    ...
    def __init__(
        ...
        theUStart: float,
        theUEnd: float,
        theIsFilledCircleSens: Optional[bool] = False,
    ) -> None: ...
...
class AIS_ColorScale(AIS_InteractiveObject):
    ...
    def AcceptDisplayMode(self, theMode: int) -> bool: ...
    def ColorRange(
        self, theMinColor: Quantity_Color, theMaxColor: Quantity_Color
    ) -> None: ...
    def Compute(
        self,
        thePrsMgr: PrsMgr_PresentationManager,
    ...
    @staticmethod
    def MakeUniformColors(
        theNbColors: int, theLightness: float, theHueFrom: float, theHueTo: float
    ...
    def SetUniformColors(
        self, theLightness: float, theHueFrom: float, theHueTo: float
    ) -> None: ...
...
class AIS_ConnectedInteractive(AIS_InteractiveObject):
    def __init__(
        self,
        aTypeOfPresentation3d: Optional[
    ...
    @overload
    def Connect(
        self, theAnotherObj: AIS_InteractiveObject, theLocation: gp_Trsf
    ) -> None: ...
    @overload
    def Connect(
        self, theAnotherObj: AIS_InteractiveObject, theLocation: TopLoc_Datum3D
    ) -> None: ...
...
class AIS_LightSource(AIS_InteractiveObject):
    ...
    def SetMarkerImage(
        self, theImage: Graphic3d_MarkerImage, theIsEnabled: bool
    ) -> None: ...
    def SetMarkerType(
        self, theType: Aspect_TypeOfMarker, theIsEnabled: bool
    ) -> None: ...
...
class AIS_Manipulator(AIS_InteractiveObject):
    ...
    def HilightSelected(
        self, thePM: PrsMgr_PresentationManager, theSeq: SelectMgr_SequenceOfOwner
    ) -> None: ...
    ...
    def ObjectTransformation(
        self, theX: int, theY: int, theView: V3d_View, theTrsf: gp_Trsf
    ) -> bool: ...
    ...
    @overload
    def SetPart(
        self, theAxisIndex: int, theMode: AIS_ManipulatorMode, theIsEnabled: bool
    ) -> None: ...
    @overload
...
class AIS_MediaPlayer(AIS_InteractiveObject):
    ...
    def PresentFrame(
        self, theLeftCorner: Graphic3d_Vec2i, theMaxSize: Graphic3d_Vec2i
    ) -> bool: ...
...
class AIS_MultipleConnectedInteractive(AIS_InteractiveObject):
    ...
    @overload
    def Connect(
        self, theAnotherObj: AIS_InteractiveObject
    ) -> AIS_InteractiveObject: ...
    @overload
    def Connect(
        self, theAnotherObj: AIS_InteractiveObject, theLocation: gp_Trsf
...
class AIS_Plane(AIS_InteractiveObject):
    @overload
    def __init__(
        self, aComponent: Geom_Plane, aCurrentMode: Optional[bool] = False
    ) -> None: ...
    @overload
    def __init__(
        self,
        ...
        aCenter: gp_Pnt,
        aCurrentMode: Optional[bool] = False,
    ) -> None: ...
    @overload
    def __init__(
        self,
    ...
    def PlaneAttributes(
        self, aComponent: Geom_Plane, aCenter: gp_Pnt, aPmin: gp_Pnt, aPmax: gp_Pnt
    ) -> bool: ...
    def SetAxis2Placement(
        self, aComponent: Geom_Axis2Placement, aPlaneType: AIS_TypeOfPlane
    ) -> None: ...
    ...
    def SetTypeOfSensitivity(
        self, theTypeOfSensitivity: Select3D_TypeOfSensitivity
    ) -> None: ...
    def Signature(self) -> int: ...
...
class AIS_PointCloud(AIS_InteractiveObject):
    ...
    def SetPoints(
        ...
        theColors: Optional[Quantity_HArray1OfColor] = None,
        theNormals: Optional[TColgp_HArray1OfDir] = None,
    ) -> None: ...
    def UnsetColor(self) -> None: ...
...
class AIS_RubberBand(AIS_InteractiveObject):
    ...
    def __init__(
        ...
        theLineWidth: Optional[float] = 1.0,
        theIsPolygonClosed: Optional[bool] = True,
    ) -> None: ...
    @overload
    def __init__(
        self,
        ...
        theTransparency: Optional[float] = 1.0,
        theLineWidth: Optional[float] = 1.0,
        theIsPolygonClosed: Optional[bool] = True,
    ) -> None: ...
    ...
    def SetRectangle(
        self, theMinX: int, theMinY: int, theMaxX: int, theMaxY: int
    ) -> None: ...
...
class AIS_SignatureFilter(AIS_TypeFilter):
    def __init__(
        self, aGivenKind: AIS_KindOfInteractive, aGivenSignature: int
    ) -> None: ...
    def IsOk(self, anobj: SelectMgr_EntityOwner) -> bool: ...
...
class AIS_TextLabel(AIS_InteractiveObject):
    ...
    def SetHJustification(
        self, theHJust: Graphic3d_HorizontalTextAlignment
    ) -> None: ...
...
class AIS_Trihedron(AIS_InteractiveObject):
    ...
    def HilightSelected(
        self, thePM: PrsMgr_PresentationManager, theOwners: SelectMgr_SequenceOfOwner
    ) -> None: ...
    ...
    @overload
    def SetArrowColor(
        self, thePart: Prs3d_DatumParts, theColor: Quantity_Color
    ) -> None: ...
    ...
    def SetSelectionPriority(
        self, thePart: Prs3d_DatumParts, thePriority: int
    ) -> None: ...
...
class AIS_ViewCube(AIS_InteractiveObject):
    ...
    def SetBoxSideLabel(
        self, theSide: V3d_TypeOfOrientation, theLabel: str
    ) -> None: ...
    ...
    def SetSize(
        self, theValue: float, theToAdaptAnother: Optional[bool] = true
    ) -> None: ...
    def SetTextColor(self, theColor: Quantity_Color) -> None: ...
    def SetTransparency(self, theValue: float) -> None: ...
    def SetViewAnimation(self, theAnimation: AIS_AnimationCamera) -> None: ...
    def SetYup(
        self, theIsYup: bool, theToUpdateLabels: Optional[bool] = True
    ) -> None: ...
    def Size(self) -> float: ...
...
class AIS_XRTrackedDevice(AIS_InteractiveObject):
    @overload
    def __init__(
        self, theTris: Graphic3d_ArrayOfTriangles, theTexture: Image_Texture
    ) -> None: ...
    @overload
    def __init__(self) -> None: ...
...
class AIS_ColoredShape(AIS_Shape):
    ...
    def SetColor(self, theColor: Quantity_Color) -> None: ...
    def SetCustomColor(
        self, theShape: TopoDS_Shape, theColor: Quantity_Color
    ) -> None: ...
    def SetCustomTransparency(
        self, theShape: TopoDS_Shape, theTransparency: float
    ) -> None: ...
    ...
    def UnsetCustomAspects(
        self, theShape: TopoDS_Shape, theToUnregister: Optional[bool] = False
    ) -> None: ...
    def UnsetTransparency(self) -> None: ...
    def UnsetWidth(self) -> None: ...
...
class AIS_TexturedShape(AIS_Shape):
    ...
    def SetTextureOrigin(
        ...
        theUOrigin: Optional[float] = 0.0,
        theVOrigin: Optional[float] = 0.0,
    ) -> None: ...
    def SetTexturePixMap(self, theTexturePixMap: Image_PixMap) -> None: ...
    def SetTextureRepeat(
        self,
        theToRepeat: bool,
        theURepeat: Optional[float] = 1.0,
        theVRepeat: Optional[float] = 1.0,
    ) -> None: ...
    def SetTextureScale(
        self,
        theToSetTextureScale: bool,
        theScaleU: Optional[float] = 1.0,
        theScaleV: Optional[float] = 1.0,
    ) -> None: ...
