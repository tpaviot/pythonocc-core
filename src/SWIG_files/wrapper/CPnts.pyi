...
class CPnts_AbscissaPoint:
    ...
    @overload
    @staticmethod
    def Length(C: Adaptor3d_Curve) -> False: ...
    @overload
    @staticmethod
    def Length(C: Adaptor2d_Curve2d) -> False: ...
    @overload
    @staticmethod
    def Length(C: Adaptor3d_Curve, Tol: float) -> False: ...
    @overload
    @staticmethod
    def Length(C: Adaptor2d_Curve2d, Tol: float) -> False: ...
    @overload
    @staticmethod
    def Length(C: Adaptor3d_Curve, U1: float, U2: float) -> False: ...
    @overload
    @staticmethod
    def Length(C: Adaptor2d_Curve2d, U1: float, U2: float) -> False: ...
    @overload
    @staticmethod
    def Length(C: Adaptor3d_Curve, U1: float, U2: float, Tol: float) -> False: ...
    @overload
    @staticmethod
    def Length(C: Adaptor2d_Curve2d, U1: float, U2: float, Tol: float) -> False: ...
