...
class IntRes2d_SequenceOfIntersectionPoint:
    def Assign(
        self, theItem: IntRes2d_IntersectionPoint
...
class IntRes2d_SequenceOfIntersectionSegment:
    def Assign(
        self, theItem: IntRes2d_IntersectionSegment
    ...
    def Reverse(self) -> None: ...
    def SetValue(
        self, theIndex: int, theValue: IntRes2d_IntersectionSegment
    ) -> None: ...
    def Size(self) -> int: ...
    def UpdateUpperBound(self, int) -> None: ...
    def UpdateLowerBound(self, int) -> None: ...
...
class IntRes2d_IntersectionSegment:
    ...
    @overload
    def __init__(
        self, P: IntRes2d_IntersectionPoint, First: bool, Oppos: bool, ReverseFlag: bool
    ) -> None: ...
    @overload
...
class IntRes2d_Transition:
    ...
    @overload
    def __init__(
        self, Tangent: bool, Pos: IntRes2d_Position, Type: IntRes2d_TypeTrans
    ) -> None: ...
    @overload
    def __init__(
        self,
