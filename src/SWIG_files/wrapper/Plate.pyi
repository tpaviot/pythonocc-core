...
class Plate_SequenceOfLinearScalarConstraint:
    def Assign(
        self, theItem: Plate_LinearScalarConstraint
    ...
    def SetValue(
        self, theIndex: int, theValue: Plate_LinearScalarConstraint
    ) -> None: ...
    def Size(self) -> int: ...
...
class Plate_SequenceOfLinearXYZConstraint:
    def Assign(
        self, theItem: Plate_LinearXYZConstraint
...
class Plate_SequenceOfPinpointConstraint:
    def Assign(self, theItem: Plate_PinpointConstraint) -> Plate_PinpointConstraint: ...
    def Clear(self) -> None: ...
    def First(self) -> Plate_PinpointConstraint: ...
    def IsDeletables(self) -> bool: ...
    def IsEmpty(self) -> bool: ...
    ...
    def Lower(self) -> int: ...
    def Prepend(
        self, theItem: Plate_PinpointConstraint
...
class Plate_D3:
    @overload
    def __init__(
        self, duuu: gp_XYZ, duuv: gp_XYZ, duvv: gp_XYZ, dvvv: gp_XYZ
    ) -> None: ...
    @overload
...
class Plate_FreeGtoCConstraint:
    ...
    def __init__(
        ...
        D1S: Plate_D1,
        D1T: Plate_D1,
        IncrementalLoad: Optional[float] = 1.0,
...
class Plate_GtoCConstraint:
    ...
    @overload
    def __init__(
        self, point2d: gp_XY, D1S: Plate_D1, D1T: Plate_D1, nP: gp_XYZ
    ) -> None: ...
    @overload
    def __init__(
        self, point2d: gp_XY, D1S: Plate_D1, D1T: Plate_D1, D2S: Plate_D2, D2T: Plate_D2
    ) -> None: ...
    @overload
    def __init__(
        self,
...
class Plate_LineConstraint:
    def __init__(
        self, point2d: gp_XY, lin: gp_Lin, iu: Optional[int] = 0, iv: Optional[int] = 0
    ) -> None: ...
...
class Plate_LinearScalarConstraint:
    ...
    @overload
    def __init__(
        self, thePPC: Plate_Array1OfPinpointConstraint, theCoeff: TColgp_Array1OfXYZ
    ) -> None: ...
    @overload
    def __init__(
        self, thePPC: Plate_Array1OfPinpointConstraint, theCoeff: TColgp_Array2OfXYZ
    ) -> None: ...
    @overload
...
class Plate_LinearXYZConstraint:
    ...
    @overload
    def __init__(
        self, thePPC: Plate_Array1OfPinpointConstraint, theCoeff: TColStd_Array1OfReal
    ) -> None: ...
    @overload
    def __init__(
        self, thePPC: Plate_Array1OfPinpointConstraint, theCoeff: TColStd_Array2OfReal
    ) -> None: ...
    @overload
    def __init__(self, ColLen: int, RowLen: int) -> None: ...
...
class Plate_PlaneConstraint:
    def __init__(
        self, point2d: gp_XY, pln: gp_Pln, iu: Optional[int] = 0, iv: Optional[int] = 0
    ) -> None: ...
    def LSC(self) -> Plate_LinearScalarConstraint: ...
...
class Plate_Plate:
    ...
    def SolveTI(
        self,
        ord: Optional[int] = 4,
        anisotropie: Optional[float] = 1.0,
...
class Plate_HArray1OfPinpointConstraint(
    Plate_Array1OfPinpointConstraint, Standard_Transient
):
    def __init__(self, theLower: int, theUpper: int) -> None: ...
