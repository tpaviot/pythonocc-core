...
class Plate_SequenceOfLinearScalarConstraint:
    def Assign(self, theItem: Plate_LinearScalarConstraint) -> Plate_LinearScalarConstraint: ...
    def Clear(self) -> None: ...
...
class Plate_SequenceOfLinearXYZConstraint:
    def Assign(self, theItem: Plate_LinearXYZConstraint) -> Plate_LinearXYZConstraint: ...
    def Clear(self) -> None: ...
