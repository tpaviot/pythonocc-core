...
class gp_Mat:
    ...
    def ChangeValue(self, theRow: int, theCol: int) -> False: ...
    ...
    def Value(self, theRow: int, theCol: int) -> False: ...
...
class gp_XY:
    ...
    def ChangeCoord(self, theIndex: int) -> False: ...
    @overload
    def Coord(self, theIndex: int) -> float: ...
