...
from OCC.TopoDS import topods, TopoDS_Wire, TopoDS_Vertex, TopoDS_Edge, TopoDS_Face, TopoDS_Shell, TopoDS_Solid, \
    TopoDS_Compound, TopoDS_CompSolid, topods_Edge, topods_Vertex
...
def dump_topology(shape,level=0):
    ...
    from OCC.Utils.enum import topo_lut, shape_lut
